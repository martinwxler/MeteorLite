...
public class VorbisFloor {
   @ObfuscatedName("v")
   static final int[] field403 = new int[]{256, 128, 86, 64};
   @ObfuscatedName("n")
      ...
      if (var1 != 1) {
         ...
         for(var4 = 0; var4 < var3; ++var4) {
            ...
            for(var6 = 0; var6 < var5; ++var6) {
               var7[var6] = VorbisSample.readBits(8) - 1;
            }
         }
         ...
         this.field405 = new int[var5];
         this.field405[0] = 0;
         this.field405[1] = 1 << var4;
         var5 = 2;

         for(var9 = 0; var9 < var2; ++var9) {
            var6 = this.partitionClassList[var9];
         ...
         if (field410 == null || field410.length < var5) {
            field410 = new int[var5];
            field413 = new int[var5];
            field412 = new boolean[var5];
         }
   ...
   void VarbisFloor_sort(int var1, int var2) {
      if (var1 < var2) {
         ...
         int var5 = field413[var1];
         boolean var6 = field412[var1];

         for(int var7 = var1 + 1; var7 <= var2; ++var7) {
            int var8 = field410[var7];
            if (var8 < var4) {
               field410[var3] = var8;
               field413[var3] = field413[var7];
               field412[var3] = field412[var7];
               ++var3;
               field410[var7] = field410[var3];
               field413[var7] = field413[var3];
               field412[var7] = field412[var3];
            }
         }
   ...
   boolean readSubmapFloor() {
      ...
      if (!var1) {
         ...
         var3 = field403[this.multiplier - 1];
         int var4 = CollisionMap.iLog(var3 - 1);
         field413[0] = VorbisSample.readBits(var4);
         field413[1] = VorbisSample.readBits(var4);
         int var5 = 2;
         ...
         for(int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
            ...
            for(int var12 = 0; var12 < var8; ++var12) {
               ...
               var11 >>>= var9;
               field413[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method1014() : 0;
            }
         }
   ...
   void method712(float[] var1, int var2) {
      int var3 = this.field405.length;
      int var4 = field403[this.multiplier - 1];
      boolean[] var5 = field412;
      field412[1] = true;
      var5[0] = true;
      ...
      for(var6 = 2; var6 < var3; ++var6) {
         var7 = method705(field410, var6);
         var8 = method721(field410, var6);
         var9 = this.method706(field410[var7], field413[var7], field410[var8], field413[var8], field410[var6]);
         var10 = field413[var6];
         int var11 = var4 - var9;
         int var12 = (var11 < var9 ? var11 : var9) << 1;
         if (var10 != 0) {
            boolean[] var13 = field412;
            field412[var8] = true;
            var13[var7] = true;
            field412[var6] = true;
            if (var10 >= var12) {
               field413[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
            } else {
               field413[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
            }
         } else {
            field412[var6] = false;
            field413[var6] = var9;
      ...
      var6 = 0;
      var7 = field413[0] * this.multiplier;

      for(var8 = 1; var8 < var3; ++var8) {
         if (field412[var8]) {
            var9 = field410[var8];
            var10 = field413[var8] * this.multiplier;
            this.method719(var6, var7, var9, var10, var1, var2);
            if (var9 >= var2) {
               return;
            }
      ...
      float var14 = VorbisFloor_decibelStatics[var7];
