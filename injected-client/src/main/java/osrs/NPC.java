...
public final class NPC extends Actor {
   ...
   protected final Model getModel() {
      if (this.definition == null) {
         ...
         SequenceDefinition var2 = super.movementSequence != -1 && (super.idleSequence != super.movementSequence || var1 == null) ? LoginScreenAnimation.SequenceDefinition_get(super.movementSequence) : null;
   ...
   final void method2260(int var1, int var2, boolean var3) {
      ...
      super.pathX[0] = var1;
      super.pathY[0] = var2;
      super.x = super.pathX[0] * 128 + super.field1239 * 64;
      super.y = super.pathY[0] * 128 + super.field1239 * 64;
   }
