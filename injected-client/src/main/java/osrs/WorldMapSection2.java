...
public class WorldMapSection2 implements WorldMapSection {
   ...
   public int[] getBorderTileLengths(int var1, int var2, int var3) {
      if (!this.containsCoord(var1, var2, var3)) {
         ...
         int[] var4 = new int[]{var2 + (this.field1952 * 64 - this.regionStartX * 64), var3 + (this.field1947 * 64 - this.regionStartY * 64)};
         return var4;
      }
   }
   ...
   public Coord coord(int var1, int var2) {
      if (!this.containsPosition(var1, var2)) {
         ...
         int var4 = var2 + (this.regionStartY * 64 - this.field1947 * 64);
      ...
      if (var0 == 3300) {
         ...
         if (var0 == 3301) {
            ...
            if (var0 == 3308) {
               ...
               var4 = (class93.localPlayer.x >> 7) + VertexNormal.baseX;
               var5 = (class93.localPlayer.y >> 7) + SoundSystem.baseY;
               ...
               class44.Interpreter_intStackSize -= 2;
               var3 = Interpreter.Interpreter_intStack[class44.Interpreter_intStackSize] + '耀';
               var4 = Interpreter.Interpreter_intStack[class44.Interpreter_intStackSize + 1];
               Interpreter.Interpreter_intStack[++class44.Interpreter_intStackSize - 1] = GameEngine.method538(var3, var4);
               return 1;
            } else if (var0 == 3314) {
