...
public class Bounds {
   ...
   void method5981(Bounds var1, Bounds var2) {
      ...
      if (this.lowX < var1.lowX) {
         var2.highX = (var2.highX * -888661779 - (var1.lowX * -888661779 - this.lowX * -888661779)) * -250215195;
         var2.lowX = var1.lowX;
      }
   ...
   void method5982(Bounds var1, Bounds var2) {
      ...
      if (this.lowY < var1.lowY) {
         var2.highY = (var2.highY * 1584612999 - (var1.lowY * 1584612999 - this.lowY * 1584612999)) * 1839374135;
         var2.lowY = var1.lowY;
      }
