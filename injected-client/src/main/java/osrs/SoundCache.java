   ...
   public static void method830() {
      try {
         ...
         if (var0.exists()) {
            ...
            label34:
            for(int var2 = 0; var2 < PlayerType.cacheSubPaths.length; ++var2) {
               for(var1 = 0; var1 < InterfaceParent.cacheParentPaths.length; ++var1) {
                  File var3 = new File(InterfaceParent.cacheParentPaths[var1] + PlayerType.cacheSubPaths[var2] + File.separatorChar + "random.dat");
                  if (var3.exists()) {
