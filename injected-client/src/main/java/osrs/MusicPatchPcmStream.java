...
public class MusicPatchPcmStream extends PcmStream {
   ...
   void method4604(MusicPatchNode var1, int[] var2, int var3, int var4, int var5) {
      if ((this.superStream.field2846[var1.field2905] & 4) != 0 && var1.field2895 < 0) {
         int var6 = this.superStream.field2851[var1.field2905] / PcmPlayer.field428;
         ...
         while(true) {
            ...
            int var8 = PcmPlayer.field428 / 100;
   ...
   void method4605(MusicPatchNode var1, int var2) {
      if ((this.superStream.field2846[var1.field2905] & 4) != 0 && var1.field2895 < 0) {
         int var3 = this.superStream.field2851[var1.field2905] / PcmPlayer.field428;
   ...
   protected void fill(int[] var1, int var2, int var3) {
      ...
      for(MusicPatchNode var4 = (MusicPatchNode)this.queue.last(); var4 != null; var4 = (MusicPatchNode)this.queue.previous()) {
         if (!this.superStream.method4442(var4)) {
            int var5 = var2;
            int var6 = var3;

            do {
               if (var6 <= var4.field2891) {
                  this.method4604(var4, var1, var5, var6, var5 + var6);
                  var4.field2891 -= var6;
                  break;
               }

               this.method4604(var4, var1, var5, var4.field2891, var6 + var5);
               var5 += var4.field2891;
               var6 -= var4.field2891;
            } while(!this.superStream.method4443(var4, var1, var5, var6));
         }
      }
   ...
   protected void skip(int var1) {
      ...
      for(MusicPatchNode var2 = (MusicPatchNode)this.queue.last(); var2 != null; var2 = (MusicPatchNode)this.queue.previous()) {
         if (!this.superStream.method4442(var2)) {
            int var3 = var1;

            do {
               if (var3 <= var2.field2891) {
                  this.method4605(var2, var3);
                  var2.field2891 -= var3;
                  break;
               }

               this.method4605(var2, var2.field2891);
               var3 -= var2.field2891;
            } while(!this.superStream.method4443(var2, (int[])null, 0, var3));
         }
      }
