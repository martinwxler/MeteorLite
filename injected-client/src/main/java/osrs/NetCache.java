...
public class NetCache {
   ...
   @ObfuscatedName("w")
   public static byte field3607 = 0;
   @ObfuscatedName("t")
   @ObfuscatedGetter(
      intValue = -1063840627
   )
   ...
   static final void method5025(int var0, int var1, int var2, int var3) {
      ...
      for(var9 = 0; var9 < var7 + Client.npcCount; ++var9) {
         ...
         Ignored.drawActor2d((Actor)var10, var9, var0, var1, var2, var3);
      }
      ...
      for(var9 = 0; var9 < Client.overheadTextCount; ++var9) {
         ...
         if (Client.chatEffects == 0) {
            ...
            if (Client.overheadTextEffects[var9] == 0) {
               Widget.fontBold12.drawCentered(var20, var0 + Client.viewportTempX, Client.viewportTempY + var1, var16, 0);
            }

            if (Client.overheadTextEffects[var9] == 1) {
               Widget.fontBold12.drawCenteredWave(var20, var0 + Client.viewportTempX, Client.viewportTempY + var1, var16, 0, Client.viewportDrawCount);
            }

            if (Client.overheadTextEffects[var9] == 2) {
               Widget.fontBold12.drawCenteredWave2(var20, var0 + Client.viewportTempX, Client.viewportTempY + var1, var16, 0, Client.viewportDrawCount);
            }

            if (Client.overheadTextEffects[var9] == 3) {
               Widget.fontBold12.drawCenteredShake(var20, var0 + Client.viewportTempX, Client.viewportTempY + var1, var16, 0, Client.viewportDrawCount, 150 - Client.overheadTextCyclesRemaining[var9]);
            }

            if (Client.overheadTextEffects[var9] == 4) {
               var17 = (150 - Client.overheadTextCyclesRemaining[var9]) * (Widget.fontBold12.stringWidth(var20) + 100) / 150;
               Rasterizer2D.Rasterizer2D_expandClip(var0 + Client.viewportTempX - 50, var1, var0 + Client.viewportTempX + 50, var3 + var1);
               Widget.fontBold12.draw(var20, var0 + Client.viewportTempX + 50 - var17, Client.viewportTempY + var1, var16, 0);
            ...
            if (Client.overheadTextEffects[var9] == 5) {
               ...
               Widget.fontBold12.drawCentered(var20, var0 + Client.viewportTempX, var18 + Client.viewportTempY + var1, var16, 0);
               Rasterizer2D.Rasterizer2D_setClip(var0, var1, var0 + var2, var3 + var1);
            }
         } else {
            Widget.fontBold12.drawCentered(var20, var0 + Client.viewportTempX, Client.viewportTempY + var1, 16776960, 0);
         }
      }
