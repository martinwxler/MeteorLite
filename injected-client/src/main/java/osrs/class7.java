...
public class class7 extends class16 {
   ...
   static final void logOut() {
      ...
      NetCache.archive0.clearFiles();
      class27.archive1.clearFiles();
      ClanChannel.archive3.clearFiles();
      class32.archive4.clearFiles();
      class247.archive5.clearFiles();
      UrlRequest.archive6.clearFiles();
      Decimator.archive7.clearFiles();
      GrandExchangeOfferAgeComparator.archive8.clearFiles();
      CollisionMap.archive9.clearFiles();
   ...
   static final void updateActorSequence(Actor var0, int var1) {
      ...
      if (var0.x < 128 || var0.y < 128 || var0.x >= 13184 || var0.y >= 13184) {
         ...
         var0.field1265 = 0;
         var0.field1283 = 0;
         var0.x = var0.field1239 * 64 + var0.pathX[0] * 128;
