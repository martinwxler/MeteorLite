   ...
   static final void addPendingSpawnToScene(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      if (var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) {
         ...
         if (0L != var7) {
            ...
            int var13 = class93.Entity_unpackID(var7);
            int var14 = var12 & 31;
            int var15 = var12 >> 6 & 3;
            ObjectComposition var16;
            if (var1 == 0) {
               AbstractSocket.scene.removeBoundaryObject(var0, var2, var3);
               var16 = class23.getObjectDefinition(var13);
               if (var16.interactType != 0) {
                  Client.collisionMaps[var0].method3156(var2, var3, var14, var15, var16.boolean1);
               }
            }
