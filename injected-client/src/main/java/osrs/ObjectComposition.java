...
public class ObjectComposition extends DualNode {
   ...
   static ModelData[] field1758 = new ModelData[4];
   @ObfuscatedName("d")
   @ObfuscatedGetter(
      intValue = 1257920551
   )
      ...
      if (this.models != null) {
         for(int var4 = 0; var4 < this.models.length; ++var4) {
            if (this.models[var4] == var1) {
               return class310.ObjectDefinition_modelsArchive.tryLoadFile(this.modelIds[var4] & '\uffff', 0);
            }
         }
         ...
         for(int var3 = 0; var3 < this.modelIds.length; ++var3) {
            var2 &= class310.ObjectDefinition_modelsArchive.tryLoadFile(this.modelIds[var3] & '\uffff', 0);
         }
   ...
   public final boolean needsModelFiles() {
      if (this.modelIds == null) {
         ...
         for(int var2 = 0; var2 < this.modelIds.length; ++var2) {
            var1 &= class310.ObjectDefinition_modelsArchive.tryLoadFile(this.modelIds[var2] & '\uffff', 0);
         }
   ...
   public final Renderable getEntity(int var1, int var2, int[][] var3, int var4, int var5, int var6) {
      ...
      if (this.clipType >= 0) {
         if (var9 instanceof Model) {
            ...
            var9 = ((ModelData)var9).method3761(var3, var4, var5, var6, true, this.clipType);
         }
      }
   ...
   final ModelData getModelData(int var1, int var2) {
      ...
      if (this.models == null) {
         ...
         for(var7 = 0; var7 < var5; ++var7) {
            ...
            if (var3 == null) {
               var3 = ModelData.ModelData_get(class310.ObjectDefinition_modelsArchive, var6 & '\uffff', 0);
               if (var3 == null) {
                  return null;
               }
         ...
         if (var3 == null) {
            var3 = ModelData.ModelData_get(class310.ObjectDefinition_modelsArchive, var5 & '\uffff', 0);
            if (var3 == null) {
               return null;
            }
      ...
      if (var4) {
         var9.resize(this.modelSizeX, this.modelHeight, this.modelSizeY);
      }

      if (var10) {
         var9.changeOffset(this.offsetX, this.offsetHeight, this.offsetY);
      }
   ...
   static void findItemDefinitions(String var0, boolean var1) {
      ...
      for(int var4 = 0; var4 < ItemComposition.ItemDefinition_fileCount; ++var4) {
         ItemComposition var5 = class260.ItemDefinition_get(var4);
      ...
      for(int var9 = 0; var9 < ClanSettings.foundItemIdCount; ++var9) {
         var8[var9] = class260.ItemDefinition_get(var2[var9]).name;
      }
