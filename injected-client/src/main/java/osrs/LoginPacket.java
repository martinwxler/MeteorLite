...
public class LoginPacket implements class223 {
   ...
   public static final LoginPacket field2806 = new LoginPacket(14, 0);
   @ObfuscatedName("n")
   @ObfuscatedSignature(
      descriptor = "Lhv;"
   )
   static final LoginPacket field2800 = new LoginPacket(15, 4);
   @ObfuscatedName("f")
   @ObfuscatedSignature(
      descriptor = "Lhv;"
   )
   public static final LoginPacket field2802 = new LoginPacket(16, -2);
   @ObfuscatedName("y")
   @ObfuscatedSignature(
      descriptor = "Lhv;"
   )
   public static final LoginPacket field2799 = new LoginPacket(18, -2);
   @ObfuscatedName("p")
   @ObfuscatedSignature(
      descriptor = "Lhv;"
   )
   public static final LoginPacket field2803 = new LoginPacket(19, -2);
   @ObfuscatedName("j")
   @ObfuscatedSignature(
      descriptor = "Lhv;"
   )
   static final LoginPacket field2804 = new LoginPacket(27, 0);
   @ObfuscatedName("b")
   @ObfuscatedSignature(
      descriptor = "[Lhv;"
   )
