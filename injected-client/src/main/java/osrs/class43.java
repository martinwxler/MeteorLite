...
public class class43 {
   ...
   static Script getWorldMapScript(int var0, int var1, int var2) {
      ...
      Script var4 = (Script)Script.Script_cached.get((long)(var3 << 16));
      Script var5;
      if (var4 != null) {
         var5 = var4;
      } else {
         String var6 = String.valueOf(var3);
         int var7 = UserComparator5.archive12.getGroupId(var6);
         if (var7 == -1) {
            var5 = null;
         } else {
            label57: {
               byte[] var8 = UserComparator5.archive12.takeFileFlat(var7);
               if (var8 != null) {
                  if (var8.length <= 1) {
                     var5 = null;
                     break label57;
                  ...
                  var4 = UserList.newScript(var8);
                  if (var4 != null) {
                     Script.Script_cached.put(var4, (long)(var3 << 16));
                     var5 = var4;
                     break label57;
                  }
               }
      ...
      if (var5 != null) {
         ...
         Script var13 = (Script)Script.Script_cached.get((long)(var12 << 16));
         Script var14;
         if (var13 != null) {
            var14 = var13;
         } else {
            String var9 = String.valueOf(var12);
            int var10 = UserComparator5.archive12.getGroupId(var9);
            if (var10 == -1) {
               var14 = null;
            } else {
               byte[] var11 = UserComparator5.archive12.takeFileFlat(var10);
               if (var11 != null) {
                  if (var11.length <= 1) {
                     var14 = null;
                  ...
                  var13 = UserList.newScript(var11);
                  if (var13 != null) {
                     Script.Script_cached.put(var13, (long)(var12 << 16));
   ...
   protected static int getGcDuration() {
      ...
      if (class124.garbageCollector != null) {
         ...
         GameEngine.garbageCollectorLastCheckTimeMs = var10;
      }
