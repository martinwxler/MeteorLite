...
public class ItemComposition extends DualNode {
   ...
   public final ModelData getModelData(int var1) {
      ...
      if (this.countobj != null && var1 > 1) {
         ...
         if (var3 != -1) {
            return class260.ItemDefinition_get(var3).getModelData(1);
         }
      }
   ...
   static void readPlayerUpdate(PacketBuffer var0, int var1) {
      ...
      if (var3 == 0) {
         if (var2) {
            ...
            Players.Players_regions[var1] = (var4.plane << 28) + (VertexNormal.baseX + var4.pathX[0] >> 13 << 14) + (SoundSystem.baseY + var4.pathY[0] >> 13);
            if (var4.field1264 != -1) {
         ...
         if (var3 == 1) {
            ...
            if (var5 == 0) {
               ...
               var8 = var6 >> 14 & 16383;
               var9 = var6 & 16383;
               var10 = (var8 + VertexNormal.baseX + var4.pathX[0] & 16383) - VertexNormal.baseX;
               var11 = (var9 + SoundSystem.baseY + var4.pathY[0] & 16383) - SoundSystem.baseY;
               if (Client.localPlayerIndex == var1 && (var4.x < 1536 || var4.y < 1536 || var4.x >= 11776 || var4.y >= 11776)) {
                  var4.resetPath(var10, var11);
                  var4.field1218 = false;
               } else if (var2) {
