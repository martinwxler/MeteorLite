...
public class class169 implements WorldMapSection {
   ...
   public int[] getBorderTileLengths(int var1, int var2, int var3) {
      if (!this.containsCoord(var1, var2, var3)) {
         ...
         int[] var4 = new int[]{var2 + (this.field2014 * 64 - this.field2012 * 64) + (this.field2013 * 8 - this.field2010 * 8), var3 + (this.field2015 * 64 - this.field2016 * 64) + (this.field2019 * 8 - this.field2017 * 8)};
         return var4;
      }
   }
   ...
   public Coord coord(int var1, int var2) {
      if (!this.containsPosition(var1, var2)) {
         ...
         int var4 = var2 + (this.field2016 * 64 - this.field2015 * 64) + (this.field2017 * 8 - this.field2019 * 8);
   ...
   static void method3549(int var0, int var1, int var2, int var3) {
      for(ObjectSound var4 = (ObjectSound)ObjectSound.objectSounds.last(); var4 != null; var4 = (ObjectSound)ObjectSound.objectSounds.previous()) {
         if (var4.soundEffectId != -1 || var4.soundEffectIds != null) {
            int var5 = 0;
            if (var1 > var4.field956) {
               var5 += var1 - var4.field956;
            } else if (var1 < var4.x) {
               var5 += var4.x - var1;
            }

            if (var2 > var4.field957) {
            ...
            if (var5 - 64 <= var4.field958 && ObjectComposition.clientPreferences.areaSoundEffectsVolume != 0 && var0 == var4.plane) {
               ...
               if (var4.stream1 == null) {
                  if (var4.soundEffectId >= 0) {
                     SoundEffect var7 = SoundEffect.readSoundEffect(class32.archive4, var4.soundEffectId, 0);
                     if (var7 != null) {
               ...
               if (var4.stream2 == null) {
                  if (var4.soundEffectIds != null && (var4.field954 -= var3) <= 0) {
                     ...
                     SoundEffect var12 = SoundEffect.readSoundEffect(class32.archive4, var4.soundEffectIds[var11], 0);
                     if (var12 != null) {
