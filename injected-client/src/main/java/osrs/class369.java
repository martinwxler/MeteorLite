...
public class class369 extends class340 implements class216 {
   ...
   final DemotingHashTable field4118 = new DemotingHashTable(64);
   @ObfuscatedName("y")
   @ObfuscatedGetter(
      intValue = 640434103
   )
   ...
   protected class342 vmethod6434(int var1) {
      DemotingHashTable var2 = this.field4118;
      synchronized(this.field4118) {
         class341 var3 = (class341)this.field4118.get((long)var1);
         if (var3 == null) {
            var3 = this.method6432(var1);
            this.field4118.method4290(var3, (long)var1);
         }
   ...
   public void method6433() {
      DemotingHashTable var1 = this.field4118;
      synchronized(this.field4118) {
