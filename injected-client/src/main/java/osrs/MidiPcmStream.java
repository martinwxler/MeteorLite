...
public class MidiPcmStream extends PcmStream {
   ...
   int field2853 = 1000000;
   @ObfuscatedName("y")
   int[] field2854 = new int[16];
   @ObfuscatedName("p")
   int[] field2837 = new int[16];
   @ObfuscatedName("j")
   int[] field2835 = new int[16];
   @ObfuscatedName("r")
   int[] field2839 = new int[16];
   @ObfuscatedName("b")
   int[] field2861 = new int[16];
   @ObfuscatedName("d")
   int[] field2841 = new int[16];
   @ObfuscatedName("s")
   int[] field2842 = new int[16];
   @ObfuscatedName("u")
   int[] field2843 = new int[16];
   @ObfuscatedName("l")
   int[] field2852 = new int[16];
   @ObfuscatedName("x")
   int[] field2846 = new int[16];
   @ObfuscatedName("z")
   int[] field2844 = new int[16];
   @ObfuscatedName("w")
   int[] field2848 = new int[16];
   @ObfuscatedName("t")
   int[] field2836 = new int[16];
   @ObfuscatedName("h")
   int[] field2850 = new int[16];
   @ObfuscatedName("q")
   int[] field2851 = new int[16];
   @ObfuscatedName("i")
   @ObfuscatedSignature(
      descriptor = "[[Liq;"
   )
   MusicPatchNode[][] field2847 = new MusicPatchNode[16][128];
   @ObfuscatedName("ae")
   @ObfuscatedSignature(
      descriptor = "[[Liq;"
   )
   MusicPatchNode[][] field2849 = new MusicPatchNode[16][128];
   @ObfuscatedName("ap")
   @ObfuscatedSignature(
      descriptor = "Lir;"
   )
   ...
   protected synchronized void fill(int[] var1, int var2, int var3) {
      if (this.midiFile.isReady()) {
         int var4 = this.midiFile.division * this.field2853 / PcmPlayer.field428;
   ...
   protected synchronized void skip(int var1) {
      if (this.midiFile.isReady()) {
         int var2 = this.midiFile.division * this.field2853 / PcmPlayer.field428;
   ...
   void method4420(int var1, int var2, int var3) {
      ...
      if ((this.field2846[var1] & 2) != 0) {
         for(MusicPatchNode var4 = (MusicPatchNode)this.patchStream.queue.first(); var4 != null; var4 = (MusicPatchNode)this.patchStream.queue.next()) {
            if (var4.field2905 == var1 && var4.field2895 < 0) {
               ...
               int var5 = (var4.field2901 * var4.field2899 >> 12) + var4.field2900;
               var4.field2900 += var2 - var4.field2896 << 8;
               var4.field2899 = var5 - var4.field2900;
               var4.field2901 = 4096;
               var4.field2896 = var2;
               return;
            }
      ...
      MusicPatch var8 = (MusicPatch)this.musicPatches.get((long)this.field2861[var1]);
      if (var8 != null) {
         ...
         if (var9 != null) {
            ...
            var6.patch = var8;
            var6.rawSound = var9;
            var6.field2894 = var8.field2876[var2];
            var6.field2893 = var8.field2882[var2];
            var6.field2896 = var2;
            var6.field2897 = var3 * var3 * var8.field2879[var2] * var8.field2881 + 1024 >> 11;
            var6.field2898 = var8.field2880[var2] & 255;
            var6.field2900 = (var2 << 8) - (var8.field2878[var2] & 32767);
            var6.field2902 = 0;
            var6.field2903 = 0;
            var6.field2911 = 0;
            var6.field2895 = -1;
            ...
            if (this.field2836[var1] == 0) {
               var6.stream = RawPcmStream.method842(var9, this.method4415(var6), this.method4434(var6), this.method4435(var6));
            } else {
               var6.stream = RawPcmStream.method842(var9, this.method4415(var6), 0, this.method4435(var6));
               this.method4421(var6, var8.field2878[var2] < 0);
            }

            if (var8.field2878[var2] < 0) {
   ...
   void method4426(int var1) {
      for(MusicPatchNode var2 = (MusicPatchNode)this.patchStream.queue.last(); var2 != null; var2 = (MusicPatchNode)this.patchStream.queue.previous()) {
         if (var1 < 0 || var2.field2905 == var1) {
            if (var2.stream != null) {
               var2.stream.method855(PcmPlayer.field428 / 100);
   ...
   int method4415(MusicPatchNode var1) {
      ...
      var4 = (int)((double)(var1.rawSound.sampleRate * 256) * Math.pow(2.0D, 3.255208333333333E-4D * (double)var2) / (double)PcmPlayer.field428 + 0.5D);
   ...
   int method4434(MusicPatchNode var1) {
      ...
      if (var2.field2825 != null) {
         var4 = var1.field2903;
         var5 = var2.field2825[var1.field2911 + 1];
         if (var1.field2911 < var2.field2825.length - 2) {
            var6 = (var2.field2825[var1.field2911] & 255) << 8;
            var7 = (var2.field2825[var1.field2911 + 2] & 255) << 8;
            var5 += (var4 - var6) * (var2.field2825[var1.field2911 + 3] - var5) / (var7 - var6);
         }
      ...
      if (var1.field2895 > 0 && var2.field2816 != null) {
         var4 = var1.field2895;
         var5 = var2.field2816[var1.field2906 + 1];
         if (var1.field2906 < var2.field2816.length - 2) {
            var6 = (var2.field2816[var1.field2906] & 255) << 8;
            var7 = (var2.field2816[var1.field2906 + 2] & 255) << 8;
            var5 += (var2.field2816[var1.field2906 + 3] - var5) * (var4 - var6) / (var7 - var6);
         }
   ...
   boolean method4443(MusicPatchNode var1, int[] var2, int var3, int var4) {
      var1.field2891 = PcmPlayer.field428 / 100;
      if (var1.field2895 < 0 || var1.stream != null && !var1.stream.method848()) {
         ...
         if (var6.field2825 != null) {
            ...
            while(var1.field2911 < var6.field2825.length - 2 && var1.field2903 > (var6.field2825[var1.field2911 + 2] & 255) << 8) {
               var1.field2911 += 2;
            }

            if (var6.field2825.length - 2 == var1.field2911 && var6.field2825[var1.field2911 + 1] == 0) {
               var7 = true;
            }
         }
         ...
         if (var1.field2895 >= 0 && var6.field2816 != null && (this.field2846[var1.field2905] & 1) == 0 && (var1.field2893 < 0 || var1 != this.field2849[var1.field2905][var1.field2893])) {
            ...
            while(var1.field2906 < var6.field2816.length - 2 && var1.field2895 > (var6.field2816[var1.field2906 + 2] & 255) << 8) {
               var1.field2906 += 2;
            }

            if (var6.field2816.length - 2 == var1.field2906) {
               var7 = true;
            }
         }
