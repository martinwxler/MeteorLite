...
public class FloorOverlayDefinition extends DualNode {
   ...
   static final void method3104() {
      ...
      if (Client.oculusOrbState == 0) {
         ...
         var2 = 0;
         if (var11 >= 0 || var10 != 0) {
            var2 = KeyHandler.KeyHandler_pressedKeys[81] ? Client.oculusOrbSlowedSpeed * 988767649 * 918404705 : Client.oculusOrbNormalSpeed * 615844635 * -503425261;
            var2 *= 16;
            Client.field732 = var11;
            Client.field720 = var10;
         }
      ...
      if (MouseHandler.MouseHandler_currentButton == 4 && Client.mouseCam) {
         ...
         Client.mouseCamClickedY = var0 != -1 && var0 != 1 ? (MouseHandler.MouseHandler_y + Client.mouseCamClickedY) / 2 : MouseHandler.MouseHandler_y * 1903378733 * -460999003;
         var1 = Client.mouseCamClickedX - MouseHandler.MouseHandler_x;
         Client.camAngleDY = var1 * 2;
         Client.mouseCamClickedX = var1 != -1 && var1 != 1 ? (MouseHandler.MouseHandler_x + Client.mouseCamClickedX) / 2 : MouseHandler.MouseHandler_x * -678881683 * -243899547;
      } else {
