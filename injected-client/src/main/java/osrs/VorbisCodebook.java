...
public class VorbisCodebook {
   ...
   VorbisCodebook() {
      ...
      if (var1) {
         ...
         for(var3 = VorbisSample.readBits(5) + 1; var2 < this.entries; ++var3) {
            int var5 = VorbisSample.readBits(CollisionMap.iLog(this.entries - var2));
         ...
         boolean var15 = VorbisSample.readBit() != 0;

         for(var3 = 0; var3 < this.entries; ++var3) {
            if (var15 && VorbisSample.readBit() == 0) {
      ...
      if (var2 > 0) {
         ...
         float var6 = VorbisSample.float32Unpack(VorbisSample.readBits(32));
         var4 = VorbisSample.readBits(4) + 1;
         boolean var7 = VorbisSample.readBit() != 0;
         int var8;
         if (var2 == 1) {
            var8 = mapType1QuantValues(this.entries, this.dimensions);
         } else {
            var8 = this.entries * this.dimensions;
         }

         this.field504 = new int[var8];

         int var9;
         for(var9 = 0; var9 < var8; ++var9) {
            this.field504[var9] = VorbisSample.readBits(var4);
         }

         this.field505 = new float[this.entries][this.dimensions];
         float var10;
         int var11;
         int var12;
         if (var2 == 1) {
            for(var9 = 0; var9 < this.entries; ++var9) {
               ...
               for(var12 = 0; var12 < this.dimensions; ++var12) {
                  ...
                  float var14 = (float)this.field504[var13] * var6 + var16 + var10;
                  this.field505[var9][var12] = var14;
                  if (var7) {
                     var10 = var14;
                  }
            ...
            for(var9 = 0; var9 < this.entries; ++var9) {
               ...
               for(var12 = 0; var12 < this.dimensions; ++var12) {
                  float var17 = (float)this.field504[var11] * var6 + var16 + var10;
                  this.field505[var9][var12] = var17;
                  if (var7) {
                     var10 = var17;
                  }
         ...
         if (var4 != 0) {
            ...
            for(var7 = 0; var7 < var4; ++var7) {
               ...
               if (var6 >= this.keys.length) {
                  int[] var11 = new int[this.keys.length * 2];

                  for(var9 = 0; var9 < this.keys.length; ++var9) {
                     var11[var9] = this.keys[var9];
                  }
   ...
   @ObfuscatedName("y")
   float[] method1015() {
      return this.field505[this.method1014()];
   }
