...
public class class44 {
   ...
   static final void method449(Actor var0) {
      ...
      if (var0.spotAnimation != -1 && Client.cycle >= var0.field1287) {
         ...
         int var2 = VarcInt.SpotAnimationDefinition_get(var0.spotAnimation).sequence;
         if (var2 != -1) {
            SequenceDefinition var3 = LoginScreenAnimation.SequenceDefinition_get(var2);
            if (var3 != null && var3.frameIds != null) {
               ...
               if (var0.spotAnimationFrame < var3.frameIds.length && var0.spotAnimationFrameCycle > var3.frameLengths[var0.spotAnimationFrame]) {
                  ...
                  Decimator.method1074(var3, var0.spotAnimationFrame, var0.x, var0.y);
               }
