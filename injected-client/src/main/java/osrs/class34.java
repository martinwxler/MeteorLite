...
public enum class34 implements Enumerated {
   ...
   private class34(int var3, int var4) {
      this.field252 = var3;
      this.field253 = var4;
   }
   ...
   static void method328() {
      Tiles.field1120 = (byte[][][])null;
      class253.field3130 = (byte[][][])null;
      class20.field182 = (byte[][][])null;
      DirectByteArrayCopier.field3128 = (byte[][][])null;
      UrlRequester.field1419 = (int[][][])null;
      class372.field4123 = (byte[][][])null;
      class229.field2813 = (int[][])null;
