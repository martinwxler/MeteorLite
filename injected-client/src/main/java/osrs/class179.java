...
public class class179 {
   ...
   static final class179 field2100 = new class179(0);
   @ObfuscatedName("n")
   @ObfuscatedSignature(
      descriptor = "Lfn;"
   )
   static final class179 field2099 = new class179(1);
   @ObfuscatedName("ek")
   @ObfuscatedSignature(
      descriptor = "Ljp;"
   )
   ...
   static void method3634(AbstractArchive var0, AbstractArchive var1, boolean var2, int var3) {
      if (Login.clearLoginScreen) {
         ...
         IndexedSprite[] var7 = VerticalAlignment.method2799(var1, var5, var6);
         Login.runesSprite = var7;
         var6 = var1.getGroupId("title_mute");
         int var8 = var1.getFileId(var6, "");
         IndexedSprite[] var9 = VerticalAlignment.method2799(var1, var6, var8);
