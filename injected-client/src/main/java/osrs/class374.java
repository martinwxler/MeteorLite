...
public class class374 implements Enumerated {
   ...
   public static final class374 field4131 = new class374(2, 0, Integer.class, new class371());
   @ObfuscatedName("n")
   @ObfuscatedSignature(
      descriptor = "Lnp;"
   )
   public static final class374 field4128 = new class374(0, 1, Long.class, new class373());
   @ObfuscatedName("f")
   @ObfuscatedSignature(
      descriptor = "Lnp;"
   )
   public static final class374 field4129 = new class374(1, 2, String.class, new class375());
   @ObfuscatedName("y")
   @ObfuscatedGetter(
      intValue = -1536498237
   )
