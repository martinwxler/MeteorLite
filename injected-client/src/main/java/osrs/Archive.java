...
public class Archive extends AbstractArchive {
      ...
      if (this.archiveDisk != null && this.validGroups != null && this.validGroups[var1]) {
         ...
         synchronized(ArchiveDiskActionHandler.ArchiveDiskActionHandler_requestQueue) {
            for(ArchiveDiskAction var5 = (ArchiveDiskAction)ArchiveDiskActionHandler.ArchiveDiskActionHandler_requestQueue.last(); var5 != null; var5 = (ArchiveDiskAction)ArchiveDiskActionHandler.ArchiveDiskActionHandler_requestQueue.previous()) {
               if (var5.key == (long)var1 && var2 == var5.archiveDisk && var5.type == 0) {
                  var3 = var5.data;
                  break;
               }
            }
         ...
         if (var3 != null) {
            ...
            byte[] var8 = var2.read(var1);
            this.load(var2, var1, var8, true);
         }
      } else {
   ...
   public void loadIndex(int var1, int var2) {
      ...
      if (this.masterDisk != null) {
         ...
         synchronized(ArchiveDiskActionHandler.ArchiveDiskActionHandler_requestQueue) {
            for(ArchiveDiskAction var7 = (ArchiveDiskAction)ArchiveDiskActionHandler.ArchiveDiskActionHandler_requestQueue.last(); var7 != null; var7 = (ArchiveDiskAction)ArchiveDiskActionHandler.ArchiveDiskActionHandler_requestQueue.previous()) {
               if ((long)var3 == var7.key && var4 == var7.archiveDisk && var7.type == 0) {
                  var5 = var7.data;
                  break;
               }
            }
         ...
         if (var5 != null) {
            ...
            byte[] var10 = var4.read(var3);
            this.load(var4, var3, var10, true);
         }
      } else {
   ...
   public void write(int var1, byte[] var2, boolean var3, boolean var4) {
      if (var3) {
         ...
         if (this.archiveDisk != null) {
            ArchiveDisk var17 = this.archiveDisk;
            ArchiveDiskAction var18 = new ArchiveDiskAction();
            var18.type = 0;
            var18.key = (long)var1;
            var18.data = var2;
            var18.archiveDisk = var17;
      ...
      if (var1 == this.masterDisk) {
         ...
         if (var3 == null) {
            ...
            if (var5 != this.indexCrc) {
               ...
               Buffer var6 = new Buffer(UserComparator6.decompressBytes(var3));
