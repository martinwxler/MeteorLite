...
public class LoginScreenAnimation {
   ...
   void initColors() {
      ...
      for(var1 = 0; var1 < 64; ++var1) {
         this.field1304[var1 + 64] = var1 * 4 + '\uff00';
      }

      for(var1 = 0; var1 < 64; ++var1) {
         this.field1304[var1 + 128] = var1 * 262144 + '\uffff';
      }
      ...
      this.field1320 = 0;
      this.field1319 = new int['耀'];
      this.field1312 = new int['耀'];
      this.method2232((IndexedSprite)null);
      this.field1316 = new int['耀'];
      this.field1317 = new int['耀'];
   }
   ...
   final void method2204(int var1) {
      ...
      for(int var6 = 0; var6 < var4; ++var6) {
         var5 = this.field1316[var2 + var3] - this.field1319[var2 + this.field1320 & this.field1319.length - 1] * var1 / 6;
         if (var5 < 0) {
            var5 = 0;
         }

         this.field1316[var2++] = var5;
      }
      ...
      for(var7 = 256 - var1; var7 < 256; ++var7) {
         ...
         for(int var10 = 0; var10 < 128; ++var10) {
            ...
            if (var8 < 50 && var10 > var15 && var10 < var5) {
               this.field1316[var9 + var10] = 255;
            } else {
               this.field1316[var10 + var9] = 0;
            }
         }
      }
      ...
      if (this.field1318 == 0 && this.field1313 == 0) {
   ...
   final void method2206(int var1) {
      ...
      if (this.field1318 > 0) {
         this.method2201(this.field1318, this.field1304);
      } else if (this.field1313 > 0) {
         this.method2201(this.field1313, this.field1315);
      } else {
      ...
      for(int var3 = 1; var3 < 255; ++var3) {
         ...
         for(int var9 = var6; var9 < var7; ++var9) {
            ...
            if (var10 != 0 && var11 >= Rasterizer2D.Rasterizer2D_xClipStart && var11 < Rasterizer2D.Rasterizer2D_xClipEnd) {
               ...
               class26.rasterProvider.pixels[var8++] = -16777216 | ((var14 & 16711935) * var13 + (var10 & 16711935) * var12 & -16711936) + (var12 * (var10 & '\uff00') + var13 * (var14 & '\uff00') & 16711680) >> 8;
            } else {
               ++var8;
            }
         }
