...
public abstract class AbstractFont extends Rasterizer2D {
         ...
         for(var14 = 0; var14 < 256; ++var14) {
            if (var14 != 32 && var14 != 160) {
               for(var7 = 0; var7 < 256; ++var7) {
                  if (var7 != 32 && var7 != 160) {
                     this.kerning[var7 + (var14 << 8)] = (byte)method5350(var6, var13, var4, this.advances, var12, var14, var7);
                  }
               }
            }
         }
   ...
   int charWidth(char var1) {
      ...
      return this.advances[ServerPacket.charToByteCp1252(var1) & 255];
   }
      ...
      if (var1 == null) {
         ...
         for(int var5 = 0; var5 < var1.length(); ++var5) {
            ...
            if (var6 == '<') {
                  ...
                  if (var7.equals("lt")) {
                     ...
                     if (!var7.equals("gt")) {
                        if (var7.startsWith("img=")) {
                           try {
                              int var8 = class82.method1908(var7.substring(4));
               ...
               if (var2 == -1) {
                  var4 += this.advances[(char)(ServerPacket.charToByteCp1252(var6) & 255)];
            ...
            if (var15 == '<') {
               ...
               if (var15 == '>' && var10 != -1) {
                  ...
                  if (var16.equals("br")) {
                     ...
                     try {
                        int var17 = class82.method1908(var16.substring(4));
   ...
   void decodeTag(String var1) {
      try {
         ...
         if (var1.startsWith("col=")) {
            ...
            var2 = class24.method260(var3, 16, true);
                  ...
                  if (var9.equals("lt")) {
                     ...
                     if (!var9.equals("gt")) {
                        if (var9.startsWith("img=")) {
                           try {
                              var8 = class82.method1908(var9.substring(4));
                     ...
                     if (!var14.equals("gt")) {
                        if (var14.startsWith("img=")) {
                           try {
                              ...
                              ++var8;
                              var13 = class82.method1908(var14.substring(4));
