...
public class Buffer extends Node {
   ...
   public void writeCESU8(CharSequence var1) {
      ...
      for(int var9 = 0; var9 < var7; ++var9) {
         ...
         if (var10 <= 127) {
            var11[var8++] = (byte)var10;
         } else if (var10 <= 2047) {
            var11[var8++] = (byte)(192 | var10 >> 6);
            var11[var8++] = (byte)(128 | var10 & 63);
         } else {
            var11[var8++] = (byte)(224 | var10 >> 12);
            var11[var8++] = (byte)(128 | var10 >> 6 & 63);
            var11[var8++] = (byte)(128 | var10 & 63);
         }
      }

      var4 = var8 - var6;
      this.offset = (var3 + var4 * -1025691571) * -442398587;
   }
