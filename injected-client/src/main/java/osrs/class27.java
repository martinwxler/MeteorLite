...
public class class27 extends class14 {
   ...
   static void playSong(int var0) {
      if (var0 == -1 && !Client.field881) {
         ...
         Canvas.method395(2, UrlRequest.archive6, var0, 0, ObjectComposition.clientPreferences.musicVolume, false);
      }
   ...
   static final void method283(int var0, int var1, int var2, int var3) {
      Client.field755 = 0;
      int var4 = (class93.localPlayer.x >> 7) + VertexNormal.baseX;
      int var5 = (class93.localPlayer.y >> 7) + SoundSystem.baseY;
