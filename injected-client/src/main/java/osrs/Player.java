...
public final class Player extends Actor {
   ...
   final void read(Buffer var1) {
      ...
      for(int var8 = 0; var8 < 12; ++var8) {
         ...
         if (var5 == 0) {
            ...
            var4[var8] = var6 + (var5 << 8);
            if (var8 == 0 && var4[0] == 65535) {
               var3 = var1.readUnsignedShort();
               break;
            }

            if (var4[var8] >= 512) {
               var7 = class260.ItemDefinition_get(var4[var8] - 512).team;
               if (var7 != 0) {
                  this.team = var7;
               }
            }
      ...
      for(var5 = 0; var5 < 5; ++var5) {
         var6 = var1.readUnsignedByte();
         if (var6 < 0 || var6 >= class15.field137[var5].length) {
            var6 = 0;
         }
      ...
      if (var1.offset < var1.array.length) {
         ...
         var10 = (var7 >> 15 & 1) == 1;
         if (var7 > 0 && var7 != 32768) {
            var9 = new class135[12];

            for(int var11 = 0; var11 < 12; ++var11) {
               int var12 = var7 >> 12 - var11 & 1;
               if (var12 == 1) {
                  int var13 = var4[var11] - 512;
                  int var14 = var1.readUnsignedByte();
                  boolean var15 = (var14 & 1) != 0;
                  boolean var16 = (var14 & 2) != 0;
                  class135 var17 = new class135(var13);
                  int var18;
                  int[] var19;
                  boolean var20;
                  int var21;
                  ...
                  if (var15) {
                     ...
                     var19 = new int[]{var18 & 15, var18 >> 4 & 15};
                     var20 = var17.field1537 != null && var19.length == var17.field1537.length;

                     for(var21 = 0; var21 < 2; ++var21) {
                        if (var19[var21] != 15) {
                           var22 = (short)var1.readUnsignedShort();
                           if (var20) {
                              var17.field1537[var19[var21]] = var22;
                           }
                        }
                     }
                  }
                  ...
                  if (var16) {
                     var18 = var1.readUnsignedByte();
                     var19 = new int[]{var18 & 15, var18 >> 4 & 15};
                     var20 = var17.field1538 != null && var19.length == var17.field1538.length;

                     for(var21 = 0; var21 < 2; ++var21) {
                        if (var19[var21] != 15) {
                           var22 = (short)var1.readUnsignedShort();
                           if (var20) {
                              var17.field1538[var19[var21]] = var22;
                           }
                        }
                     }
                  }
      ...
      this.appearance.method4704(var4, var9, var10, var23, var2 == 1, var3);
   }
   ...
   protected final Model getModel() {
      if (this.appearance == null) {
         ...
         SequenceDefinition var2 = super.movementSequence != -1 && !this.isUnanimated && (super.movementSequence != super.idleSequence || var1 == null) ? LoginScreenAnimation.SequenceDefinition_get(super.movementSequence) : null;
         ...
         if (var3 == null) {
            ...
            if (!this.isUnanimated && this.model0 != null) {
               ...
               if (Client.cycle >= this.animationCycleStart && Client.cycle < this.animationCycleEnd) {
                  var4 = this.model0;
                  var4.offsetBy(this.field1202 - super.x, this.tileHeight2 - this.tileHeight, this.field1220 - super.y);
                  ...
                  var4.offsetBy(super.x - this.field1202, this.tileHeight - this.tileHeight2, super.y - this.field1220);
               }
            }
   ...
   void updateIsInFriendsChat() {
      this.isInFriendsChat = WorldMapRegion.friendsChat != null && WorldMapRegion.friendsChat.contains(this.username) ? TriBool.TriBool_true : TriBool.TriBool_false;
   }
