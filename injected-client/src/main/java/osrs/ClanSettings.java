            ...
            if (var4 > 0) {
               ...
               while(var4-- > 0) {
                  ...
                  if (var7 == 0) {
                     ...
                     this.parameters.put(new ObjectNode(var11), (long)var6);
                  }
               }
            }
         }
   ...
   static final void updateItemPile(int var0, int var1) {
      ...
      if (var2 == null) {
         ...
         if (var5 == null) {
            ...
            AbstractSocket.scene.newGroundItemPile(class22.Client_plane, var0, var1, class105.getTileHeight(var0 * 128 + 64, var1 * 128 + 64, class22.Client_plane), var5, var9, var11, var12);
         }
      }
