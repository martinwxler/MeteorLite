...
public class MouseHandler implements MouseListener, MouseMotionListener, FocusListener {
   ...
   public static IndexedSprite method647(AbstractArchive var0, int var1) {
      if (!Decimator.method1075(var0, var1)) {
         ...
         IndexedSprite var2 = new IndexedSprite();
         var2.width = class396.SpriteBuffer_spriteWidth;
         var2.height = UserComparator2.SpriteBuffer_spriteHeight;
         var2.xOffset = WorldMapDecoration.SpriteBuffer_xOffsets[0];
         var2.yOffset = Calendar.SpriteBuffer_yOffsets[0];
         var2.subWidth = class396.SpriteBuffer_spriteWidths[0];
         var2.subHeight = class302.SpriteBuffer_spriteHeights[0];
         var2.palette = MilliClock.SpriteBuffer_spritePalette;
         var2.pixels = class396.SpriteBuffer_pixels[0];
