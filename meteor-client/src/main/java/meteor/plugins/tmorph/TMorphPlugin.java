...
public class TMorphPlugin extends Plugin
{
  ...
  @Provides
  public TMorphConfig getConfig(ConfigManager configManager)
  {
  ...
  private void setTmorphs()
  {
    ...
    if (changed)
    {
      client.getLocalPlayer().getPlayerComposition().setHash$api();
    }
  }
}
