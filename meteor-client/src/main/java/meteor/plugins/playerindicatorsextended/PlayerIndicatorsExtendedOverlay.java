...
public class PlayerIndicatorsExtendedOverlay extends Overlay {
    ...
    public Dimension render(Graphics2D graphics)
    {
        for (Actor actor : this.plugin.getPlayers())
        {
            ...
            if (p.isFriendsChatMember$api() && configManager.getConfiguration("playerindicators", "drawClanMemberNames").equals("true") && configManager.getConfiguration("playerindicators", "clanMenuIcons").equals("true"))
            {
            ...
            else if (p.isClanMember$api() && configManager.getConfiguration("playerindicators", "drawClanChatMemberNames").equals("true") && configManager.getConfiguration("playerindicators", "clanchatMenuIcons").equals("true"))
            {
