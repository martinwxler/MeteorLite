package meteor.plugins.entityinspector.scriptinspector;
...
import meteor.ui.DynamicGridLayout;
...
public class ScriptInspector
{
    ...
    public void open()
    {
        ...
        if (frame == null) {
            ...
            String blacklistConfig = configManager.getConfiguration("botlin", "devtools.blacklist");
            ...
            String highlightsConfig = configManager.getConfiguration("botlin", "devtools.highlights");
    ...
    public void close()
    {
        configManager.setConfiguration("botlin", "devtools.highlights",
                Text.toCSV(Lists.transform(new ArrayList<>(highlights), String::valueOf)));
        configManager.setConfiguration("botlin", "devtools.blacklist",
