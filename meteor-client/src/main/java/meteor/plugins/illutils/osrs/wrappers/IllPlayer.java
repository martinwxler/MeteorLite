...
public class IllPlayer extends IllActor {
    private final Player player;
    private final PlayerComposition definition;

    public IllPlayer(OSRSUtils game, Player player, PlayerComposition definition) {
        super(game, player);
        this.player = player;
...
//    } //TODO
     ...
     *
     * @see IllPlayer#equipment()
     * @see IllPlayer#bodyColors()
     */
    ...
    public int[] bodyColors() { //TODO
        return player.getModel$api().getFaceColors1();
    }
    ...
    public boolean isFriend() {
        return player.isFriend$api();
    }

    public boolean isFriendChatMember() {
        return player.isFriendsChatMember$api();
    }
