...
public class PlayerUtils {
    ...
    private final Logger log = new Logger("iUtils-PlayerUtils");
    ...
    public WidgetItem shouldStamPot(int energy) {
        Integer[] itemIDs = new Integer[]{ItemID.STAMINA_POTION1, ItemID.STAMINA_POTION2, ItemID.STAMINA_POTION3,
        ...
        final List<Integer> STAMINA_POTIONS = new ArrayList<>(Arrays.asList(itemIDs));
