...
public class IllEquipmentItem implements Interactable {
    private final OSRSUtils game;
    private final Item item;
    private final ItemComposition definition;
    private final EquipmentSlot equipmentSlot;

    public IllEquipmentItem(OSRSUtils game, Item item, ItemComposition definition, EquipmentSlot equipmentSlot) {
        this.game = game;
        this.item = item;
