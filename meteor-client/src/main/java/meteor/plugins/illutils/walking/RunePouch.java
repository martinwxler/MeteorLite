...
public class RunePouch {
    ...
    public enum RuneSlot {
        ...
        public int getQuantity(OSRSUtils game) {
            return game.varb(quantityVarbitIndex);
        }

    }

    public static int getQuantity(OSRSUtils game, RuneElement runeElement) {
        if (!hasPouch(game)) {
            return 0;
        }
    ...
    private static boolean hasPouch(OSRSUtils game) {
