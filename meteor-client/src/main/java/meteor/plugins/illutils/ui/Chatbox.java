...
public class Chatbox {
    ...
    private Logger log = new Logger("iUtils-Chatbox");

    @Inject
    public Chatbox(OSRSUtils game) {
        this.game = game;
    }
...
//            throw new IllegalStateException("Not an options chat");
        ...
        for (int i = 0; i < game.widget(219, 1).items().size(); i++) {
    ...
    public void selectMenu(String option) { //TODO untested
        ...
        for (IllWidget child : game.widget(187, 3).items()) {
