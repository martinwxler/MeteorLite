...
import meteor.plugins.illutils.api.GrandExchangePrices;
...
public class GrandExchange {
    ...
    private final Logger log = new Logger("iUtils-GrandExchange");

    public GrandExchange(OSRSUtils game) {
        this.game = game;
    }
    ...
    public void sell(int item, int price) {
        ...
        int baseId = game.getFromClientThread(() -> game.client().getItemComposition(item).getNote() == 799 ?
