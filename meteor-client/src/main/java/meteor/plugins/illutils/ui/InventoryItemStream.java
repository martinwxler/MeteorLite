...
public class InventoryItemStream extends RandomizedStreamAdapter<IllInventoryItem, InventoryItemStream> {
    public InventoryItemStream(Stream<IllInventoryItem> stream) {
        super(stream);
    }

    @Override
    protected InventoryItemStream wrap(Stream<IllInventoryItem> stream) {
        return new InventoryItemStream(stream);
    }

    /**
     * Returns a stream consisting of the elements of this stream with
     * any of the given {@link IllInventoryItem#id()}s
     */
    ...
    /**
     * Returns a stream consisting of the elements of this stream with
     * a minimum {@link IllInventoryItem#quantity()}
     */
    ...
    /**
     * Returns a stream consisting of the elements of this stream with
     * any of the given {@link IllInventoryItem#name()}s
     */
     ...
     * {@link IllInventoryItem#name()}s contain any of the given name parts
     */
    ...
    /**
     * Returns a stream consisting of the elements of this stream with
     * any of the given {@link IllInventoryItem#actions()}s
     */
    ...
    /**
     * Returns a stream consisting of the elements of this stream with
     * any of the given {@link IllInventoryItem#slot()}s
     */
    ...
    /**
     * Returns the total {@link IllInventoryItem#quantity()} of the elements of this stream.
     */
    public int quantity() {
    ...
    public void forEachWaiting(Consumer<IllInventoryItem> action) {
