 ...
 */
package meteor.plugins.illutils;
...
import meteor.plugins.illutils.util.ActionQueue;
...
@Singleton
public class IllUtils extends Plugin {
    ...
    @Provides
    public IllUtilsConfig getConfig(ConfigManager configManager) {
        return configManager.getConfig(IllUtilsConfig.class);
    }
    ...
    private void loadBankInventoryItems() {
        ...
        for (Widget item : client.getWidget(WidgetInfo.BANK_INVENTORY_ITEMS_CONTAINER).getDynamicChildren()) {
            ...
            bankInventoryitems.add(new IllWidget(game, item));
        }
    }
    ...
    private void loadBankItems() {
        ...
        for (Widget item : client.getWidget(WidgetInfo.BANK_ITEM_CONTAINER).getDynamicChildren()) {
            ...
            bankitems.add(new IllWidget(game, item));
        }
    }
