...
class NightmareOverlay extends Overlay
{
	...
	private final OPRSModelOutlineRenderer outliner;
	private int timeout;
	private static final int NIGHTMARE_SHADOW = 1767;

	@Inject
	private NightmareOverlay(final Client client, final NightmarePlugin plugin, final NightmareConfig config, OPRSModelOutlineRenderer outliner)
	{
		this.client = client;
		this.plugin = plugin;
		this.config = config;
