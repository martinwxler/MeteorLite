...
public class NightmarePlugin extends Plugin
{
	...
	private static final Set<LocalPoint> PHOSANIS_MIDDLE_LOCATIONS = ImmutableSet
			.of(new LocalPoint(6208, 7104), new LocalPoint(7232, 7104));
	...
	@Provides
	public NightmareConfig getConfig(ConfigManager configManager)
	{
