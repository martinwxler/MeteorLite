...
public interface CettiTutorialConfig extends Config {
	...
	default Methods.GameMode gameMode() {
		return Methods.GameMode.REGULAR;
	}
	...
	default boolean customAppearance() {
		return false;
	}
	...
	default boolean randomAppearance() {
		return false;
	}
