...
public class CollisionMap {
    ...
    public boolean s(WorldPoint worldPoint) {
        return s(worldPoint.getX(), worldPoint.getY(), worldPoint.getPlane());
    }

    public boolean w(WorldPoint worldPoint) {
