...
public class WebsocketManager extends WebSocketListener
{
	...
	@Inject
	WebsocketManager(ChinManagerPlugin chinManagerPlugin, ChinManager chinManager)
	{
	...
	private void status()
	{
		...
		jsonDataData.addProperty("client", MeteorLiteClientModule.uuid);
	...
	private void location()
	{
		...
		jsonLocation.addProperty("client", MeteorLiteClientModule.uuid);
