...
public class ModelData extends Renderable {
	...
	static {
		field2196 = new int[10000]; // L: 44
		field2163 = new int[10000]; // L: 45
		field2198 = 0; // L: 46
		...
		for (var9 = 0; var9 < var2; ++var9) { // L: 522
			...
			if (var10 != null) { // L: 524
				...
				for (var11 = 0; var11 < var10.faceCount; ++var11) { // L: 525
					...
					this.indices1[this.faceCount] = this.method3759(var10, var10.indices1[var11]); // L: 548
					this.indices2[this.faceCount] = this.method3759(var10, var10.indices2[var11]); // L: 549
					this.indices3[this.faceCount] = this.method3759(var10, var10.indices3[var11]); // L: 550
				...
				for (var11 = 0; var11 < var10.textureTriangleCount; ++var11) { // L: 553
					...
					if (var12 == 0) { // L: 555
						this.texTriangleX[this.textureTriangleCount] = (short)this.method3759(var10, var10.texTriangleX[var11]); // L: 556
						this.texTriangleY[this.textureTriangleCount] = (short)this.method3759(var10, var10.texTriangleY[var11]); // L: 557
						this.texTriangleZ[this.textureTriangleCount] = (short)this.method3759(var10, var10.texTriangleZ[var11]); // L: 558
					}
	...
	ModelData(byte[] var1) {
		...
		if (var1[var1.length - 1] == -1 && var1[var1.length - 2] == -1) { // L: 59
			this.method3780(var1);
		} else {
			this.method3758(var1); // L: 60
		}

	} // L: 61

	@ObfuscatedSignature(
		descriptor = "(Lgm;ZZZZ)V",
		garbageValue = "1"
	)
	...
	final int method3759(ModelData var1, int var2) {
		int var3 = -1; // L: 567
	...
	@ObfuscatedName("s")
	@ObfuscatedSignature(
		descriptor = "([[IIIIZI)Lgm;"
	)
	public ModelData method3761(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
		this.calculateBounds(); // L: 686
		int var7 = var2 + this.field2192; // L: 687
		int var8 = var2 + this.field2195; // L: 688
		int var9 = var4 + this.field2199; // L: 689
		int var10 = var4 + this.field2174; // L: 690
	...
	@ObfuscatedName("e")
	public void method3776(int var1) {
	...
	void calculateBounds() {
		if (!this.isBoundsCalculated) { // L: 950
			...
			this.field2191 = 0; // L: 952
			this.field2192 = 999999; // L: 953
			this.field2195 = -999999; // L: 954
			this.field2174 = -99999; // L: 955
			this.field2199 = 99999; // L: 956
			...
			for (int var1 = 0; var1 < this.verticesCount; ++var1) { // L: 957
				...
				if (var2 < this.field2192) { // L: 961
					this.field2192 = var2;
				}

				if (var2 > this.field2195) { // L: 962
					this.field2195 = var2;
				}

				if (var4 < this.field2199) { // L: 963
					this.field2199 = var4;
				}

				if (var4 > this.field2174) { // L: 964
					this.field2174 = var4;
				}
	...
	public final Model toModel(int var1, int var2, int var3, int var4, int var5) {
		...
		if (this.textureTriangleCount > 0 && this.textureCoords != null) { // L: 1035
			...
			var8.field2443 = new int[var8.field2442]; // L: 1044
			var8.field2444 = new int[var8.field2442]; // L: 1045
			var8.field2468 = new int[var8.field2442]; // L: 1046
			var10 = 0; // L: 1047

			int var11;
			for (var11 = 0; var11 < this.textureTriangleCount; ++var11) { // L: 1048
				if (var9[var11] > 0 && this.textureRenderTypes[var11] == 0) { // L: 1049
					var8.field2443[var10] = this.texTriangleX[var11] & '\uffff'; // L: 1050
					var8.field2444[var10] = this.texTriangleY[var11] & '\uffff'; // L: 1051
					var8.field2468[var10] = this.texTriangleZ[var11] & '\uffff'; // L: 1052
			...
			var8.field2439 = new byte[this.faceCount]; // L: 1057
			...
			if (var12 == -1) { // L: 1075
				if (var17 != 0) { // L: 1076
					if (var17 == 1) { // L: 1093
						...
						var8.faceColors1[var16] = method3764(this.faceColors[var16] & '\uffff', var14); // L: 1096
					...
					if (this.field2166 != null && this.field2166[this.indices1[var16]] != null) { // L: 1080
						var13 = this.field2166[this.indices1[var16]];
					} else {
					...
					var8.faceColors1[var16] = method3764(var15, var14); // L: 1083
					if (this.field2166 != null && this.field2166[this.indices2[var16]] != null) { // L: 1084
						var13 = this.field2166[this.indices2[var16]];
					} else {
					...
					var8.faceColors2[var16] = method3764(var15, var14); // L: 1087
					if (this.field2166 != null && this.field2166[this.indices3[var16]] != null) { // L: 1088
						var13 = this.field2166[this.indices3[var16]];
					} else {
					...
					var8.faceColors3[var16] = method3764(var15, var14); // L: 1091
				}
				...
				if (var17 == 1) { // L: 1124
					...
					var8.faceColors1[var16] = method3777(var14); // L: 1127
					var8.faceColors3[var16] = -1; // L: 1128
				} else {
					var8.faceColors3[var16] = -2; // L: 1131
				}
			} else {
				if (this.field2166 != null && this.field2166[this.indices1[var16]] != null) { // L: 1111
					var13 = this.field2166[this.indices1[var16]];
				} else {
				...
				var8.faceColors1[var16] = method3777(var14); // L: 1114
				if (this.field2166 != null && this.field2166[this.indices2[var16]] != null) { // L: 1115
					var13 = this.field2166[this.indices2[var16]];
				} else {
				...
				var8.faceColors2[var16] = method3777(var14); // L: 1118
				if (this.field2166 != null && this.field2166[this.indices3[var16]] != null) { // L: 1119
					var13 = this.field2166[this.indices3[var16]];
				} else {
				...
				var8.faceColors3[var16] = method3777(var14); // L: 1122
			}
		}

		this.method3809(); // L: 1135
		...
		var8.field2441 = this.priority; // L: 1146
	...
	@ObfuscatedName("h")
	@ObfuscatedSignature(
		descriptor = "(Lgm;Lgm;IIIZ)V"
	)
	static void method3774(ModelData var0, ModelData var1, int var2, int var3, int var4, boolean var5) {
			...
			if (var10.magnitude != 0) { // L: 982
				...
				if (var11 <= var1.field2191) { // L: 984
					...
					if (var12 >= var1.field2192 && var12 <= var1.field2195) { // L: 986
						...
						if (var13 >= var1.field2199 && var13 <= var1.field2174) { // L: 988
							for (int var14 = 0; var14 < var8; ++var14) { // L: 989
								...
								if (var12 == var7[var14] && var13 == var1.verticesZ[var14] && var11 == var1.verticesY[var14] && var15.magnitude != 0) { // L: 991
									if (var0.field2166 == null) { // L: 992
										var0.field2166 = new VertexNormal[var0.verticesCount];
									}

									if (var1.field2166 == null) { // L: 993
										var1.field2166 = new VertexNormal[var8];
									}

									VertexNormal var16 = var0.field2166[var9]; // L: 994
									if (var16 == null) { // L: 995
										var16 = var0.field2166[var9] = new VertexNormal(var10);
									}

									VertexNormal var17 = var1.field2166[var14]; // L: 996
									if (var17 == null) {
										var17 = var1.field2166[var14] = new VertexNormal(var15); // L: 997
									}
									...
									++var6; // L: 1006
									field2196[var9] = field2198; // L: 1007
									field2163[var14] = field2198; // L: 1008
								}
							}
						}
					}
		...
		if (var6 >= 3 && var5) { // L: 1012
			for (var9 = 0; var9 < var0.faceCount; ++var9) { // L: 1013
				if (field2196[var0.indices1[var9]] == field2198 && field2196[var0.indices2[var9]] == field2198 && field2196[var0.indices3[var9]] == field2198) { // L: 1014
			...
			for (var9 = 0; var9 < var1.faceCount; ++var9) { // L: 1019
				if (field2198 == field2163[var1.indices1[var9]] && field2198 == field2163[var1.indices2[var9]] && field2198 == field2163[var1.indices3[var9]]) { // L: 1020
	...
	@ObfuscatedName("i")
	static final int method3764(int var0, int var1) {
	...
	@ObfuscatedName("ae")
	static final int method3777(int var0) {
		if (var0 < 2) { // L: 1161
			var0 = 2;
		} else if (var0 > 126) {
			var0 = 126; // L: 1162
