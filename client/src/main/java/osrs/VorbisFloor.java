...
public class VorbisFloor {
	...
	static {
		field403 = new int[]{256, 128, 86, 64}; // L: 8
	...
	VorbisFloor() {
		...
		if (var1 != 1) { // L: 109
			...
			this.field405 = new int[var5]; // L: 137
			this.field405[0] = 0; // L: 138
			this.field405[1] = 1 << var4; // L: 139
			var5 = 2; // L: 140
			...
			for (var6 = 0; var6 < var2; ++var6) { // L: 141
				...
				for (int var8 = 0; var8 < this.classDimensions[var7]; ++var8) { // L: 143
					this.field405[var5++] = VorbisSample.readBits(var4);
				}
			}

			if (field410 == null || field410.length < var5) { // L: 145
				field410 = new int[var5]; // L: 146
				field413 = new int[var5]; // L: 147
				field412 = new boolean[var5]; // L: 148
			}
	...
	@ObfuscatedName("f")
	int method706(int var1, int var2, int var3, int var4, int var5) {
	...
	@ObfuscatedName("y")
	void method719(int var1, int var2, int var3, int var4, float[] var5, int var6) {
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) { // L: 83
			int var3 = var1; // L: 84
			int var4 = field410[var1]; // L: 85
			int var5 = field413[var1]; // L: 86
			boolean var6 = field412[var1]; // L: 87

			for (int var7 = var1 + 1; var7 <= var2; ++var7) { // L: 88
				int var8 = field410[var7]; // L: 89
				if (var8 < var4) { // L: 90
					field410[var3] = var8; // L: 91
					field413[var3] = field413[var7]; // L: 92
					field412[var3] = field412[var7]; // L: 93
					++var3; // L: 94
					field410[var7] = field410[var3]; // L: 95
					field413[var7] = field413[var3]; // L: 96
					field412[var7] = field412[var3]; // L: 97
				}
			}

			field410[var3] = var4; // L: 100
			field413[var3] = var5; // L: 101
			field412[var3] = var6; // L: 102
	...
	boolean readSubmapFloor() {
		...
		if (!var1) { // L: 154
			...
			int var2 = this.field405.length; // L: 155

			int var3;
			for (var3 = 0; var3 < var2; ++var3) { // L: 156
				field410[var3] = this.field405[var3];
			}

			var3 = field403[this.multiplier - 1]; // L: 157
			int var4 = CollisionMap.iLog(var3 - 1); // L: 158
			field413[0] = VorbisSample.readBits(var4); // L: 159
			field413[1] = VorbisSample.readBits(var4); // L: 160
			int var5 = 2; // L: 161
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) { // L: 162
				...
				int var11 = 0; // L: 167
				if (var9 > 0) { // L: 168
					var11 = VorbisSample.VorbisSample_codebooks[this.classMasterbooks[var7]].method1014();
				}

				for (int var12 = 0; var12 < var8; ++var12) { // L: 169
					int var13 = this.subclassBooks[var7][var11 & var10]; // L: 170
					var11 >>>= var9; // L: 171
					field413[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method1014() : 0; // L: 172
				}
			}
	...
	@ObfuscatedName("r")
	void method712(float[] var1, int var2) {
		int var3 = this.field405.length; // L: 179
		int var4 = field403[this.multiplier - 1]; // L: 180
		boolean[] var5 = field412; // L: 181
		field412[1] = true; // L: 182
		var5[0] = true; // L: 183
		...
		for (var6 = 2; var6 < var3; ++var6) { // L: 184
			var7 = method705(field410, var6); // L: 185
			var8 = method721(field410, var6); // L: 186
			var9 = this.method706(field410[var7], field413[var7], field410[var8], field413[var8], field410[var6]); // L: 187
			var10 = field413[var6]; // L: 188
			int var11 = var4 - var9; // L: 189
			int var13 = (var11 < var9 ? var11 : var9) << 1; // L: 191
			if (var10 != 0) { // L: 192
				boolean[] var14 = field412; // L: 193
				field412[var8] = true; // L: 195
				var14[var7] = true; // L: 196
				field412[var6] = true; // L: 197
				if (var10 >= var13) { // L: 198
					field413[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1; // L: 199
				} else {
					field413[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9; // L: 202
				}
			} else {
				field412[var6] = false; // L: 206
				field413[var6] = var9; // L: 207
			}
		}

		this.VarbisFloor_sort(0, var3 - 1); // L: 210
		var6 = 0; // L: 211
		var7 = field413[0] * this.multiplier; // L: 212

		for (var8 = 1; var8 < var3; ++var8) { // L: 213
			if (field412[var8]) { // L: 214
				var9 = field410[var8]; // L: 215
				var10 = field413[var8] * this.multiplier; // L: 216
				this.method719(var6, var7, var9, var10, var1, var2); // L: 217
				if (var9 >= var2) { // L: 218
					return;
				}
