	...
	static void getLoginError(int var0) {
		if (var0 == -3) { // L: 2542
			...
			if (var0 == 7) { // L: 2559
				...
				class260.setLoginResponseString("Your attempt to osiris.log into your account was", "unsuccessful.  Don't worry, you can sort", "this out by visiting the billing system.");
