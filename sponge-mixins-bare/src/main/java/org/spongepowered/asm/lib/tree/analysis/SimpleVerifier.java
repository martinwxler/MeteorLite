...
public class SimpleVerifier extends BasicVerifier {
    ...
    protected boolean isAssignableFrom(Type t, Type u) {
        if (t.equals(u)) {
            ...
            return this.getSuperClass(u) == null ? false : (!this.isInterface ? this.isAssignableFrom(t, this.getSuperClass(u)) : u.getSort() == 10 || u.getSort() == 9);
            ...
            if (this.isAssignableFrom(t, this.currentSuperClass)) {
                ...
                if (this.currentClassInterfaces != null) {
                    for (int var5 = 0; var5 < this.currentClassInterfaces.size(); ++var5) {
                        Type v = (Type) this.currentClassInterfaces.get(var5);
