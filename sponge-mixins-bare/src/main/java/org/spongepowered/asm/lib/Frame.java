...
class Frame {
    ...
    private static int type(ClassWriter cw, String desc) {
        int index = desc.charAt(0) == 40 ? desc.indexOf(41) + 1 : 0;
        String t;
        switch (desc.charAt(index)) {
            ...
            default:
                int dims;
                for (dims = index + 1; desc.charAt(dims) == 91; ++dims) {
                    ;
                }
                ...
                if ((u & 267386880) != 24117248 && (u & -268435456) == 0) {
                    ...
                    if ((t & -1048576) == (u & -1048576)) {
                        if ((u & 267386880) == 24117248) {
                            ...
                            tdim = -268435456 + (u & -268435456);
                            v = tdim | 24117248 | cw.addType("java/lang/Object");
                        }
                    } else if ((t & 267386880) != 24117248 && (t & -268435456) == 0) {
                        v = 16777216;
                    } else {
                        tdim = ((t & -268435456) != 0 && (t & 267386880) != 24117248 ? -268435456 : 0) + (t & -268435456);
    ...
    private void push(int type) {
        ...
        if (this.outputStackTop >= n) {
            int[] top = new int[Math.max(this.outputStackTop + 1, 2 * n)];
            System.arraycopy(this.outputStack, 0, top, 0, n);
            this.outputStack = top;
        }

        this.outputStack[this.outputStackTop++] = type;
        int top1 = this.owner.inputStackTop + this.outputStackTop;
        if (top1 > this.owner.outputStackMax) {
            this.owner.outputStackMax = top1;
        }
    ...
    private int init(ClassWriter cw, int t) {
        ...
        if (t == 16777222) {
            ...
            String j = cw.typeTable[t & 1048575].strVal1;
            s = 24117248 | cw.addType(j);
        }

        for (int var8 = 0; var8 < this.initializationCount; ++var8) {
            int u = this.initializations[var8];
            int dim = u & -268435456;
    ...
    void execute(int opcode, int arg, ClassWriter cw, Item item) {
        ...
        switch (opcode) {
            ...
            case 185:
                ...
                if (opcode != 184) {
                    t1 = this.pop();
                    if (opcode == 183 && item.strVal2.charAt(0) == 60) {
                        this.init(t1);
                    }
                }
