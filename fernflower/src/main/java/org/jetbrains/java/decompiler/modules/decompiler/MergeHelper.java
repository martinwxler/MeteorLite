        ...
        if (firstif.iftype == IfStatement.IFTYPE_IF) {
          if (firstif.getIfstat() == null) {
            ...
            if (isDirectPath(stat, elseedge.getDestination())) {
              ...
              stat.setConditionExprent(
                  ((IfExprent) firstif.getHeadexprent().copy()).getCondition());
              ...
              if (firstif.getIfstat() == null) {
                ...
                // lift closures
                for (StatEdge prededge : elseedge.getDestination()
                    .getPredecessorEdges(StatEdge.TYPE_BREAK)) {
