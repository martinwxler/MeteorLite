...
public class ConstantsUtil {
  ...
  private static final Class[] opcodeClasses = {
      ...
      INVOKEDYNAMIC.class,
      //    "xxxunusedxxx" Java 6 and before, "invokedynamic" Java 7 and later
      NEW.class,                                //    "new",
  ...
  public static Instruction getInstructionInstance(int opcode, boolean wide, int group,
      int bytecode_version, int[] operands) {
    ...
    try {
      ...
      if ((opcode >= CodeConstants.opc_ifeq &&
        ...
        if (opcode == CodeConstants.opc_invokedynamic
            && bytecode_version < CodeConstants.BYTECODE_JAVA_7) {
