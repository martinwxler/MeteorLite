...
public class VorbisCodebook {
   ...
   VorbisCodebook() {
      ...
      if (var1) {
         ...
         for(var3 = VorbisSample.readBits(5) + 1; var2 < this.entries; ++var3) {
            int var4 = VorbisSample.readBits(class65.iLog(this.entries - var2));
         ...
         if (var2 == 1) {
            for(var8 = 0; var8 < this.entries; ++var8) {
               ...
               for(var11 = 0; var11 < this.dimensions; ++var11) {
                  ...
                  float var13 = (float)this.field331[var12] * var16 + var15 + var9;
                  this.field328[var8][var11] = var13;
                  if (var6) {
                     var9 = var13;
                  }
            ...
            for(var8 = 0; var8 < this.entries; ++var8) {
               ...
               for(var11 = 0; var11 < this.dimensions; ++var11) {
                  float var17 = (float)this.field331[var10] * var16 + var15 + var9;
                  this.field328[var8][var11] = var17;
                  if (var6) {
                     var9 = var17;
                  }
   ...
   @ObfuscatedName("a")
   float[] method1008() {
      return this.field328[this.method1006()];
   }
   ...
   static int mapType1QuantValues(int var0, int var1) {
      int var2;
      for(var2 = (int)Math.pow((double)var0, 1.0D / (double)var1) + 1; class317.method5852(var2, var1) > var0; --var2) {
         ;
      }
