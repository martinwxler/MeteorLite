...
public class VorbisCodebook {
	...
	VorbisCodebook() {
		...
		if (var1) {
			...
			for (var3 = VorbisSample.readBits(5) + 1; var2 < this.entries; ++var3) {
				int var4 = VorbisSample.readBits(WorldMapData_0.iLog(this.entries - var2));
		...
		if (var2 > 0) {
			...
			this.field344 = new int[var7];

			int var8;
			for (var8 = 0; var8 < var7; ++var8) {
				this.field344[var8] = VorbisSample.readBits(var5);
			}
			...
			if (var2 == 1) {
				for (var8 = 0; var8 < this.entries; ++var8) {
					...
					for (var11 = 0; var11 < this.dimensions; ++var11) {
						...
						float var13 = (float)this.field344[var12] * var16 + var15 + var9;
						this.field345[var8][var11] = var13;
						if (var6) {
							var9 = var13;
						}
				...
				for (var8 = 0; var8 < this.entries; ++var8) {
					...
					for (var11 = 0; var11 < this.dimensions; ++var11) {
						float var17 = (float)this.field344[var10] * var16 + var15 + var9;
						this.field345[var8][var11] = var17;
						if (var6) {
							var9 = var17;
						}
	...
	@ObfuscatedName("k")
	float[] method990() {
		return this.field345[this.method989()];
	}
