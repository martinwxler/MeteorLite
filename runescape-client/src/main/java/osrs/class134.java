...
public class class134 extends class116 {
   ...
   void vmethod2847(Buffer var1) {
      this.field1501 = var1.readInt();
      this.field1502 = var1.readInt();
   }
   ...
   void vmethod2848(ClanSettings var1) {
      var1.method2664(this.field1501, this.field1502);
   }
   ...
   public static String method2788(CharSequence var0) {
      String var1 = FontName.base37DecodeLong(WorldMapScaleHandler.method4096(var0));
      if (var1 == null) {
         var1 = "";
      }
