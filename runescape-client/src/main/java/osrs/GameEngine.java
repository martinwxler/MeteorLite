...
public abstract class GameEngine extends Applet implements Runnable, FocusListener, WindowListener {
	...
	final synchronized void addCanvas() {
		...
		this.field207 = Ignored.getServerTime(); // L: 263
	} // L: 264
	...
	@Export("clientTick")
	void clientTick() {
		long var1 = Ignored.getServerTime(); // L: 327
	...
	void graphicsTick() {
		...
		long var2 = Ignored.getServerTime(); // L: 340
	...
	public final synchronized void paint(Graphics var1) {
		if (this == gameEngine && !isKilled) { // L: 438
			...
			if (Ignored.getServerTime() - this.field207 > 1000L) { // L: 440
	...
	public final void destroy() {
		if (this == gameEngine && !isKilled) { // L: 425
			stopTimeMs = Ignored.getServerTime(); // L: 426
	...
	public void run() {
		try {
			...
			while (0L == stopTimeMs || Ignored.getServerTime() < stopTimeMs) { // L: 312
	...
	public final void stop() {
		if (this == gameEngine && !isKilled) { // L: 419
			stopTimeMs = Ignored.getServerTime() + 4000L; // L: 420
		}
	} // L: 421
