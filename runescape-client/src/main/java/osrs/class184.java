...
public class class184 implements WorldMapSection {
   ...
   public int[] getBorderTileLengths(int var1, int var2, int var3) {
      if (!this.containsCoord(var1, var2, var3)) {
         ...
         int[] var4 = new int[]{var2 + (this.field2095 * 64 - this.field2102 * 64) + (this.field2091 * 8 - this.field2092 * 8), var3 + (this.field2096 * 64 - this.field2094 * 64) + (this.field2100 * 8 - this.field2098 * 8)};
         return var4;
      }
   }
   ...
   public Coord coord(int var1, int var2) {
      if (!this.containsPosition(var1, var2)) {
         ...
         int var4 = var2 + (this.field2094 * 64 - this.field2096 * 64) + (this.field2098 * 8 - this.field2100 * 8);
