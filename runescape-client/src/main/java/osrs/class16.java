...
public class class16 implements ThreadFactory {
   ...
   static void method219(int var0, Coord var1, boolean var2) {
      ...
      int var5 = (HealthBarDefinition.localPlayer.x >> 7) + class19.baseX;
      int var6 = (HealthBarDefinition.localPlayer.y >> 7) + DefaultsGroup.baseY;
   ...
   static final void updateNpcs(boolean var0, PacketBuffer var1) {
      ...
      for(var2 = 0; var2 < Client.field512; ++var2) {
         ...
         if ((var5 & 1) != 0) {
            ...
            var8 = var4.x - (var6 - class19.baseX - class19.baseX) * 64;
            var9 = var4.y - (var7 - DefaultsGroup.baseY - DefaultsGroup.baseY) * 64;
            if (var8 != 0 || var9 != 0) {
         ...
         if ((var5 & 64) != 0) {
            ...
            var4.field1125 = (var6 & '\uffff') + Client.cycle;
