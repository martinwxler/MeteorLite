...
public class MidiPcmStream extends PcmStream {
   ...
   int field2931 = 1000000;
   @ObfuscatedName("o")
   int[] field2956 = new int[16];
   @ObfuscatedName("g")
   int[] field2933 = new int[16];
   @ObfuscatedName("e")
   int[] field2934 = new int[16];
   @ObfuscatedName("p")
   int[] field2941 = new int[16];
   @ObfuscatedName("j")
   int[] field2936 = new int[16];
   @ObfuscatedName("b")
   int[] field2937 = new int[16];
   @ObfuscatedName("x")
   int[] field2938 = new int[16];
   @ObfuscatedName("y")
   int[] field2939 = new int[16];
   @ObfuscatedName("k")
   int[] field2940 = new int[16];
   @ObfuscatedName("d")
   int[] field2944 = new int[16];
   @ObfuscatedName("r")
   int[] field2942 = new int[16];
   @ObfuscatedName("m")
   int[] field2943 = new int[16];
   @ObfuscatedName("c")
   int[] field2932 = new int[16];
   @ObfuscatedName("f")
   int[] field2945 = new int[16];
   @ObfuscatedName("h")
   ...
   MusicPatchNode[][] field2952 = new MusicPatchNode[16][128];
   @ObfuscatedName("ag")
   @ObfuscatedSignature(
      descriptor = "[[Liu;"
   )
   MusicPatchNode[][] field2949 = new MusicPatchNode[16][128];
   @ObfuscatedName("ae")
   @ObfuscatedSignature(
      descriptor = "Liz;"
   )
   ...
   protected synchronized void fill(int[] var1, int var2, int var3) {
      if (this.midiFile.isReady()) {
         int var4 = this.midiFile.division * this.field2931 / UserComparator2.field4359;
   ...
   protected synchronized void skip(int var1) {
      if (this.midiFile.isReady()) {
         int var2 = this.midiFile.division * this.field2931 / UserComparator2.field4359;
   ...
   void method4776(int var1) {
      ...
      if (var2 == 128) {
         ...
         if (var4 == 81) {
            if (var5 >= 64) {
               this.field2944[var3] |= 4;
            } else {
               this.method4775(var3);
               this.field2944[var3] &= -5;
            }
         }
   ...
   static void changeWorld(World var0) {
      ...
      ApproximateRouteStrategy.worldPort = Client.gameBuild == 0 ? 'ꩊ' : var0.id + '鱀';
      ParamComposition.js5Port = Client.gameBuild == 0 ? 443 : var0.id + '썐';
