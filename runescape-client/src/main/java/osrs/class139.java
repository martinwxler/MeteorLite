         ...
         if (var0 == ScriptOpcodes.FRIEND_GETNAME) {
            ...
            if (var0 == ScriptOpcodes.FRIEND_SETRANK) {
               ...
               if (AbstractArchive.friendsChat != null) {
                  Interpreter.Interpreter_stringStack[++class295.Interpreter_stringStackSize - 1] = AbstractArchive.friendsChat.name;
               } else {
                  Interpreter.Interpreter_stringStack[++class295.Interpreter_stringStackSize - 1] = "";
               }
               ...
               if (AbstractArchive.friendsChat != null) {
                  Interpreter.Interpreter_intStack[++class14.Interpreter_intStackSize - 1] = AbstractArchive.friendsChat.getSize();
               } else {
                  Interpreter.Interpreter_intStack[++class14.Interpreter_intStackSize - 1] = 0;
               }
               ...
               var3 = Interpreter.Interpreter_intStack[--class14.Interpreter_intStackSize];
               if (AbstractArchive.friendsChat != null && var3 < AbstractArchive.friendsChat.getSize()) {
                  Interpreter.Interpreter_stringStack[++class295.Interpreter_stringStackSize - 1] = AbstractArchive.friendsChat.get(var3).getUsername().getName();
               } else {
                  Interpreter.Interpreter_stringStack[++class295.Interpreter_stringStackSize - 1] = "";
               }
               ...
               var3 = Interpreter.Interpreter_intStack[--class14.Interpreter_intStackSize];
               if (AbstractArchive.friendsChat != null && var3 < AbstractArchive.friendsChat.getSize()) {
                  Interpreter.Interpreter_intStack[++class14.Interpreter_intStackSize - 1] = ((Buddy)AbstractArchive.friendsChat.get(var3)).getWorld();
               } else {
                  Interpreter.Interpreter_intStack[++class14.Interpreter_intStackSize - 1] = 0;
               }
               ...
               var3 = Interpreter.Interpreter_intStack[--class14.Interpreter_intStackSize];
               if (AbstractArchive.friendsChat != null && var3 < AbstractArchive.friendsChat.getSize()) {
                  Interpreter.Interpreter_intStack[++class14.Interpreter_intStackSize - 1] = ((Buddy)AbstractArchive.friendsChat.get(var3)).rank;
               } else {
                  Interpreter.Interpreter_intStack[++class14.Interpreter_intStackSize - 1] = 0;
               }
               ...
               Interpreter.Interpreter_intStack[++class14.Interpreter_intStackSize - 1] = AbstractArchive.friendsChat != null ? AbstractArchive.friendsChat.minKick : 0;
               return 1;
               ...
               Interpreter.Interpreter_intStack[++class14.Interpreter_intStackSize - 1] = AbstractArchive.friendsChat != null ? AbstractArchive.friendsChat.rank * 1093956825 * 1525992297 : 0;
               return 1;
               ...
               var3 = Interpreter.Interpreter_intStack[--class14.Interpreter_intStackSize];
               if (AbstractArchive.friendsChat != null && var3 < AbstractArchive.friendsChat.getSize() && AbstractArchive.friendsChat.get(var3).getUsername().equals(HealthBarDefinition.localPlayer.username)) {
                  Interpreter.Interpreter_intStack[++class14.Interpreter_intStackSize - 1] = 1;
               } else {
                  Interpreter.Interpreter_intStack[++class14.Interpreter_intStackSize - 1] = 0;
               }
               ...
               if (AbstractArchive.friendsChat != null && AbstractArchive.friendsChat.owner != null) {
                  Interpreter.Interpreter_stringStack[++class295.Interpreter_stringStackSize - 1] = AbstractArchive.friendsChat.owner;
               } else {
                  Interpreter.Interpreter_stringStack[++class295.Interpreter_stringStackSize - 1] = "";
               }
               ...
               var3 = Interpreter.Interpreter_intStack[--class14.Interpreter_intStackSize];
               if (AbstractArchive.friendsChat != null && var3 < AbstractArchive.friendsChat.getSize() && ((ClanMate)AbstractArchive.friendsChat.get(var3)).isFriend()) {
                  Interpreter.Interpreter_intStack[++class14.Interpreter_intStackSize - 1] = 1;
               } else {
                  Interpreter.Interpreter_intStack[++class14.Interpreter_intStackSize - 1] = 0;
               }
               ...
               if (var0 == 3628) {
                  ...
                  if (var0 == 3629) {
                     ...
                     if (AbstractArchive.friendsChat != null) {
                        AbstractArchive.friendsChat.removeComparator();
                     }
                     ...
                     var7 = Interpreter.Interpreter_intStack[--class14.Interpreter_intStackSize] == 1;
                     if (AbstractArchive.friendsChat != null) {
                        AbstractArchive.friendsChat.addComparator(new UserComparator1(var7));
                     }
                     ...
                     var7 = Interpreter.Interpreter_intStack[--class14.Interpreter_intStackSize] == 1;
                     if (AbstractArchive.friendsChat != null) {
                        AbstractArchive.friendsChat.addComparator(new UserComparator2(var7));
                     }
                     ...
                     var7 = Interpreter.Interpreter_intStack[--class14.Interpreter_intStackSize] == 1;
                     if (AbstractArchive.friendsChat != null) {
                        AbstractArchive.friendsChat.addComparator(new UserComparator3(var7));
                     }
                     ...
                     var7 = Interpreter.Interpreter_intStack[--class14.Interpreter_intStackSize] == 1;
                     if (AbstractArchive.friendsChat != null) {
                        AbstractArchive.friendsChat.addComparator(new UserComparator4(var7));
                     }
                     ...
                     var7 = Interpreter.Interpreter_intStack[--class14.Interpreter_intStackSize] == 1;
                     if (AbstractArchive.friendsChat != null) {
                        AbstractArchive.friendsChat.addComparator(new UserComparator5(var7));
                     }
                     ...
                     var7 = Interpreter.Interpreter_intStack[--class14.Interpreter_intStackSize] == 1;
                     if (AbstractArchive.friendsChat != null) {
                        AbstractArchive.friendsChat.addComparator(new UserComparator6(var7));
                     }
                     ...
                     var7 = Interpreter.Interpreter_intStack[--class14.Interpreter_intStackSize] == 1;
                     if (AbstractArchive.friendsChat != null) {
                        AbstractArchive.friendsChat.addComparator(new UserComparator7(var7));
                     }
                     ...
                     var7 = Interpreter.Interpreter_intStack[--class14.Interpreter_intStackSize] == 1;
                     if (AbstractArchive.friendsChat != null) {
                        AbstractArchive.friendsChat.addComparator(new UserComparator8(var7));
                     }
                     ...
                     var7 = Interpreter.Interpreter_intStack[--class14.Interpreter_intStackSize] == 1;
                     if (AbstractArchive.friendsChat != null) {
                        AbstractArchive.friendsChat.addComparator(new UserComparator9(var7));
                     }
                     ...
                     var7 = Interpreter.Interpreter_intStack[--class14.Interpreter_intStackSize] == 1;
                     if (AbstractArchive.friendsChat != null) {
                        AbstractArchive.friendsChat.addComparator(new UserComparator10(var7));
                     }
                     ...
                     var7 = Interpreter.Interpreter_intStack[--class14.Interpreter_intStackSize] == 1;
                     if (AbstractArchive.friendsChat != null) {
                        AbstractArchive.friendsChat.addComparator(new BuddyRankComparator(var7));
                     }
               ...
               var3 = Interpreter.Interpreter_intStack[--class14.Interpreter_intStackSize];
               if (AbstractArchive.friendsChat != null && var3 < AbstractArchive.friendsChat.getSize() && ((ClanMate)AbstractArchive.friendsChat.get(var3)).isIgnored()) {
                  Interpreter.Interpreter_intStack[++class14.Interpreter_intStackSize - 1] = 1;
               } else {
                  Interpreter.Interpreter_intStack[++class14.Interpreter_intStackSize - 1] = 0;
               }
