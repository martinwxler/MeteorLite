...
public class LoginType {
   ...
   @Export("oldscape")
   public static final LoginType oldscape = new LoginType(0, 0, "", "");
   @ObfuscatedName("w")
   @ObfuscatedSignature(
      descriptor = "Lni;"
   )
   static final LoginType field4224 = new LoginType(8, 1, "", "");
   @ObfuscatedName("s")
   @ObfuscatedSignature(
      descriptor = "Lni;"
   )
   static final LoginType field4232 = new LoginType(7, 2, "", "");
   @ObfuscatedName("a")
   @ObfuscatedSignature(
      descriptor = "Lni;"
   )
   static final LoginType field4226 = new LoginType(4, 3, "", "");
   @ObfuscatedName("o")
   @ObfuscatedSignature(
      descriptor = "Lni;"
   )
   static final LoginType field4227 = new LoginType(1, 4, "", "");
   @ObfuscatedName("g")
   @ObfuscatedSignature(
      descriptor = "Lni;"
   )
   static final LoginType field4228 = new LoginType(2, 5, "", "");
   @ObfuscatedName("e")
   @ObfuscatedSignature(
      descriptor = "Lni;"
   )
   static final LoginType field4233 = new LoginType(6, 6, "", "");
   @ObfuscatedName("p")
   @ObfuscatedSignature(
      descriptor = "Lni;"
   )
   static final LoginType field4230 = new LoginType(5, 7, "", "");
   @ObfuscatedName("j")
   @ObfuscatedSignature(
      descriptor = "Lni;"
   )
