...
public final class Tiles {
   ...
   static int[][][] field962;
   @ObfuscatedName("q")
   static final int[] field964 = new int[]{1, 2, 4, 8};
   @ObfuscatedName("d")
   static final int[] field967 = new int[]{16, 32, 64, 128};
   @ObfuscatedName("r")
   static final int[] field966 = new int[]{1, 0, -1, 0};
   @ObfuscatedName("m")
   static final int[] field960 = new int[]{0, -1, 0, 1};
   @ObfuscatedName("c")
   static final int[] field957 = new int[]{1, -1, -1, 1};
   @ObfuscatedName("f")
   ...
   static final String formatItemStacks(int var0) {
      ...
      if (var1.length() > 9) {
         ...
         return var1.length() > 6 ? " " + MouseHandler.colorStartTag(16777215) + var1.substring(0, var1.length() - 4) + "K" + " " + " (" + var1 + ")" + "</col>" : " " + MouseHandler.colorStartTag(16776960) + var1 + "</col>";
      }
   }
}
