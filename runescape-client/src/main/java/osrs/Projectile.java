...
public final class Projectile extends Renderable {
   ...
   static void readPlayerUpdate(PacketBuffer var0, int var1) {
      ...
      if (var3 == 0) {
         if (var2) {
            ...
            Players.Players_regions[var1] = (var4.plane << 28) + (class19.baseX + var4.pathX[0] >> 13 << 14) + (DefaultsGroup.baseY + var4.pathY[0] >> 13);
            if (var4.field1112 != -1) {
         ...
         if (var3 == 1) {
            ...
            if (var5 == 0) {
               ...
               var11 = (var9 + DefaultsGroup.baseY + var4.pathY[0] & 16383) - DefaultsGroup.baseY;
               if (Client.localPlayerIndex == var1 && (var4.x < 1536 || var4.y < 1536 || var4.x >= 11776 || var4.y >= 11776)) {
                  var4.resetPath(var10, var11);
                  var4.field1067 = false;
               } else if (var2) {
   ...
   static final void drawEntities(int var0, int var1, int var2, int var3) {
      ...
      if (Client.hintArrowType == 2) {
         DefaultsGroup.worldToScreen((Client.hintArrowX - class19.baseX << 7) + Client.hintArrowSubX, (Client.hintArrowY - DefaultsGroup.baseY << 7) + Client.hintArrowSubY, Client.hintArrowHeight * 2);
   ...
   static final void method1957(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      ...
      if (Client.oculusOrbState == 1 && Client.staffModLevel >= 2 && Client.cycle % 50 == 0 && (class320.oculusOrbFocalPointX >> 7 != HealthBarDefinition.localPlayer.x >> 7 || class18.oculusOrbFocalPointY >> 7 != HealthBarDefinition.localPlayer.y >> 7)) {
         ...
         var13 = (class320.oculusOrbFocalPointX >> 7) + class19.baseX;
         var14 = (class18.oculusOrbFocalPointY >> 7) + DefaultsGroup.baseY;
