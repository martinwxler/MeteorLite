...
public class LoginScreenAnimation {
   ...
   void initColors() {
      ...
      for(var1 = 0; var1 < 64; ++var1) {
         this.field1171[var1 + 64] = var1 * 4 + '\uff00';
      }

      for(var1 = 0; var1 < 64; ++var1) {
         this.field1171[var1 + 128] = var1 * 262144 + '\uffff';
      }
      ...
      this.field1169 = 0;
      this.field1166 = new int['耀'];
      this.field1168 = new int['耀'];
      this.method2189((IndexedSprite)null);
      this.field1157 = new int['耀'];
      this.field1161 = new int['耀'];
   }
   ...
   final void method2190(int var1) {
      ...
      if (this.field1163 == 0 && this.field1164 == 0) {
   ...
   final void method2192(int var1) {
      ...
      if (this.field1163 > 0) {
         this.method2195(this.field1163, this.field1171);
      } else if (this.field1164 > 0) {
         this.method2195(this.field1164, this.field1162);
      } else {
      ...
      for(int var3 = 1; var3 < 255; ++var3) {
         ...
         for(int var9 = var6; var9 < var7; ++var9) {
            ...
            if (var10 != 0 && var11 >= Rasterizer2D.Rasterizer2D_xClipStart && var11 < Rasterizer2D.Rasterizer2D_xClipEnd) {
               ...
               Canvas.rasterProvider.pixels[var8++] = -16777216 | ((var10 & 16711935) * var12 + (var14 & 16711935) * var13 & -16711936) + (var12 * (var10 & '\uff00') + var13 * (var14 & '\uff00') & 16711680) >> 8;
            } else {
               ++var8;
            }
         }
   ...
   static final void updatePlayer(PacketBuffer var0) {
      ...
      var2.pathY[0] = var6 - DefaultsGroup.baseY;
