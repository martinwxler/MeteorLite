...
public class VorbisFloor {
   @ObfuscatedName("i")
   static final int[] field247 = new int[]{256, 128, 86, 64};
   @ObfuscatedName("w")
   ...
   VorbisFloor() {
      ...
      if (var1 != 1) {
         ...
         this.field241 = new int[var5];
         this.field241[0] = 0;
         this.field241[1] = 1 << var4;
         var5 = 2;
         ...
         if (field239 == null || field239.length < var5) {
            field239 = new int[var5];
            field249 = new int[var5];
            field250 = new boolean[var5];
         }
   ...
   void VarbisFloor_sort(int var1, int var2) {
      if (var1 < var2) {
         int var3 = var1;
         int var4 = field239[var1];
         int var5 = field249[var1];
         boolean var6 = field250[var1];

         for(int var7 = var1 + 1; var7 <= var2; ++var7) {
            int var8 = field239[var7];
            if (var8 < var4) {
               field239[var3] = var8;
               field249[var3] = field249[var7];
               field250[var3] = field250[var7];
               ++var3;
               field239[var7] = field239[var3];
               field249[var7] = field249[var3];
               field250[var7] = field250[var3];
            }
         }
   ...
   boolean readSubmapFloor() {
      ...
      if (!var1) {
         ...
         var3 = field247[this.multiplier - 1];
         int var4 = class65.iLog(var3 - 1);
         field249[0] = VorbisSample.readBits(var4);
         field249[1] = VorbisSample.readBits(var4);
         int var5 = 2;
         ...
         for(int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
            ...
            for(int var12 = 0; var12 < var8; ++var12) {
               ...
               var11 >>>= var9;
               field249[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method1006() : 0;
            }
         }
   ...
   void method692(float[] var1, int var2) {
      int var3 = this.field241.length;
      int var4 = field247[this.multiplier - 1];
      boolean[] var5 = field250;
      field250[1] = true;
      var5[0] = true;
      ...
      for(var6 = 2; var6 < var3; ++var6) {
         var7 = method697(field239, var6);
         var8 = method705(field239, var6);
         var9 = this.method688(field239[var7], field249[var7], field239[var8], field249[var8], field239[var6]);
         var10 = field249[var6];
         int var11 = var4 - var9;
         int var13 = (var11 < var9 ? var11 : var9) << 1;
         if (var10 != 0) {
            boolean[] var14 = field250;
            field250[var8] = true;
            var14[var7] = true;
            field250[var6] = true;
            if (var10 >= var13) {
               field249[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
            } else {
               field249[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
            }
         } else {
            field250[var6] = false;
            field249[var6] = var9;
      ...
      var6 = 0;
      var7 = field249[0] * this.multiplier;

      for(var8 = 1; var8 < var3; ++var8) {
         if (field250[var8]) {
            var9 = field239[var8];
            var10 = field249[var8] * this.multiplier;
            this.method689(var6, var7, var9, var10, var1, var2);
            if (var9 >= var2) {
               return;
            }
