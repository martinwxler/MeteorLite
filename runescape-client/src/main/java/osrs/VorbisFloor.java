...
public class VorbisFloor {
	...
	static {
		field265 = new int[]{256, 128, 86, 64};
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			this.field256 = new int[var5];
			this.field256[0] = 0;
			this.field256[1] = 1 << var4;
			var5 = 2;
			...
			for (var6 = 0; var6 < var2; ++var6) {
				...
				for (int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
					this.field256[var5++] = VorbisSample.readBits(var4);
				}
			}

			if (field263 == null || field263.length < var5) {
				field263 = new int[var5];
				field264 = new int[var5];
				field255 = new boolean[var5];
			}
	...
	@ObfuscatedName("m")
	int method679(int var1, int var2, int var3, int var4, int var5) {
		int var6 = var4 - var2;
		int var7 = var3 - var1;
	...
	@ObfuscatedName("k")
	void method700(int var1, int var2, int var3, int var4, float[] var5, int var6) {
		int var7 = var4 - var2;
		int var8 = var3 - var1;
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) {
			int var3 = var1;
			int var4 = field263[var1];
			int var5 = field264[var1];
			boolean var6 = field255[var1];

			for (int var7 = var1 + 1; var7 <= var2; ++var7) {
				int var8 = field263[var7];
				if (var8 < var4) {
					field263[var3] = var8;
					field264[var3] = field264[var7];
					field255[var3] = field255[var7];
					++var3;
					field263[var7] = field263[var3];
					field264[var7] = field264[var3];
					field255[var7] = field255[var3];
				}
			}
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			int var2 = this.field256.length;

			int var3;
			for (var3 = 0; var3 < var2; ++var3) {
				field263[var3] = this.field256[var3];
			}

			var3 = field265[this.multiplier - 1];
			int var4 = WorldMapData_0.iLog(var3 - 1);
			field264[0] = VorbisSample.readBits(var4);
			field264[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				int var11 = 0;
				if (var9 > 0) {
					var11 = VorbisSample.VorbisSample_codebooks[this.classMasterbooks[var7]].method989();
				}

				for (int var12 = 0; var12 < var8; ++var12) {
					int var13 = this.subclassBooks[var7][var11 & var10];
					var11 >>>= var9;
					field264[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method989() : 0;
				}
			}
	...
	@ObfuscatedName("z")
	void method686(float[] var1, int var2) {
		int var3 = this.field256.length;
		int var4 = field265[this.multiplier - 1];
		boolean[] var5 = field255;
		field255[1] = true;
		var5[0] = true;
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method685(field263, var6);
			var8 = method705(field263, var6);
			var9 = this.method679(field263[var7], field264[var7], field263[var8], field264[var8], field263[var6]);
			var10 = field264[var6];
			int var11 = var4 - var9;
			int var13 = (var11 < var9 ? var11 : var9) << 1;
			if (var10 != 0) {
				boolean[] var14 = field255;
				field255[var8] = true;
				var14[var7] = true;
				field255[var6] = true;
				if (var10 >= var13) {
					field264[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field264[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field255[var6] = false;
				field264[var6] = var9;
		...
		var6 = 0;
		var7 = field264[0] * this.multiplier;

		for (var8 = 1; var8 < var3; ++var8) {
			if (field255[var8]) {
				var9 = field263[var8];
				var10 = field264[var8] * this.multiplier;
				this.method700(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
	...
	@ObfuscatedName("n")
	static int method685(int[] var0, int var1) {
		int var2 = var0[var1];
		int var3 = -1;
