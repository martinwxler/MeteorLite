...
public class VorbisFloor {
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			this.field178 = new int[var5];
			this.field178[0] = 0;
			this.field178[1] = 1 << var4;
			var5 = 2;
			...
			for (var6 = 0; var6 < var2; ++var6) {
				...
				for (int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
					this.field178[var5++] = VorbisSample.readBits(var4);
				}
			}

			if (field177 == null || field177.length < var5) {
				field177 = new int[var5];
				field176 = new int[var5];
				field170 = new boolean[var5];
			}
	...
	@ObfuscatedName("v")
	int method425(int var1, int var2, int var3, int var4, int var5) {
		int var6 = var4 - var2;
		int var7 = var3 - var1;
	...
	@ObfuscatedName("j")
	void method426(int var1, int var2, int var3, int var4, float[] var5, int var6) {
		int var7 = var4 - var2;
		int var8 = var3 - var1;
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) {
			int var3 = var1;
			int var4 = field177[var1];
			int var5 = field176[var1];
			boolean var6 = field170[var1];

			for (int var7 = var1 + 1; var7 <= var2; ++var7) {
				int var8 = field177[var7];
				if (var8 < var4) {
					field177[var3] = var8;
					field176[var3] = field176[var7];
					field170[var3] = field170[var7];
					++var3;
					field177[var7] = field177[var3];
					field176[var7] = field176[var3];
					field170[var7] = field170[var3];
				}
			}
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			int var2 = this.field178.length;

			int var3;
			for (var3 = 0; var3 < var2; ++var3) {
				field177[var3] = this.field178[var3];
			}

			var3 = field172[this.multiplier - 1];
			int var4 = ItemLayer.iLog(var3 - 1);
			field176[0] = VorbisSample.readBits(var4);
			field176[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				int var11 = 0;
				if (var9 > 0) {
					var11 = VorbisSample.VorbisSample_codebooks[this.classMasterbooks[var7]].method736();
				}

				for (int var12 = 0; var12 < var8; ++var12) {
					int var13 = this.subclassBooks[var7][var11 & var10];
					var11 >>>= var9;
					field176[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method736() : 0;
				}
			}
	...
	@ObfuscatedName("w")
	void method429(float[] var1, int var2) {
		int var3 = this.field178.length;
		int var4 = field172[this.multiplier - 1];
		boolean[] var5 = field170;
		field170[1] = true;
		var5[0] = true;
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method441(field177, var6);
			var8 = method424(field177, var6);
			var9 = this.method425(field177[var7], field176[var7], field177[var8], field176[var8], field177[var6]);
			var10 = field176[var6];
			int var11 = var4 - var9;
			int var13 = (var11 < var9 ? var11 : var9) << 1;
			if (var10 != 0) {
				boolean[] var14 = field170;
				field170[var8] = true;
				var14[var7] = true;
				field170[var6] = true;
				if (var10 >= var13) {
					field176[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field176[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field170[var6] = false;
				field176[var6] = var9;
		...
		var6 = 0;
		var7 = field176[0] * this.multiplier;

		for (var8 = 1; var8 < var3; ++var8) {
			if (field170[var8]) {
				var9 = field177[var8];
				var10 = field176[var8] * this.multiplier;
				this.method426(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
	...
	@ObfuscatedName("s")
	static int method441(int[] var0, int var1) {
		int var2 = var0[var1];
		int var3 = -1;
	...
	@ObfuscatedName("t")
	static int method424(int[] var0, int var1) {
		int var2 = var0[var1];
		int var3 = -1;
