...
public final class Client extends GameEngine implements Usernamed, OAuthTokens {
	...
	protected final void resizeGame() {
		field514 = Ignored.getServerTime() + 500L; // L: 4994
	...
	protected final void draw(boolean var1) {
		...
		if ((gameState == 10 || gameState == 20 || gameState == 30) && field514 != 0L && Ignored.getServerTime() > field514) { // L: 1888 1889
			...
			if (--field517 + 1 <= 0) { // L: 2019
				try {
					...
					if (js5ConnectState == 2) { // L: 2032
						...
						class120.field1450 = Ignored.getServerTime(); // L: 2044
					}
					...
					if (js5ConnectState == 3) { // L: 2046
						...
						} else if (Ignored.getServerTime() - class120.field1450 > 30000L) { // L: 2056
							...
							if (var3 == null) { // L: 2081
								while (true) {
									...
									if (var3 == null) { // L: 2088
										...
										UserComparator7.field1319 = Ignored.getServerTime(); // L: 2112
				...
				while (true) {
					...
					if (!var30) { // L: 3698
						...
						if (MouseHandler.MouseHandler_lastButton == 1337
							|| MouseHandler.MouseHandler_lastButton == 1 || !class150.mouseCam && MouseHandler.MouseHandler_lastButton == 4 || MouseHandler.MouseHandler_lastButton == 2) { // L: 3806
							...
							var18 = HitSplatDefinition.getPacketBufferNode(ClientPacket.EVENT_MOUSE_CLICK, packetWriter.isaacCipher); // L: 3817
		...
		if (var2 == null) { // L: 6474
			...
			try {
				...
				if (ServerPacket.field2933 == var1.serverPacket) { // L: 7463
					...
					if (var66) { // L: 7465
						WorldMapSprite.field2727 = Ignored.getServerTime() - var3.readLong(); // L: 7466
