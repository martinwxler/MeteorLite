...
public final class Client extends GameEngine implements Usernamed, OAuthTokens {
   ...
   static int field476 = -1;
   @ObfuscatedName("da")
   @ObfuscatedGetter(
      longValue = -3998157933727729695L
   )
   static long field477 = -1L;
   @ObfuscatedName("dw")
   @Export("hadFocus")
   ...
   protected final void setUp() {
      ...
      ApproximateRouteStrategy.worldPort = gameBuild == 0 ? 'ꩊ' : worldId + '鱀';
      ParamComposition.js5Port = gameBuild == 0 ? 443 : worldId + '썐';
         ...
         if (gameState == 20) {
            ...
            if (!var70) {
               ...
               for(var2 = 0; var2 < ModeWhere.regionLandArchives.length; ++var2) {
                  ...
                  if (var3 != null) {
                     var4 = (LoginScreenAnimation.regions[var2] >> 8) * 64 - class19.baseX;
                     var5 = (LoginScreenAnimation.regions[var2] & 255) * 64 - DefaultsGroup.baseY;
                     if (isInInstance) {
                        var4 = 10;
                        var5 = 10;
                     }
               ...
               if (!var70) {
                  ...
                  MouseRecorder.field1039 = new int[104];
                  ...
                  if (!isInInstance) {
                     ...
                     for(var46 = 0; var46 < var2; ++var46) {
                        var4 = (LoginScreenAnimation.regions[var46] >> 8) * 64 - class19.baseX;
                        var5 = (LoginScreenAnimation.regions[var46] & 255) * 64 - DefaultsGroup.baseY;
                     ...
                     for(var46 = 0; var46 < var2; ++var46) {
                        ...
                        if (var47 != null) {
                           var5 = (LoginScreenAnimation.regions[var46] >> 8) * 64 - class19.baseX;
                           var48 = (LoginScreenAnimation.regions[var46] & 255) * 64 - DefaultsGroup.baseY;
                           class14.playPcmPlayers();
                  ...
                  for(var5 = 0; var5 < 4; ++var5) {
                     ...
                     for(var14 = 0; var14 < 104; ++var14) {
                        ...
                        MouseRecorder.field1039[var14] = 0;
                     }
                        ...
                        for(var15 = 0; var15 < 104; ++var15) {
                           ...
                           if (var16 >= 0 && var16 < 104) {
                              ...
                              if (var17 > 0) {
                                 ...
                                 TileItem.Tiles_hue[var15] += var64.hue;
                                 class397.Tiles_saturation[var15] += var64.saturation;
                                 Tiles.Tiles_lightness[var15] += var64.lightness;
                                 class1.Tiles_hueMultiplier[var15] += var64.hueMultiplier;
                                 ++MouseRecorder.field1039[var15];
                              }
                           }
                           ...
                           if (var17 >= 0 && var17 < 104) {
                              ...
                              if (var50 > 0) {
                                 ...
                                 TileItem.Tiles_hue[var15] -= var65.hue;
                                 class397.Tiles_saturation[var15] -= var65.saturation;
                                 Tiles.Tiles_lightness[var15] -= var65.lightness;
                                 class1.Tiles_hueMultiplier[var15] -= var65.hueMultiplier;
                                 --MouseRecorder.field1039[var15];
                              }
                           }
                        }
                        ...
                        if (var14 >= 1 && var14 < 103) {
                           ...
                           for(var52 = -5; var52 < 109; ++var52) {
                              ...
                              if (var21 >= 0 && var21 < 104) {
                                 ...
                                 var51 += MouseRecorder.field1039[var21];
                              }
                              ...
                              if (var22 >= 0 && var22 < 104) {
                                 ...
                                 var51 -= MouseRecorder.field1039[var22];
                              }
                                 ...
                                 if (var23 > 0 || var24 > 0) {
                                    ...
                                    if (var5 > 0) {
                                       ...
                                       if (var73 && var26 == var25 && var25 == var27 && var25 == var28) {
                                          Tiles.field962[var5][var14][var52] |= 2340;
                                       }
                                    }
                           ...
                           for(var11 = 0; var11 <= 104; ++var11) {
                                 ...
                                 if (var16 >= 8) {
                                    ...
                                    for(var52 = var14; var52 <= var15; ++var52) {
                                       for(var21 = var12; var21 <= var13; ++var21) {
                                          Tiles.field962[var52][var11][var21] &= ~var5;
                                       }
                                    }
                                 }
                              }
                              ...
                              if ((Tiles.field962[var9][var11][var10] & var48) != 0) {
                                 ...
                                 if (var16 >= 8) {
                                    ...
                                    for(var52 = var14; var52 <= var15; ++var52) {
                                       for(var21 = var12; var21 <= var13; ++var21) {
                                          Tiles.field962[var52][var21][var10] &= ~var48;
                                       }
                                    }
                                 }
                              }
                                 ...
                                 if ((var13 - var12 + 1) * (var15 - var14 + 1) >= 4) {
                                    ...
                                    for(var17 = var12; var17 <= var13; ++var17) {
                                       for(var50 = var14; var50 <= var15; ++var50) {
                                          Tiles.field962[var9][var17][var50] &= ~var7;
                                       }
                                    }
                                 }
                              }
                  ...
                  for(int var17 = 0; var17 < 100; ++var17) {
                     ...
                     if (var7 > 0) {
                        ...
                        if (NetCache.field3719 != 0) {
                           for(var9 = 0; var9 < var8; ++var9) {
                              NetCache.NetCache_responseHeaderBuffer.array[var9 + NetCache.NetCache_responseHeaderBuffer.offset] ^= NetCache.field3719;
                           }
                        }
                        ...
                        if (NetCache.field3719 != 0) {
                           for(var10 = 0; var10 < var9; ++var10) {
                              class138.NetCache_responseArchiveBuffer.array[class138.NetCache_responseArchiveBuffer.offset + var10] ^= NetCache.field3719;
                           }
                        }

                        class138.NetCache_responseArchiveBuffer.offset += var9;
         ...
         if (loginState == 13) {
            ...
            if (loginState == 15 && ((AbstractSocket)var1).available() >= TextureProvider.field2485) {
               ...
               try {
                  ...
                  getWindow(var17).call("zap", (Object[])null);
            ...
            if (loginState != 16) {
               ...
               if (((AbstractSocket)var1).available() >= packetWriter.serverPacketLength) {
                  ...
                  Frames.method4481();
                  AbstractArchive.friendsChat = null;
         ...
         if (gameState == 30) {
            while(true) {
               ...
               if (!var32) {
                  ...
                  Object var42 = Interpreter.mouseRecorder.lock;
                  int var4;
                  int var5;
                  int var6;
                  int var7;
                  ...
                  synchronized(Interpreter.mouseRecorder.lock) {
                     if (!field497) {
                        ...
                        for(var7 = 0; var7 < Interpreter.mouseRecorder.index && (var33 == null || var33.packetBuffer.offset - var3 < 246); ++var7) {
                           ...
                           if (var9 != field475 || var8 != field476) {
                              ...
                              if (var12 < 8 && var10 >= -32 && var10 <= 31 && var11 >= -32 && var11 <= 31) {
                                 ...
                                 var33.packetBuffer.writeShort((var12 & 8191) + '\ue000');
                                 if (var9 != -1 && var8 != -1) {
                                    var33.packetBuffer.writeInt(var9 | var8 << 16);
                                 } else {
                                    var33.packetBuffer.writeInt(Integer.MIN_VALUE);
                        ...
                        if (var4 >= Interpreter.mouseRecorder.index) {
                           ...
                           Interpreter.mouseRecorder.index -= var4;
                  ...
                  if (class6.ClanChat_inClanChat) {
                     if (AbstractArchive.friendsChat != null) {
                        AbstractArchive.friendsChat.sort();
                     }

                     TileItem.method2315();
                     class6.ClanChat_inClanChat = false;
                  }
                  ...
                  for(PendingSpawn var43 = (PendingSpawn)pendingSpawns.last(); var43 != null; var43 = (PendingSpawn)pendingSpawns.previous()) {
                     if (var43.hitpoints > 0) {
                        --var43.hitpoints;
                     }

                     if (var43.hitpoints == 0) {
                        if (var43.objectId < 0 || NPC.method2265(var43.objectId, var43.field1076)) {
                           MusicPatchNode2.addPendingSpawnToScene(var43.plane, var43.type, var43.x, var43.y, var43.objectId, var43.field1075, var43.field1076);
                           var43.remove();
                        }
                     } else {
                        if (var43.delay > 0) {
                        ...
                        if (var43.delay == 0 && var43.x >= 1 && var43.y >= 1 && var43.x <= 102 && var43.y <= 102 && (var43.id < 0 || NPC.method2265(var43.id, var43.field1082))) {
                           MusicPatchNode2.addPendingSpawnToScene(var43.plane, var43.type, var43.x, var43.y, var43.id, var43.orientation, var43.field1082);
                           var43.delay = -1;
                           if (var43.id == var43.objectId && var43.objectId == -1) {
                              var43.remove();
                           } else if (var43.objectId == var43.id && var43.field1075 == var43.orientation && var43.field1076 == var43.field1082) {
                              var43.remove();
                           }
                        }
                     }
                  ...
                  for(var1 = 0; var1 < soundEffectCount; ++var1) {
                     ...
                     if (queuedSoundEffectDelays[var1] >= -10) {
                        ...
                        if (var35 == null) {
                           ...
                           queuedSoundEffectDelays[var1] += var35.calculateDelay();
                  ...
                  int[] var44 = Players.Players_indices;

                  for(var15 = 0; var15 < Players.Players_count; ++var15) {
                     Player var54 = players[var44[var15]];
                     if (var54 != null && var54.overheadTextCyclesRemaining > 0) {
                        --var54.overheadTextCyclesRemaining;
                        if (var54.overheadTextCyclesRemaining == 0) {
                           var54.overheadText = null;
                        }
                     }
                  }
                  ...
                  for(var15 = 0; var15 < npcCount; ++var15) {
                     ...
                     NPC var49 = npcs[var3];
                     if (var49 != null && var49.overheadTextCyclesRemaining > 0) {
                        --var49.overheadTextCyclesRemaining;
                        if (var49.overheadTextCyclesRemaining == 0) {
                           var49.overheadText = null;
                        }
                     }
                  }
                  ...
                  Widget var45 = WorldMapData_0.mousedOverWidgetIf1;
                  ...
                  while(WorldMapElement.isKeyDown() && field695 < 128) {
                     if (staffModLevel >= 2 && KeyHandler.KeyHandler_pressedKeys[82] && class12.field55 == 66) {
                        ...
                        Message var46;
                        for(Iterator var51 = Messages.Messages_hashTable.iterator(); var51.hasNext(); var50 = var50 + var46.sender + ':' + var46.text + '\n') {
                           var46 = (Message)var51.next();
                        }

                        ArchiveLoader.client.method484(var50);
                  ...
                  if (var38 && KeyHandler.KeyHandler_pressedKeys[82] && KeyHandler.KeyHandler_pressedKeys[81] && mouseWheelRotation != 0) {
                     ...
                     if (var4 != HealthBarDefinition.localPlayer.plane) {
                        InvDefinition.method2986(HealthBarDefinition.localPlayer.pathX[0] + class19.baseX, HealthBarDefinition.localPlayer.pathY[0] + DefaultsGroup.baseY, var4, false);
                     }
                  ...
                  while(true) {
                     ...
                     Widget var53;
                     do {
                        var52 = (ScriptEvent)field674.removeLast();
                        if (var52 == null) {
                           while(true) {
                              do {
                                 var52 = (ScriptEvent)field675.removeLast();
                                 if (var52 == null) {
                                    while(true) {
                                       do {
                                          ...
                                          if (var52 == null) {
                                             this.menu();
                                             if (class133.worldMap != null) {
                                                class133.worldMap.method6497(GrandExchangeOfferTotalQuantityComparator.Client_plane, (HealthBarDefinition.localPlayer.x >> 7) + class19.baseX, (HealthBarDefinition.localPlayer.y >> 7) + DefaultsGroup.baseY, false);
                                                ...
                                                if (MouseHandler.MouseHandler_currentButton == 0) {
                                                   if (field667) {
                                                      if (class274.hoveredItemContainer == class247.dragInventoryWidget && dragItemSlotDestination != dragItemSlotSource) {
                                                         Widget var55 = class247.dragInventoryWidget;
                                                         byte var39 = 0;
                                                         if (field656 == 1 && var55.contentType == 206) {
                                                            var39 = 1;
                                                         }

                                                         if (var55.itemIds[dragItemSlotDestination] <= 0) {
                                                            var39 = 0;
                                                         }

                                                         if (TileItem.method2316(PendingSpawn.getWidgetFlags(var55))) {
                                                            var6 = dragItemSlotSource;
                                                            var7 = dragItemSlotDestination;
                                                            var55.itemIds[var7] = var55.itemIds[var6];
                                                            var55.itemQuantities[var7] = var55.itemQuantities[var6];
                                                            var55.itemIds[var6] = -1;
                                                            var55.itemQuantities[var6] = 0;
                                                         } else if (var39 == 1) {
                                                            var6 = dragItemSlotSource;
                                                            var7 = dragItemSlotDestination;
                                                            ...
                                                            var55.swapItems(dragItemSlotDestination, dragItemSlotSource);
                                                         }
                                                      ...
                                                      var4 = draggedWidgetX;
                                                      var5 = draggedWidgetY;
                                                      MenuAction var48 = class274.tempMenuAction;
                                                      class14.menuAction(var48.param0, var48.param1, var48.opcode, var48.identifier, var48.action, var48.action, var4, var5);
                                             ...
                                             if (var45 != WorldMapData_0.mousedOverWidgetIf1) {
                                                if (var45 != null) {
                                                   class184.invalidateWidget(var45);
                                                }
                                             ...
                                             if (oculusOrbState == 0) {
                                                ...
                                                var6 = 0;
                                                if (var40 >= 0 || var41 != 0) {
                                                   var6 = KeyHandler.KeyHandler_pressedKeys[81] ? oculusOrbSlowedSpeed * -1748111485 * 2001475371 : oculusOrbNormalSpeed * -347452533 * -567507933;
                                                   var6 *= 16;
                                                   field520 = var40;
                                                   field549 = var41;
                                                }
                                             ...
                                             if (MouseHandler.MouseHandler_currentButton == 4 && ApproximateRouteStrategy.mouseCam) {
                                                ...
                                                camAngleDX = var4 * 2;
                                                mouseCamClickedY = var4 != -1 && var4 != 1 ? (mouseCamClickedY + MouseHandler.MouseHandler_y) / 2 : MouseHandler.MouseHandler_y * 111270843 * -1137004173;
                                                var5 = mouseCamClickedX - MouseHandler.MouseHandler_x;
                                                camAngleDY = var5 * 2;
                                                mouseCamClickedX = var5 != -1 && var5 != 1 ? (mouseCamClickedX + MouseHandler.MouseHandler_x) / 2 : MouseHandler.MouseHandler_x * -1783686409 * 1769064135;
                                             } else {
                                          ...
                                          var53 = var52.widget;
                                          if (var53.childIndex < 0) {
                                             break;
                                          }

                                          var47 = UserComparator9.getWidget(var53.parentId);
                                       } while(var47 == null || var47.children == null || var53.childIndex >= var47.children.length || var53 != var47.children[var53.childIndex]);

                                       Tile.runScriptEvent(var52);
                                    }
                                 }
   ...
   final void drawLoggedIn() {
      ...
      if (showMouseCross) {
         if (mouseCrossColor == 1) {
            UserComparator10.crossSprites[mouseCrossState / 100].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
         }

         if (mouseCrossColor == 2) {
            UserComparator10.crossSprites[mouseCrossState / 100 + 4].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
         }
      }
      ...
      if (var2 == null) {
         ...
         try {
            ...
            if (ServerPacket.field2806 == var1.serverPacket) {
               isCameraLocked = true;
               UrlRequest.field1298 = var3.readUnsignedByte();
               SoundSystem.field288 = var3.readUnsignedByte();
               ...
               if (TextureProvider.field2484 >= 100) {
                  var17 = UrlRequest.field1298 * 128 + 64;
                  var5 = SoundSystem.field288 * 128 + 64;
            ...
            if (ServerPacket.field2833 == var1.serverPacket) {
               isCameraLocked = true;
               SpotAnimationDefinition.field1761 = var3.readUnsignedByte();
               BuddyRankComparator.field1333 = var3.readUnsignedByte();
            ...
            if (ServerPacket.field2828 == var1.serverPacket) {
               ...
               if (var36 != null) {
                  class184.invalidateWidget(var36);
                  MouseRecorder.revalidateWidgetScroll(WorldMapSection1.Widget_interfaceComponents[var36.id >>> 16], var36, true);
               }
            ...
            if (ServerPacket.field2881 == var1.serverPacket) {
               if (var1.serverPacketLength == 0) {
                  ...
                  if (AbstractArchive.friendsChat == null) {
                     AbstractArchive.friendsChat = new FriendsChat(GrandExchangeOfferUnitPriceComparator.loginType, ArchiveLoader.client);
                  }

                  AbstractArchive.friendsChat.readUpdate(var3);
               }
            ...
            if (ServerPacket.field2799 == var1.serverPacket) {
               if (AbstractArchive.friendsChat != null) {
                  AbstractArchive.friendsChat.method6040(var3);
               }
            ...
            MilliClock.RunException_sendStackTrace("" + (var1.serverPacket != null ? var1.serverPacket.id * 1996281945 * -662376471 : -1) + "," + (var1.field1284 != null ? var1.field1284.id * 1996281945 * -662376471 : -1) + "," + (var1.field1285 != null ? var1.field1285.id * 1996281945 * -662376471 : -1) + "," + var1.serverPacketLength, (Throwable)null);
            SequenceDefinition.logOut();
         } catch (IOException var44) {
            Clock.method2960();
         } catch (Exception var45) {
            var19 = "" + (var1.serverPacket != null ? var1.serverPacket.id * 1996281945 * -662376471 : -1) + "," + (var1.field1284 != null ? var1.field1284.id * 1996281945 * -662376471 : -1) + "," + (var1.field1285 != null ? var1.field1285.id * 1996281945 * -662376471 : -1) + "," + var1.serverPacketLength + "," + (HealthBarDefinition.localPlayer.pathX[0] + class19.baseX) + "," + (HealthBarDefinition.localPlayer.pathY[0] + DefaultsGroup.baseY) + ",";
