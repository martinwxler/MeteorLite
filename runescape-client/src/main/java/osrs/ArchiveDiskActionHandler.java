...
public class ArchiveDiskActionHandler implements Runnable {
   ...
   static void method5258() {
      if (Login.clearLoginScreen) {
         ...
         class12.loginWorldsButton = null;
   ...
   static int method5257(int var0, Script var1, boolean var2) {
      ...
      if (var0 == 6600) {
         ...
         int var15 = (HealthBarDefinition.localPlayer.x >> 7) + class19.baseX;
         int var8 = (HealthBarDefinition.localPlayer.y >> 7) + DefaultsGroup.baseY;
