...
public class Decimator {
	...
	static final void menuAction(int var0, int var1, int var2, int var3, String var4, String var5, int var6, int var7) {
		...
		if (var2 == 1) { // L: 9021
			...
			var8.packetBuffer.writeByteC(Calendar.selectedItemSlot); // L: 9463
			var8.packetBuffer.writeByteC(var0 + class131.baseX); // L: 9464
			...
			if (var2 == 7) {
				...
				if (var2 == 14) {
					...
					if (var15 != null) { // L: 9356
						...
						var9.packetBuffer.writeByteC(var3); // L: 9367
