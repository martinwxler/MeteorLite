...
public class PcmPlayer {
   ...
   PcmStream[] field268 = new PcmStream[8];
   @ObfuscatedName("as")
   @ObfuscatedSignature(
      descriptor = "[Lav;"
   )
   PcmStream[] field269 = new PcmStream[8];
   ...
   static void method757(GameEngine var0) {
      while(WorldMapElement.isKeyDown()) {
         ...
         } else if (class12.field55 == 97 && Login.worldSelectPage < Login.worldSelectPagesCount && MouseRecorder.worldSelectRightSprite != null) {
            ++Login.worldSelectPage;
         }
      }
