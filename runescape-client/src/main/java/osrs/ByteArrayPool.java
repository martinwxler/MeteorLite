...
public class ByteArrayPool {
   ...
   static int field3891 = 0;
   @ObfuscatedName("j")
   @ObfuscatedGetter(
      intValue = 450416009
   )
   static int field3881 = 1000;
   @ObfuscatedName("b")
   @ObfuscatedGetter(
      intValue = -358256925
   )
   static int field3882 = 250;
   @ObfuscatedName("x")
   @ObfuscatedGetter(
      intValue = -477323591
   )
   static int field3883 = 100;
   @ObfuscatedName("y")
   @ObfuscatedGetter(
      intValue = 231839197
   )
   static int field3884 = 50;
   @ObfuscatedName("k")
   ...
   @ObfuscatedName("u")
   static byte[][] field3888 = new byte[50][];
   @ObfuscatedName("z")
   @Export("ByteArrayPool_altSizeArrayCounts")
   static int[] ByteArrayPool_altSizeArrayCounts;
   @ObfuscatedName("d")
   static ArrayList field3890 = new ArrayList();
