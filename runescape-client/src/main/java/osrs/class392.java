...
public class class392 implements MouseWheel {
   ...
   public static final class392 field4276 = new class392(2, 0, Integer.class, new class389());
   @ObfuscatedName("w")
   @ObfuscatedSignature(
      descriptor = "Log;"
   )
   public static final class392 field4270 = new class392(1, 1, Long.class, new class391());
   @ObfuscatedName("s")
   @ObfuscatedSignature(
      descriptor = "Log;"
   )
   public static final class392 field4271 = new class392(0, 2, String.class, new class393());
   @ObfuscatedName("a")
   @ObfuscatedGetter(
      intValue = 309429929
   )
