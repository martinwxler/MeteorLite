...
class class12 extends SSLSocket {
   ...
   static void drawTitle(Font var0, Font var1, Font var2) {
      ...
      if (Login.worldSelectOpen) {
         ...
         if (MouseRecorder.worldSelectRightSprite == null) {
         ...
         if (DirectByteArrayCopier.worldSelectBackSprites != null) {
            ...
            if (MouseRecorder.worldSelectRightSprite != null && Login.worldSelectPage < Login.worldSelectPagesCount) {
               MouseRecorder.worldSelectRightSprite.drawAt(GameEngine.canvasWidth - MouseRecorder.worldSelectRightSprite.subWidth - 8, KeyHandler.canvasHeight / 2 - MouseRecorder.worldSelectRightSprite.subHeight / 2);
            }
         ...
         if (Client.gameState == 10 || Client.gameState == 11) {
            ...
            if (Login.loginIndex == 0) {
               ...
               IndexedSprite var9 = var10 ? (var11 ? ClanMate.field3950 : class9.options_buttons_2Sprite) : (var11 ? Login.optionSprite : NetSocket.options_buttons_0Sprite);
               ...
               IndexedSprite var13 = var14 ? (var15 ? ClanMate.field3950 : class9.options_buttons_2Sprite) : (var15 ? Login.optionSprite
                   : NetSocket.options_buttons_0Sprite);
         ...
         if (Client.gameState > 5 && Language.Language_EN == MouseHandler.clientLanguage) {
            if (loginWorldsButton != null) {
               var33 = Login.xPadding + 5;
               var34 = 463;
               byte var46 = 100;
               byte var27 = 35;
               loginWorldsButton.drawAt(var33, var34);
               ...
               loginWorldsButton = Script.SpriteBuffer_getIndexedSpriteByName(GrandExchangeOfferOwnWorldComparator.archive8, "sl_button", "");
            }
         }
