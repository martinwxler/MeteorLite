...
public class World {
  ...
  static void changeWorldSelectSorting(int var0, int var1) {
    ...
    FileSystem.sortWorlds(World_worlds, 0, World_worlds.length - 1, World_sortOption1,
        World_sortOption2); // L: 77
  } // L: 78
  ...
  static final void updateActorSequence(Actor var0, int var1) {
    ...
    if (class262.localPlayer == var0 && (var0.x < 1536 || var0.y < 1536 || var0.x >= 11776
        || var0.y >= 11776)) { // L: 4101 4102
    ...
    if (var0.field1275 != 0) { // L: 4113
      ...
      if (var5 != 0) { // L: 4137
        ...
        if (var5 > 1024) { // L: 4139
          ...
          if (var0.idleSequence == var0.movementSequence && (var0.field1274 > 25
              || var7)) { // L: 4146
  ...
  static void performPlayerAnimation(Player var0, int var1, int var2) {
    if (var0.sequence == var1 && var1 != -1) { // L: 4371
      ...
      if (var3 == 2) { // L: 4379
        ...
        || WorldMapScaleHandler.SequenceDefinition_get(var1).field1892 >= WorldMapScaleHandler
        .SequenceDefinition_get(var0.sequence).field1892) { // L: 4383
