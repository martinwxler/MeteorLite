...
public class PcmStreamMixer extends PcmStream {
  ...
  void method778() {
    if (this.field373 > 0) { // L: 23
      for (PcmStreamMixerListener var1 = (PcmStreamMixerListener) this.field374.last();
          var1 != null; var1 = (PcmStreamMixerListener) this.field374.previous()) { // L: 24
  ...
  void method755(Node var1, PcmStreamMixerListener var2) {
    while (this.field374.sentinel != var1
        && ((PcmStreamMixerListener) var1).field519 <= var2.field519) { // L: 33
      var1 = var1.previous;
    }
  ...
  void updateSubStreams(int[] var1, int var2, int var3) {
    for (PcmStream var4 = (PcmStream) this.subStreams.last(); var4 != null;
        var4 = (PcmStream) this.subStreams.previous()) { // L: 92
  ...
  void skipSubStreams(int var1) {
    for (PcmStream var2 = (PcmStream) this.subStreams.last(); var2 != null;
        var2 = (PcmStream) this.subStreams.previous()) { // L: 130
