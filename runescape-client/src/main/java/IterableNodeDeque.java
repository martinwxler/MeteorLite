...
public class IterableNodeDeque implements Iterable, Collection {
  ...
  int method5363() {
    ...
    for (Node var2 = this.sentinel.previous; var2 != this.sentinel;
        var2 = var2.previous) { // L: 73 74 76
      ++var1; // L: 75
    }
  ...
  Node[] method5370() {
    ...
    for (Node var3 = this.sentinel.previous; var3 != this.sentinel;
        var3 = var3.previous) { // L: 88 89 91
      var1[var2++] = var3; // L: 90
    }
  ...
  public Object[] toArray(Object[] var1) {
    ...
    for (Node var3 = this.sentinel.previous; var3 != this.sentinel;
        var3 = var3.previous) { // L: 118 119 121
