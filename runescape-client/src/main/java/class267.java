    ...
    if (var0 == ScriptOpcodes.CLIENTCLOCK) { // L: 1869
      ...
      if (var0 == ScriptOpcodes.INV_GETOBJ) { // L: 1873
        ...
        var4 = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
            + 1]; // L: 1876
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = Canvas
            .method498(var3, var4); // L: 1877
        return 1; // L: 1878
        ...
        var4 = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
            + 1]; // L: 1883
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = class143
            .ItemContainer_getCount(var3, var4); // L: 1884
        return 1; // L: 1885
        ...
        var4 = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
            + 1]; // L: 1890
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = class26
            .method351(var3, var4); // L: 1891
        return 1; // L: 1892
        ...
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = class261
            .getInvDefinition(var3).size; // L: 1896
        return 1; // L: 1897
      } else if (var0 == ScriptOpcodes.STAT) { // L: 1899
        var3 = Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]; // L: 1900
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
            - 1] = Client.currentLevels[var3]; // L: 1901
        return 1; // L: 1902
        ...
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
            - 1] = Client.experience[var3]; // L: 1911
        return 1; // L: 1912
      } else {
        int var5;
        if (var0 == ScriptOpcodes.COORD) { // L: 1914
          ...
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
              Client.isMembersWorld ? 1 : 0; // L: 1937
          return 1; // L: 1938
          ...
          var4 = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
              + 1]; // L: 1950
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = class143
              .ItemContainer_getCount(var3, var4); // L: 1951
          return 1; // L: 1952
          ...
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
              - 1] = Client.worldProperties; // L: 1988
          return 1; // L: 1989
          ...
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
              - 1] = Client.field843; // L: 2004
          return 1; // L: 2005
        } else if (var0 == 3327) { // L: 2007
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
              - 1] = Client.field633; // L: 2008
          return 1; // L: 2009
        } else {
          return 2; // L: 2011
        }
