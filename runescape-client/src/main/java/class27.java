...
public class class27 extends class14 {
  ...
  static void method364(AbstractArchive var0, int var1) {
    if ((var1 & 536870912) != 0) { // L: 183
      Messages.logoSprite = TextureProvider
          .SpriteBuffer_getIndexedSpriteByName(var0, "logo_deadman_mode", ""); // L: 184
    } else if ((var1 & 1073741824) != 0) { // L: 186
      Messages.logoSprite = TextureProvider
          .SpriteBuffer_getIndexedSpriteByName(var0, "logo_seasonal_mode", ""); // L: 187
    } else {
      Messages.logoSprite = TextureProvider
          .SpriteBuffer_getIndexedSpriteByName(var0, "logo", ""); // L: 190
    }
  ...
  static void method353(Font var0, Font var1) {
    ...
    if (class364.worldSelectFlagSprites == null) { // L: 1261
      class364.worldSelectFlagSprites = WorldMapLabelSize
          .method3268(ModeWhere.archive8, "sl_flags", "");
    }
    ...
    if (NetCache.worldSelectLeftSprite == null) { // L: 1264
      NetCache.worldSelectLeftSprite = TextureProvider
          .SpriteBuffer_getIndexedSpriteByName(ModeWhere.archive8, "leftarrow", "");
    }

    if (class12.worldSelectRightSprite == null) { // L: 1265
      class12.worldSelectRightSprite = TextureProvider
          .SpriteBuffer_getIndexedSpriteByName(ModeWhere.archive8, "rightarrow", "");
    }

    Rasterizer2D.Rasterizer2D_fillRectangle(Login.xPadding, 23, 765, 480, 0); // L: 1266
    Rasterizer2D.Rasterizer2D_fillRectangleGradient(Login.xPadding, 0, 125, 23, 12425273,
        9135624); // L: 1267
    Rasterizer2D.Rasterizer2D_fillRectangleGradient(Login.xPadding + 125, 0, 640, 23, 5197647,
        2697513); // L: 1268
    ...
    if (Varcs.worldSelectBackSprites != null) { // L: 1305
      ...
      if (NetCache.worldSelectLeftSprite != null && Login.worldSelectPage > 0) { // L: 1326
        NetCache.worldSelectLeftSprite.drawAt(8,
            class0.canvasHeight / 2 - NetCache.worldSelectLeftSprite.subHeight / 2); // L: 1327
      }

      if (class12.worldSelectRightSprite != null
          && Login.worldSelectPage < Login.worldSelectPagesCount) { // L: 1329
        class12.worldSelectRightSprite
            .drawAt(AttackOption.canvasWidth - class12.worldSelectRightSprite.subWidth - 8,
                class0.canvasHeight / 2 - class12.worldSelectRightSprite.subHeight / 2); // L: 1330
      }
      ...
      int var16;
      for (var16 = var15 * var5; var16 < World.World_count && var15 - Login.worldSelectPage < var4;
          ++var16) { // L: 1337 1338
        ...
        if (MouseHandler.MouseHandler_x >= var28 && MouseHandler.MouseHandler_y >= var11
            && MouseHandler.MouseHandler_x < var31 + var28
            && MouseHandler.MouseHandler_y < var32 + var11 && var18) { // L: 1375
          Login.hoveredWorldIndex = var16; // L: 1376
          Varcs.worldSelectBackSprites[var20]
              .drawTransOverlayAt(var28, var11, 128, 16777215); // L: 1377
          var14 = true; // L: 1378
        } else {
        ...
        if (class364.worldSelectFlagSprites != null) { // L: 1381
          class364.worldSelectFlagSprites[(var17.isMembersOnly() ? 8 : 0) + var17.location]
              .drawAt(var28 + 29, var11);
        }

        var0.drawCentered(Integer.toString(var17.id), var28 + 15, var32 / 2 + var11 + 5, var21,
            -1); // L: 1382
      ...
      if (var14) { // L: 1392
        var16 =
            var1.stringWidth(World.World_worlds[Login.hoveredWorldIndex].activity) + 6; // L: 1393
        ...
        Rasterizer2D
            .Rasterizer2D_fillRectangle(MouseHandler.MouseHandler_x - var16 / 2, var30, var16,
                var29, 16777120); // L: 1399
        Rasterizer2D
            .Rasterizer2D_drawRectangle(MouseHandler.MouseHandler_x - var16 / 2, var30, var16,
                var29, 0); // L: 1400
        var1.drawCentered(World.World_worlds[Login.hoveredWorldIndex].activity,
            MouseHandler.MouseHandler_x, var30 + var1.ascent + 4, 0, -1); // L: 1401
      }
    }
      ...
      try {
        ...
        while (true) {
          ...
          if (var6 == 4) { // L: 10084
            ...
            if (var11 != -1 && (!class250.ItemDefinition_get(var11).isMembersOnly
                || Client.isMembersWorld)) { // L: 10089
