...
public class class29 implements Callable {
  ...
  static void SpriteBuffer_decode(byte[] var0) {
    ...
    var1.offset =
        var0.length - 7 - class397.SpriteBuffer_spriteCount * 8 - (var2 - 1) * 3; // L: 163
  ...
  static final void method378(int var0, int var1) {
    ClanChannel var2 =
        var0 >= 0 ? Client.currentClanChannels[var0] : AttackOption.guestClanChannel; // L: 11495
    if (var2 != null && var1 >= 0 && var1 < var2.method49()) { // L: 11496
      ...
      if (var3.rank == -1) { // L: 11498
        ...
        PacketBufferNode var6 = InterfaceParent
            .getPacketBufferNode(ClientPacket.field2583, var5.isaacCipher); // L: 11501
        var6.packetBuffer
            .writeByte(3 + class44.stringCp1252NullTerminatedByteSize(var4)); // L: 11502
