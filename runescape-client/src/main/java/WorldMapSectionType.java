...
public enum WorldMapSectionType implements Enumerated {
  ...
  public static FloorOverlayDefinition method3677(int var0) {
    FloorOverlayDefinition var1 = (FloorOverlayDefinition) FloorOverlayDefinition.FloorOverlayDefinition_cached
        .get((long) var0); // L: 30
    if (var1 != null) { // L: 31
      return var1;
    } else {
      byte[] var2 = GrandExchangeOfferUnitPriceComparator.FloorOverlayDefinition_archive
          .takeFile(4, var0); // L: 32
  ...
  static WorldMapSectionType[] method3676() {
    return new WorldMapSectionType[]{WORLDMAPSECTIONTYPE2, WORLDMAPSECTIONTYPE0,
        WORLDMAPSECTIONTYPE1, WORLDMAPSECTIONTYPE3}; // L: 17
  }
  ...
  static int method3668(int var0, Script var1, boolean var2) {
    if (var0 == ScriptOpcodes.GETWINDOWMODE) { // L: 3469
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = class302
          .getWindowedMode(); // L: 3470
      return 1; // L: 3471
    } else {
      int var3;
      if (var0 == ScriptOpcodes.SETWINDOWMODE) { // L: 3473
        ...
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
            - 1] = class4.clientPreferences.windowMode; // L: 3479
        return 1; // L: 3480
