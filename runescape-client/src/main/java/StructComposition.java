...
public class StructComposition extends DualNode {
  ...
  static int method2972(int var0, Script var1, boolean var2) {
    Widget var3 = WorldMapData_1.getWidget(
        Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]); // L: 1390
    if (var0 == ScriptOpcodes.IF_GETTARGETMASK) { // L: 1391
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = ModelData0
          .Widget_unpackTargetMask(class22.getWidgetFlags(var3)); // L: 1392
      return 1; // L: 1393
      ...
      if (var3.actions != null && var4 < var3.actions.length
          && var3.actions[var4] != null) { // L: 1398
        Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
            - 1] = var3.actions[var4]; // L: 1399
      } else {
