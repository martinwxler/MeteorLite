...
public class class248 {
  ...
  public static NPCComposition getNpcDefinition(int var0) {
    NPCComposition var1 = (NPCComposition) NPCComposition.NpcDefinition_cached
        .get((long) var0); // L: 57
    if (var1 != null) { // L: 58
      return var1;
    } else {
  ...
  static int method4915(int var0, int var1) {
    ...
    return class34.NetCache_currentResponse != null && var2 == class34.NetCache_currentResponse.key
        ? class254.NetCache_responseArchiveBuffer.offset * 99 / (
        class254.NetCache_responseArchiveBuffer.array.length
            - class34.NetCache_currentResponse.padding) + 1 : 0; // L: 146 147
  }
