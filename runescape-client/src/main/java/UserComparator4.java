...
public class UserComparator4 implements Comparator {
  ...
  static final void drawActor2d(Actor var0, int var1, int var2, int var3, int var4, int var5) {
    if (var0 != null && var0.isVisible()) { // L: 4886
      ...
      byte var8 = 0; // L: 4894
      int var10;
      if (var1 < var76 && var0.playerCycle == Client.cycle && Canvas
          .method492((Player) var0)) { // L: 4895
        ...
        if (var1 < var76) { // L: 4897
          ...
          AbstractFont var11 = (AbstractFont) Client.fontsMap
              .get(FontName.FontName_plain12); // L: 4902
          byte var12 = 9; // L: 4903
          var11.drawCentered(var9.username.getName(), var2 + Client.viewportTempX,
              var3 + Client.viewportTempY - var12, 16777215, 0); // L: 4904
          var8 = 18; // L: 4905
        }
      }
      ...
      if (!var0.healthBars.method5364()) { // L: 4909
        ...
        for (HealthBar var89 = (HealthBar) var0.healthBars.last(); var89 != null;
            var89 = (HealthBar) var0.healthBars.previous()) { // L: 4914
          ...
          if (var81 == null) { // L: 4916
            ...
            if (var81.cycleOffset > var86) { // L: 4931
              var88 =
                  var13.field1607 == 0 ? 0 : var13.field1607 * (var86 / var13.field1607); // L: 4932
            ...
            if (var82 != null && var83 != null) { // L: 4942
              ...
              if (var18 >= 0 && var18 < 255) { // L: 4950
                ...
                Rasterizer2D
                    .Rasterizer2D_expandClip(var23, var24, var94 + var23, var88 + var24); // L: 4952
                var83.drawTransAt(var23, var24, var18); // L: 4953
              } else {
                var82.drawTransBgAt(var23, var24); // L: 4956
                Rasterizer2D
                    .Rasterizer2D_expandClip(var23, var24, var23 + var94, var24 + var88); // L: 4957
              ...
              if (Client.viewportTempX > -1) { // L: 4965
                ...
                Rasterizer2D.Rasterizer2D_fillRectangle(var94 + var88, var23, var84 - var94, 5,
                    16711680); // L: 4969
              }
      ...
      if (var1 < var76) { // L: 4979
        ...
        if (var78.headIconPk != -1 || var78.headIconPrayer != -1) { // L: 4982
          ...
          if (Client.viewportTempX > -1) { // L: 4987
            if (var78.headIconPk != -1) { // L: 4988
              var77 += 25; // L: 4989
              ScriptFrame.headIconPkSprites[var78.headIconPk]
                  .drawTransBgAt(var2 + Client.viewportTempX - 12,
                      var3 + Client.viewportTempY - var77); // L: 4990
            }

            if (var78.headIconPrayer != -1) { // L: 4992
              var77 += 25; // L: 4993
              class20.headIconPrayerSprites[var78.headIconPrayer]
                  .drawTransBgAt(var2 + Client.viewportTempX - 12,
                      var3 + Client.viewportTempY - var77); // L: 4994
            }
          }
        }

        if (var1 >= 0 && Client.hintArrowType == 10
            && var7[var1] == Client.hintArrowPlayerIndex) { // L: 4998
          ...
          if (Client.viewportTempX > -1) { // L: 5003
            ...
            Skills.headIconHintSprites[1].drawTransBgAt(var2 + Client.viewportTempX - 12,
                var3 + Client.viewportTempY - var77); // L: 5005
          }
        }
      } else {
        ...
        if (var93.headIconPrayer >= 0
            && var93.headIconPrayer < class20.headIconPrayerSprites.length) { // L: 5012
          var79 = var0.defaultHeight + 15; // L: 5013
          ClanChannel.worldToScreen(var0.x, var0.y, var79); // L: 5015
          if (Client.viewportTempX > -1) { // L: 5017
            class20.headIconPrayerSprites[var93.headIconPrayer]
                .drawTransBgAt(var2 + Client.viewportTempX - 12,
                    var3 + Client.viewportTempY - 30); // L: 5018
          }
        }

        if (Client.hintArrowType == 1 && Client.npcIndices[var1 - var76] == Client.hintArrowNpcIndex
            && Client.cycle % 20 < 10) { // L: 5021
          var79 = var0.defaultHeight + 15; // L: 5022
          ClanChannel.worldToScreen(var0.x, var0.y, var79); // L: 5024
          if (Client.viewportTempX > -1) { // L: 5026
            Skills.headIconHintSprites[0]
                .drawTransBgAt(var2 + Client.viewportTempX - 12, var3 + Client.viewportTempY - 28);
          }
        }
      }

      if (var0.overheadText != null && (var1 >= var76 || !var0.field1253 && (
          Client.publicChatMode == 4 || !var0.isAutoChatting && (Client.publicChatMode == 0
              || Client.publicChatMode == 3 || Client.publicChatMode == 1 && ((Player) var0)
              .isFriend())))) { // L: 5029 5030
        var10 = var0.defaultHeight; // L: 5031
        ClanChannel.worldToScreen(var0.x, var0.y, var10); // L: 5033
        if (Client.viewportTempX > -1
            && Client.overheadTextCount < Client.overheadTextLimit) { // L: 5035
          Client.overheadTextXOffsets[Client.overheadTextCount] =
              class309.fontBold12.stringWidth(var0.overheadText) / 2; // L: 5036
              ...
              if (var74 >= 0 && var74 < 255) { // L: 5273
                ...
                if (var20 != null) { // L: 5276
                  for (var75 = 0; var75 < var50; ++var75) { // L: 5277
                    var20.drawTransAt(var75 * var24 + (var55 + var66 - var28), var67,
                        var74); // L: 5278
                  }
                }
                ...
                if (var16 != null) { // L: 5283
                  ...
                  if (var32 != null) { // L: 5286
                    for (var75 = 0; var75 < var51; ++var75) { // L: 5287
                      var32.drawTransAt(var75 * var36 + (var66 + var60 - var40), var67,
                          var74); // L: 5288
                    }
                  }
                  ...
                  var45
                      .drawAlpha(var47, var66 + var62, var73, var16.textColor, 0, var74); // L: 5292
                }
              } else {
                ...
                if (var16 != null) { // L: 5305
                  ...
                  if (var32 != null) { // L: 5308
                    for (var75 = 0; var75 < var51; ++var75) { // L: 5309
                      var32
                          .drawTransBgAt(var75 * var36 + (var66 + var60 - var40), var67); // L: 5310
                    }
                  }
                  ...
                  var45
                      .draw(var47, var66 + var62, var73, var16.textColor | -16777216, 0); // L: 5314
                }
              }
            }
          }
