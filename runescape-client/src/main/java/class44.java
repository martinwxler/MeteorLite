    ...
    if (var0 != -1) { // L: 240
      if (Widget.Widget_loadedInterfaces[var0]) { // L: 241
        ...
        if (GrandExchangeOfferOwnWorldComparator.Widget_interfaceComponents[var0]
          ...
          for (int var2 = 0;
              var2 < GrandExchangeOfferOwnWorldComparator.Widget_interfaceComponents[var0].length;
              ++var2) { // L: 245
            if (GrandExchangeOfferOwnWorldComparator.Widget_interfaceComponents[var0][var2]
                != null) { // L: 246
              if (GrandExchangeOfferOwnWorldComparator.Widget_interfaceComponents[var0][var2].type
                  != 2) { // L: 247
