...
public class class23 extends class14 {
  ...
  public static KitDefinition KitDefinition_get(int var0) {
    KitDefinition var1 = (KitDefinition) KitDefinition.KitDefinition_cached
        .get((long) var0); // L: 27
    if (var1 != null) { // L: 28
      return var1;
    } else {
  ...
  static LoginPacket[] method318() {
    return new LoginPacket[]{LoginPacket.field2809, LoginPacket.field2804, LoginPacket.field2802,
        LoginPacket.field2801, LoginPacket.field2806, LoginPacket.field2803}; // L: 22
  }
