...
public class class170 implements WorldMapSection {
  ...
  public boolean containsCoord(int var1, int var2, int var3) {
    if (var1 >= this.field2015 && var1 < this.field2013 + this.field2015) { // L: 28
      return var2 >= (this.field2014 << 6) + (this.field2018 << 3)
          && var2 <= (this.field2014 << 6) + (this.field2018 << 3) + 7
          && var3 >= (this.field2012 << 6) + (this.field2019 << 3)
          && var3 <= (this.field2012 << 6) + (this.field2019 << 3) + 7; // L: 31
    } else {
      return false; // L: 29
    }
  }
  ...
  public boolean containsPosition(int var1, int var2) {
    return var1 >= (this.field2023 << 6) + (this.field2020 << 3)
        && var1 <= (this.field2023 << 6) + (this.field2020 << 3) + 7
        && var2 >= (this.field2017 << 6) + (this.field2021 << 3)
        && var2 <= (this.field2017 << 6) + (this.field2021 << 3) + 7; // L: 35
  }
  ...
  public int[] getBorderTileLengths(int var1, int var2, int var3) {
    if (!this.containsCoord(var1, var2, var3)) { // L: 39
      ...
      int[] var4 = new int[]{
          var2 + (this.field2023 * 64 - this.field2014 * 64) + (this.field2020 * 8
              - this.field2018 * 8),
          var3 + (this.field2017 * 64 - this.field2012 * 64) + (this.field2021 * 8
              - this.field2019 * 8)}; // L: 42 43 44
      return var4; // L: 45
    }
  }
  ...
  public Coord coord(int var1, int var2) {
    if (!this.containsPosition(var1, var2)) { // L: 49
      ...
      int var3 =
          this.field2014 * 64 - this.field2023 * 64 + (this.field2018 * 8 - this.field2020 * 8)
              + var1; // L: 52
      int var4 = var2 + (this.field2012 * 64 - this.field2017 * 64) + (this.field2019 * 8
          - this.field2021 * 8); // L: 53
