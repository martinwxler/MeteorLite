...
public class BufferedSource implements Runnable {
  ...
  static final void drawScrollBar(int var0, int var1, int var2, int var3, int var4) {
    ...
    Rasterizer2D
        .Rasterizer2D_fillRectangle(var0, var1 + 16, 16, var3 - 32, Client.field685); // L: 10035
    ...
    Rasterizer2D
        .Rasterizer2D_fillRectangle(var0, var6 + var1 + 16, 16, var5, Client.field686); // L: 10039
    Rasterizer2D
        .Rasterizer2D_drawVerticalLine(var0, var6 + var1 + 16, var5, Client.field688); // L: 10040
    Rasterizer2D.Rasterizer2D_drawVerticalLine(var0 + 1, var6 + var1 + 16, var5,
        Client.field688); // L: 10041
    Rasterizer2D
        .Rasterizer2D_drawHorizontalLine(var0, var6 + var1 + 16, 16, Client.field688); // L: 10042
    Rasterizer2D
        .Rasterizer2D_drawHorizontalLine(var0, var6 + var1 + 17, 16, Client.field688); // L: 10043
    Rasterizer2D.Rasterizer2D_drawVerticalLine(var0 + 15, var6 + var1 + 16, var5,
        Client.field818); // L: 10044
    Rasterizer2D.Rasterizer2D_drawVerticalLine(var0 + 14, var6 + var1 + 17, var5 - 1,
        Client.field818); // L: 10045
    Rasterizer2D.Rasterizer2D_drawHorizontalLine(var0, var5 + var6 + var1 + 15, 16,
        Client.field818); // L: 10046
    Rasterizer2D.Rasterizer2D_drawHorizontalLine(var0 + 1, var6 + var5 + var1 + 14, 15,
        Client.field818); // L: 10047
  } // L: 10048
