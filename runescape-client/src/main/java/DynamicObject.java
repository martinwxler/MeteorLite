...
public class DynamicObject extends Renderable {
  ...
  DynamicObject(int var1, int var2, int var3, int var4, int var5, int var6, int var7, boolean var8,
      Renderable var9) {
    this.id = var1; // L: 20
    this.type = var2; // L: 21
    ...
    if (var7 != -1) { // L: 26
      ...
      if (this.sequenceDefinition.field1894 == 0 && var9 != null
          && var9 instanceof DynamicObject) { // L: 30
      ...
      if (var8 && this.sequenceDefinition.frameCount != -1) { // L: 38
        this.frame = (int) (Math.random()
            * (double) this.sequenceDefinition.frameIds.length); // L: 39
        this.cycleStart -= (int) (Math.random()
            * (double) this.sequenceDefinition.frameLengths[this.frame]); // L: 40
      }
    }
  ...
  static final void method2099(boolean var0) {
    ...
    if (Client.packetWriter.pendingWrites >= 50 || var0) { // L: 5704
      ...
      if (!Client.hadNetworkError && Client.packetWriter.getSocket() != null) { // L: 5706
        PacketBufferNode var1 = InterfaceParent.getPacketBufferNode(ClientPacket.field2647,
            Client.packetWriter.isaacCipher); // L: 5708
  ...
  protected final Model getModel() {
    ...
    if (var12 == null) { // L: 64
      ...
      int var9 =
          var8[var4][var7] + var8[var4][var6] + var8[var5][var6] + var8[var5][var7] >> 2; // L: 80
      int var10 = (this.x << 7) + (var2 << 6); // L: 81
      int var11 = (this.y << 7) + (var3 << 6); // L: 82
      return var12.getModelDynamic(this.type, this.orientation, var8, var10, var9, var11,
          this.sequenceDefinition, this.frame); // L: 83
    }
  }
}
