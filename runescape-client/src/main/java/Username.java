...
public class Username implements Comparable {
  ...
  public Username(String var1, LoginType var2) {
    ...
    if (var1 == null) { // L: 15
      ...
      int var6;
      for (var6 = var1.length(); var5 < var6 && SpriteMask.method4777(var1.charAt(var5));
          ++var5) { // L: 20 21
      }
  ...
  public boolean equals(Object var1) {
    if (var1 instanceof Username) { // L: 54
      ...
      if (this.cleanName == null) {
        ...
        return this.hashCode() != var2.hashCode() ? false
            : this.cleanName.equals(var2.cleanName); // L: 58 59
      }
    } else {
      return false; // L: 61
    }
