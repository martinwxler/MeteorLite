...
public class WorldMapData_1 extends AbstractWorldMapData {
  ...
  public static PacketBufferNode method3583() {
    return PacketBufferNode.PacketBufferNode_packetBufferNodeCount == 0 ? new PacketBufferNode()
        : PacketBufferNode.PacketBufferNode_packetBufferNodes[--PacketBufferNode.PacketBufferNode_packetBufferNodeCount]; // L: 22 23
  }
  ...
  public static class226[] method3582() {
    return new class226[]{class226.field2688, class226.field2683, class226.field2684,
        class226.field2692, class226.field2693, class226.field2687, class226.field2686,
        class226.field2689, class226.field2690, class226.field2691}; // L: 17
  }
  ...
  public static Widget getWidget(int var0) {
    ...
    if (GrandExchangeOfferOwnWorldComparator.Widget_interfaceComponents[var1] == null
        || GrandExchangeOfferOwnWorldComparator.Widget_interfaceComponents[var1][var2]
        == null) { // L: 201
  ...
  void readGeography(Buffer var1) {
    ...
    if (var2 != class180.field2103.value) { // L: 40
      ...
      if (var3 == super.regionX && var4 == super.regionY && var5 == this.chunkX
          && var6 == this.chunkY) { // L: 47
