...
public final class NPC extends Actor {
  ...
  @ObfuscatedSignature(
      descriptor = "(IBI)V",
      garbageValue = "464713679"
  )
  final void method2343(int var1, byte var2) {
    ...
    if (super.sequence != -1
        && WorldMapScaleHandler.SequenceDefinition_get(super.sequence).field1893 == 1) { // L: 37
      super.sequence = -1;
    }
    ...
    if (this.definition == null) { // L: 77
      ...
      SequenceDefinition var1 =
          super.sequence != -1 && super.sequenceDelay == 0 ? WorldMapScaleHandler
              .SequenceDefinition_get(super.sequence) : null; // L: 78
      SequenceDefinition var2 = super.movementSequence == -1
          || super.idleSequence == super.movementSequence && var1 != null ? null
          : WorldMapScaleHandler.SequenceDefinition_get(super.movementSequence); // L: 79
      Model var3 = this.definition
          .getModel(var1, super.sequenceFrame, var2, super.movementFrame); // L: 80
      if (var3 == null) { // L: 81
        return null;
      } else {
        ...
        if (super.spotAnimation != -1 && super.spotAnimationFrame != -1) { // L: 84
          Model var4 = Tiles.SpotAnimationDefinition_get(super.spotAnimation)
              .getModel(super.spotAnimationFrame); // L: 85
          if (var4 != null) { // L: 86
            var4.offsetBy(0, -super.field1263, 0); // L: 87
  ...
  final void method2347(int var1, int var2, boolean var3) {
    if (super.sequence != -1
        && WorldMapScaleHandler.SequenceDefinition_get(super.sequence).field1893 == 1) { // L: 50
      super.sequence = -1;
    }
    ...
    super.field1281 = 0; // L: 68
    super.field1242 = 0; // L: 69
    super.pathX[0] = var1; // L: 70
    super.pathY[0] = var2; // L: 71
    super.x = super.pathX[0] * 128 + super.field1225 * 64; // L: 72
    super.y = super.field1225 * 64 + super.pathY[0] * 128; // L: 73
  } // L: 74
