...
public class UserComparator6 extends AbstractUserComparator {
  ...
  static final void method2580(byte[] var0, int var1, int var2, int var3, int var4, int var5,
      int var6, int var7, CollisionMap[] var8) {
    int var10;
    ...
    for (var10 = 0; var10 < 4; ++var10) { // L: 68
      for (int var11 = 0; var11 < 64; ++var11) { // L: 69
        for (int var12 = 0; var12 < 64; ++var12) { // L: 70
          if (var10 == var4 && var11 >= var5 && var11 < var5 + 8 && var12 >= var6
              && var12 < var6 + 8) { // L: 71
            Huffman.loadTerrain(var13, var1, var2 + class143.method2815(var11 & 7, var12 & 7, var7),
                var3 + class171.method3614(var11 & 7, var12 & 7, var7), 0, 0, var7); // L: 72
          } else {
  ...
  int compareBuddy(Buddy var1, Buddy var2) {
    if (var1.world != 0 && var2.world != 0) { // L: 14
      return this.reversed ? var1.getUsername().compareToTyped(var2.getUsername())
          : var2.getUsername().compareToTyped(var1.getUsername()); // L: 15
    } else {
