...
public class PacketWriter {
  ...
  static final void insertMenuItem(String var0, String var1, int var2, int var3, int var4, int var5,
      boolean var6) {
  ...
  static final void updateRootInterface(int var0, int var1, int var2, int var3, int var4, int var5,
      int var6) {
    if (class20.loadInterface(var0)) { // L: 10365
      MenuAction
          .updateInterface(GrandExchangeOfferOwnWorldComparator.Widget_interfaceComponents[var0],
              -1, var1, var2, var3, var4, var5, var6); // L: 10366
    }
  } // L: 10367
  ...
  final void flush() throws IOException {
    if (this.socket != null && this.bufferSize > 0) { // L: 37
      ...
      while (true) {
        ...
        if (var1 == null
            || var1.index > this.buffer.array.length - this.buffer.offset) { // L: 41 42
