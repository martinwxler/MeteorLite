...
public class WorldMapSection2 implements WorldMapSection {
  ...
  public static VarbitComposition method3329(int var0) {
    VarbitComposition var1 = (VarbitComposition) VarbitComposition.VarbitDefinition_cached
        .get((long) var0); // L: 28
    if (var1 != null) { // L: 29
      return var1;
    } else {
  ...
  public boolean containsCoord(int var1, int var2, int var3) {
    if (var1 >= this.minPlane && var1 < this.planes + this.minPlane) {
      return var2 >> 6 >= this.regionStartX && var2 >> 6 <= this.regionEndX
          && var3 >> 6 >= this.regionStartY && var3 >> 6 <= this.regionEndY;
    } else {
      return false;
    }
  }
  ...
  public boolean containsPosition(int var1, int var2) {
    return var1 >> 6 >= this.field1962 && var1 >> 6 <= this.field1964 && var2 >> 6 >= this.field1963
        && var2 >> 6 <= this.field1965; // L: 35
  }
  ...
  public int[] getBorderTileLengths(int var1, int var2, int var3) {
    if (!this.containsCoord(var1, var2, var3)) { // L: 39
      ...
      int[] var4 = new int[]{var2 + (this.field1962 * 64 - this.regionStartX * 64),
          var3 + (this.field1963 * 64 - this.regionStartY * 64)}; // L: 42 43 44
      return var4; // L: 45
    }
  }
