...
public class WorldMapIcon_0 extends AbstractWorldMapIcon {
  ...
  public static ServerPacket[] ServerPacket_values() {
    return new ServerPacket[]{ServerPacket.field2752, ServerPacket.field2704,
        ServerPacket.field2705, ServerPacket.field2706, ServerPacket.field2707,
        ServerPacket.field2708, ServerPacket.field2709, ServerPacket.field2746,
        ServerPacket.field2711, ServerPacket.field2728, ServerPacket.field2713,
        ServerPacket.field2714, ServerPacket.field2715, ServerPacket.field2716,
        ServerPacket.field2721, ServerPacket.field2718, ServerPacket.field2719,
        ServerPacket.field2778, ServerPacket.field2765, ServerPacket.field2722,
        ServerPacket.field2720, ServerPacket.field2724, ServerPacket.field2725,
        ServerPacket.field2726, ServerPacket.field2712, ServerPacket.field2753,
        ServerPacket.field2732, ServerPacket.field2773, ServerPacket.field2731,
        ServerPacket.field2798, ServerPacket.field2733, ServerPacket.field2734,
        ServerPacket.field2735, ServerPacket.field2717, ServerPacket.field2737,
        ServerPacket.field2738, ServerPacket.field2739, ServerPacket.field2740,
        ServerPacket.field2741, ServerPacket.field2742, ServerPacket.field2743,
        ServerPacket.field2744, ServerPacket.field2710, ServerPacket.field2793,
        ServerPacket.field2747, ServerPacket.field2723, ServerPacket.field2749,
        ServerPacket.field2748, ServerPacket.field2751, ServerPacket.field2727,
        ServerPacket.field2736, ServerPacket.field2754, ServerPacket.field2755,
        ServerPacket.field2703, ServerPacket.field2757, ServerPacket.field2758,
        ServerPacket.field2799, ServerPacket.field2760, ServerPacket.field2761,
        ServerPacket.field2762, ServerPacket.field2763, ServerPacket.field2764,
        ServerPacket.field2794, ServerPacket.field2766, ServerPacket.field2767,
        ServerPacket.field2768, ServerPacket.field2769, ServerPacket.field2770,
        ServerPacket.field2771, ServerPacket.field2772, ServerPacket.field2759,
        ServerPacket.field2774, ServerPacket.field2775, ServerPacket.field2776,
        ServerPacket.field2777, ServerPacket.field2780, ServerPacket.field2779,
        ServerPacket.field2730, ServerPacket.field2781, ServerPacket.field2750,
        ServerPacket.field2782, ServerPacket.field2784, ServerPacket.field2785,
        ServerPacket.field2786, ServerPacket.field2729, ServerPacket.field2792,
        ServerPacket.field2789, ServerPacket.field2790, ServerPacket.field2783,
        ServerPacket.field2791, ServerPacket.field2745, ServerPacket.field2756,
        ServerPacket.field2795, ServerPacket.field2796, ServerPacket.field2797}; // L: 104
  }
    ...
    if (0L != var5) { // L: 5721
      ...
      if (var15.mapSceneId != -1) { // L: 5735
        ...
        if (var16 != null) { // L: 5737
          ...
          var16.drawAt(var17 + var1 * 4 + 48,
              var18 + (104 - var2 - var15.sizeY) * 4 + 48); // L: 5740
        }
      } else {
    ...
    if (0L != var5) { // L: 5805
      ...
      if (var19.mapSceneId != -1) { // L: 5811
        ...
        if (var26 != null) { // L: 5813
          ...
          var26.drawAt(var13 + var1 * 4 + 48,
              var14 + (104 - var2 - var19.sizeY) * 4 + 48); // L: 5816
        }
    ...
    if (0L != var5) { // L: 5843
      ...
      if (var23.mapSceneId != -1) { // L: 5846
        ...
        if (var24 != null) { // L: 5848
          ...
          var24.drawAt(var10 + var1 * 4 + 48,
              (104 - var2 - var23.sizeY) * 4 + var25 + 48); // L: 5851
        }
      }
    }
  ...
  static final void Clan_leaveChat() {
    PacketBufferNode var0 = InterfaceParent
        .getPacketBufferNode(ClientPacket.field2667, Client.packetWriter.isaacCipher); // L: 11489
