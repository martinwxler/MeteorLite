...
public class Widget extends Node {
  ...
  public SpritePixels getSprite(boolean var1) {
    ...
    if (var2 == -1) { // L: 563
      ...
      long var3 =
          (long) var2 + ((long) this.outline << 36) + ((this.spriteFlipV ? 1L : 0L) << 38) + (
              (this.spriteFlipH ? 1L : 0L) << 39) + ((long) this.spriteShadow << 40); // L: 564
  ...
  public Font getFont() {
    ...
    if (this.fontId == -1) { // L: 584
      ...
      if (var1 != null) { // L: 586
        ...
        var1 = Bounds
            .method6034(class44.Widget_spritesArchive, ChatChannel.Widget_fontsArchive, this.fontId,
                0); // L: 587
        if (var1 != null) {
  ...
  public SpriteMask getSpriteMask(boolean var1) {
    ...
    int var2 = var1 ? this.spriteId * -1019565859 * -1228050571
        : this.spriteId2 * -241980903 * 218370601; // L: 667
    if (var2 == -1) { // L: 668
      return null;
    } else {
      long var3 = ((long) this.spriteShadow << 40) + ((this.spriteFlipV ? 1L : 0L) << 38) + (
          (long) this.outline << 36) + (long) var2 + ((this.spriteFlipH ? 1L : 0L) << 39); // L: 669
