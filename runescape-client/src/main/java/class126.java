...
public enum class126 implements Enumerated {
  ...
  public static final boolean method2595(int var0, int var1, RouteStrategy var2,
      CollisionMap var3) {
    int var4 = var0; // L: 19
    int var5 = var1; // L: 20
    byte var6 = 64; // L: 21
    ...
    while (var11 != var18) { // L: 34
      ...
      if (var16 > 0 && class160.directions[var16 - 1][var17] == 0
          && (var12[var13 - 1][var14] & 19136776) == 0) { // L: 48
      ...
      if (var16 < 127 && class160.directions[var16 + 1][var17] == 0
          && (var12[var13 + 1][var14] & 19136896) == 0) { // L: 55
      ...
      if (var17 > 0 && class160.directions[var16][var17 - 1] == 0
          && (var12[var13][var14 - 1] & 19136770) == 0) { // L: 62
      ...
      if (var17 < 127 && class160.directions[var16][var17 + 1] == 0
      ...
      if (var16 > 0 && var17 > 0 && class160.directions[var16 - 1][var17 - 1] == 0
          && (var12[var13 - 1][var14 - 1] & 19136782) == 0
          && (var12[var13 - 1][var14] & 19136776) == 0
          && (var12[var13][var14 - 1] & 19136770) == 0) { // L: 76
      ...
      if (var16 < 127 && var17 > 0 && class160.directions[var16 + 1][var17 - 1] == 0
          && (var12[var13 + 1][var14 - 1] & 19136899) == 0
          && (var12[var13 + 1][var14] & 19136896) == 0
          && (var12[var13][var14 - 1] & 19136770) == 0) { // L: 83
      ...
      if (var16 > 0 && var17 < 127 && class160.directions[var16 - 1][var17 + 1] == 0
          && (var12[var13 - 1][var14 + 1] & 19136824) == 0
          && (var12[var13 - 1][var14] & 19136776) == 0
          && (var12[var13][var14 + 1] & 19136800) == 0) { // L: 90
      ...
      if (var16 < 127 && var17 < 127 && class160.directions[var16 + 1][var17 + 1] == 0
          && (var12[var13 + 1][var14 + 1] & 19136992) == 0
          && (var12[var13 + 1][var14] & 19136896) == 0
          && (var12[var13][var14 + 1] & 19136800) == 0) { // L: 97
    ...
    for (int var3 = 0; var3 < var2.size; ++var3) { // L: 142
      try {
        ...
        if (var4 != 0 && var4 != 1 && var4 != 2) { // L: 145
          ...
          var2.fields[var3] = Reflection
              .findField(FontName.loadClassFromDescriptor(var5), var6); // L: 153
        }
