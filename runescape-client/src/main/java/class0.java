...
public class class0 extends class14 {
  ...
  static final void method11(Actor var0) {
    ...
    if (var0.movementSequence != -1) { // L: 4294
      ...
      if (var1 != null && var1.frameIds != null) { // L: 4296
        ...
        if (var0.movementFrame < var1.frameIds.length
            && var0.movementFrameCycle > var1.frameLengths[var0.movementFrame]) { // L: 4298
    ...
    if (var0.spotAnimation != -1 && Client.cycle >= var0.field1262) { // L: 4311
      ...
      if (var3 != -1) { // L: 4314
        ...
        if (var2 != null && var2.frameIds != null) { // L: 4316
          ...
          if (var0.spotAnimationFrame < var2.frameIds.length && var0.spotAnimationFrameCycle
              > var2.frameLengths[var0.spotAnimationFrame]) { // L: 4318
          ...
          if (var0.spotAnimationFrame >= var2.frameIds.length && (var0.spotAnimationFrame < 0
              || var0.spotAnimationFrame >= var2.frameIds.length)) { // L: 4323 4324
    ...
    if (var0.sequence != -1 && var0.sequenceDelay <= 1) { // L: 4331
      ...
      if (var1.field1895 == 1 && var0.field1281 > 0 && var0.field1276 <= Client.cycle
          && var0.field1269 < Client.cycle) { // L: 4333 4334
    ...
    if (var0.sequence != -1 && var0.sequenceDelay == 0) { // L: 4340
      ...
      if (var1 != null && var1.frameIds != null) { // L: 4342
        ...
        if (var0.sequenceFrame < var1.frameIds.length
            && var0.sequenceFrameCycle > var1.frameLengths[var0.sequenceFrame]) { // L: 4344
        ...
        if (var0.sequenceFrame >= var1.frameIds.length) { // L: 4349
          ...
          if (var0.field1258 >= var1.field1896) { // L: 4352
            var0.sequence = -1;
          } else if (var0.sequenceFrame >= 0
              && var0.sequenceFrame < var1.frameIds.length) { // L: 4353
  ...
  static String method1(int var0) {
    if (var0 < 0) { // L: 8997
      ...
      return Client.menuTargets[var0].length() > 0 ? Client.menuActions[var0] + " "
          + Client.menuTargets[var0] : Client.menuActions[var0]; // L: 8998 8999
    }
  }
  ...
  static final void method0(int var0) {
    ...
    if (var0 != class4.clientPreferences.musicVolume) { // L: 11113
      if (class4.clientPreferences.musicVolume == 0
          && Client.currentTrackGroupId != -1) { // L: 11114
        class105.method2357(DynamicObject.archive6, Client.currentTrackGroupId, 0, var0,
            false); // L: 11115
