...
public class class19 {
  ...
  static final IterableNodeHashTable readStringIntParameters(Buffer var0,
      IterableNodeHashTable var1) {
  ...
  static int method276(int var0, Script var1, boolean var2) {
    if (var0 == ScriptOpcodes.VIEWPORT_SETFOV) { // L: 3571
      ...
      Client.field876 = (short) ScriptFrame.method1233(
          Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize]); // L: 3573
      if (Client.field876 <= 0) { // L: 3574
        Client.field876 = 256;
      }

      Client.field877 = (short) ScriptFrame.method1233(
          Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize + 1]); // L: 3575
      ...
      Client.zoomWidth = (short) Interpreter.Interpreter_intStack[
          ChatChannel.Interpreter_intStackSize + 1]; // L: 3583
      ...
      Client.field864 = (short) Interpreter.Interpreter_intStack[
          ChatChannel.Interpreter_intStackSize + 1]; // L: 3591
      ...
      Client.field881 = (short) Interpreter.Interpreter_intStack[
          ChatChannel.Interpreter_intStackSize + 2]; // L: 3594
      if (Client.field881 <= 0) { // L: 3595
        Client.field881 = 1;
      }

      Client.field690 = (short) Interpreter.Interpreter_intStack[
          ChatChannel.Interpreter_intStackSize + 3]; // L: 3596
      ...
      if (Client.viewportWidget != null) { // L: 3602
        Interpreter
            .setViewportShape(0, 0, Client.viewportWidget.width, Client.viewportWidget.height,
                false); // L: 3603
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
            - 1] = Client.viewportWidth; // L: 3604
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
            - 1] = Client.viewportHeight; // L: 3605
      } else {
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
            - 1] = -1; // L: 3608
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
      ...
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
          - 1] = Client.zoomHeight; // L: 3614
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
          - 1] = Client.zoomWidth; // L: 3615
      return 1; // L: 3616
    } else if (var0 == ScriptOpcodes.VIEWPORT_GETFOV) { // L: 3618
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = class17
          .method258(Client.field876); // L: 3619
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = class17
          .method258(Client.field877); // L: 3620
      return 1; // L: 3621
      ...
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
          - 1] = AttackOption.canvasWidth; // L: 3632
      return 1; // L: 3633
    } else if (var0 == 6223) { // L: 3635
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
          - 1] = class0.canvasHeight; // L: 3636
      return 1; // L: 3637
    } else {
      return 2; // L: 3639
    }
  ...
  static final void method281(boolean var0) {
    if (var0) { // L: 3181
      ...
      Client.field656 =
          class4.clientPreferences.parameters.containsKey(class125.method2586(Login.Login_username))
              ? class126.field1478 : class126.field1475; // L: 3185
    }
  ...
  static void method282() {
    if (class80.worldMap != null) { // L: 4364
      class80.worldMap
          .method6287(SoundSystem.Client_plane, (class262.localPlayer.x >> 7) + class15.baseX,
              (class262.localPlayer.y >> 7) + WorldMapSprite.baseY, false); // L: 4365
  ...
  static String method283(String var0, boolean var1) {
    ...
    return var2 + var0 + "." + var4 + "/l=" + AbstractArchive.clientLanguage + "/a="
        + class82.field999 + var3 + "/"; // L: 11583
  }
  ...
  void method277(Buffer var1) {
    ...
    for (int var2 = var1.readUnsignedByte(); var2 != 0;
        var2 = var1.readUnsignedByte()) { // L: 24 35
      Object var3;
      if (var2 == 1) {
  ...
  public void method278(ClanChannel var1) {
    if (var1.key == this.field155 && var1.field25 == this.field152) { // L: 40
      for (class16 var2 = (class16) this.field153.last(); var2 != null;
          var2 = (class16) this.field153.previous()) { // L: 41
