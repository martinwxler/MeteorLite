  ...
  static final void updateItemPile(int var0, int var1) {
    ...
    if (var2 == null) { // L: 7443
      DevicePcmPlayerProvider.scene
          .removeGroundItemPile(SoundSystem.Client_plane, var0, var1); // L: 7444
    } else {
      long var3 = -99999999L; // L: 7447
      TileItem var5 = null; // L: 7448

      TileItem var6;
      for (var6 = (TileItem) var2.last(); var6 != null;
          var6 = (TileItem) var2.previous()) { // L: 7449 7450 7458
      ...
      if (var5 == null) { // L: 7460
        DevicePcmPlayerProvider.scene
            .removeGroundItemPile(SoundSystem.Client_plane, var0, var1); // L: 7461
      } else {
        ...
        for (var6 = (TileItem) var2.last(); var6 != null;
            var6 = (TileItem) var2.previous()) { // L: 7467 7468 7473
        ...
        DevicePcmPlayerProvider.scene.newGroundItemPile(SoundSystem.Client_plane, var0, var1,
            ItemContainer.getTileHeight(var0 * 128 + 64, var1 * 128 + 64, SoundSystem.Client_plane),
            var5, var9, var13, var8); // L: 7476
      }
    }
  } // L: 7445 7462 7477
