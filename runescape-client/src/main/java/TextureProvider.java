...
public class TextureProvider implements TextureLoader {
  ...
  public TextureProvider(AbstractArchive var1, AbstractArchive var2, int var3, double var4,
      int var6) {
  ...
  public static EnumComposition getEnum(int var0) {
    EnumComposition var1 = (EnumComposition) EnumComposition.EnumDefinition_cached
        .get((long) var0); // L: 29
    if (var1 != null) { // L: 30
      return var1;
    } else {
  ...
  public static IndexedSprite SpriteBuffer_getIndexedSpriteByName(AbstractArchive var0, String var1,
      String var2) {
  ...
  static final void method4291(String var0) {
    PacketBufferNode var1 = InterfaceParent
        .getPacketBufferNode(ClientPacket.field2643, Client.packetWriter.isaacCipher); // L: 198
