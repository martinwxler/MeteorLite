...
public class class2 {
  ...
  static final void forceDisconnect(int var0) {
    ...
    switch (var0) { // L: 3152
      case 1:
        ...
        CollisionMap
            .setLoginResponseString("", "You were disconnected from the server.", ""); // L: 3157
        break;
      case 2:
  ...
  void method23(Buffer var1) {
    ...
    for (int var2 = var1.readUnsignedByte(); var2 != 0;
        var2 = var1.readUnsignedByte()) { // L: 34 35 55
      Object var3;
      if (var2 == 3) { // L: 37
  ...
  public void method24(ClanSettings var1) {
    if (var1.field82 == this.field18 && this.field13 == var1.field83) { // L: 60
      for (class14 var2 = (class14) this.field14.last(); var2 != null;
          var2 = (class14) this.field14.previous()) { // L: 61
