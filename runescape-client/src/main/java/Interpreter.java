...
public class Interpreter {
  ...
  static {
    ...
    Interpreter_MONTHS = new String[]{"Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep",
        "Oct", "Nov", "Dec"}; // L: 92
    field963 = false; // L: 95
    field951 = false; // L: 96
    ...
    if (var7 < Client.field881) { // L: 4723
      ...
      if (var6 > Client.field864) { // L: 4726
        ...
        if (var4) { // L: 4730
          ...
          Rasterizer2D.Rasterizer2D_fillRectangle(var0 + var2 - var9, var1, var9, var3,
              -16777216); // L: 4733
        }
      ...
      if (var6 < Client.field880) { // L: 4742
        ...
        if (var4) { // L: 4746
          ...
          Rasterizer2D.Rasterizer2D_fillRectangle(var0, var3 + var1 - var9, var2, var9,
              -16777216); // L: 4749
        }
