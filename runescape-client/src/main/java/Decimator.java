...
public class Decimator {
  ...
  public static HitSplatDefinition method1171(int var0) {
    HitSplatDefinition var1 = (HitSplatDefinition) HitSplatDefinition.HitSplatDefinition_cached
        .get((long) var0); // L: 52
    if (var1 != null) { // L: 53
      return var1;
    } else {
  ...
  static final void method1167(int var0, int var1, int var2, int var3, int var4, int var5, int var6,
      Scene var7, CollisionMap var8) {
    ...
    int var17 =
        var16[var12][var15] + var16[var12][var14] + var16[var13][var14] + var16[var13][var15]
            >> 2; // L: 906
    ...
    if (var6 == 22) { // L: 912
      if (var9.animationId == -1 && var9.transforms == null) { // L: 914
        ...
        var30 = new DynamicObject(var4, 22, var5, var1, var2, var3, var9.animationId,
            var9.field1784, (Renderable) null); // L: 915
      }
      ...
      if (var6 >= 12) { // L: 928
        if (var9.animationId == -1 && var9.transforms == null) { // L: 930
          ...
          var30 = new DynamicObject(var4, var6, var5, var1, var2, var3, var9.animationId,
              var9.field1784, (Renderable) null); // L: 931
        }

        var7.method4046(var0, var2, var3, var17, 1, 1, (Renderable) var30, 0, var20,
            var22); // L: 932
        ...
        if (var9.animationId == -1 && var9.transforms == null) { // L: 938
          ...
          var30 = new DynamicObject(var4, 0, var5, var1, var2, var3, var9.animationId,
              var9.field1784, (Renderable) null); // L: 939
        }

        var7.newBoundaryObject(var0, var2, var3, var17, (Renderable) var30, (Renderable) null,
            Tiles.field1102[var5], 0, var20, var22); // L: 940
        ...
        if (var9.animationId == -1 && var9.transforms == null) { // L: 946
          ...
          var30 = new DynamicObject(var4, 1, var5, var1, var2, var3, var9.animationId,
              var9.field1784, (Renderable) null); // L: 947
        }

        var7.newBoundaryObject(var0, var2, var3, var17, (Renderable) var30, (Renderable) null,
            Tiles.field1107[var5], 0, var20, var22); // L: 948
        ...
        if (var6 == 2) { // L: 952
          ...
          if (var9.animationId == -1 && var9.transforms == null) { // L: 956
            ...
            var31 = new DynamicObject(var4, 2, var5 + 4, var1, var2, var3, var9.animationId,
                var9.field1784, (Renderable) null); // L: 961
            var25 = new DynamicObject(var4, 2, var23, var1, var2, var3, var9.animationId,
                var9.field1784, (Renderable) null); // L: 962
          }

          var7.newBoundaryObject(var0, var2, var3, var17, (Renderable) var31, (Renderable) var25,
              Tiles.field1102[var5], Tiles.field1102[var23], var20, var22); // L: 964
          ...
          if (var9.animationId == -1 && var9.transforms == null) { // L: 970
            ...
            var30 = new DynamicObject(var4, 3, var5, var1, var2, var3, var9.animationId,
                var9.field1784, (Renderable) null); // L: 971
          }

          var7.newBoundaryObject(var0, var2, var3, var17, (Renderable) var30, (Renderable) null,
              Tiles.field1107[var5], 0, var20, var22); // L: 972
          ...
          if (var9.animationId == -1 && var9.transforms == null) { // L: 978
            ...
            var30 = new DynamicObject(var4, var6, var5, var1, var2, var3, var9.animationId,
                var9.field1784, (Renderable) null); // L: 979
          }
          ...
          if (var9.animationId == -1 && var9.transforms == null) { // L: 986
            ...
            var30 = new DynamicObject(var4, 4, var5, var1, var2, var3, var9.animationId,
                var9.field1784, (Renderable) null); // L: 987
          }

          var7.newWallDecoration(var0, var2, var3, var17, (Renderable) var30, (Renderable) null,
              Tiles.field1102[var5], 0, 0, 0, var20, var22); // L: 988
        } else {
          long var24;
          Object var26;
          if (var6 == 5) { // L: 991
            ...
            if (var9.animationId == -1 && var9.transforms == null) { // L: 996
              ...
              var26 = new DynamicObject(var4, 4, var5, var1, var2, var3, var9.animationId,
                  var9.field1784, (Renderable) null); // L: 997
            }

            var7.newWallDecoration(var0, var2, var3, var17, (Renderable) var26, (Renderable) null,
                Tiles.field1102[var5], 0, var23 * Tiles.field1100[var5],
                var23 * Tiles.field1105[var5], var20, var22); // L: 998
            ...
            if (var9.animationId == -1 && var9.transforms == null) { // L: 1006
              ...
              var26 = new DynamicObject(var4, 4, var5 + 4, var1, var2, var3, var9.animationId,
                  var9.field1784, (Renderable) null); // L: 1007
            }

            var7.newWallDecoration(var0, var2, var3, var17, (Renderable) var26, (Renderable) null,
                256, var5, var23 * Tiles.field1106[var5], var23 * Tiles.field1097[var5], var20,
                var22); // L: 1008
            ...
            if (var9.animationId == -1 && var9.transforms == null) { // L: 1014
              ...
              var30 = new DynamicObject(var4, 4, var29 + 4, var1, var2, var3, var9.animationId,
                  var9.field1784, (Renderable) null); // L: 1015
            }

            var7.newWallDecoration(var0, var2, var3, var17, (Renderable) var30, (Renderable) null,
                256, var29, 0, 0, var20, var22); // L: 1016
            ...
            if (var9.animationId == -1 && var9.transforms == null) { // L: 1026
              ...
              var26 = new DynamicObject(var4, 4, var5 + 4, var1, var2, var3, var9.animationId,
                  var9.field1784, (Renderable) null); // L: 1031
              var27 = new DynamicObject(var4, 4, var28 + 4, var1, var2, var3, var9.animationId,
                  var9.field1784, (Renderable) null); // L: 1032
            }

            var7.newWallDecoration(var0, var2, var3, var17, (Renderable) var26, (Renderable) var27,
                256, var5, var23 * Tiles.field1106[var5], var23 * Tiles.field1097[var5], var20,
                var22); // L: 1034
          }
        }
      ...
      if (var9.animationId == -1 && var9.transforms == null) { // L: 922
        ...
        var30 = new DynamicObject(var4, 10, var5, var1, var2, var3, var9.animationId,
            var9.field1784, (Renderable) null); // L: 923
      }

      if (var30 != null) { // L: 924
        var7.method4046(var0, var2, var3, var17, var10, var11, (Renderable) var30,
            var6 == 11 ? 256 : 0, var20, var22);
      }
  ...
  byte[] resample(byte[] var1) {
    if (this.table != null) { // L: 40
      int var2 =
          (int) ((long) this.outputRate * (long) var1.length / (long) this.inputRate) + 14; // L: 41
