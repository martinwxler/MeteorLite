...
public final class Projectile extends Renderable {
  ...
  static void updateGameState(int var0) {
    if (var0 != Client.gameState) { // L: 1388
      ...
      if (var0 != 5 && var0 != 10) { // L: 1410
        if (var0 == 20) { // L: 1413
          DesktopPlatformInfoProvider.method6109(JagexCache.archive10, ModeWhere.archive8, true,
              Client.gameState == 11 ? 4 : 0); // L: 1414
        } else if (var0 == 11) { // L: 1416
          DesktopPlatformInfoProvider
              .method6109(JagexCache.archive10, ModeWhere.archive8, false, 4); // L: 1417
        ...
        DesktopPlatformInfoProvider
            .method6109(JagexCache.archive10, ModeWhere.archive8, true, 0); // L: 1411
      }
  ...
  final void setDestination(int var1, int var2, int var3, int var4) {
    ...
    this.accelerationZ =
        ((double) var3 - this.z - this.speedZ * var5) * 2.0D / (var5 * var5); // L: 67
  } // L: 68
  ...
  final void advance(int var1) {
    ...
    this.z += this.speedZ * (double) var1
        + 0.5D * this.accelerationZ * (double) var1 * (double) var1; // L: 74
