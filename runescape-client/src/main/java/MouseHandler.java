...
public class MouseHandler implements MouseListener, MouseMotionListener, FocusListener {
    ...
    synchronized (ArchiveDiskActionHandler.ArchiveDiskActionHandler_lock) { // L: 27
      if (ArchiveDiskActionHandler.field3557 == 0) { // L: 28
        class305.ArchiveDiskActionHandler_thread = new Thread(
            new ArchiveDiskActionHandler()); // L: 29
          ...
          try {
            ...
            if (var4 != 3) { // L: 63
              ...
              for (int var8 = 0; var8 < var10.length; ++var8) { // L: 67
                ObjectInputStream var9 = new ObjectInputStream(
                    new ByteArrayInputStream(var10[var8])); // L: 68
  ...
  static int method718(int var0, Script var1, boolean var2) {
    ...
    if (var0 == ScriptOpcodes.CC_CREATE) { // L: 482
      ...
      int var11 = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
          + 2]; // L: 486
      if (var4 == 0) { // L: 487
      ...
      if (var0 == ScriptOpcodes.CC_DELETE) { // L: 509
        ...
        var3 = WorldMapData_1.getWidget(
            Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]); // L: 517
        ...
        if (var0 == ScriptOpcodes.IF_FIND) { // L: 543
          var3 = WorldMapData_1.getWidget(
              Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]); // L: 544
          if (var3 != null) { // L: 545
  ...
  static HorizontalAlignment[] method726() {
    return new HorizontalAlignment[]{HorizontalAlignment.field1632, HorizontalAlignment.field1630,
        HorizontalAlignment.HorizontalAlignment_centered}; // L: 14
  }
  ...
  static int method747(int var0, Script var1, boolean var2) {
    ...
    if (var0 == ScriptOpcodes.IF_GETINVOBJECT) { // L: 1364
      var5 = WorldMapData_1.getWidget(
          Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]); // L: 1365
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
          - 1] = var5.itemId; // L: 1366
      return 1; // L: 1367
    } else if (var0 == ScriptOpcodes.IF_GETINVCOUNT) { // L: 1369
      var5 = WorldMapData_1.getWidget(
          Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]); // L: 1370
  ...
  static void method741() {
    if (Client.combatTargetPlayerIndex >= 0
        && Client.players[Client.combatTargetPlayerIndex] != null) { // L: 4772
    ...
    if (var5 != null) { // L: 8819
      ...
      if (var8) { // L: 8830
        if (class136.method2696(class22.getWidgetFlags(var5), var0 - 1)) { // L: 8831
          ...
          if (var0 == 1) { // L: 8834
            var7 = InterfaceParent.getPacketBufferNode(ClientPacket.field2658,
                Client.packetWriter.isaacCipher); // L: 8836
          ...
          if (var0 == 2) { // L: 8842
            var7 = InterfaceParent.getPacketBufferNode(ClientPacket.field2631,
                Client.packetWriter.isaacCipher); // L: 8844
          ...
          if (var0 == 3) { // L: 8850
            var7 = InterfaceParent.getPacketBufferNode(ClientPacket.field2630,
                Client.packetWriter.isaacCipher); // L: 8852
          ...
          if (var0 == 4) { // L: 8858
            var7 = InterfaceParent.getPacketBufferNode(ClientPacket.field2659,
                Client.packetWriter.isaacCipher); // L: 8860
          ...
          if (var0 == 5) { // L: 8866
            var7 = InterfaceParent.getPacketBufferNode(ClientPacket.field2588,
                Client.packetWriter.isaacCipher); // L: 8868
          ...
          if (var0 == 6) { // L: 8874
            var7 = InterfaceParent.getPacketBufferNode(ClientPacket.field2579,
                Client.packetWriter.isaacCipher); // L: 8876
          ...
          if (var0 == 7) { // L: 8882
            var7 = InterfaceParent.getPacketBufferNode(ClientPacket.field2660,
                Client.packetWriter.isaacCipher); // L: 8884
          ...
          if (var0 == 8) { // L: 8890
            var7 = InterfaceParent.getPacketBufferNode(ClientPacket.field2633,
                Client.packetWriter.isaacCipher); // L: 8892
          ...
          if (var0 == 9) { // L: 8898
            var7 = InterfaceParent.getPacketBufferNode(ClientPacket.field2598,
                Client.packetWriter.isaacCipher); // L: 8900
          ...
          if (var0 == 10) { // L: 8906
            var7 = InterfaceParent.getPacketBufferNode(ClientPacket.field2592,
                Client.packetWriter.isaacCipher); // L: 8908
