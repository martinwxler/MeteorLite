      ...
      try {
        ...
        if (this.idxFile.length() < (long) (var1 * 6 + 6)) { // L: 23
          ...
          int var3 = ((ArchiveDisk_buffer[0] & 255) << 16) + (ArchiveDisk_buffer[2] & 255) + (
              (ArchiveDisk_buffer[1] & 255) << 8); // L: 26
          int var4 = (ArchiveDisk_buffer[5] & 255) + ((ArchiveDisk_buffer[3] & 255) << 16) + (
              (ArchiveDisk_buffer[4] & 255) << 8); // L: 27
            ...
            for (int var7 = 0; var6 < var3; ++var7) { // L: 32 33 65
              ...
              if (var1 > 65535) { // L: 42
                ...
                var9 = ((ArchiveDisk_buffer[1] & 255) << 16) + ((ArchiveDisk_buffer[0] & 255) << 24)
                    + (ArchiveDisk_buffer[3] & 255) + ((ArchiveDisk_buffer[2] & 255) << 8); // L: 46
                var10 =
                    (ArchiveDisk_buffer[5] & 255) + ((ArchiveDisk_buffer[4] & 255) << 8); // L: 47
                var11 = (ArchiveDisk_buffer[8] & 255) + ((ArchiveDisk_buffer[7] & 255) << 8) + (
                    (ArchiveDisk_buffer[6] & 255) << 16); // L: 48
                ...
                var9 =
                    (ArchiveDisk_buffer[1] & 255) + ((ArchiveDisk_buffer[0] & 255) << 8); // L: 55
                var10 =
                    (ArchiveDisk_buffer[3] & 255) + ((ArchiveDisk_buffer[2] & 255) << 8); // L: 56
                var11 =
                    ((ArchiveDisk_buffer[5] & 255) << 8) + ((ArchiveDisk_buffer[4] & 255) << 16) + (
                        ArchiveDisk_buffer[6] & 255); // L: 57
      ...
      try {
        ...
        if (var4) { // L: 90
          ...
          var6 = (ArchiveDisk_buffer[5] & 255) + ((ArchiveDisk_buffer[3] & 255) << 16) + (
              (ArchiveDisk_buffer[4] & 255) << 8); // L: 94
            ...
            label171:
            {
              ...
              if (var4) { // L: 113
                ...
                if (var1 > 65535) { // L: 118
                  ...
                  var10 =
                      ((ArchiveDisk_buffer[1] & 255) << 16) + ((ArchiveDisk_buffer[0] & 255) << 24)
                          + (ArchiveDisk_buffer[3] & 255) + ((ArchiveDisk_buffer[2] & 255)
                          << 8); // L: 125
                  var11 = (ArchiveDisk_buffer[5] & 255) + ((ArchiveDisk_buffer[4] & 255)
                      << 8); // L: 126
                  var9 = (ArchiveDisk_buffer[8] & 255) + ((ArchiveDisk_buffer[7] & 255) << 8) + (
                      (ArchiveDisk_buffer[6] & 255) << 16); // L: 127
                  ...
                  var10 = (ArchiveDisk_buffer[1] & 255) + ((ArchiveDisk_buffer[0] & 255)
                      << 8); // L: 137
                  var11 = (ArchiveDisk_buffer[3] & 255) + ((ArchiveDisk_buffer[2] & 255)
                      << 8); // L: 138
                  var9 =
                      ((ArchiveDisk_buffer[5] & 255) << 8) + ((ArchiveDisk_buffer[4] & 255) << 16)
                          + (ArchiveDisk_buffer[6] & 255); // L: 139
