...
public class DevicePcmPlayerProvider implements PlayerProvider {
  ...
  static final void addNpcsToScene(boolean var0) {
    for (int var1 = 0; var1 < Client.npcCount; ++var1) { // L: 4807
      ...
      if (var2 != null && var2.isVisible() && var2.definition.isVisible == var0 && var2.definition
          .transformIsVisible()) { // L: 4809
        ...
        if (var3 >= 0 && var3 < 104 && var4 >= 0 && var4 < 104) { // L: 4812
          ...
          long var5 = UserComparator3.calculateTag(0, 0, 1, !var2.definition.isInteractable,
              Client.npcIndices[var1]); // L: 4817
          var2.playerCycle = Client.cycle; // L: 4818
          scene.drawEntity(SoundSystem.Client_plane, var2.x, var2.y, ItemContainer
                  .getTileHeight(var2.field1225 * 64 - 64 + var2.x, var2.field1225 * 64 - 64 + var2.y,
                      SoundSystem.Client_plane), var2.field1225 * 64 - 64 + 60, var2, var2.rotation,
              var5, var2.isWalking); // L: 4819
        }
      }
    }
  ...
  static void findItemDefinitions(String var0, boolean var1) {
    ...
    for (int var4 = 0; var4 < ItemComposition.ItemDefinition_fileCount; ++var4) { // L: 11619
      ...
      if ((!var1 || var9.isTradable) && var9.noteTemplate == -1
          && var9.name.toLowerCase().indexOf(var0) != -1) { // L: 11621 11622 11623
        if (var3 >= 250) { // L: 11624
