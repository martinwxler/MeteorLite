...
public class MidiPcmStream extends PcmStream {
  ...
  synchronized boolean loadMusicTrack(MusicTrack var1, AbstractArchive var2, SoundCache var3,
      int var4) {
    ...
    for (ByteArrayNode var7 = (ByteArrayNode) var1.table.first(); var7 != null;
        var7 = (ByteArrayNode) var1.table.next()) { // L: 62
  ...
  synchronized void clearAll() {
    for (MusicPatch var1 = (MusicPatch) this.musicPatches.first(); var1 != null;
        var1 = (MusicPatch) this.musicPatches.next()) { // L: 89
      var1.clear();
    }
  ...
  synchronized void removeAll() {
    for (MusicPatch var1 = (MusicPatch) this.musicPatches.first(); var1 != null;
        var1 = (MusicPatch) this.musicPatches.next()) { // L: 93
      var1.remove();
    }
  ...
  protected synchronized void fill(int[] var1, int var2, int var3) {
    if (this.midiFile.isReady()) { // L: 481
      ...
      do {
        ...
        int var7 = (int) ((this.field2864 - this.field2863 + (long) var4 - 1L)
            / (long) var4); // L: 489
  ...
  protected synchronized void skip(int var1) {
    if (this.midiFile.isReady()) { // L: 502
      ...
      do {
        ...
        int var5 = (int) (((long) var2 + (this.field2864 - this.field2863) - 1L)
            / (long) var2); // L: 510
  ...
  void method4566(int var1, int var2, int var3) {
    ...
    if ((this.field2851[var1] & 2) != 0) { // L: 140
      for (MusicPatchNode var4 = (MusicPatchNode) this.patchStream.queue.first(); var4 != null;
          var4 = (MusicPatchNode) this.patchStream.queue.next()) { // L: 141
    ...
    if (var9 != null) { // L: 155
      ...
      if (var5 != null) { // L: 157
        ...
        if (this.field2854[var1] == 0) { // L: 173
          var6.stream = RawPcmStream.method937(var5, this.method4632(var6), this.method4581(var6),
              this.method4650(var6)); // L: 174
        } else {
          var6.stream = RawPcmStream
              .method937(var5, this.method4632(var6), 0, this.method4650(var6)); // L: 177
  ...
  void method4666(int var1, int var2, int var3) {
    ...
    if (var4 != null) { // L: 213
      ...
      if ((this.field2851[var1] & 2) != 0) { // L: 215
        for (MusicPatchNode var5 = (MusicPatchNode) this.patchStream.queue.last(); var5 != null;
            var5 = (MusicPatchNode) this.patchStream.queue.previous()) { // L: 216
  ...
  void method4572(int var1) {
    for (MusicPatchNode var2 = (MusicPatchNode) this.patchStream.queue.last(); var2 != null;
        var2 = (MusicPatchNode) this.patchStream.queue.previous()) { // L: 236
  ...
  void method4644(int var1) {
    for (MusicPatchNode var2 = (MusicPatchNode) this.patchStream.queue.last(); var2 != null;
        var2 = (MusicPatchNode) this.patchStream.queue.previous()) { // L: 270
  ...
  void method4649(int var1) {
    if ((this.field2851[var1] & 2) != 0) { // L: 288
      for (MusicPatchNode var2 = (MusicPatchNode) this.patchStream.queue.last(); var2 != null;
          var2 = (MusicPatchNode) this.patchStream.queue.previous()) { // L: 289
        if (var2.field2898 == var1 && this.field2857[var1][var2.field2910] == null
            && var2.field2903 < 0) { // L: 290 291
          var2.field2903 = 0;
        }
      }
    }
  ...
  void method4617(int var1) {
    if ((this.field2851[var1] & 4) != 0) { // L: 298
      for (MusicPatchNode var2 = (MusicPatchNode) this.patchStream.queue.last(); var2 != null;
          var2 = (MusicPatchNode) this.patchStream.queue.previous()) { // L: 299
  ...
  void method4579(int var1, int var2) {
    ...
    this.field2856[var1] = (int) (2097152.0D * Math.pow(2.0D, (double) var2 * 5.4931640625E-4D)
        + 0.5D); // L: 411
  } // L: 412
  ...
  int method4632(MusicPatchNode var1) {
    ...
    var2 +=
        (this.field2848[var1.field2898] - 8192) * this.field2850[var1.field2898] >> 12; // L: 416
    MusicPatchNode2 var3 = var1.field2904; // L: 417
    int var4;
    if (var3.field2827 > 0 && (var3.field2826 > 0
        || this.field2849[var1.field2898] > 0)) { // L: 418
    ...
    var4 = (int) ((double) (var1.rawSound.sampleRate * 256) * Math
        .pow(2.0D, (double) var2 * 3.255208333333333E-4D) / (double) class341.field3921
        + 0.5D); // L: 426
  ...
  int method4581(MusicPatchNode var1) {
    ...
    int var3 =
        this.field2842[var1.field2898] * this.field2861[var1.field2898] + 4096 >> 13; // L: 432
    ...
    if (var2.field2823 > 0) { // L: 436
      var3 = (int) ((double) var3 * Math
          .pow(0.5D, (double) var2.field2823 * 1.953125E-5D * (double) var1.field2894)
          + 0.5D); // L: 437
    }
    ...
    if (var2.field2821 != null) { // L: 439
      ...
      if (var1.field2905 < var2.field2821.length - 2) { // L: 442
        ...
        var5 +=
            (var2.field2821[var1.field2905 + 3] - var5) * (var4 - var6) / (var7 - var6); // L: 445
      }
    ...
    if (var1.field2903 > 0 && var2.field2828 != null) { // L: 449
      ...
      if (var1.field2909 < var2.field2828.length - 2) { // L: 452
        ...
        var5 +=
            (var4 - var6) * (var2.field2828[var1.field2909 + 3] - var5) / (var7 - var6); // L: 455
      }
  ...
  int method4650(MusicPatchNode var1) {
    ...
    return var2 < 8192 ? var2 * var1.field2902 + 32 >> 6
        : 16384 - ((128 - var1.field2902) * (16384 - var2) + 32 >> 6); // L: 464 465
  }
  ...
  void method4588() {
    ...
    long var3;
    for (var3 = this.field2864; var2 == this.trackLength;
        var3 = this.midiFile.method4710(var2)) { // L: 524 525 547
  ...
  boolean method4589(MusicPatchNode var1) {
    if (var1.stream == null) { // L: 555
      if (var1.field2903 >= 0) { // L: 556
        var1.remove(); // L: 557
        if (var1.field2897 > 0
            && var1 == this.field2858[var1.field2898][var1.field2897]) { // L: 558
  ...
  boolean method4590(MusicPatchNode var1, int[] var2, int var3, int var4) {
    ...
    if (var1.field2903 < 0 || var1.stream != null && !var1.stream.method1065()) { // L: 569
      ...
      if (var5 > 0) { // L: 578
        var5 -= (int) (
            16.0D * Math.pow(2.0D, (double) this.field2853[var1.field2898] * 4.921259842519685E-4D)
                + 0.5D); // L: 579
        if (var5 < 0) { // L: 580
          var5 = 0;
        }
      ...
      double var8 = (double) ((var1.field2910 - 60 << 8) + (var1.field2914 * var1.field2901 >> 12))
          * 5.086263020833333E-6D; // L: 588
      ...
      if (var6.field2821 != null) { // L: 593
        ...
        while (var1.field2905 < var6.field2821.length - 2
            && var1.field2906 > (var6.field2821[var1.field2905 + 2] & 255) << 8) { // L: 596
          var1.field2905 += 2;
        }

        if (var6.field2821.length - 2 == var1.field2905
            && var6.field2821[var1.field2905 + 1] == 0) { // L: 597
          var7 = true;
        }
      }

      if (var1.field2903 >= 0 && var6.field2828 != null && (this.field2851[var1.field2898] & 1) == 0
          && (var1.field2897 < 0
          || var1 != this.field2858[var1.field2898][var1.field2897])) { // L: 599 600
        ...
        while (var1.field2909 < var6.field2828.length - 2
            && var1.field2903 > (var6.field2828[var1.field2909 + 2] & 255) << 8) { // L: 603
          var1.field2909 += 2;
        }
      ...
      if (var7) { // L: 607
        ...
        if (var1.field2903 >= 0) { // L: 613
          var1.remove(); // L: 614
          if (var1.field2897 > 0
              && var1 == this.field2858[var1.field2898][var1.field2897]) { // L: 615
        ...
        var1.stream
            .method954(var1.field2913, this.method4581(var1), this.method4650(var1)); // L: 621
        return false; // L: 622
      }
    } else {
