...
public class ItemComposition extends DualNode {
  ...
  public final ModelData getModelData(int var1) {
    ...
    ModelData var4 = ModelData
        .ModelData_get(SoundCache.ItemDefinition_modelArchive, this.model, 0); // L: 300
    if (var4 == null) { // L: 301
      return null;
    } else {
  ...
  public final Model getModel(int var1) {
    ...
    if (var5 != null) { // L: 325
      ...
      ModelData var6 = ModelData
          .ModelData_get(SoundCache.ItemDefinition_modelArchive, this.model, 0); // L: 326
      if (var6 == null) { // L: 327
        return null;
      } else {
  ...
  public final ModelData method3070(boolean var1) {
    ...
    if (var2 == -1) { // L: 456
      ...
      ModelData var5 = ModelData
          .ModelData_get(SoundCache.ItemDefinition_modelArchive, var2, 0); // L: 457
      if (var3 != -1) { // L: 458
        ModelData var6 = ModelData
            .ModelData_get(SoundCache.ItemDefinition_modelArchive, var3, 0); // L: 459
        if (var4 != -1) { // L: 460
          ModelData var7 = ModelData
              .ModelData_get(SoundCache.ItemDefinition_modelArchive, var4, 0); // L: 461
  ...
  public final ModelData method3082(boolean var1) {
    ...
    if (var2 == -1) { // L: 506
      ...
      ModelData var4 = ModelData
          .ModelData_get(SoundCache.ItemDefinition_modelArchive, var2, 0); // L: 507
      if (var3 != -1) { // L: 508
        ModelData var5 = ModelData
            .ModelData_get(SoundCache.ItemDefinition_modelArchive, var3, 0); // L: 509
  ...
  public int getShiftClickIndex() {
    if (this.shiftClickIndex != -1 && this.inventoryActions != null) { // L: 549
      if (this.shiftClickIndex >= 0) { // L: 550
        return this.inventoryActions[this.shiftClickIndex] != null ? this.shiftClickIndex
            * -53430605 * -1740445573 : -1;
      } else {
