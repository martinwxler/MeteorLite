    ...
    while (true) {
      ...
      if (var27 != var6) { // L: 9017
        label328:
        {
          ...
          var14 = var14; // L: 9028
          int var29 = TextureProvider
              .method4272(ViewportMouse.ViewportMouse_entityTags[var8]); // L: 9031
          int var16 = var29; // L: 9033
          long var19 = ViewportMouse.ViewportMouse_entityTags[var8]; // L: 9037
          int var18 = (int) (var19 >>> 14 & 3L); // L: 9039
          int var30 = Message
              .Entity_unpackID(ViewportMouse.ViewportMouse_entityTags[var8]); // L: 9046
          int var20 = var30; // L: 9048
          if (var18 == 2 && DevicePcmPlayerProvider.scene
              .getObjectFlags(SoundSystem.Client_plane, var14, var29, var27) >= 0) { // L: 9049 9050
            ...
            if (Client.isItemSelected == 1) { // L: 9054
              class22.insertMenuItemNoShift("Use",
                  Client.selectedItemName + " " + "->" + " " + SecureRandomFuture
                      .colorStartTag(65535) + var21.name, 1, var30, var14, var29); // L: 9055
              ...
              if ((LoginPacket.selectedSpellFlags & 4) == 4) { // L: 9059
                class22.insertMenuItemNoShift(Client.selectedSpellActionName,
                    Client.selectedSpellName + " " + "->" + " " + SecureRandomFuture
                        .colorStartTag(65535) + var21.name, 2, var30, var14, var29); // L: 9060
              }
            } else {
              ...
              if (var22 != null) { // L: 9066
                for (int var23 = 4; var23 >= 0; --var23) { // L: 9067
                  if (var22[var23] != null) { // L: 9068
                    ...
                    class22.insertMenuItemNoShift(var22[var23],
                        SecureRandomFuture.colorStartTag(65535) + var21.name, var24, var20, var14,
                        var16); // L: 9075
                  }
                }
              }
              ...
              class22.insertMenuItemNoShift("Examine",
                  SecureRandomFuture.colorStartTag(65535) + var21.name, 1002, var21.id, var14,
                  var16); // L: 9080
            }
          }
          ...
          if (var18 == 1) { // L: 9085
            ...
            if (var35.definition.size == 1 && (var35.x & 127) == 64
                && (var35.y & 127) == 64) { // L: 9088
              for (var31 = 0; var31 < Client.npcCount; ++var31) { // L: 9089
                var32 = Client.npcs[Client.npcIndices[var31]]; // L: 9090
                if (var32 != null && var32 != var35 && var32.definition.size == 1
                    && var32.x == var35.x && var35.y == var32.y) { // L: 9091
          ...
          if (var18 == 0) { // L: 9102
            ...
            if ((var36.x & 127) == 64 && (var36.y & 127) == 64) { // L: 9105
              for (var31 = 0; var31 < Client.npcCount; ++var31) { // L: 9106
                ...
                if (var32 != null && var32.definition.size == 1 && var36.x == var32.x
                    && var32.y == var36.y) { // L: 9108
                  FontName.addNpcToMenu(var32.definition, Client.npcIndices[var31], var14, var16);
                }
              }
              ...
              for (var39 = 0; var39 < var31; ++var39) { // L: 9112
                ...
                if (var25 != null && var36 != var25 && var36.x == var25.x
                    && var25.y == var36.y) { // L: 9114
                  Actor.addPlayerToMenu(var25, var40[var39], var14, var16);
                }
              }
            }
          ...
          if (var18 == 3) { // L: 9120
            ...
            if (var38 != null) { // L: 9122
              for (TileItem var37 = (TileItem) var38.first(); var37 != null;
                  var37 = (TileItem) var38.next()) { // L: 9123 9124 9157
                ItemComposition var41 = class250.ItemDefinition_get(var37.id); // L: 9125
                if (Client.isItemSelected == 1) { // L: 9126
                  class22.insertMenuItemNoShift("Use",
                      Client.selectedItemName + " " + "->" + " " + SecureRandomFuture
                          .colorStartTag(16748608) + var41.name, 16, var37.id, var14,
                      var16); // L: 9127
                } else if (Client.isSpellSelected) { // L: 9130
                  if ((LoginPacket.selectedSpellFlags & 1) == 1) { // L: 9131
                    class22.insertMenuItemNoShift(Client.selectedSpellActionName,
                        Client.selectedSpellName + " " + "->" + " " + SecureRandomFuture
                            .colorStartTag(16748608) + var41.name, 17, var37.id, var14,
                        var16); // L: 9132
                  }
                } else {
                  ...
                  for (int var34 = 4; var34 >= 0; --var34) { // L: 9138
                    if (var33 != null && var33[var34] != null) { // L: 9139
                      ...
                      class22.insertMenuItemNoShift(var33[var34],
                          SecureRandomFuture.colorStartTag(16748608) + var41.name, var26, var37.id,
                          var14, var16); // L: 9146
                    } else if (var34 == 2) { // L: 9149
                      class22.insertMenuItemNoShift("Take",
                          SecureRandomFuture.colorStartTag(16748608) + var41.name, 20, var37.id,
                          var14, var16); // L: 9150
                    }
                  }

                  class22.insertMenuItemNoShift("Examine",
                      SecureRandomFuture.colorStartTag(16748608) + var41.name, 1004, var37.id,
                      var14, var16); // L: 9154
                }
              }
            }
