...
public abstract class class343 implements class214 {
  ...
  static final boolean method6080(Widget var0) {
    ...
    if (var1 == 205) { // L: 11286
      ...
      if (var1 == 326) { // L: 11302
        PacketBufferNode var4 = InterfaceParent.getPacketBufferNode(ClientPacket.field2648,
            Client.packetWriter.isaacCipher); // L: 11304
  ...
  public void method6070(Buffer var1) {
    while (true) {
      ...
      class339[] var3 = new class339[]{class339.field3916, class339.field3914, class339.field3913,
          class339.field3915}; // L: 21
        ...
        switch (var4.field3912) { // L: 25
          case 0:
            ...
            throw new IllegalStateException(
                "Unknown ScriptVarType ID in VarType.decode: " + var5); // L: 46
          case 1:
