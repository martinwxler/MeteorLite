...
public class class17 extends class14 {
  ...
  static String method255() {
    return class4.clientPreferences.hideUsername ? class22.method315(Login.Login_username)
        : Login.Login_username; // L: 179
  }
  ...
  public static Widget getWidgetChild(int var0, int var1) {
    ...
    if (var1 == -1) { // L: 210
      ...
      return var2 != null && var2.children != null && var1 < var2.children.length
          ? var2.children[var1] : null; // L: 211 212
    }
  }
  ...
  static final void method261() {
    for (PendingSpawn var0 = (PendingSpawn) Client.pendingSpawns.last(); var0 != null;
        var0 = (PendingSpawn) Client.pendingSpawns.previous()) { // L: 7351 7352 7395
      ...
      if (var0.hitpoints == 0) { // L: 7354
        ...
        WorldMapEvent.addPendingSpawnToScene(var0.plane, var0.type, var0.x, var0.y, var0.objectId,
            var0.field1209, var0.field1210); // L: 7368
        var0.remove(); // L: 7369
      } else {
        ...
        if (var0.delay == 0 && var0.x >= 1 && var0.y >= 1 && var0.x <= 102
            && var0.y <= 102) { // L: 7374
          if (var0.id >= 0) { // L: 7376
            var2 = var0.id; // L: 7378
          ...
          WorldMapEvent.addPendingSpawnToScene(var0.plane, var0.type, var0.x, var0.y, var0.id,
              var0.orientation, var0.field1213); // L: 7388
          var0.delay = -1; // L: 7389
          if (var0.id == var0.objectId && var0.objectId == -1) { // L: 7390
            var0.remove();
          } else if (var0.id == var0.objectId && var0.field1209 == var0.orientation
