...
public class class35 {
  ...
  public static void method422() {
    while (true) {
      ...
      synchronized (ArchiveDiskActionHandler.ArchiveDiskActionHandler_requestQueue) { // L: 60
        var0 = (ArchiveDiskAction) ArchiveDiskActionHandler.ArchiveDiskActionHandler_responseQueue
            .removeLast(); // L: 61
      } // L: 62
  ...
  static void doWorldSorting(int var0, int var1, int var2, boolean var3, int var4, boolean var5) {
    if (var0 < var1) { // L: 177
      ...
      for (int var9 = var0; var9 < var1; ++var9) { // L: 183
        if (ReflectionCheck.method1227(World.World_worlds[var9], var8, var2, var3, var4, var5)
            <= 0) { // L: 184
  ...
  static boolean updateExternalPlayer(PacketBuffer var0, int var1) {
    ...
    if (var2 == 0) { // L: 379
      ...
      if (Client.players[var1] != null) { // L: 385
        ...
        var11.resetPath((var9 << 13) + var3 - class15.baseX,
            (var10 << 13) + var4 - WorldMapSprite.baseY); // L: 399
      ...
      Players.Players_regions[var1] =
          (((var4 >> 28) + var3 & 3) << 28) + (var4 & 268435455); // L: 406
      return false; // L: 407
    } else {
      int var5;
      int var6;
  ...
  static void method421() {
    Client.packetWriter.addNode(InterfaceParent
        .getPacketBufferNode(ClientPacket.field2599, Client.packetWriter.isaacCipher)); // L: 11673
