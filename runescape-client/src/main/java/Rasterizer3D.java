...
public class Rasterizer3D extends Rasterizer2D {
  ...
  public static final void Rasterizer3D_setClipFromRasterizer2D() {
    Rasterizer3D_setClip(Rasterizer2D.Rasterizer2D_xClipStart, Rasterizer2D.Rasterizer2D_yClipStart,
        Rasterizer2D.Rasterizer2D_xClipEnd, Rasterizer2D.Rasterizer2D_yClipEnd); // L: 54
  } // L: 55
  ...
  static final void Rasterizer3D_setClip(int var0, int var1, int var2, int var3) {
    ...
    if (Rasterizer3D_rowOffsets.length < Rasterizer3D_clipHeight) { // L: 61
      Rasterizer3D_rowOffsets = new int[UrlRequester.method2504(Rasterizer3D_clipHeight)];
    }
  ...
  @ObfuscatedName("y")
  public static final void method3950(int var0, int var1) {
  ...
  @ObfuscatedName("h")
  public static void method3959(int var0, int var1, int var2) {
    field2262 =
        var0 < 0 || var0 > Rasterizer3D_clipWidth || var1 < 0 || var1 > Rasterizer3D_clipWidth
            || var2 < 0 || var2 > Rasterizer3D_clipWidth; // L: 156
  } // L: 157

  @ObfuscatedName("d")
  static final void method3960(int var0, int var1, int var2, int var3, int var4, int var5, int var6,
      int var7, int var8) {
              ...
              while (true) {
                ...
                if (var1 < 0) {
                  while (true) {
                    ...
                    Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var0, 0, 0, var4 >> 14,
                        var5 >> 14, var6, var19); // L: 229
                    var5 += var17; // L: 230
                    var4 += var15; // L: 231
                    var6 += var20; // L: 232
                ...
                Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var0, 0, 0, var3 >> 14,
                    var5 >> 14, var6, var19); // L: 222
                var5 += var17; // L: 223
                var3 += var16; // L: 224
                var6 += var20; // L: 225
              ...
              while (true) {
                ...
                if (var1 < 0) {
                  while (true) {
                    ...
                    Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var0, 0, 0, var5 >> 14,
                        var4 >> 14, var6, var19); // L: 209
                    var5 += var17; // L: 210
                    var4 += var15; // L: 211
                    var6 += var20; // L: 212
              ...
              while (true) {
                ...
                if (var2 < 0) {
                  while (true) {
                    ...
                    Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var1, 0, 0, var5 >> 14,
                        var3 >> 14, var7, var19); // L: 343
                    var3 += var16; // L: 344
                    var5 += var17; // L: 345
                    var7 += var20; // L: 346
                ...
                Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var1, 0, 0, var4 >> 14,
                    var3 >> 14, var7, var19); // L: 336
                var3 += var16; // L: 337
                var4 += var15; // L: 338
                var7 += var20; // L: 339
              ...
              while (true) {
                ...
                if (var2 < 0) {
                  while (true) {
                    ...
                    Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var1, 0, 0, var3 >> 14,
                        var5 >> 14, var7, var19); // L: 323
                    var3 += var16; // L: 324
                    var5 += var17; // L: 325
                    var7 += var20; // L: 326
            ...
            while (true) {
              ...
              if (var0 < 0) {
                while (true) {
                  ...
                  Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, 0, 0, var4 >> 14,
                      var3 >> 14, var8, var19); // L: 437
                  var4 += var15; // L: 438
                  var3 += var16; // L: 439
                  var8 += var20; // L: 440
            ...
            while (true) {
              ...
              if (var0 < 0) {
                while (true) {
                  ...
                  Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, 0, 0, var3 >> 14,
                      var4 >> 14, var8, var19); // L: 457
                  var4 += var15; // L: 458
                  var3 += var16; // L: 459
                  var8 += var20; // L: 460
              ...
              Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, 0, 0, var5 >> 14,
                  var4 >> 14, var8, var19); // L: 450
              var4 += var15; // L: 451
              var5 += var17; // L: 452
              var8 += var20; // L: 453
  ...
  static final void Rasterizer3D_vertAlpha(int[] var0, int var1, int var2, int var3, int var4,
        ...
        if (Rasterizer3D_alpha == 0) { // L: 534
          ...
          if (var3 > 0) { // L: 556
            do {
              ...
              var6 += var7; // L: 559
              var2 = (var9 * (var2 & 65280) >> 8 & 65280) + (var9 * (var2 & 16711935) >> 8
                  & 16711935); // L: 560
              var10 = var0[var1]; // L: 561
              var0[var1++] =
                  ((var10 & 16711935) * var8 >> 8 & 16711935) + var2 + (var8 * (var10 & 65280) >> 8
                      & 65280); // L: 562
  ...
  @ObfuscatedName("b")
  public static final void method3962(int var0, int var1, int var2, int var3, int var4, int var5,
      int var6) {
    int var7 = 0; // L: 607
    if (var0 != var1) { // L: 608
        ...
        if (var1 < var2) { // L: 617
          ...
          if (var0 != var1 && var9 < var7 || var0 == var1 && var9 > var8) { // L: 629
            ...
            while (true) {
              ...
              if (var1 < 0) {
                while (true) {
                  ...
                  Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var0, var6, 0,
                      var5 >> 14, var4 >> 14); // L: 640
                  var5 += var9; // L: 641
                  var4 += var8; // L: 642
              ...
              Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var0, var6, 0, var5 >> 14,
                  var3 >> 14); // L: 634
              var5 += var9; // L: 635
              var3 += var7; // L: 636
            ...
            while (true) {
              ...
              Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var0, var6, 0, var3 >> 14,
                  var5 >> 14); // L: 652
              var5 += var9; // L: 653
              var3 += var7; // L: 654
          ...
          if (var0 != var2 && var9 < var7 || var0 == var2 && var8 > var7) { // L: 678
            ...
            while (true) {
              ...
              Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var0, var6, 0, var4 >> 14,
                  var3 >> 14); // L: 683
              var4 += var9; // L: 684
              var3 += var7; // L: 685
        ...
        if (var2 < var0) { // L: 720
          ...
          if (var2 != var1 && var7 < var8 || var2 == var1 && var7 > var9) { // L: 732
            ...
            while (true) {
              ...
              if (var2 < 0) {
                while (true) {
                  ...
                  Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var1, var6, 0,
                      var3 >> 14, var5 >> 14); // L: 743
                  var3 += var7; // L: 744
                  var5 += var9; // L: 745
              ...
              Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var1, var6, 0, var3 >> 14,
                  var4 >> 14); // L: 737
              var3 += var7; // L: 738
              var4 += var8; // L: 739
            ...
            while (true) {
              ...
              Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var1, var6, 0, var4 >> 14,
                  var3 >> 14); // L: 755
              var3 += var7; // L: 756
              var4 += var8; // L: 757
          ...
          if (var7 < var8) { // L: 781
            ...
            while (true) {
              ...
              Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var1, var6, 0, var5 >> 14,
                  var4 >> 14); // L: 786
              var5 += var7; // L: 787
              var4 += var8; // L: 788
          ...
          while (true) {
            ...
            if (var0 < 0) {
              while (true) {
                ...
                Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, var6, 0, var4 >> 14,
                    var3 >> 14); // L: 846
                var4 += var8; // L: 847
                var3 += var7; // L: 848
          ...
          while (true) {
            ...
            if (var0 < 0) {
              while (true) {
                ...
                Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, var6, 0, var3 >> 14,
                    var4 >> 14); // L: 864
                var4 += var8; // L: 865
                var3 += var7; // L: 866
            ...
            Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, var6, 0, var5 >> 14,
                var4 >> 14); // L: 858
            var4 += var8; // L: 859
            var5 += var9; // L: 860
  ...
  static final void Rasterizer3D_horizAlpha(int[] var0, int var1, int var2, int var3, int var4,
      int var5) {
    if (field2262) { // L: 925
    ...
    if (var4 < var5) { // L: 929
      ...
      if (Rasterizer3D_alpha != 0) { // L: 932
        if (Rasterizer3D_alpha == 254) { // L: 944
          ...
          var2 = (var7 * (var2 & 65280) >> 8 & 65280) + (var7 * (var2 & 16711935) >> 8
              & 16711935); // L: 959
          ...
          while (true) {
            ...
            if (var3 < 0) {
              ...
              while (true) {
                ...
                var0[var1++] =
                    ((var8 & 16711935) * var6 >> 8 & 16711935) + var2 + (var6 * (var8 & 65280) >> 8
                        & 65280); // L: 973
              }
            }
  ...
  @ObfuscatedName("k")
  static final void method3964(int var0, int var1, int var2, int var3, int var4, int var5, int var6,
      int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14,
      int var15, int var16, int var17, int var18) {
    ...
    if (var19 == null) { // L: 980
      ...
      method3960(var0, var1, var2, var3, var4, var5, method3968(var20, var6),
          method3968(var20, var7), method3968(var20, var8)); // L: 982
    } else {
      ...
      if (var29 != 0) { // L: 1000
        ...
        int var33 = (int) (((long) (var15 * var14 - var17 * var12) << 3 << 14)
            / (long) Rasterizer3D_zoom); // L: 1010
        int var34 = (int) (((long) (var17 * var9 - var11 * var15) << 14)
            / (long) Rasterizer3D_zoom); // L: 1011
        int var35 = var10 * var12 - var13 * var9 << 14; // L: 1012
        int var36 = (int) (((long) (var13 * var15 - var16 * var12) << 3 << 14)
            / (long) Rasterizer3D_zoom); // L: 1013
        int var37 = (int) (((long) (var16 * var9 - var10 * var15) << 14)
            / (long) Rasterizer3D_zoom); // L: 1014
        int var38 = var13 * var11 - var10 * var14 << 14; // L: 1015
        int var39 = (int) (((long) (var16 * var14 - var13 * var17) << 3 << 14)
            / (long) Rasterizer3D_zoom); // L: 1016
        int var40 = (int) (((long) (var17 * var10 - var11 * var16) << 14)
            / (long) Rasterizer3D_zoom); // L: 1017
        int var41;
            ...
            if (var1 < var2) { // L: 1023
                ...
                while (true) {
                  ...
                  if (var1 < 0) {
                    while (true) {
                      ...
                      Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0,
                          var5 >> 14, var4 >> 14, var6, var30, var32, var35, var38, var33, var36,
                          var39); // L: 1055
                      var5 += var28; // L: 1056
                      var4 += var27; // L: 1057
                      var6 += var31; // L: 1058
                  ...
                  Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0,
                      var5 >> 14, var3 >> 14, var6, var30, var32, var35, var38, var33, var36,
                      var39); // L: 1045
                  var5 += var28; // L: 1046
                  var3 += var26; // L: 1047
                  var6 += var31; // L: 1048
                ...
                while (true) {
                  ...
                  if (var1 < 0) {
                    while (true) {
                      ...
                      Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0,
                          var4 >> 14, var5 >> 14, var6, var30, var32, var35, var38, var33, var36,
                          var39); // L: 1081
                      var5 += var28; // L: 1082
                      var4 += var27; // L: 1083
                      var6 += var31; // L: 1084
                  ...
                  Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0,
                      var3 >> 14, var5 >> 14, var6, var30, var32, var35, var38, var33, var36,
                      var39); // L: 1071
                  var5 += var28; // L: 1072
                  var3 += var26; // L: 1073
                  var6 += var31; // L: 1074
              ...
              if (var0 != var2 && var28 < var26 || var0 == var2 && var27 > var26) { // L: 1110
                ...
                while (true) {
                  ...
                  Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0,
                      var4 >> 14, var3 >> 14, var6, var30, var32, var35, var38, var33, var36,
                      var39); // L: 1115
                  var4 += var28; // L: 1116
                  var3 += var26; // L: 1117
                  var6 += var31; // L: 1118
                ...
                while (true) {
                  ...
                  Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0,
                      var3 >> 14, var4 >> 14, var6, var30, var32, var35, var38, var33, var36,
                      var39); // L: 1141
                  var4 += var28; // L: 1142
                  var3 += var26; // L: 1143
                  var6 += var31; // L: 1144
            ...
            if (var2 < var0) { // L: 1169
                ...
                while (true) {
                  ...
                  if (var2 < 0) {
                    while (true) {
                      ...
                      Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1,
                          var5 >> 14, var3 >> 14, var7, var30, var32, var35, var38, var33, var36,
                          var39); // L: 1227
                      var3 += var26; // L: 1228
                      var5 += var28; // L: 1229
                      var7 += var31; // L: 1230
                  ...
                  Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1,
                      var4 >> 14, var3 >> 14, var7, var30, var32, var35, var38, var33, var36,
                      var39); // L: 1217
                  var3 += var26; // L: 1218
                  var4 += var27; // L: 1219
                  var7 += var31; // L: 1220
                ...
                while (true) {
                  ...
                  if (var2 < 0) {
                    while (true) {
                      ...
                      Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1,
                          var3 >> 14, var5 >> 14, var7, var30, var32, var35, var38, var33, var36,
                          var39); // L: 1201
                      var3 += var26; // L: 1202
                      var5 += var28; // L: 1203
                      var7 += var31; // L: 1204
                  ...
                  Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1,
                      var3 >> 14, var4 >> 14, var7, var30, var32, var35, var38, var33, var36,
                      var39); // L: 1191
                  var3 += var26; // L: 1192
                  var4 += var27; // L: 1193
                  var7 += var31; // L: 1194
              ...
              if (var26 < var27) { // L: 1256
                ...
                while (true) {
                  ...
                  Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1,
                      var5 >> 14, var4 >> 14, var7, var30, var32, var35, var38, var33, var36,
                      var39); // L: 1261
                  var5 += var26; // L: 1262
                  var4 += var27; // L: 1263
                  var7 += var31; // L: 1264
                ...
                while (true) {
                  ...
                  Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1,
                      var4 >> 14, var5 >> 14, var7, var30, var32, var35, var38, var33, var36,
                      var39); // L: 1287
                  var5 += var26; // L: 1288
                  var4 += var27; // L: 1289
                  var7 += var31; // L: 1290
          ...
          if (var0 < var1) { // L: 1315
              ...
              while (true) {
                ...
                if (var0 < 0) {
                  while (true) {
                    ...
                    Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2,
                        var4 >> 14, var3 >> 14, var8, var30, var32, var35, var38, var33, var36,
                        var39); // L: 1347
                    var4 += var27; // L: 1348
                    var3 += var26; // L: 1349
                    var8 += var31; // L: 1350
                ...
                Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2,
                    var4 >> 14, var5 >> 14, var8, var30, var32, var35, var38, var33, var36,
                    var39); // L: 1337
                var4 += var27; // L: 1338
                var5 += var28; // L: 1339
                var8 += var31; // L: 1340
              ...
              while (true) {
                ...
                if (var0 < 0) {
                  while (true) {
                    ...
                    Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2,
                        var3 >> 14, var4 >> 14, var8, var30, var32, var35, var38, var33, var36,
                        var39); // L: 1373
                    var4 += var27; // L: 1374
                    var3 += var26; // L: 1375
                    var8 += var31; // L: 1376
                ...
                Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2,
                    var5 >> 14, var4 >> 14, var8, var30, var32, var35, var38, var33, var36,
                    var39); // L: 1363
                var4 += var27; // L: 1364
                var5 += var28; // L: 1365
                var8 += var31; // L: 1366
            ...
            if (var27 < var28) { // L: 1402
              ...
              while (true) {
                ...
                Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2,
                    var3 >> 14, var5 >> 14, var8, var30, var32, var35, var38, var33, var36,
                    var39); // L: 1407
                var3 += var27; // L: 1408
                var5 += var28; // L: 1409
                var8 += var31; // L: 1410
              ...
              while (true) {
                ...
                Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2,
                    var5 >> 14, var3 >> 14, var8, var30, var32, var35, var38, var33, var36,
                    var39); // L: 1433
                var3 += var27; // L: 1434
                var5 += var28; // L: 1435
                var8 += var31; // L: 1436
  ...
  static final void Rasterizer3D_iDontKnow(int[] var0, int[] var1, int var2, int var3, int var4,
      int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13,
      int var14) {
    if (field2262) { // L: 1461
        ...
        if (field2259) { // L: 1509
          if (var17 > 0) { // L: 1510
            do {
              ...
              var0[var4++] =
                  (var15 * (var3 & 65280) & 16711680) + ((var3 & 16711935) * var15 & -16711936)
                      >> 8; // L: 1513
              var2 += var16; // L: 1514
  ...
  static final void drawTexturedTile(int var0, int var1, int var2, int var3, int var4, int var5,
      int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14,
      int var15, int var16, int var17, int var18) {
    ...
    if (var19 == null) { // L: 1823
      ...
      method3960(var0, var1, var2, var3, var4, var5, method3968(var20, var6),
          method3968(var20, var7), method3968(var20, var8)); // L: 1825
    } else {
      Rasterizer3D_isLowDetailTexture = Rasterizer3D_textureLoader.isLowDetail(var18); // L: 1828
      field2259 = Rasterizer3D_textureLoader.vmethod4428(var18); // L: 1829
      ...
      if (var29 != 0) { // L: 1843
        ...
        int var33 = (int) (((long) (var15 * var14 - var17 * var12) << 14)
            / (long) Rasterizer3D_zoom); // L: 1853
        int var34 = (int) (((long) (var17 * var9 - var11 * var15) << 14)
            / (long) Rasterizer3D_zoom); // L: 1854
        int var35 = var10 * var12 - var13 * var9 << 14; // L: 1855
        int var36 = (int) (((long) (var13 * var15 - var16 * var12) << 14)
            / (long) Rasterizer3D_zoom); // L: 1856
        int var37 = (int) (((long) (var16 * var9 - var10 * var15) << 14)
            / (long) Rasterizer3D_zoom); // L: 1857
        int var38 = var13 * var11 - var10 * var14 << 14; // L: 1858
        int var39 = (int) (((long) (var16 * var14 - var13 * var17) << 14)
            / (long) Rasterizer3D_zoom); // L: 1859
        int var40 = (int) (((long) (var17 * var10 - var11 * var16) << 14)
            / (long) Rasterizer3D_zoom); // L: 1860
        int var41;
                ...
                while (true) {
                  ...
                  if (var1 < 0) {
                    while (true) {
                      ...
                      Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0,
                          var5 >> 14, var4 >> 14, var6, var30, var32, var35, var38, var33, var36,
                          var39); // L: 1898
                      var5 += var28; // L: 1899
                      var4 += var27; // L: 1900
                ...
                while (true) {
                  ...
                  if (var2 < 0) {
                    while (true) {
                      ...
                      Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1,
                          var5 >> 14, var3 >> 14, var7, var30, var32, var35, var38, var33, var36,
                          var39); // L: 2070
                      var3 += var26; // L: 2071
                      var5 += var28; // L: 2072
              ...
              while (true) {
                ...
                if (var0 < 0) {
                  while (true) {
                    ...
                    Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2,
                        var4 >> 14, var3 >> 14, var8, var30, var32, var35, var38, var33, var36,
                        var39); // L: 2190
                    var4 += var27; // L: 2191
                    var3 += var26; // L: 2192
  ...
  static final void Rasterizer3D_textureAlpha(int[] var0, int[] var1, int var2, int var3, int var4,
      int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13,
      int var14) {
    if (field2262) { // L: 2304
  ...
  @ObfuscatedName("u")
  static final int method3968(int var0, int var1) {
  ...
  @ObfuscatedName("q")
  static final int method3969(int var0, int var1, int var2, int var3) {
    return var0 * var2 + var3 * var1 >> 16; // L: 2596
  }

  @ObfuscatedName("s")
  static final int method3970(int var0, int var1, int var2, int var3) {
    return var2 * var1 - var3 * var0 >> 16; // L: 2600
  }

  @ObfuscatedName("p")
  static final int method3992(int var0, int var1, int var2, int var3) {
    return var0 * var2 - var3 * var1 >> 16; // L: 2604
  }

  @ObfuscatedName("c")
  static final int method4000(int var0, int var1, int var2, int var3) {
    return var3 * var0 + var2 * var1 >> 16; // L: 2608
  }

  @ObfuscatedName("n")
  static final int method3973(int var0, int var1, int var2, int var3) {
    return var0 * var2 + var3 * var1 >> 16; // L: 2612
  }

  @ObfuscatedName("l")
  static final int method4031(int var0, int var1, int var2, int var3) {
