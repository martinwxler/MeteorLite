...
public final class SpritePixels extends Rasterizer2D {
  ...
  @ObfuscatedName("z")
  @Export("Sprite_draw")
  static void Sprite_draw(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6,
      int var7) {
  ...
  static void Sprite_drawTransBg(int[] var0, int[] var1, int var2, int var3, int var4, int var5,
  ...
  static void Sprite_drawScaled(int[] var0, int[] var1, int var2, int var3, int var4, int var5,
  ...
  static void Sprite_drawTransOverlay(int[] var0, int[] var1, int var2, int var3, int var4,
  ...
  static void Sprite_drawTransparent(int[] var0, int[] var1, int var2, int var3, int var4, int var5,
      ...
      for (int var12 = -var5; var12 < 0; ++var12) { // L: 427
        ...
        if (var2 != 0) { // L: 429
          ...
          var0[var4++] = ((var13 & 16711935) * var10 + var9 * (var2 & 16711935) & -16711936) + (
              (var2 & 65280) * var9 + var10 * (var13 & 65280) & 16711680) >> 8; // L: 431
        } else {
          ++var4; // L: 433
        }
      }
  ...
  static void Sprite_drawTransScaled(int[] var0, int[] var1, int var2, int var3, int var4, int var5,
    ...
    for (int var15 = -var8; var15 < 0; ++var15) { // L: 489
      ...
      for (int var17 = -var7; var17 < 0; ++var17) { // L: 491
        ...
        if (var2 != 0) { // L: 493
          ...
          var0[var5++] = ((var2 & 65280) * var12 + var13 * (var18 & 65280) & 16711680) + (
              (var18 & 16711935) * var13 + var12 * (var2 & 16711935) & -16711936) >> 8; // L: 495
        } else {
          ++var5; // L: 497
        }
  ...
  @ObfuscatedName("n")
  static void method7036(int var0, int var1, int var2, int[] var3, int[] var4, int var5, int var6,
  ...
  @ObfuscatedName("l")
  static void method7065(int var0, int var1, int var2, int[] var3, int[] var4, int var5, int var6,
      int var7, int var8, int var9, int var10, int var11, int var12, int var13) {
  ...
  @ObfuscatedName("a")
  static void method7039(int var0, int var1, int var2, int var3, int[] var4, int[] var5, int var6,
  ...
  @ObfuscatedName("aw")
  static void method7064(int var0, int var1, int var2, int var3, int[] var4, int[] var5, int var6,
      int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14,
      int var15, int var16) {
  ...
  public SpritePixels mirrorHorizontally() {
    ...
    for (int var2 = 0; var2 < this.subHeight; ++var2) { // L: 39
      for (int var3 = 0; var3 < this.subWidth; ++var3) { // L: 40
        var1.pixels[var3 + var2 * this.subWidth] = this.pixels[var2 * this.subWidth + this.subWidth
            - 1 - var3]; // L: 41
      }
    }
    ...
    if (this.subWidth != this.width || this.subHeight != this.height) { // L: 77
      ...
      for (int var9 = 0; var9 < this.subHeight; ++var9) { // L: 89
        for (int var10 = 0; var10 < this.subWidth; ++var10) { // L: 90
          var8[var6 * (var9 + var4) + var10 + var2] = this.pixels[var10
              + var9 * this.subWidth]; // L: 91
        }
      }
      ...
      for (int var5 = 0; var5 < this.subWidth; ++var5) { // L: 125
        ...
        if (var6 == 0) { // L: 127
          if (var5 > 0 && this.pixels[var3 - 1] != 0) { // L: 128
            ...
            var6 = var1; // L: 130
          } else if (var4 < this.subHeight - 1
              && this.pixels[var3 + this.subWidth] != 0) { // L: 131
            var6 = var1;
          }
        }
    ...
    for (int var2 = this.subHeight - 1; var2 > 0; --var2) { // L: 140
      ...
      for (int var4 = this.subWidth - 1; var4 > 0; --var4) { // L: 142
        if (this.pixels[var4 + var3] == 0
            && this.pixels[var4 + var3 - 1 - this.subWidth] != 0) { // L: 143
  ...
  public void drawAt(int var1, int var2) {
    ...
    if (var6 > 0 && var5 > 0) { // L: 180
      Sprite_draw(Rasterizer2D.Rasterizer2D_pixels, this.pixels, var4, var3, var6, var5, var7,
          var8); // L: 181
    }
  } // L: 182
  ...
  public void drawTransBgAt(int var1, int var2) {
    ...
    if (var6 > 0 && var5 > 0) { // L: 234
      Sprite_drawTransBg(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var4, var3, var6, var5,
          var7, var8); // L: 235
    }
  } // L: 236
  ...
  public void drawScaledAt(int var1, int var2, int var3, int var4) {
    if (var3 > 0 && var4 > 0) { // L: 267
      ...
      Sprite_drawScaled(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var7, var8, var13, var14,
          var3, var4, var11, var12, var5); // L: 309
    }
  } // L: 310
  ...
  public void drawTransOverlayAt(int var1, int var2, int var3, int var4) {
    if (var3 == 256) { // L: 329
      ...
      if (var8 > 0 && var7 > 0) { // L: 364
        Sprite_drawTransOverlay(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var6, var5, var8,
            var7, var9, var10, var3, var4); // L: 365
      }
    }
  } // L: 331 366
  ...
  public void drawTransAt(int var1, int var2, int var3) {
    ...
    if (var7 > 0 && var6 > 0) { // L: 420
      Sprite_drawTransparent(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var5, var4, var7,
          var6, var8, var9, var3); // L: 421
    }
  } // L: 422
  ...
  public void drawTransScaledAt(int var1, int var2, int var3, int var4, int var5) {
    if (var3 > 0 && var4 > 0) { // L: 441
      ...
      Sprite_drawTransScaled(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var8, var9, var14,
          var15, var3, var4, var12, var13, var6, var5); // L: 483
    }
  } // L: 484

  @ObfuscatedName("c")
  public void method7035(int var1, int var2, int var3) {
    ...
    if (var7 > 0 && var6 > 0) { // L: 538
      if (var3 == 256) {
        method7036(0, 0, 0, Rasterizer2D.Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7,
            var6, var8, var9); // L: 539
      } else {
        method7065(0, 0, 0, Rasterizer2D.Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7,
            var6, var8, var9, var3); // L: 540
      }
  ...
  @ObfuscatedName("w")
  public void method7038(int var1, int var2, int var3, int var4, int var5) {
    if (var3 > 0 && var4 > 0) { // L: 582
      ...
      if (var5 == 256) { // L: 624
        method7039(0, 0, 0, var8, this.pixels, Rasterizer2D.Rasterizer2D_pixels, 0, 0, -var4, var9,
            var14, var15, var3, var12, var13, var6);
      } else {
        method7064(0, 0, 0, var8, this.pixels, Rasterizer2D.Rasterizer2D_pixels, 0, 0, -var4, var9,
            var14, var15, var3, var12, var13, var6, var5); // L: 625
      }
  ...
  @ObfuscatedName("ak")
  public void method7041(int var1, int var2, int var3, int var4, int var5, int var6, int[] var7,
      int[] var8) {
    ...
    int var13 =
        var3 + var11 + (var9 + var2 + var4) * Rasterizer2D.Rasterizer2D_width + var1; // L: 679
  ...
  public void drawRotatedMaskedCenteredAround(int var1, int var2, int var3, int var4, int var5,
  ...
  @ObfuscatedName("at")
  public void method7043(int var1, int var2, int var3, int var4, int var5, int var6, double var7,
      int var9) {
    try {
  ...
  @ObfuscatedName("ah")
  public void method7097(int var1, int var2, int var3, int var4) {
    this.method7045(this.width << 3, this.height << 3, var1 << 4, var2 << 4, var3, var4); // L: 762
  } // L: 763

  @ObfuscatedName("az")
  void method7045(int var1, int var2, int var3, int var4, int var5, int var6) {
    if (var6 != 0) { // L: 766
      ...
      int var17 =
          ((this.subHeight << 4) - var2) * var9 + var10 * ((this.subWidth << 4) - var1); // L: 778
      int var18 =
          ((this.subHeight << 4) - var2) * var10 + var9 * -((this.subWidth << 4) - var1); // L: 779
      int var19;
      int var20;
          ...
          if (var27 == 0) { // L: 837
            if (var26 == 0) { // L: 838
              for (var33 = var22; var33 < 0; var23 += Rasterizer2D.Rasterizer2D_width) {
                ...
                if (var30 >= 0 && var31 >= 0 && var30 - (this.subWidth << 12) < 0
                    && var31 - (this.subHeight << 12) < 0) { // L: 844 845 846 847
              ...
              for (var33 = var22; var33 < 0; var23 += Rasterizer2D.Rasterizer2D_width) {
                ...
                if (var30 >= 0 && var30 - (this.subWidth << 12) < 0) { // L: 884 885
                  ...
                  if ((var32 = (var36 + 1 - (this.subHeight << 12) - var26) / var26)
                      > var37) { // L: 892
                    var37 = var32;
                  }
            ...
            for (var33 = var22; var33 < 0; var23 += Rasterizer2D.Rasterizer2D_width) {
              ...
              if (var31 >= 0 && var31 - (this.subHeight << 12) < 0) { // L: 996 997
                ...
                if ((var32 = (var35 + 1 - (this.subWidth << 12) - var27) / var27)
                    > var37) { // L: 1004
                  var37 = var32;
                }
  ...
  public void drawScaledWorldmap(int var1, int var2, int var3, int var4) {
    if (var3 <= this.width && var4 <= this.height) { // L: 1079
      ...
      int var6 =
          (var3 * (this.xOffset + this.subWidth) + this.width - 1) / this.width + var1; // L: 1083
      int var7 = var2 + var4 * this.yOffset / this.height; // L: 1084
      int var8 = var2
          + (this.height + (this.yOffset + this.subHeight) * var4 - 1) / this.height; // L: 1085
