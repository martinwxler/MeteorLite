    ...
    if (var2 == 1) {
      ...
      if (var2 == 7) { // L: 67
        ...
        if (var2 == 17) {
          ...
          this.horizontalAlignment = (HorizontalAlignment) Clock
              .findEnumerated(MouseHandler.method726(), var1.readUnsignedByte()); // L: 115
        } else if (var2 == 30) { // L: 117
          this.verticalAlignment = (VerticalAlignment) Clock
              .findEnumerated(class106.method2373(), var1.readUnsignedByte());
        }
      }
    }
