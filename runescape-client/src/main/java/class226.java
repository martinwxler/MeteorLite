  ...
  public static int compareStrings(CharSequence var0, CharSequence var1, Language var2) {
    ...
    while (var5 - var7 < var3 || var6 - var8 < var4) { // L: 18
      ...
      if (var10 != var9 && Character.toUpperCase(var9) != Character.toUpperCase(var10)) { // L: 85
        ...
        if (var10 != var9) { // L: 88
          return SpotAnimationDefinition.lowercaseChar(var9, var2) - SpotAnimationDefinition
              .lowercaseChar(var10, var2);
        }
      }
    }
    ...
    for (var17 = 0; var17 < var16; ++var17) { // L: 92
      ...
      if (var20 != var18 && Character.toUpperCase(var18) != Character
          .toUpperCase(var20)) { // L: 100
        var18 = Character.toLowerCase(var18); // L: 101
        var20 = Character.toLowerCase(var20); // L: 102
        if (var20 != var18) {
          return SpotAnimationDefinition.lowercaseChar(var18, var2) - SpotAnimationDefinition
              .lowercaseChar(var20, var2); // L: 103
        }
      }
    }
    ...
    if (var17 != 0) { // L: 107
      ...
      for (int var19 = 0; var19 < var16; ++var19) { // L: 108
        ...
        if (var20 != var13) { // L: 111
          return SpotAnimationDefinition.lowercaseChar(var20, var2) - SpotAnimationDefinition
              .lowercaseChar(var13, var2);
        }
      }
