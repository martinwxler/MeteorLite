...
public class MusicPatchNode extends Node {
  ...
  static final String formatItemStacks(int var0) {
    ...
    if (var1.length() > 9) { // L: 9910
      return " " + SecureRandomFuture.colorStartTag(65408) + var1.substring(0, var1.length() - 8)
          + "M" + " " + " (" + var1 + ")" + "</col>";
    } else {
      return var1.length() > 6 ? " " + SecureRandomFuture.colorStartTag(16777215) + var1
          .substring(0, var1.length() - 4) + "K" + " " + " (" + var1 + ")" + "</col>"
          : " " + SecureRandomFuture.colorStartTag(16776960) + var1 + "</col>"; // L: 9911 9912
    }
  }
