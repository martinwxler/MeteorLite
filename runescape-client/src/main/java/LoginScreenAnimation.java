...
public class LoginScreenAnimation {
    ...
    if (var0 == ScriptOpcodes.FRIEND_COUNT) { // L: 2086
      if (DevicePcmPlayerProvider.friendSystem.field928 == 0) { // L: 2087
        ...
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
            - 1] = DevicePcmPlayerProvider.friendSystem.friendsList.getSize(); // L: 2089
      }
      ...
      if (var0 == ScriptOpcodes.FRIEND_GETNAME) {
        ...
        if (DevicePcmPlayerProvider.friendSystem.method1804() && var3 >= 0
            && var3 < DevicePcmPlayerProvider.friendSystem.friendsList.getSize()) { // L: 2094
          Friend var8 = (Friend) DevicePcmPlayerProvider.friendSystem.friendsList
              .get(var3); // L: 2095
          Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
              - 1] = var8.getName(); // L: 2096
          Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
              - 1] = var8.getPreviousName(); // L: 2097
        } else {
          Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
              - 1] = ""; // L: 2100
          Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
        ...
        if (DevicePcmPlayerProvider.friendSystem.method1804() && var3 >= 0
            && var3 < DevicePcmPlayerProvider.friendSystem.friendsList.getSize()) { // L: 2107
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
              - 1] = ((Buddy) DevicePcmPlayerProvider.friendSystem.friendsList
              .get(var3)).world; // L: 2108
        } else {
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
              - 1] = 0; // L: 2110
        }
        ...
        if (DevicePcmPlayerProvider.friendSystem.method1804() && var3 >= 0
            && var3 < DevicePcmPlayerProvider.friendSystem.friendsList.getSize()) { // L: 2115
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
              - 1] = ((Buddy) DevicePcmPlayerProvider.friendSystem.friendsList
              .get(var3)).rank; // L: 2116
        } else {
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
              - 1] = 0; // L: 2118
        }
        ...
        if (var0 == ScriptOpcodes.FRIEND_SETRANK) {
          ...
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
              DevicePcmPlayerProvider.friendSystem.isFriended(new Username(var5, loginType), false)
                  ? 1 : 0; // L: 2150
          return 1; // L: 2151
        } else if (var0 == ScriptOpcodes.CLAN_GETCHATDISPLAYNAME) {
          if (class289.friendsChat != null) { // L: 2154
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                - 1] = class289.friendsChat.name; // L: 2155
          } else {
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                - 1] = ""; // L: 2157
          }
          ...
          if (class289.friendsChat != null) { // L: 2161
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = class289.friendsChat.getSize(); // L: 2162
          } else {
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = 0; // L: 2164
          }
          ...
          if (class289.friendsChat != null && var3 < class289.friendsChat.getSize()) { // L: 2169
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                - 1] = class289.friendsChat.get(var3).getUsername().getName(); // L: 2170
          } else {
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                - 1] = ""; // L: 2172
          }
          ...
          if (class289.friendsChat != null && var3 < class289.friendsChat.getSize()) { // L: 2177
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = ((Buddy) class289.friendsChat.get(var3)).getWorld(); // L: 2178
          } else {
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = 0; // L: 2180
          }
          ...
          if (class289.friendsChat != null && var3 < class289.friendsChat.getSize()) { // L: 2185
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = ((Buddy) class289.friendsChat.get(var3)).rank; // L: 2186
          } else {
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = 0; // L: 2188
          }
          ...
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
              class289.friendsChat != null ? class289.friendsChat.minKick : 0; // L: 2192
          return 1; // L: 2193
          ...
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
              class289.friendsChat != null ? class289.friendsChat.rank * 1745656179 * 1281242043
                  : 0; // L: 2201
          return 1; // L: 2202
          ...
          if (!DevicePcmPlayerProvider.friendSystem.method1804()) { // L: 2214
            ...
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = DevicePcmPlayerProvider.friendSystem.ignoreList.getSize(); // L: 2215
          }
          ...
          if (DevicePcmPlayerProvider.friendSystem.method1804() && var3 >= 0
              && var3 < DevicePcmPlayerProvider.friendSystem.ignoreList.getSize()) { // L: 2220
            Ignored var4 = (Ignored) DevicePcmPlayerProvider.friendSystem.ignoreList
                .get(var3); // L: 2221
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                - 1] = var4.getName(); // L: 2222
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                - 1] = var4.getPreviousName(); // L: 2223
          } else {
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                - 1] = ""; // L: 2226
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
          ...
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
              DevicePcmPlayerProvider.friendSystem.isIgnored(new Username(var5, loginType)) ? 1
                  : 0; // L: 2234
          return 1; // L: 2235
        } else if (var0 == ScriptOpcodes.CLAN_ISSELF) {
          var3 = Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]; // L: 2238
          if (class289.friendsChat != null && var3 < class289.friendsChat.getSize()
              && class289.friendsChat.get(var3).getUsername()
          ...
          if (class289.friendsChat != null && class289.friendsChat.owner != null) { // L: 2246
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                - 1] = class289.friendsChat.owner; // L: 2247
          } else {
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                - 1] = ""; // L: 2249
          }
          ...
          if (class289.friendsChat != null && var3 < class289.friendsChat.getSize()
              && ((ClanMate) class289.friendsChat.get(var3)).isFriend()) { // L: 2254
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = 1; // L: 2255
          } else {
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
          ...
          if (var0 == 3628) {
            ...
            if (var0 == 3629) {
              var7 = Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]
                  == 1; // L: 2273
              DevicePcmPlayerProvider.friendSystem.friendsList
                  .addComparator(new UserComparator1(var7)); // L: 2274
              return 1; // L: 2275
            } else if (var0 == 3630) {
              var7 = Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]
                  == 1; // L: 2278
              DevicePcmPlayerProvider.friendSystem.friendsList
                  .addComparator(new UserComparator2(var7)); // L: 2279
              return 1; // L: 2280
            } else if (var0 == 3631) {
              var7 = Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]
                  == 1; // L: 2283
              DevicePcmPlayerProvider.friendSystem.friendsList
                  .addComparator(new UserComparator3(var7)); // L: 2284
              return 1; // L: 2285
            } else if (var0 == 3632) {
              var7 = Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]
                  == 1; // L: 2288
              DevicePcmPlayerProvider.friendSystem.friendsList
                  .addComparator(new UserComparator4(var7)); // L: 2289
              return 1; // L: 2290
            } else if (var0 == 3633) {
              var7 = Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]
                  == 1; // L: 2293
              DevicePcmPlayerProvider.friendSystem.friendsList
                  .addComparator(new UserComparator5(var7)); // L: 2294
              return 1; // L: 2295
            } else if (var0 == 3634) {
              var7 = Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]
                  == 1; // L: 2298
              DevicePcmPlayerProvider.friendSystem.friendsList
                  .addComparator(new UserComparator6(var7)); // L: 2299
              return 1; // L: 2300
            } else if (var0 == 3635) {
              var7 = Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]
                  == 1; // L: 2303
              DevicePcmPlayerProvider.friendSystem.friendsList
                  .addComparator(new UserComparator7(var7)); // L: 2304
              return 1; // L: 2305
            } else if (var0 == 3636) {
              var7 = Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]
                  == 1; // L: 2308
              DevicePcmPlayerProvider.friendSystem.friendsList
                  .addComparator(new UserComparator8(var7)); // L: 2309
              return 1; // L: 2310
            } else if (var0 == 3637) {
              var7 = Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]
                  == 1; // L: 2313
              DevicePcmPlayerProvider.friendSystem.friendsList
                  .addComparator(new UserComparator9(var7)); // L: 2314
              return 1; // L: 2315
            } else if (var0 == 3638) {
              var7 = Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]
                  == 1; // L: 2318
              DevicePcmPlayerProvider.friendSystem.friendsList
                  .addComparator(new UserComparator10(var7)); // L: 2319
              return 1; // L: 2320
            } else if (var0 == 3639) {
              ...
              DevicePcmPlayerProvider.friendSystem.ignoreList
                  .addComparator(new UserComparator1(var7)); // L: 2332
              return 1; // L: 2333
            } else if (var0 == 3642) {
              var7 = Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]
                  == 1; // L: 2336
              DevicePcmPlayerProvider.friendSystem.ignoreList
                  .addComparator(new UserComparator2(var7)); // L: 2337
              return 1; // L: 2338
            } else if (var0 == 3643) {
              ...
              var7 = Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]
                  == 1; // L: 2427
              DevicePcmPlayerProvider.friendSystem.friendsList
                  .addComparator(new BuddyRankComparator(var7)); // L: 2428
              return 1; // L: 2429
            } else if (var0 == 3657) {
              var7 = Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]
                  == 1; // L: 2432
          ...
          if (class289.friendsChat != null && var3 < class289.friendsChat.getSize()
              && ((ClanMate) class289.friendsChat.get(var3)).isIgnored()) { // L: 2262
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = 1; // L: 2263
          } else {
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
  ...
  static int method2285(int var0, Script var1, boolean var2) {
    ...
    if (var0 == ScriptOpcodes.CAM_FORCEANGLE) { // L: 3515
      ...
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
          - 1] = Client.camAngleX; // L: 3526
      return 1; // L: 3527
    } else if (var0 == ScriptOpcodes.CAM_GETANGLE_YA) { // L: 3529
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
          - 1] = Client.camAngleY; // L: 3530
      return 1; // L: 3531
      ...
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
          - 1] = Client.camFollowHeight; // L: 3540
      return 1; // L: 3541
    } else {
      return 2; // L: 3543
    }
  ...
  final void method2293(int var1) {
    ...
    for (int var5 = 0; var5 < var4; ++var5) { // L: 98
      var6 = this.field1305[var2 + var3]
          - this.field1302[var2 + this.field1290 & this.field1302.length - 1] * var1 / 6; // L: 99
      if (var6 < 0) { // L: 100
        var6 = 0;
      }
    ...
    for (var7 = 256 - var1; var7 < 256; ++var7) { // L: 121
      this.field1300[var7] = (int) (Math.sin((double) this.field1304 / 14.0D) * 16.0D
          + Math.sin((double) this.field1304 / 15.0D) * 14.0D
          + Math.sin((double) this.field1304 / 16.0D) * 12.0D); // L: 122
  ...
  final int method2297(int var1, int var2, int var3) {
    ...
    return (var4 * (var1 & 65280) + var3 * (var2 & 65280) & 16711680) + (
        var4 * (var1 & 16711935) + var3 * (var2 & 16711935) & -16711936) >> 8; // L: 160
  }
  ...
  final void method2291(int var1, int[] var2) {
    ...
    for (int var4 = 0; var4 < var3; ++var4) { // L: 179
      if (var1 > 768) { // L: 180
        ...
        this.field1294[var4] = this
            .method2297(var2[var4], this.field1295[var4], 256 - var1); // L: 182
      }
    }
    ...
    for (int var3 = 1; var3 < 255; ++var3) { // L: 188
      ...
      for (int var9 = var6; var9 < var7; ++var9) { // L: 202
        ...
        if (var10 != 0 && var11 >= Rasterizer2D.Rasterizer2D_xClipStart
            && var11 < Rasterizer2D.Rasterizer2D_xClipEnd) { // L: 205
          ...
          AbstractWorldMapData.rasterProvider.pixels[var8++] = -16777216 |
              ((var14 & 16711935) * var13 + (var10 & 16711935) * var12 & -16711936) + (
                  var13 * (var14 & 65280) + var12 * (var10 & 65280) & 16711680) >> 8; // L: 210
        } else {
          ++var8; // L: 212
        }
      }
    ...
    for (var2 = 0; var2 < 20; ++var2) { // L: 224
      for (var3 = 1; var3 < 255; ++var3) { // L: 225
        for (var4 = 1; var4 < 127; ++var4) { // L: 226
          ...
          this.field1303[var5] =
              (this.field1302[var5 + 1] + this.field1302[var5 + 128] + this.field1302[var5 - 128]
                  + this.field1302[var5 - 1]) / 4; // L: 228
        }
      }
