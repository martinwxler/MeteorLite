...
public final class GameObject {
  ...
  static void method4433() {
    if (Client.Login_isUsernameRemembered && Login.Login_username != null
        && Login.Login_username.length() > 0) { // L: 195
  ...
  static void method4432() {
    ...
    CollisionMap.setLoginResponseString("The game servers are currently being updated.",
        "Please wait a few minutes and try again.", ""); // L: 1528
  } // L: 1529
  ...
  @Export("menuAction")
  static final void menuAction(int var0, int var1, int var2, int var3, String var4, String var5,
      int var6, int var7) {
    if (var2 >= 2000) { // L: 7935
      var2 -= 2000;
    }
    ...
    if (var2 == 1) { // L: 7936
      ...
      var8 = InterfaceParent
          .getPacketBufferNode(ClientPacket.field2642, Client.packetWriter.isaacCipher); // L: 8027
      ...
      var8 = InterfaceParent
          .getPacketBufferNode(ClientPacket.field2639, Client.packetWriter.isaacCipher); // L: 8638
      ...
      var8 = InterfaceParent
          .getPacketBufferNode(ClientPacket.field2578, Client.packetWriter.isaacCipher); // L: 8434
      ...
      var8 = InterfaceParent
          .getPacketBufferNode(ClientPacket.field2589, Client.packetWriter.isaacCipher); // L: 8676
      ...
      var8 = InterfaceParent
          .getPacketBufferNode(ClientPacket.field2657, Client.packetWriter.isaacCipher); // L: 8321
      ...
      var8 = InterfaceParent
          .getPacketBufferNode(ClientPacket.field2616, Client.packetWriter.isaacCipher); // L: 8624
      ...
      if (var2 == 7) {
        ...
        if (var13 != null) { // L: 8559
          ...
          var9 = InterfaceParent.getPacketBufferNode(ClientPacket.field2666,
              Client.packetWriter.isaacCipher); // L: 8567
        ...
        if (var13 != null) { // L: 8053
          ...
          var9 = InterfaceParent.getPacketBufferNode(ClientPacket.field2617,
              Client.packetWriter.isaacCipher); // L: 8060
        ...
        if (var13 != null) { // L: 8109
          ...
          var9 = InterfaceParent.getPacketBufferNode(ClientPacket.field2671,
              Client.packetWriter.isaacCipher); // L: 8117
        ...
        if (var13 != null) { // L: 8273
          ...
          var9 = InterfaceParent.getPacketBufferNode(ClientPacket.field2649,
              Client.packetWriter.isaacCipher); // L: 8281
        ...
        if (var13 != null) { // L: 8443
          ...
          var9 = InterfaceParent.getPacketBufferNode(ClientPacket.field2597,
              Client.packetWriter.isaacCipher); // L: 8451
        ...
        if (var13 != null) { // L: 7954
          ...
          var9 = InterfaceParent.getPacketBufferNode(ClientPacket.field2681,
              Client.packetWriter.isaacCipher); // L: 7962
        ...
        if (var13 != null) { // L: 7997
          ...
          var9 = InterfaceParent.getPacketBufferNode(ClientPacket.field2595,
              Client.packetWriter.isaacCipher); // L: 8005
        ...
        if (var2 == 14) {
          ...
          if (var15 != null) { // L: 8588
            ...
            var9 = InterfaceParent.getPacketBufferNode(ClientPacket.field2650,
                Client.packetWriter.isaacCipher); // L: 8596
          ...
          if (var15 != null) { // L: 8239
            ...
            var9 = InterfaceParent.getPacketBufferNode(ClientPacket.field2611,
                Client.packetWriter.isaacCipher); // L: 8246
          ...
          var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2654,
              Client.packetWriter.isaacCipher); // L: 8227
          ...
          var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2646,
              Client.packetWriter.isaacCipher); // L: 8655
          ...
          var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2614,
              Client.packetWriter.isaacCipher); // L: 8347
          ...
          var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2613,
              Client.packetWriter.isaacCipher); // L: 8708
          ...
          var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2602,
              Client.packetWriter.isaacCipher); // L: 8295
          ...
          var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2678,
              Client.packetWriter.isaacCipher); // L: 8481
          ...
          var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2604,
              Client.packetWriter.isaacCipher); // L: 8362
          ...
          if (Client.isMenuOpen) { // L: 8012
            ...
            DevicePcmPlayerProvider.scene
                .menuOpen(SoundSystem.Client_plane, var0, var1, true); // L: 8016
          }
        } else {
          ...
          if (var2 == 24) {
            ...
            if (var12) { // L: 8609
              var11 = InterfaceParent.getPacketBufferNode(ClientPacket.field2677,
                  Client.packetWriter.isaacCipher); // L: 8611
            ...
            if (var2 == 25) {
              ...
              if (var16 != null) { // L: 8205
                ...
                ItemComposition.selectSpell(var1, var0,
                    ModelData0.Widget_unpackTargetMask(class22.getWidgetFlags(var16)),
                    var16.itemId); // L: 8207
                Client.isItemSelected = 0; // L: 8208
                Client.selectedSpellActionName = SecureRandomCallable
                    .Widget_getSpellActionName(var16); // L: 8209
                ...
                if (var16.isIf3) { // L: 8211
                  Client.selectedSpellName =
                      var16.dataText + SecureRandomFuture.colorStartTag(16777215);
                } else {
                  Client.selectedSpellName =
                      SecureRandomFuture.colorStartTag(65280) + var16.spellName + SecureRandomFuture
                          .colorStartTag(16777215); // L: 8212
                }
              }
            ...
            if (var2 == 26) {
              ...
              Widget var14;
              if (var2 == 28) {
                var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2677,
                    Client.packetWriter.isaacCipher); // L: 8387
                ...
                var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2677,
                    Client.packetWriter.isaacCipher); // L: 8039
                ...
                var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2620,
                    Client.packetWriter.isaacCipher); // L: 8490
                ...
                var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2632,
                    Client.packetWriter.isaacCipher); // L: 8399
                ...
                var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2663,
                    Client.packetWriter.isaacCipher); // L: 8071
                ...
                var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2638,
                    Client.packetWriter.isaacCipher); // L: 8548
                ...
                var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2628,
                    Client.packetWriter.isaacCipher); // L: 8515
                ...
                var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2590,
                    Client.packetWriter.isaacCipher); // L: 7986
                ...
                var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2580,
                    Client.packetWriter.isaacCipher); // L: 8537
                ...
                if (var2 == 38) {
                  ...
                  Client.selectedItemName = SecureRandomFuture.colorStartTag(16748608) + class250
                      .ItemDefinition_get(var3).name + SecureRandomFuture
                      .colorStartTag(16777215); // L: 8103
                ...
                if (var2 == 39) {
                  var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2640,
                      Client.packetWriter.isaacCipher); // L: 8504
                  ...
                  var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2641,
                      Client.packetWriter.isaacCipher); // L: 8526
                  ...
                  var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2637,
                      Client.packetWriter.isaacCipher); // L: 8304
                  ...
                  var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2672,
                      Client.packetWriter.isaacCipher); // L: 8330
                  ...
                  var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2645,
                      Client.packetWriter.isaacCipher); // L: 8691
                  ...
                  if (var15 != null) { // L: 8459
                    ...
                    var9 = InterfaceParent.getPacketBufferNode(ClientPacket.field2618,
                        Client.packetWriter.isaacCipher); // L: 8467
                    var9.packetBuffer.method6705(var3); // L: 8468
                    var9.packetBuffer
                        .method6640(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8469
                  ...
                  if (var15 != null) { // L: 7970
                    ...
                    var9 = InterfaceParent.getPacketBufferNode(ClientPacket.field2625,
                        Client.packetWriter.isaacCipher); // L: 7978
                    var9.packetBuffer.method6649(var3); // L: 7979
                    var9.packetBuffer
                        .method6641(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 7980
                  ...
                  if (var15 != null) { // L: 7938
                    ...
                    var9 = InterfaceParent.getPacketBufferNode(ClientPacket.field2652,
                        Client.packetWriter.isaacCipher); // L: 7946
                    var9.packetBuffer
                        .method6639(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 7947
                  ...
                  if (var15 != null) { // L: 8257
                    ...
                    var9 = InterfaceParent.getPacketBufferNode(ClientPacket.field2627,
                        Client.packetWriter.isaacCipher); // L: 8265
                    var9.packetBuffer
                        .method6640(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8266
                  ...
                  if (var15 != null) { // L: 8412
                    ...
                    var9 = InterfaceParent.getPacketBufferNode(ClientPacket.field2608,
                        Client.packetWriter.isaacCipher); // L: 8420
                    var9.packetBuffer.method6648(var3); // L: 8421
                    var9.packetBuffer
                        .method6641(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8422
                  ...
                  if (var15 != null) { // L: 8371
                    ...
                    var9 = InterfaceParent.getPacketBufferNode(ClientPacket.field2605,
                        Client.packetWriter.isaacCipher); // L: 8379
                    var9.packetBuffer.method6649(var3); // L: 8380
                    var9.packetBuffer
                        .method6639(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8381
                  ...
                  if (var15 != null) { // L: 8189
                    ...
                    var9 = InterfaceParent.getPacketBufferNode(ClientPacket.field2673,
                        Client.packetWriter.isaacCipher); // L: 8197
                    var9.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1
                        : 0); // L: 8198
                  ...
                  if (var15 != null) { // L: 8142
                    ...
                    var9 = InterfaceParent.getPacketBufferNode(ClientPacket.field2674,
                        Client.packetWriter.isaacCipher); // L: 8150
                    var9.packetBuffer.method6641(
                        KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8151
                  ...
                  if (var2 == 58) {
                    ...
                    if (var16 != null) { // L: 8158
                      var9 = InterfaceParent.getPacketBufferNode(ClientPacket.field2676,
                          Client.packetWriter.isaacCipher); // L: 8160
                    ...
                    var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2623,
                        Client.packetWriter.isaacCipher); // L: 8088
                    var8.packetBuffer.method6649(var3); // L: 8089
                    var8.packetBuffer
                        .method6641(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8090
                    ...
                    var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2626,
                        Client.packetWriter.isaacCipher); // L: 8129
                    ...
                    if (var13 != null) { // L: 8176
                      ...
                      if (var17 != null) { // L: 8179
                        var11 = InterfaceParent.getPacketBufferNode(ClientPacket.field2634,
                            Client.packetWriter.isaacCipher); // L: 8181
                    ...
                    var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2629,
                        Client.packetWriter.isaacCipher); // L: 8582
                    ...
                    if (var16 != null && var16.itemQuantities[var0] >= 100000) { // L: 8717
                      UserComparator10.addGameMessage(27, "",
                          var16.itemQuantities[var0] + " x " + class250
                              .ItemDefinition_get(var3).name);
                    } else {
                      var9 = InterfaceParent.getPacketBufferNode(ClientPacket.field2629,
                          Client.packetWriter.isaacCipher); // L: 8720
                  ...
                  } else if (var2 == 1012 || var2 == 1011 || var2 == 1009 || var2 == 1008
                      || var2 == 1010) {
                    class80.worldMap.worldMapMenuAction(var2, var3, new Coord(var0),
                        new Coord(var1)); // L: 8666
                  }
                } else {
                  var16 = class17.getWidgetChild(var1, var0); // L: 8684
                  if (var16 != null) { // L: 8685
                    MouseHandler
                        .widgetDefaultMenuAction(var3, var1, var0, var16.itemId, var5); // L: 8686
                  }
                }
              }
            }
