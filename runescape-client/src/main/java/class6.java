...
public class class6 extends class14 {
  ...
  static void playSong(int var0) {
    if (var0 == -1 && !Client.field862) { // L: 3785
      Decimator.method1169(); // L: 3786
        ...
        && class4.clientPreferences.musicVolume != 0 && !Client.field862) { // L: 3788
      WorldMapIcon_1
          .method3300(2, DynamicObject.archive6, var0, 0, class4.clientPreferences.musicVolume,
              false); // L: 3789
    }
  ...
  static final void changeGameOptions(int var0) {
    ...
    if (var1 != 0) { // L: 11147
      ...
      AttackOption[] var3;
      if (var1 == 18) { // L: 11182
        var3 = new AttackOption[]{AttackOption.AttackOption_leftClickWhereAvailable,
            AttackOption.AttackOption_alwaysRightClick,
            AttackOption.AttackOption_dependsOnCombatLevels,
            AttackOption.AttackOption_hidden}; // L: 11185
