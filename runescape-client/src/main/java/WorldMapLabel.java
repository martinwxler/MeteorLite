    ...
    if (var0 != ScriptOpcodes.CC_CALLONRESIZE && var0 != ScriptOpcodes.IF_CALLONRESIZE) { // L: 1223
      ...
      if (var0 == ScriptOpcodes.CC_TRIGGEROP) { // L: 1240
        ...
        if (var5 >= 1 && var5 <= 10) { // L: 1255
          class106 var6 = new class106(var5, var3, var4,
              WorldMapData_1.getWidget(var3).itemId); // L: 1258
      ...
      if (var0 >= 2000) { // L: 1228
        var7 = WorldMapData_1.getWidget(
            Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]); // L: 1229
      } else {
