...
public class Model extends Renderable {
      ...
      if (var3 == var1[var7][var9] && var3 == var1[var8][var9] && var3 == var1[var7][var10]
        ...
        if (var6 == 0) { // L: 210
          for (var12 = 0; var12 < var11.verticesCount; ++var12) { // L: 211
            ...
            var18 = var14 >> 7; // L: 217
            var19 =
                var1[var17][var18] * (128 - var15) + var1[var17 + 1][var18] * var15 >> 7; // L: 218
            var20 = var1[var17][var18 + 1] * (128 - var15) + var15 * var1[var17 + 1][var18 + 1]
                >> 7; // L: 219
          ...
          for (var12 = 0; var12 < var11.verticesCount; ++var12) { // L: 225
            ...
            if (var13 < var6) { // L: 227
              ...
              var18 = var14 >> 7; // L: 232
              var19 = var15 >> 7; // L: 233
              var20 = var1[var18][var19] * (128 - var16) + var1[var18 + 1][var19] * var16
                  >> 7; // L: 234
              var21 = var1[var18][var19 + 1] * (128 - var16) + var16 * var1[var18 + 1][var19 + 1]
                  >> 7; // L: 235
              int var22 = var20 * (128 - var17) + var21 * var17 >> 7; // L: 236
              var11.verticesY[var12] =
                  (var6 - var13) * (var22 - var3) / var6 + this.verticesY[var12]; // L: 237
            }
          }
        }
  ...
  public Model toSharedSequenceModel(boolean var1) {
    ...
    return this.buildSharedModel(var1, Model_sharedSequenceModel,
        Model_sharedSequenceModelFaceAlphas); // L: 247
  }
  ...
  public Model toSharedSpotAnimationModel(boolean var1) {
    ...
    return this.buildSharedModel(var1, Model_sharedSpotAnimationModel,
        Model_sharedSpotAnimationModelFaceAlphas); // L: 252
  }
  ...
  void calculateBoundingBox(int var1) {
    if (this.xMidOffset == -1) { // L: 300
      ...
      for (int var10 = 0; var10 < this.verticesCount; ++var10) { // L: 309
        int var11 = Rasterizer3D
            .method3969(this.verticesX[var10], this.verticesZ[var10], var8, var9); // L: 310
        int var12 = this.verticesY[var10]; // L: 311
        int var13 = Rasterizer3D
            .method3970(this.verticesX[var10], this.verticesZ[var10], var8, var9); // L: 312
        if (var11 < var2) { // L: 313
          var2 = var11;
        }
  ...
  public void calculateBoundsCylinder() {
    if (this.boundsType != 1) { // L: 337
      ...
      this.radius = (int) (
          Math.sqrt((double) (this.xzRadius * this.xzRadius + super.height * super.height))
              + 0.99D); // L: 352
      this.diameter = this.radius + (int) (
          Math.sqrt((double) (this.xzRadius * this.xzRadius + this.bottomY * this.bottomY))
              + 0.99D); // L: 353
    }
  } // L: 354
      ...
      if (var2 != -1) { // L: 384
        ...
        for (int var5 = 0; var5 < var3.transformCount; ++var5) { // L: 390
          ...
          this.transform(var4.transformTypes[var6], var4.labels[var6], var3.transformXs[var5],
              var3.transformYs[var5], var3.transformZs[var5]); // L: 392
        }
          ...
          if (var8 < this.vertexLabels.length) { // L: 479
            ...
            for (var10 = 0; var10 < var9.length; ++var10) { // L: 481
              ...
              if (var14 != 0) { // L: 489
                ...
                var17 =
                    var15 * this.verticesY[var11] + var16 * this.verticesX[var11] >> 16; // L: 492
                this.verticesY[var11] =
                    var16 * this.verticesY[var11] - var15 * this.verticesX[var11] >> 16; // L: 493
              ...
              if (var12 != 0) { // L: 496
                ...
                var17 =
                    var16 * this.verticesY[var11] - var15 * this.verticesZ[var11] >> 16; // L: 499
                this.verticesZ[var11] =
                    var15 * this.verticesY[var11] + var16 * this.verticesZ[var11] >> 16; // L: 500
              ...
              if (var13 != 0) { // L: 503
                ...
                var17 =
                    var15 * this.verticesZ[var11] + var16 * this.verticesX[var11] >> 16; // L: 506
                this.verticesZ[var11] =
                    var16 * this.verticesZ[var11] - var15 * this.verticesX[var11] >> 16; // L: 507
  ...
  public void rotateZ(int var1) {
    ...
    for (int var4 = 0; var4 < this.verticesCount; ++var4) { // L: 588
      ...
      this.verticesZ[var4] =
          var2 * this.verticesY[var4] + var3 * this.verticesZ[var4] >> 16; // L: 590
  ...
  @ObfuscatedName("p")
  public final void method4347(int var1, int var2, int var3, int var4, int var5, int var6,
      int var7) {
    field2466[0] = -1; // L: 615
  ...
  @ObfuscatedName("c")
  public final void method4309(int var1, int var2, int var3, int var4, int var5, int var6, int var7,
      int var8) {
    field2466[0] = -1; // L: 669
      ...
      for (var7 = 0; var7 < this.indicesCount; ++var7) { // L: 925
        if (this.faceColors3[var7] != -2) { // L: 926
          ...
          if (!var1 || var11 != -5000 && var12 != -5000 && var28 != -5000) { // L: 933
            if (var2 && FontName
                .method6331(modelViewportYs[var8], modelViewportYs[var9], modelViewportYs[var10],
                    var11, var12, var28, var6)) { // L: 959
              ViewportMouse.ViewportMouse_entityTags[++ViewportMouse.ViewportMouse_entityCount
                  - 1] = var4; // L: 962
              var2 = false; // L: 964
            }

            if ((var11 - var12) * (modelViewportYs[var10] - modelViewportYs[var9])
                - (var28 - var12) * (modelViewportYs[var8] - modelViewportYs[var9]) > 0) { // L: 966
              field2458[var7] = false; // L: 967
              if (var11 >= 0 && var12 >= 0 && var28 >= 0
                  && var11 <= Rasterizer3D.Rasterizer3D_clipWidth
                  && var12 <= Rasterizer3D.Rasterizer3D_clipWidth
                  && var28 <= Rasterizer3D.Rasterizer3D_clipWidth) { // L: 968
                field2469[var7] = false; // L: 969
              } else {
                field2469[var7] = true;
              }

              var29 = (field2461[var8] + field2461[var9] + field2461[var10]) / 3
                  + this.radius; // L: 970
            ...
            if (var15 * var23 + var18 * var24 + var21 * var25 > 0) { // L: 952
              ...
              int var26 = (field2461[var8] + field2461[var9] + field2461[var10]) / 3
                  + this.radius; // L: 954
    ...
    if (field2458[var1]) { // L: 1077
      ...
      if (this.faceTextures != null && this.faceTextures[var1] != -1) { // L: 1087
        ...
        if (this.faceColors3[var1] == -1) {
          Rasterizer3D
              .method3964(modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4],
                  modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4],
                  this.faceColors1[var1], this.faceColors1[var1], this.faceColors1[var1],
                  field2435[var5], field2435[var6], field2435[var7], field2463[var5],
                  field2463[var6], field2463[var7], field2477[var5], field2477[var6],
                  field2477[var7], this.faceTextures[var1]); // L: 1106
        } else {
          Rasterizer3D
              .method3964(modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4],
                  modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4],
                  this.faceColors1[var1], this.faceColors2[var1], this.faceColors3[var1],
                  field2435[var5], field2435[var6], field2435[var7], field2463[var5],
                  field2463[var6], field2463[var7], field2477[var5], field2477[var6],
                  field2477[var7], this.faceTextures[var1]); // L: 1107
        }
      } else if (this.faceColors3[var1] == -1) { // L: 1088
        Rasterizer3D.method3962(modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4],
            modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4],
            field2484[this.faceColors1[var1]]);
      } else {
        Rasterizer3D.method3960(modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4],
            modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4],
            this.faceColors1[var1], this.faceColors2[var1], this.faceColors3[var1]); // L: 1089
      }
  ...
  final void method4320(int var1) {
    ...
    if (var8 >= 50) { // L: 1123
      ...
      if (var10 >= 50) { // L: 1132
        ...
        field2473[var4] = var2
            + Rasterizer3D.Rasterizer3D_zoom * (var11 + ((field2435[var7] - var11) * var14 >> 16))
            / 50; // L: 1134
        field2474[var4] = var3
            + Rasterizer3D.Rasterizer3D_zoom * (var12 + ((field2463[var7] - var12) * var14 >> 16))
            / 50; // L: 1135
      ...
      if (var9 >= 50) { // L: 1138
        ...
        field2473[var4] = var2
            + Rasterizer3D.Rasterizer3D_zoom * (var11 + ((field2435[var6] - var11) * var14 >> 16))
            / 50; // L: 1140
        field2474[var4] = var3
            + Rasterizer3D.Rasterizer3D_zoom * (var12 + ((field2463[var6] - var12) * var14 >> 16))
            / 50; // L: 1141
    ...
    if (var9 >= 50) { // L: 1145
      ...
      if (var8 >= 50) { // L: 1154
        ...
        field2473[var4] = var2
            + Rasterizer3D.Rasterizer3D_zoom * (var11 + ((field2435[var5] - var11) * var14 >> 16))
            / 50; // L: 1156
        field2474[var4] = var3
            + Rasterizer3D.Rasterizer3D_zoom * (var12 + ((field2463[var5] - var12) * var14 >> 16))
            / 50; // L: 1157
    ...
    int var20;
    if (var4 == 3) { // L: 1196
      if (var11 < 0 || var12 < 0 || var13 < 0 || var11 > Rasterizer3D.Rasterizer3D_clipWidth
          || var12 > Rasterizer3D.Rasterizer3D_clipWidth
          || var13 > Rasterizer3D.Rasterizer3D_clipWidth) { // L: 1197
      ...
      if (this.faceTextures != null && this.faceTextures[var1] != -1) { // L: 1198
        ...
        if (this.faceColors3[var1] == -1) { // L: 1217
          Rasterizer3D.method3964(var14, var15, var16, var11, var12, var13, this.faceColors1[var1],
              this.faceColors1[var1], this.faceColors1[var1], field2435[var17], field2435[var18],
              field2435[var19], field2463[var17], field2463[var18], field2463[var19],
              field2477[var17], field2477[var18], field2477[var19], this.faceTextures[var1]);
        } else {
          Rasterizer3D
              .method3964(var14, var15, var16, var11, var12, var13, field2475[0], field2475[1],
                  field2475[2], field2435[var17], field2435[var18], field2435[var19],
                  field2463[var17], field2463[var18], field2463[var19], field2477[var17],
                  field2477[var18], field2477[var19], this.faceTextures[var1]); // L: 1218
        }
      } else if (this.faceColors3[var1] == -1) { // L: 1199
        Rasterizer3D.method3962(var14, var15, var16, var11, var12, var13,
            field2484[this.faceColors1[var1]]);
      } else {
        Rasterizer3D
            .method3960(var14, var15, var16, var11, var12, var13, field2475[0], field2475[1],
                field2475[2]); // L: 1200
      }
    }
    ...
    if (var4 == 4) { // L: 1221
      if (var11 < 0 || var12 < 0 || var13 < 0 || var11 > Rasterizer3D.Rasterizer3D_clipWidth
          || var12 > Rasterizer3D.Rasterizer3D_clipWidth
          || var13 > Rasterizer3D.Rasterizer3D_clipWidth || field2473[3] < 0
          || field2473[3] > Rasterizer3D.Rasterizer3D_clipWidth) { // L: 1222
        Rasterizer3D.field2262 = true;
      }
      ...
      if (this.faceTextures != null && this.faceTextures[var1] != -1) { // L: 1223
        ...
        if (this.faceColors3[var1] == -1) { // L: 1250
          Rasterizer3D.method3964(var14, var15, var16, var11, var12, var13, this.faceColors1[var1],
              this.faceColors1[var1], this.faceColors1[var1], field2435[var17], field2435[var18],
              field2435[var19], field2463[var17], field2463[var18], field2463[var19],
              field2477[var17], field2477[var18], field2477[var19], var21); // L: 1251
          Rasterizer3D.method3964(var14, var16, field2474[3], var11, var13, field2473[3],
              this.faceColors1[var1], this.faceColors1[var1], this.faceColors1[var1],
              field2435[var17], field2435[var18], field2435[var19], field2463[var17],
              field2463[var18], field2463[var19], field2477[var17], field2477[var18],
              field2477[var19], var21); // L: 1252
        } else {
          Rasterizer3D
              .method3964(var14, var15, var16, var11, var12, var13, field2475[0], field2475[1],
                  field2475[2], field2435[var17], field2435[var18], field2435[var19],
                  field2463[var17], field2463[var18], field2463[var19], field2477[var17],
                  field2477[var18], field2477[var19], var21); // L: 1255
          Rasterizer3D
              .method3964(var14, var16, field2474[3], var11, var13, field2473[3], field2475[0],
                  field2475[2], field2475[3], field2435[var17], field2435[var18], field2435[var19],
                  field2463[var17], field2463[var18], field2463[var19], field2477[var17],
                  field2477[var18], field2477[var19], var21); // L: 1256
        }
        ...
        Rasterizer3D
            .method3962(var14, var16, field2474[3], var11, var13, field2473[3], var17); // L: 1227
      } else {
        Rasterizer3D
            .method3960(var14, var15, var16, var11, var12, var13, field2475[0], field2475[1],
                field2475[2]); // L: 1230
        Rasterizer3D
            .method3960(var14, var16, field2474[3], var11, var13, field2473[3], field2475[0],
                field2475[2], field2475[3]); // L: 1231
      }
    }
  ...
  @ObfuscatedName("bh")
  @Export("draw")
  void draw(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
      long var9) {
    field2466[0] = -1; // L: 723
          ...
          if (var20 / var14 > Rasterizer3D.Rasterizer3D_clipNegativeMidY) { // L: 739
            ...
            if (var22 / var14 < Rasterizer3D.Rasterizer3D_clipMidY2) { // L: 742
                ...
                if (field2479) { // L: 759
                  ...
                  if (!class8.method103()) { // L: 763
                    ...
                    if (!ViewportMouse.ViewportMouse_false0) { // L: 768
                      ...
                      var42 = (ViewportMouse.ViewportMouse_x - Rasterizer3D.Rasterizer3D_clipMidX)
                          * var40 / Rasterizer3D.Rasterizer3D_zoom; // L: 775
                      var43 = (ViewportMouse.ViewportMouse_y - Rasterizer3D.Rasterizer3D_clipMidY)
                          * var40 / Rasterizer3D.Rasterizer3D_zoom; // L: 776
                      var44 = (ViewportMouse.ViewportMouse_x - Rasterizer3D.Rasterizer3D_clipMidX)
                          * var41 / Rasterizer3D.Rasterizer3D_zoom; // L: 777
                      int var45 =
                          (ViewportMouse.ViewportMouse_y - Rasterizer3D.Rasterizer3D_clipMidY)
                              * var41 / Rasterizer3D.Rasterizer3D_zoom; // L: 778
                    ...
                    if (Math.abs(var42) > var39 + MilliClock.field1523) { // L: 811
                      ...
                      var34 = false; // L: 820
                        ...
                        var44 * ClanChannelMember.field68 - var43 * WorldMapEvent.field2146)
                        > var54 * class21.field180 + var55 * EnumComposition.field1629) { // L: 823
                      var34 = false; // L: 824
                    } else if (Math.abs(
                        var42 * WorldMapEvent.field2146 - var44 * UserComparator5.field1442)
                        > var39 * class21.field180 + var55 * MilliClock.field1523) { // L: 827
                      var34 = false; // L: 828
                    } else if (Math.abs(
                        var43 * UserComparator5.field1442 - var42 * ClanChannelMember.field68)
                        > var54 * MilliClock.field1523
                        + var39 * EnumComposition.field1629) { // L: 831
                      var34 = false; // L: 832
                    } else {
                      var34 = true; // L: 835
                    }
              ...
              for (var37 = 0; var37 < this.verticesCount; ++var37) { // L: 882
                ...
                if (var54 >= 50) { // L: 901
                  modelViewportXs[var37] =
                      var38 * Rasterizer3D.Rasterizer3D_zoom / var54 + var52; // L: 902
                  modelViewportYs[var37] =
                      var55 * Rasterizer3D.Rasterizer3D_zoom / var54 + var53; // L: 903
                } else {
