...
public class class82 {
  ...
  static {
    ...
    field996 = new BigInteger(
        "",
        16); // L: 7
  }
  ...
  static int method2031(int var0, Script var1, boolean var2) {
    ...
    if (var0 == ScriptOpcodes.MES) { // L: 1411
      ...
      World.performPlayerAnimation(class262.localPlayer,
          Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize],
          Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize + 1]); // L: 1418
      return 1; // L: 1419
      ...
      if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
        ...
        PacketBufferNode var14 = InterfaceParent.getPacketBufferNode(ClientPacket.field2664,
            Client.packetWriter.isaacCipher); // L: 1432
        ...
        if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
          ...
          var12 = InterfaceParent.getPacketBufferNode(ClientPacket.field2582,
              Client.packetWriter.isaacCipher); // L: 1440
          ...
          var12 = InterfaceParent.getPacketBufferNode(ClientPacket.field2610,
              Client.packetWriter.isaacCipher); // L: 1449
          ...
          if (var0 == ScriptOpcodes.OPPLAYER) {
            ...
            var16 = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
                + 1]; // L: 1464
            int var9 = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
                + 2]; // L: 1465
            ...
            var16 = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
                + 1]; // L: 1473
            Widget var13 =
                var2 ? UserComparator5.scriptDotWidget : User.scriptActiveWidget; // L: 1474
            ItemLayer.clickWidget(var13, var10, var16); // L: 1475
            return 1; // L: 1476
          } else if (var0 == ScriptOpcodes.MOUSECAM) {
            UserComparator3.mouseCam =
                Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]
                    == 1; // L: 1479
            return 1; // L: 1480
          } else if (var0 == ScriptOpcodes.GETREMOVEROOFS) {
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                class4.clientPreferences.roofsHidden ? 1 : 0; // L: 1483
            return 1; // L: 1484
          } else if (var0 == ScriptOpcodes.SETREMOVEROOFS) {
            class4.clientPreferences.roofsHidden =
                Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]
                    == 1; // L: 1487
            ...
            var12 = InterfaceParent.getPacketBufferNode(ClientPacket.field2622,
                Client.packetWriter.isaacCipher); // L: 1500
            ...
            String var5 = Interpreter.Interpreter_stringStack[
                UserComparator9.Interpreter_stringStackSize + 1]; // L: 1509
            if (var4.length() > 500) { // L: 1510
              return 1;
            } else if (var5.length() > 500) { // L: 1511
              return 1;
            } else {
              PacketBufferNode var6 = InterfaceParent.getPacketBufferNode(ClientPacket.field2651,
                  Client.packetWriter.isaacCipher); // L: 1512
              var6.packetBuffer.writeShort(
                  1 + class44.stringCp1252NullTerminatedByteSize(var4) + class44
                      .stringCp1252NullTerminatedByteSize(var5)); // L: 1513
            ...
            Client.shiftClickDrop =
                Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]
                    == 1; // L: 1521
            return 1; // L: 1522
          } else if (var0 == ScriptOpcodes.SETSHOWMOUSEOVERTEXT) {
            Client.showMouseOverText =
                Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]
                    == 1; // L: 1525
            return 1; // L: 1526
            ...
            Client.showMouseCross =
                Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]
                    == 1; // L: 1557
            return 1; // L: 1558
          } else if (var0 == ScriptOpcodes.SETSHOWLOADINGMESSAGES) {
            Client.showLoadingMessages =
                Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]
                    == 1; // L: 1561
            return 1; // L: 1562
            ...
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                PendingSpawn.getTapToDrop() ? 1 : 0; // L: 1569
            return 1; // L: 1570
          } else if (var0 == 3129) {
            ...
            Client.oculusOrbSlowedSpeed = Interpreter.Interpreter_intStack[
                ChatChannel.Interpreter_intStackSize + 1]; // L: 1575
            return 1; // L: 1576
          } else if (var0 == 3130) {
            ...
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = AttackOption.canvasWidth; // L: 1587
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = class0.canvasHeight; // L: 1588
            return 1; // L: 1589
            ...
            Client.field694 = var2 ? UserComparator5.scriptDotWidget.id * -464746545 * 363798319
                : User.scriptActiveWidget.id * -464746545 * 363798319; // L: 1622
            return 1; // L: 1623
          } else {
            boolean var11;
            if (var0 == ScriptOpcodes.SETHIDEUSERNAME) {
              ...
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                  class4.clientPreferences.hideUsername ? 1 : 0; // L: 1632
              return 1; // L: 1633
              ...
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                  Client.Login_isUsernameRemembered ? 1 : 0; // L: 1645
              return 1; // L: 1646
              ...
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                  class4.clientPreferences.titleMusicDisabled ? 0 : 1; // L: 1660
              return 1; // L: 1661
            } else if (var0 == 3148) {
              return 1; // L: 1664
            } else if (var0 == 3149) {
              ...
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                  - 1] = Login.Login_loadingPercent; // L: 1683
              return 1; // L: 1684
            } else if (var0 == 3154) {
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                  - 1] = FontName.method6329(); // L: 1687
              return 1; // L: 1688
            } else if (var0 == 3155) {
              ...
              var10 = 100 - Math.min(
                  Math.max(Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize],
                      0), 100); // L: 1807
