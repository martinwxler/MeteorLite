...
public class class18 extends class14 {
  ...
  static int method262(int var0, Script var1, boolean var2) {
    ...
    if (var0 == ScriptOpcodes.ENUM_STRING) { // L: 2015
      ...
      int var5 = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
          + 2]; // L: 2035
      ...
      if (var3 == var7.inputType && var9 == var7.outputType) { // L: 2038
        ...
        if (var7 != null) { // L: 2051
          if (var9 == 115) {
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                - 1] = var7.defaultStr; // L: 2052
          } else {
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = var7.defaultInt; // L: 2053
          }
        }
  ...
  static final void method273(Widget var0, int var1, int var2, int var3, int var4, int var5,
      int var6) {
    ...
    if (MouseHandler.MouseHandler_currentButton == 1
        || !UserComparator3.mouseCam && MouseHandler.MouseHandler_currentButton == 4) { // L: 10004
    ...
    if (Client.mouseWheelRotation != 0) { // L: 10023
      ...
      if (var5 >= var1 - var7 && var6 >= var2 && var5 < var1 + 16
          && var6 <= var3 + var2) { // L: 10025
