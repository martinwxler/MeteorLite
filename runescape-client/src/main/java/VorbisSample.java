...
public class VorbisSample extends Node {
  ...
  @ObfuscatedName("n")
  static float[] field507;
  @ObfuscatedName("l")
  static float[] field495;
  @ObfuscatedName("w")
  static float[] field509;
  @ObfuscatedName("a")
  static float[] field510;
  @ObfuscatedName("aw")
  static float[] field511;
  @ObfuscatedName("ak")
  static float[] field518;
  @ObfuscatedName("ad")
  static float[] field513;
  @ObfuscatedName("at")
  static int[] field514;
  @ObfuscatedName("ah")
  static int[] field515;
  ...
  static int readBits(int var0) {
    ...
    for (var2 = 0; var0 >= 8 - VorbisSample_bitOffset; var0 -= var3) { // L: 70 71 78
      ...
      var1 += (VorbisSample_bytes[VorbisSample_byteOffset] >> VorbisSample_bitOffset & var4)
          << var2; // L: 74
    ...
    if (var0 > 0) { // L: 80
      var3 = (1 << var0) - 1; // L: 81
      var1 += (VorbisSample_bytes[VorbisSample_byteOffset] >> VorbisSample_bitOffset & var3)
          << var2; // L: 82
  ...
  static void method1133(byte[] var0) {
    ...
    field507 = new float[VorbisSample_blockSize1]; // L: 117
    ...
    for (var1 = 0; var1 < 2; ++var1) { // L: 118
      ...
      for (int var7 = 0; var7 < var4; ++var7) { // L: 124
        var12[var7 * 2] = (float) Math
            .cos((double) (var7 * 4) * 3.141592653589793D / (double) var2); // L: 125
        var12[var7 * 2 + 1] = -((float) Math
            .sin((double) (var7 * 4) * 3.141592653589793D / (double) var2)); // L: 126
      }

      float[] var13 = new float[var3]; // L: 128

      for (int var8 = 0; var8 < var4; ++var8) { // L: 129
        var13[var8 * 2] = (float) Math
            .cos((double) (var8 * 2 + 1) * 3.141592653589793D / (double) (var2 * 2)); // L: 130
        var13[var8 * 2 + 1] = (float) Math
            .sin((double) (var8 * 2 + 1) * 3.141592653589793D / (double) (var2 * 2)); // L: 131
      }

      float[] var14 = new float[var4]; // L: 133

      for (int var9 = 0; var9 < var5; ++var9) { // L: 134
        var14[var9 * 2] = (float) Math
            .cos((double) (var9 * 4 + 2) * 3.141592653589793D / (double) var2); // L: 135
        var14[var9 * 2 + 1] = -((float) Math
            .sin((double) (var9 * 4 + 2) * 3.141592653589793D / (double) var2)); // L: 136
      }

      int[] var15 = new int[var5]; // L: 138
      int var10 = class5.iLog(var5 - 1); // L: 139

      for (int var11 = 0; var11 < var5; ++var11) { // L: 140
        var15[var11] = class16.method245(var11, var10);
      }

      if (var1 != 0) { // L: 141
        field511 = var12; // L: 142
        field518 = var13; // L: 143
        field513 = var14; // L: 144
        field515 = var15; // L: 145
      } else {
        field495 = var12; // L: 148
        field509 = var13; // L: 149
        field510 = var14; // L: 150
        field514 = var15; // L: 151
      }
    }
  ...
  static boolean method1131(AbstractArchive var0) {
    if (!field502) { // L: 381
  ...
  @ObfuscatedName("h")
  @ObfuscatedSignature(
      descriptor = "(Ljp;II)Lbr;"
  )
  @Export("readMusicSample")
  static VorbisSample readMusicSample(AbstractArchive var0, int var1, int var2) {
    if (!method1131(var0)) { // L: 391
  ...
  void read(byte[] var1) {
    ...
    if (this.end < 0) { // L: 94
      ...
      this.field501 = true; // L: 96
    }

    int var3 = var2.readInt(); // L: 98
    this.field504 = new byte[var3][]; // L: 99
    ...
    for (int var4 = 0; var4 < var3; ++var4) { // L: 100
      ...
      this.field504[var4] = var7; // L: 109
    }

  } // L: 111

  @ObfuscatedName("m")
  float[] method1148(int var1) {
    VorbisSample_setData(this.field504[var1], 0); // L: 182
    readBit(); // L: 183
    int var2 = readBits(class5.iLog(VorbisSample_mapping.length - 1)); // L: 184
    ...
    for (var17 = 0; var17 < var14.submaps; ++var17) { // L: 228
      ...
      float[] var44 = field507; // L: 230
      var42.method934(var44, var4 >> 1, var45); // L: 231
    }
    ...
    if (!var15) { // L: 234
      ...
      VorbisSample_floors[var18].method815(field507, var4 >> 1); // L: 237
    }
    ...
    if (var15) { // L: 240
      ...
      float[] var40 = var3 ? field511 : field495; // L: 250
      float[] var22 = var3 ? field518 : field509; // L: 251
      float[] var23 = var3 ? field513 : field510; // L: 252
      int[] var24 = var3 ? field515 : field514; // L: 253
      ...
      var25 = class5.iLog(var4 - 1); // L: 274
      ...
      for (var46 = 0; var46 < var18; ++var46) { // L: 337
        var20[var46] =
            var20[var17 + var46 * 2] * var22[var46 * 2] + var20[var17 + var46 * 2 + 1] * var22[
                var46 * 2 + 1]; // L: 338
        var20[var17 - 1 - var46] =
            var20[var17 + var46 * 2] * var22[var46 * 2 + 1] - var20[var17 + var46 * 2 + 1] * var22[
                var46 * 2]; // L: 339
      }
      ...
      for (var46 = var8; var46 < var9; ++var46) { // L: 345
        var27 = (float) Math.sin(((double) (var46 - var8) + 0.5D) / (double) var10 * 0.5D
            * 3.141592653589793D); // L: 346
        var10000 = field507; // L: 347
      ...
      for (var46 = var11; var46 < var12; ++var46) { // L: 349
        var27 = (float) Math.sin(
            ((double) (var46 - var11) + 0.5D) / (double) var13 * 0.5D * 3.141592653589793D
                + 1.5707963267948966D); // L: 350
        var10000 = field507; // L: 351
        var10000[var46] *= (float) Math.sin(1.5707963267948966D * (double) var27 * (double) var27);
      }
    }

    float[] var41 = null; // L: 354
    if (this.field508 > 0) { // L: 355
      var18 = var4 + this.field508 >> 2; // L: 356
      var41 = new float[var18]; // L: 357
      int var43;
      if (!this.field487) { // L: 358
        for (var19 = 0; var19 < this.field490; ++var19) { // L: 359
          var43 = var19 + (this.field508 >> 1); // L: 360
          var41[var19] += this.field503[var43]; // L: 361
        }
      }
      ...
      if (!var15) { // L: 364
        for (var19 = var8; var19 < var4 >> 1; ++var19) { // L: 365
          ...
          var41[var43] += field507[var19]; // L: 367
        }
      }
    }

    float[] var54 = this.field503; // L: 371
    this.field503 = field507; // L: 372
    field507 = var54; // L: 373
    this.field508 = var4; // L: 374
    this.field490 = var12 - (var4 >> 1); // L: 375
    this.field487 = var15; // L: 376
    return var41; // L: 377
  }
  ...
  RawSound toRawSound(int[] var1) {
    if (var1 != null && var1[0] <= 0) { // L: 405
      ...
      if (this.samples == null) { // L: 406
        this.field508 = 0; // L: 407
        this.field503 = new float[VorbisSample_blockSize1]; // L: 408
        this.samples = new byte[this.sampleCount]; // L: 409
        this.field517 = 0; // L: 410
        this.field505 = 0; // L: 411
      }

      for (; this.field505 < this.field504.length; ++this.field505) { // L: 413 428
        if (var1 != null && var1[0] <= 0) { // L: 414
          return null;
        }

        float[] var2 = this.method1148(this.field505); // L: 415
        if (var2 != null) { // L: 416
          int var3 = this.field517; // L: 417
          ...
          if (var1 != null) { // L: 425
            var1[0] -= var3 - this.field517;
          }

          this.field517 = var3; // L: 426
        }
      }

      this.field503 = null; // L: 430
      byte[] var7 = this.samples; // L: 431
      this.samples = null; // L: 432
      return new RawSound(this.sampleRate, var7, this.start, this.end, this.field501); // L: 433
    }
  }
}
