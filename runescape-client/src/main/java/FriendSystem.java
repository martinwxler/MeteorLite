...
public class FriendSystem {
  ...
  static final void method1875(PendingSpawn var0) {
    ...
    if (var1 != 0L) { // L: 7339
      int var6 = DevicePcmPlayerProvider.scene
          .getObjectFlags(var0.plane, var0.x, var0.y, var1); // L: 7340
  ...
  static final InterfaceParent method1867(int var0, int var1, int var2) {
    ...
    WorldMapLabelSize.revalidateWidgetScroll(
        GrandExchangeOfferOwnWorldComparator.Widget_interfaceComponents[var0 >> 16], var4,
        false); // L: 11266
  ...
  final void processFriendUpdates() {
    for (FriendLoginUpdate var1 = (FriendLoginUpdate) this.friendsList.friendLoginUpdates.last();
        var1 != null;
        var1 = (FriendLoginUpdate) this.friendsList.friendLoginUpdates.previous()) { // L: 55
  ...
  final boolean friendsListIsFull() {
    return this.friendsList.isFull()
        || this.friendsList.getSize() >= 200 && Client.field740 != 1; // L: 143
  }
  ...
  final boolean canAddIgnore() {
    return this.ignoreList.isFull()
        || this.ignoreList.getSize() >= 100 && Client.field740 != 1; // L: 205
  }
    ...
    if (var1 != null) { // L: 212
      ...
      if (var2.hasCleanName()) { // L: 214
        if (this.friendsList.removeByUsername(var2)) { // L: 215
          ...
          PacketBufferNode var3 = InterfaceParent.getPacketBufferNode(ClientPacket.field2612,
              Client.packetWriter.isaacCipher); // L: 218
    ...
    if (var1 != null) { // L: 236
      ...
      if (var2.hasCleanName()) { // L: 238
        if (this.ignoreList.removeByUsername(var2)) { // L: 239
          ...
          PacketBufferNode var3 = InterfaceParent.getPacketBufferNode(ClientPacket.field2587,
              Client.packetWriter.isaacCipher); // L: 242
