  ...
  static Script newScript(byte[] var0) {
    ...
    if (var6 > 0) { // L: 120
      ...
      for (var7 = 0; var7 < var6; ++var7) { // L: 122
        ...
        IterableNodeHashTable var9 = new IterableNodeHashTable(
            var8 > 0 ? UrlRequester.method2504(var8) : 1); // L: 124
      ...
      if (this.exceptionWriting) { // L: 93
        ...
        synchronized (this) { // L: 98
          for (int var5 = 0; var5 < var3; ++var5) { // L: 99
            ...
            if ((this.outLength + this.maxPacketLength) % this.bufferLength
                == this.outOffset) { // L: 102
