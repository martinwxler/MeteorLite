...
public abstract class Actor extends Renderable {
      ...
      if (Client.menuOptionsCount < 400) { // L: 9283
        ...
        if (var0.skillLevel == 0) { // L: 9285
          ...
          var4 = var5 + var6 + " " + " (" + "level-" + var0.combatLevel + ")"
              + var0.actions[2]; // L: 9326
        } else {
          var4 = var0.actions[0] + var0.username + var0.actions[1] + " " + " (" + "skill-"
              + var0.skillLevel + ")" + var0.actions[2]; // L: 9328
        }
        ...
        if (Client.isItemSelected == 1) { // L: 9329
          class22.insertMenuItemNoShift("Use",
              Client.selectedItemName + " " + "->" + " " + SecureRandomFuture
                  .colorStartTag(16777215) + var4, 14, var1, var2, var3); // L: 9330
          ...
          if ((LoginPacket.selectedSpellFlags & 8) == 8) { // L: 9334
            class22.insertMenuItemNoShift(Client.selectedSpellActionName,
                Client.selectedSpellName + " " + "->" + " " + SecureRandomFuture
                    .colorStartTag(16777215) + var4, 15, var1, var2, var3); // L: 9335
          }
        } else {
            ...
            if (Client.playerMenuActions[var10] != null) { // L: 9341
              ...
              if (Client.playerMenuActions[var10].equalsIgnoreCase("Attack")) { // L: 9343
                ...
                if (AttackOption.AttackOption_alwaysRightClick == Client.playerAttackOption
                    ...
                    && var0.combatLevel > class262.localPlayer.combatLevel) { // L: 9345
                  var11 = 2000; // L: 9346
                }
              ...
              class22.insertMenuItemNoShift(Client.playerMenuActions[var10],
                  SecureRandomFuture.colorStartTag(16777215) + var4, var7, var1, var2,
                  var3); // L: 9359
            }
          }
        }
        ...
        for (var10 = 0; var10 < Client.menuOptionsCount; ++var10) { // L: 9364
          if (Client.menuOpcodes[var10] == 23) { // L: 9365
            Client.menuTargets[var10] =
                SecureRandomFuture.colorStartTag(16777215) + var4; // L: 9366
            break;
          }
        }
  ...
  final void addHealthBar(int var1, int var2, int var3, int var4, int var5, int var6) {
    ...
    HealthBar var12;
    for (var12 = (HealthBar) this.healthBars.last(); var12 != null;
        var12 = (HealthBar) this.healthBars.previous()) { // L: 146
      ++var11; // L: 147
  ...
  final void removeHealthBar(int var1) {
    ...
    for (HealthBar var3 = (HealthBar) this.healthBars.last(); var3 != null;
        var3 = (HealthBar) this.healthBars.previous()) { // L: 168
