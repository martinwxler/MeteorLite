...
public class Buffer extends Node {
  ...
  public void writeStringCp1252NullTerminated(String var1) {
    ...
    if (var2 >= 0) { // L: 124
      ...
      this.offset += HorizontalAlignment
          .encodeStringCp1252(var1, 0, var1.length(), this.array, this.offset); // L: 125
  ...
  public void writeStringCp1252NullCircumfixed(String var1) {
    ...
    if (var2 >= 0) { // L: 135
      ...
      this.offset += HorizontalAlignment
          .encodeStringCp1252(var1, 0, var1.length(), this.array, this.offset); // L: 137
  ...
  public int readUnsignedShort() {
    this.offset += 2; // L: 240
    return (this.array[this.offset - 1] & 255) + ((this.array[this.offset - 2] & 255)
        << 8); // L: 241
  }
  ...
  public int readShort() {
    this.offset += 2; // L: 245
    int var1 =
        (this.array[this.offset - 1] & 255) + ((this.array[this.offset - 2] & 255) << 8); // L: 246
    if (var1 > 32767) { // L: 247
      var1 -= 65536;
    }
  ...
  public int readMedium() {
    ...
    return ((this.array[this.offset - 3] & 255) << 16) + (this.array[this.offset - 1] & 255) + (
        (this.array[this.offset - 2] & 255) << 8); // L: 253
  }
  ...
  public int readInt() {
    this.offset += 4; // L: 257
    return ((this.array[this.offset - 3] & 255) << 16) + (this.array[this.offset - 1] & 255) + (
        (this.array[this.offset - 2] & 255) << 8) + ((this.array[this.offset - 4] & 255)
        << 24); // L: 258
  }
      ...
      if (var2 + this.offset > this.array.length) { // L: 301
        ...
        for (int var9 = var2 + var5; var8 < var9; var6[var7++] = (char) var11) { // L: 309 310 341
          ...
          if (var10 < 128) { // L: 313
            ...
            if (var8 + 1 < var9 && (var4[var8] & 192) == 128
                && (var4[var8 + 1] & 192) == 128) { // L: 326
  ...
  public int readShortSmart() {
    ...
    return var1 < 128 ? this.readUnsignedByte() - 64
        : this.readUnsignedShort() - 49152; // L: 356 357
  }
  ...
  public int method6628() {
    ...
    int var2;
    for (var2 = this.readUShortSmart(); var2 == 32767;
        var2 = this.readUShortSmart()) { // L: 368 369 371
      var1 += 32767; // L: 370
    }
  ...
  public int method6629() {
    return this.array[this.offset] < 0 ? this.readInt() & Integer.MAX_VALUE
        : this.readUnsignedShort(); // L: 378 379
  }
  ...
  public void xteaEncryptAll(int[] var1) {
    ...
    for (int var3 = 0; var3 < var2; ++var3) { // L: 402
      ...
      for (int var8 = 32; var8-- > 0; var5 +=
          var4 + (var4 << 4 ^ var4 >>> 5) ^ var1[var6 >>> 11 & 3] + var6) { // L: 407 408 411
  ...
  public void xteaDecryptAll(int[] var1) {
    ...
    for (int var3 = 0; var3 < var2; ++var3) { // L: 422
      ...
      for (int var8 = 32; var8-- > 0;
          var4 -= var5 + (var5 << 4 ^ var5 >>> 5) ^ var6 + var1[var6 & 3]) { // L: 427 428 431
  ...
  public void xteaEncrypt(int[] var1, int var2, int var3) {
    ...
    for (int var6 = 0; var6 < var5; ++var6) { // L: 443
      ...
      for (int var11 = 32; var11-- > 0; var8 +=
          var7 + (var7 << 4 ^ var7 >>> 5) ^ var1[var9 >>> 11 & 3] + var9) { // L: 448 449 452
  ...
  public void xteaDecrypt(int[] var1, int var2, int var3) {
    ...
    for (int var6 = 0; var6 < var5; ++var6) { // L: 465
      ...
      for (int var11 = 32; var11-- > 0;
          var7 -= var8 + (var8 << 4 ^ var8 >>> 5) ^ var9 + var1[var9 & 3]) { // L: 470 471 474
  ...
  public int method6651() {
    this.offset += 2; // L: 584
    return ((this.array[this.offset - 1] & 255) << 8) + (this.array[this.offset - 2]
        & 255); // L: 585
  }
  ...
  public int method6652() {
    this.offset += 2; // L: 589
    return (this.array[this.offset - 1] - 128 & 255) + ((this.array[this.offset - 2] & 255)
        << 8); // L: 590
  }
  ...
  public int method6653() {
    this.offset += 2; // L: 594
    return ((this.array[this.offset - 1] & 255) << 8) + (this.array[this.offset - 2] - 128
        & 255); // L: 595
  }
  ...
  public int method6654() {
    this.offset += 2; // L: 599
    int var1 = (this.array[this.offset - 1] - 128 & 255) + ((this.array[this.offset - 2] & 255)
        << 8); // L: 600
    if (var1 > 32767) { // L: 601
      var1 -= 65536;
    }
  ...
  public int method6757() {
    this.offset += 2; // L: 606
    int var1 = ((this.array[this.offset - 1] & 255) << 8) + (this.array[this.offset - 2] - 128
        & 255); // L: 607
    if (var1 > 32767) { // L: 608
      var1 -= 65536;
    }
  ...
  public int method6675() {
    ...
    return (this.array[this.offset - 4] & 255) + ((this.array[this.offset - 3] & 255) << 8) + (
        (this.array[this.offset - 2] & 255) << 16) + ((this.array[this.offset - 1] & 255)
        << 24); // L: 641
  }
  ...
  public int method6725() {
    ...
    return ((this.array[this.offset - 2] & 255) << 24) + ((this.array[this.offset - 4] & 255) << 8)
        + (this.array[this.offset - 3] & 255) + ((this.array[this.offset - 1] & 255)
        << 16); // L: 646
  }
  ...
  public int method6662() {
    ...
    return ((this.array[this.offset - 1] & 255) << 8) + ((this.array[this.offset - 4] & 255) << 16)
        + (this.array[this.offset - 2] & 255) + ((this.array[this.offset - 3] & 255)
        << 24); // L: 651
  }
