...
public class WorldMapLabelSize {
  ...
  static WorldMapLabelSize[] method3280() {
    return new WorldMapLabelSize[]{WorldMapLabelSize_small, WorldMapLabelSize_medium,
        WorldMapLabelSize_large}; // L: 15
  }
  ...
  static final void method3279(Actor var0) {
    if (var0.field1269 == Client.cycle || var0.sequence == -1 || var0.sequenceDelay != 0
        || var0.sequenceFrameCycle + 1 > WorldMapScaleHandler
        .SequenceDefinition_get(var0.sequence).frameLengths[var0.sequenceFrame]) { // L: 4182
  ...
  static void revalidateWidgetScroll(Widget[] var0, Widget var1, boolean var2) {
    int var3 = var1.scrollWidth != 0 ? var1.scrollWidth * 1327325403 * -1727030445
        : var1.width * 1476009263 * -527414833; // L: 9936
    int var4 = var1.scrollHeight != 0 ? var1.scrollHeight * 845859575 * -2062739769
        : var1.height * -1001050535 * 25115113; // L: 9937
