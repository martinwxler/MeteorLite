...
public class UserComparator9 extends AbstractUserComparator {
  ...
  static final void method2561(PacketBuffer var0, int var1, Player var2, int var3) {
    ...
    if ((var3 & 64) != 0) { // L: 527
      ...
      PlayerType var16 = (PlayerType) Clock
          .findEnumerated(class106.PlayerType_values(), var0.method6644()); // L: 529
      ...
      if (var2.username != null && var2.appearance != null) { // L: 533
        ...
        if (var16.isUser && DevicePcmPlayerProvider.friendSystem
            .isIgnored(var2.username)) { // L: 535 536
          var18 = true;
        }
        ...
        if (!var18 && Client.field629 == 0 && !var2.isHidden) { // L: 538
          ...
          String var11 = AbstractFont.escapeBrackets(GrandExchangeEvents
              .method5182(WorldMapIcon_1.method3304(Players.field1373))); // L: 542
          ...
          var2.field1253 = var2 != class262.localPlayer && var16.isUser && "" != Client.field642
              && var11.toLowerCase().indexOf(Client.field642) == -1; // L: 548
          ...
          if (var16.modIcon != -1) { // L: 552
            UserComparator10.addGameMessage(var12,
                MusicPatchPcmStream.method4743(var16.modIcon) + var2.username.getName(), var11);
          } else {
  ...
  static final void drawEntities(int var0, int var1, int var2, int var3) {
    ...
    if (class262.localPlayer.x >> 7 == Client.destinationX
        && class262.localPlayer.y >> 7 == Client.destinationY) { // L: 4526
    ...
    for (var6 = 0; var6 < var4; ++var6) { // L: 4536
      if (var5[var6] != Client.combatTargetPlayerIndex
          && var5[var6] != Client.localPlayerIndex) { // L: 4537
    ...
    for (GraphicsObject var15 = (GraphicsObject) Client.graphicsObjects.last(); var15 != null;
        var15 = (GraphicsObject) Client.graphicsObjects.previous()) { // L: 4544 4545 4552
        ...
        if (Client.cycle >= var15.cycleStart) { // L: 4547
          ...
          if (var15.isFinished) { // L: 4549
            ...
            DevicePcmPlayerProvider.scene
                .drawEntity(var15.plane, var15.x, var15.y, var15.height, 60, var15, 0, -1L,
                    false); // L: 4550
          }
        }
      } else {
    ...
    if (!Client.isCameraLocked) { // L: 4562
      ...
      VerticalAlignment.method2889(FriendSystem.oculusOrbFocalPointX, class14.field124,
          VarbitComposition.oculusOrbFocalPointY, var4, var16, NetSocket.method2676(var4),
          var3); // L: 4567
    }
    ...
    if (!Client.isCameraLocked) { // L: 4570
      if (class4.clientPreferences.roofsHidden) { // L: 4573
        ...
        label342:
        {
            ...
            label340:
            {
              ...
              if (var9 >= 0 && var10 >= 0 && var9 < 104 && var10 < 104) { // L: 4591
                if (var7 >= 0 && var8 >= 0 && var7 < 104 && var8 < 104) { // L: 4595
                  if ((Tiles.Tiles_renderFlags[SoundSystem.Client_plane][var9][var10] & 4)
                      != 0) { // L: 4599
          ...
          if (class262.localPlayer.x >= 0 && class262.localPlayer.y >= 0
              && class262.localPlayer.x < 13312 && class262.localPlayer.y < 13312) { // L: 4639
            if ((Tiles.Tiles_renderFlags[SoundSystem.Client_plane][class262.localPlayer.x >> 7][
                class262.localPlayer.y >> 7] & 4) != 0) { // L: 4643
              var6 = SoundSystem.Client_plane;
            }
    ...
    for (var10 = 0; var10 < 5; ++var10) { // L: 4654
      if (Client.field871[var10]) { // L: 4655
        var11 = (int) (Math.random() * (double) (Client.field872[var10] * 2 + 1)
            - (double) Client.field872[var10]
            + Math.sin((double) Client.field875[var10] * ((double) Client.field867[var10] / 100.0D))
            * (double) Client.field873[var10]); // L: 4656
        if (var10 == 0) { // L: 4657
    ...
    DevicePcmPlayerProvider.scene
        .draw(ObjectSound.cameraX, class160.cameraY, Canvas.cameraZ, class69.cameraPitch,
            class32.cameraYaw, var4); // L: 4688
    ...
    if (Client.hintArrowType == 2) { // L: 4694
      ClanChannel.worldToScreen((Client.hintArrowX - class15.baseX << 7) + Client.hintArrowSubX,
          (Client.hintArrowY - WorldMapSprite.baseY << 7) + Client.hintArrowSubY,
          Client.hintArrowHeight * 2); // L: 4695
      if (Client.viewportTempX > -1 && Client.cycle % 20 < 10) { // L: 4696
        Skills.headIconHintSprites[0]
            .drawTransBgAt(var0 + Client.viewportTempX - 12, Client.viewportTempY + var1 - 28);
      }
    }
  ...
  int compareBuddy(Buddy var1, Buddy var2) {
    if (Client.worldId == var1.world && var2.world == Client.worldId) { // L: 15
      return this.reversed ? var1.getUsername().compareToTyped(var2.getUsername())
          : var2.getUsername().compareToTyped(var1.getUsername()); // L: 16
    } else {
