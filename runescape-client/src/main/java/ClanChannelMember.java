...
public class ClanChannelMember {
  ...
  static int method106(int var0, Script var1, boolean var2) {
    ...
    if (var0 == ScriptOpcodes.CC_GETSCROLLX) { // L: 1116
      ...
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
          var3.modelTransparency ? 1 : 0; // L: 1173
      return 1; // L: 1174
  ...
  static void resumePauseWidget(int var0, int var1) {
    PacketBufferNode var2 = InterfaceParent
        .getPacketBufferNode(ClientPacket.field2662, Client.packetWriter.isaacCipher); // L: 8811
