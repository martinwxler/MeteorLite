...
public class MenuAction {
  ...
  static void requestNetFile(Archive var0, int var1, int var2, int var3, byte var4, boolean var5) {
    ...
    NetFileRequest var8 = (NetFileRequest) NetCache.NetCache_pendingPriorityWrites
        .get(var6); // L: 111
    if (var8 == null) { // L: 112
  ...
  static final String method2026(int var0) {
    if (var0 < 100000) { // L: 425
      ...
      return var0 < 10000000 ? "<col=ffffff>" + var0 / 1000 + "K" + "</col>"
          : "<col=00ff80>" + var0 / 1000000 + "M" + "</col>"; // L: 426 427
    }
  }
  ...
  static final void updateInterface(Widget[] var0, int var1, int var2, int var3, int var4, int var5,
      int var6, int var7) {
    for (int var8 = 0; var8 < var0.length; ++var8) { // L: 10371
      Widget var9 = var0[var8]; // L: 10372
      if (var9 != null && var9.parentId == var1 && (!var9.isIf3 || var9.type == 0
          || var9.hasListener || class22.getWidgetFlags(var9) != 0
          || var9 == Client.clickedWidgetParent
          || var9.contentType == 1338)) { // L: 10373 10374 10375
        if (var9.isIf3) { // L: 10376
          if (class35.isComponentHidden(var9)) { // L: 10377
            continue;
          }
        } else if (var9.type == 0 && var9 != MusicPatchNode.mousedOverWidgetIf1 && class35
            .isComponentHidden(var9)) { // L: 10380
          continue;
        }
        ...
        if (var33 || !var9.isIf3 || var12 < var14 && var13 < var15) { // L: 10447
          if (var9.isIf3) { // L: 10448
            ...
            if (var9.noClickThrough) { // L: 10449
              if (MouseHandler.MouseHandler_x >= var12 && MouseHandler.MouseHandler_y >= var13
                  && MouseHandler.MouseHandler_x < var14
                  && MouseHandler.MouseHandler_y < var15) { // L: 10450
                for (var26 = (ScriptEvent) Client.scriptEvents.last(); var26 != null;
                    var26 = (ScriptEvent) Client.scriptEvents.previous()) { // L: 10451
                ...
                && MouseHandler.MouseHandler_y < var15) { // L: 10466 10467
              for (var26 = (ScriptEvent) Client.scriptEvents.last(); var26 != null;
                  var26 = (ScriptEvent) Client.scriptEvents.previous()) { // L: 10468
          ...
          boolean var34 =
              var17 >= var12 && var18 >= var13 && var17 < var14 && var18 < var15; // L: 10482
          if (var9.contentType == 1337) { // L: 10483
            ...
            if (var9.contentType == 1400) { // L: 10491
              class80.worldMap
                  .onCycle(MouseHandler.MouseHandler_x, MouseHandler.MouseHandler_y, var34, var10,
                      var11, var9.width, var9.height); // L: 10492
            }

            if (!Client.isMenuOpen && var34) { // L: 10494
              if (var9.contentType == 1400) { // L: 10495
                class80.worldMap.addElementMenuOptions(var10, var11, var9.width, var9.height, var17,
                    var18); // L: 10496
              } else {
            ...
            if (var33) { // L: 10502
              for (int var20 = 0; var20 < var9.field3035.length; ++var20) { // L: 10503
                  ...
                  for (var23 = 0; var23 < var9.field3035[var20].length; ++var23) { // L: 10507
                    ...
                    if (class22.method314(var9.field3035[var20][var23]) || var24) { // L: 10512
                      ...
                      if (var9.field3104 != null
                          && var9.field3104[var20] > Client.cycle) { // L: 10514
                        break;
                      }

                      byte var32 = var9.field3036[var20][var23]; // L: 10515
                      if (var32 == 0 || ((var32 & 8) == 0 || !KeyHandler.KeyHandler_pressedKeys[86]
                          && !KeyHandler.KeyHandler_pressedKeys[82]
                          && !KeyHandler.KeyHandler_pressedKeys[81]) && ((var32 & 2) == 0
                          || KeyHandler.KeyHandler_pressedKeys[86]) && ((var32 & 1) == 0
                          || KeyHandler.KeyHandler_pressedKeys[82]) && ((var32 & 4) == 0
                          || KeyHandler.KeyHandler_pressedKeys[81])) { // L: 10516 10517 10518 10519 10520
                        var27 = true; // L: 10522
                        break;
                      }
                    }
                ...
                if (var27) { // L: 10528
                  if (var20 < 10) { // L: 10529
                    MouseHandler
                        .widgetDefaultMenuAction(var20 + 1, var9.id, var9.childIndex, var9.itemId,
                            "");
                  } else if (var20 == 10) { // L: 10530
                    class20.Widget_runOnTargetLeave(); // L: 10531
                    ItemComposition.selectSpell(var9.id, var9.childIndex,
                        ModelData0.Widget_unpackTargetMask(class22.getWidgetFlags(var9)),
                        var9.itemId); // L: 10532
                    Client.selectedSpellActionName = SecureRandomCallable
                        .Widget_getSpellActionName(var9); // L: 10533
                    if (Client.selectedSpellActionName == null) { // L: 10534
                      Client.selectedSpellActionName = "null";
                    }

                    Client.selectedSpellName =
                        var9.dataText + SecureRandomFuture.colorStartTag(16777215); // L: 10535
                  }
            ...
            if (var9.isIf3) { // L: 10551
              if (MouseHandler.MouseHandler_x >= var12 && MouseHandler.MouseHandler_y >= var13
                  && MouseHandler.MouseHandler_x < var14
                  && MouseHandler.MouseHandler_y < var15) { // L: 10552
                var34 = true;
              } else {
                var34 = false; // L: 10553
              }
              ...
              if ((MouseHandler.MouseHandler_currentButton == 1
                  || !UserComparator3.mouseCam && MouseHandler.MouseHandler_currentButton == 4)
                  && var34) { // L: 10555
                var35 = true;
              }
              ...
              if ((MouseHandler.MouseHandler_lastButton == 1
                  ...
                  && MouseHandler.MouseHandler_lastPressedY < var15) { // L: 10557
                var21 = true;
              }

              if (var21) { // L: 10558
                ItemLayer.clickWidget(var9, MouseHandler.MouseHandler_lastPressedX - var10,
              ...
              if (Client.clickedWidget != null && var9 != Client.clickedWidget && var34 && class5
                  .method73(class22.getWidgetFlags(var9))) { // L: 10562
              ...
              if (var9.hasListener) { // L: 10568
                ...
                if (Client.clickedWidget != null || VerticalAlignment.dragInventoryWidget != null
                    || Client.isMenuOpen) { // L: 10577
                  var21 = false; // L: 10578
                  var35 = false; // L: 10579
                  var34 = false; // L: 10580
                }
                ...
                int var36;
                int var37;
                if (var9.onVarTransmit != null
                    && Client.changedVarpCount > var9.field3089) { // L: 10669
                  if (var9.varTransmitTriggers != null
                      && Client.changedVarpCount - var9.field3089 <= 32) { // L: 10670
                    label809:
                    for (var37 = var9.field3089; var37 < Client.changedVarpCount;
                        ++var37) { // L: 10677
                      var23 = Client.changedVarps[var37 & 31]; // L: 10678

                      for (var36 = 0; var36 < var9.varTransmitTriggers.length;
                          ++var36) { // L: 10679
                ...
                if (var9.onInvTransmit != null && Client.field711 > var9.field3100) { // L: 10692
                  if (var9.invTransmitTriggers != null
                      && Client.field711 - var9.field3100 <= 32) { // L: 10693
                    label785:
                    for (var37 = var9.field3100; var37 < Client.field711; ++var37) { // L: 10700
                      var23 = Client.changedItemContainers[var37 & 31]; // L: 10701

                      for (var36 = 0; var36 < var9.invTransmitTriggers.length;
                          ++var36) { // L: 10702
                ...
                if (var9.onStatTransmit != null
                    && Client.changedSkillsCount > var9.field2971) { // L: 10715
                  if (var9.statTransmitTriggers != null
                      && Client.changedSkillsCount - var9.field2971 <= 32) { // L: 10716
                    label761:
                    for (var37 = var9.field2971; var37 < Client.changedSkillsCount;
                        ++var37) { // L: 10723
                      var23 = Client.changedSkills[var37 & 31]; // L: 10724

                      for (var36 = 0; var36 < var9.statTransmitTriggers.length;
                          ++var36) { // L: 10725
            ...
            if (!var9.isIf3) { // L: 10819
              ...
              if ((var9.mouseOverRedirect >= 0 || var9.mouseOverColor != 0)
                  ...
                  && MouseHandler.MouseHandler_x < var14
                  && MouseHandler.MouseHandler_y < var15) { // L: 10821
              ...
              if (var9.type == 8 && MouseHandler.MouseHandler_x >= var12
                  && MouseHandler.MouseHandler_y >= var13 && MouseHandler.MouseHandler_x < var14
                  && MouseHandler.MouseHandler_y < var15) { // L: 10825
                class5.field42 = var9; // L: 10826
              }

              if (var9.scrollHeight > var9.height) { // L: 10828
                class18.method273(var9, var10 + var9.width, var11, var9.height, var9.scrollHeight,
                    MouseHandler.MouseHandler_x, MouseHandler.MouseHandler_y);
              }
            }

            if (var9.type == 0) { // L: 10830
              updateInterface(var0, var9.id, var12, var13, var14, var15, var10 - var9.scrollX,
                  var11 - var9.scrollY); // L: 10831
              if (var9.children != null) { // L: 10832
                updateInterface(var9.children, var9.id, var12, var13, var14, var15,
                    var10 - var9.scrollX, var11 - var9.scrollY);
              }

              InterfaceParent var28 = (InterfaceParent) Client.interfaceParents
                  .get((long) var9.id); // L: 10833
              if (var28 != null) { // L: 10834
                if (var28.type == 0 && MouseHandler.MouseHandler_x >= var12
                    && MouseHandler.MouseHandler_y >= var13 && MouseHandler.MouseHandler_x < var14
                    && MouseHandler.MouseHandler_y < var15 && !Client.isMenuOpen) { // L: 10835
                  for (ScriptEvent var29 = (ScriptEvent) Client.scriptEvents.last(); var29 != null;
                      var29 = (ScriptEvent) Client.scriptEvents.previous()) { // L: 10836
                ...
                PacketWriter.updateRootInterface(var28.group, var12, var13, var14, var15, var10,
                    var11); // L: 10850
              }
            }
          }
