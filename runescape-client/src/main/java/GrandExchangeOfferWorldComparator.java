    ...
    if (var3 == 0) { // L: 203
      if (var2) { // L: 204
        ...
        Players.Players_regions[var1] =
            (var4.plane << 28) + (class15.baseX + var4.pathX[0] >> 13 << 14) + (
                WorldMapSprite.baseY + var4.pathY[0] >> 13); // L: 209
      ...
      if (var3 == 1) { // L: 217
        ...
        if (Client.localPlayerIndex == var1 && (var4.x < 1536 || var4.y < 1536 || var4.x >= 11776
            || var4.y >= 11776)) { // L: 241
        ...
        if (var5 == 0) { // L: 328
          ...
          if (Client.localPlayerIndex != var1
              || var4.x >= 1536 && var4.y >= 1536 && var4.x < 11776 && var4.y < 11776) { // L: 337
            if (var2) { // L: 341
          ...
          var11 = (var9 + WorldMapSprite.baseY + var4.pathY[0] & 16383)
              - WorldMapSprite.baseY; // L: 359
          if (Client.localPlayerIndex == var1 && (var4.x < 1536 || var4.y < 1536 || var4.x >= 11776
              || var4.y >= 11776)) { // L: 360
