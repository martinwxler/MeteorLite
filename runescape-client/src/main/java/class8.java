...
public class class8 extends class14 {
  ...
  static int method102(int var0, Script var1, boolean var2) {
    if (var0 == ScriptOpcodes.WORLDLIST_FETCH) { // L: 3643
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
          FaceNormal.loadWorlds() ? 1 : 0; // L: 3644
      return 1; // L: 3645
    } else {
      World var9;
      if (var0 == ScriptOpcodes.WORLDLIST_START) { // L: 3647
        ...
        if (var9 != null) { // L: 3649
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
              - 1] = var9.id; // L: 3650
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
              - 1] = var9.properties; // L: 3651
          Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
              - 1] = var9.activity; // L: 3652
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
              - 1] = var9.location; // L: 3653
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
              - 1] = var9.population; // L: 3654
          Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
              - 1] = var9.host; // L: 3655
        } else {
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
        ...
        if (var9 != null) { // L: 3669
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
              - 1] = var9.id; // L: 3670
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
              - 1] = var9.properties; // L: 3671
          Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
              - 1] = var9.activity; // L: 3672
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
              - 1] = var9.location; // L: 3673
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
              - 1] = var9.population; // L: 3674
          Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
              - 1] = var9.host; // L: 3675
        } else {
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
        ...
        if (var0 == ScriptOpcodes.WORLDLIST_SPECIFIC) { // L: 3687
          ...
          if (var7 != null) { // L: 3696
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = var7.id; // L: 3697
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = var7.properties; // L: 3698
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                - 1] = var7.activity; // L: 3699
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = var7.location; // L: 3700
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
          ...
          boolean var10 = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize + 1]
              == 1; // L: 3717
          var8 = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
              + 2]; // L: 3718
          boolean var6 = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize + 3]
              == 1; // L: 3719
            ...
            if (var0 == ScriptOpcodes.NC_PARAM) { // L: 3748
              ...
              if (var5.isString()) { // L: 3753
                Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                    ...
                    .getStringParam(var4, var5.defaultStr); // L: 3754
              } else {
                Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                    - 1] = class248.getNpcDefinition(var3)
                    .getIntParam(var4, var5.defaultInt); // L: 3757
              }
              ...
              if (var5.isString()) { // L: 3766
                Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                    - 1] = Tiles.getObjectDefinition(var3)
                    .getStringParam(var4, var5.defaultStr); // L: 3767
              } else {
                Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = Tiles
                    .getObjectDefinition(var3).getIntParam(var4, var5.defaultInt); // L: 3770
              }
              ...
              if (var5.isString()) { // L: 3779
                Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                    - 1] = class250.ItemDefinition_get(var3)
                    .getStringParam(var4, var5.defaultStr); // L: 3780
              } else {
                Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                    - 1] = class250.ItemDefinition_get(var3)
                    .getIntParam(var4, var5.defaultInt); // L: 3783
              }
              ...
              if (var5.isString()) { // L: 3792
                Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                    - 1] = UserComparator10.StructDefinition_getStructDefinition(var3)
                    .getStringParam(var4, var5.defaultStr); // L: 3793
              } else {
                Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                    - 1] = UserComparator10.StructDefinition_getStructDefinition(var3)
                    .getIntParam(var4, var5.defaultInt); // L: 3796
              }

              return 1; // L: 3798
            } else if (var0 == ScriptOpcodes.ON_MOBILE) { // L: 3800
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                  Client.onMobile ? 1 : 0; // L: 3801
              return 1; // L: 3802
            } else if (var0 == ScriptOpcodes.CLIENTTYPE) { // L: 3804
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                  Client.clientType & 3; // L: 3805
              return 1; // L: 3806
          ...
          if (var3 >= 0 && var3 < World.World_count) { // L: 3725
            ...
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = var7.id; // L: 3727
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = var7.properties; // L: 3728
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                - 1] = var7.activity; // L: 3729
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = var7.location; // L: 3730
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = var7.population; // L: 3731
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                - 1] = var7.host; // L: 3732
          } else {
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
  ...
  static final void runIntfCloseListeners(int var0, int var1) {
    if (class20.loadInterface(var0)) { // L: 10864
      JagexCache.runComponentCloseListeners(
          GrandExchangeOfferOwnWorldComparator.Widget_interfaceComponents[var0], var1); // L: 10865
    }
  } // L: 10866
