...
public class class15 extends class14 {
  ...
  public static Frames method240(AbstractArchive var0, AbstractArchive var1, int var2,
      boolean var3) {
  ...
  static final void method241(int var0, int var1) {
    if (Client.menuOptionsCount >= 2 || Client.isItemSelected != 0
        || Client.isSpellSelected) { // L: 7744
      if (Client.showMouseOverText) { // L: 7745
        ...
        if (Client.menuOptionsCount > 2) { // L: 7751
          var3 = var3 + SecureRandomFuture.colorStartTag(16777215) + " " + '/' + " " + (
              Client.menuOptionsCount - 2) + " more options";
        }

        class309.fontBold12.drawRandomAlphaAndSpacing(var3, var0 + 4, var1 + 15, 16777215, 0,
            Client.cycle / 1000); // L: 7752
      }
    }
  } // L: 7753
