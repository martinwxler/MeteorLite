...
public class ClanSettings {
  ...
  static void queueSoundEffect(int var0, int var1, int var2) {
    if (class4.clientPreferences.soundEffectsVolume != 0 && var1 != 0
        && Client.soundEffectCount < 50) { // L: 3774
  ...
  void method121(int var1) {
    if (this.useHashes) { // L: 47
      if (this.memberHashes != null) { // L: 48
        System.arraycopy(this.memberHashes, 0, this.memberHashes = new long[var1], 0,
            this.memberCount);
      } else {
    ...
    if (this.useNames) { // L: 51
      if (this.memberNames != null) { // L: 52
        System.arraycopy(this.memberNames, 0, this.memberNames = new String[var1], 0,
            this.memberCount);
      } else {
    ...
    if (this.memberRanks != null) {
      System.arraycopy(this.memberRanks, 0, this.memberRanks = new byte[var1], 0,
          this.memberCount); // L: 55
    } else {
  ...
  public Integer getTitleGroupValue(int var1) {
    if (this.parameters == null) { // L: 90
      ...
      return var2 != null && var2 instanceof IntegerNode ? new Integer(((IntegerNode) var2).integer)
          : null; // L: 92 93
    }
  }
  ...
  void method126(long var1, String var3, int var4) {
    ...
    if (var1 > 0L != this.useHashes) { // L: 115
      ...
      if (var1 > 0L && (this.memberHashes == null || this.memberCount >= this.memberHashes.length)
          || var3 != null && (this.memberNames == null
          || this.memberCount >= this.memberNames.length)) { // L: 117
  ...
  void method127(int var1) {
    if (var1 >= 0 && var1 < this.memberCount) { // L: 135
      ...
      if (this.memberCount == 0) { // L: 138
        ...
        System.arraycopy(this.memberRanks, var1 + 1, this.memberRanks, var1,
            this.memberCount - var1); // L: 149
        System.arraycopy(this.field95, var1 + 1, this.field95, var1,
            this.memberCount - var1); // L: 150
        System.arraycopy(this.field96, var1 + 1, this.field96, var1,
            this.memberCount - var1); // L: 151
        System.arraycopy(this.field97, var1 + 1, this.field97, var1,
            this.memberCount - var1); // L: 152
        if (this.memberHashes != null) { // L: 153
          System.arraycopy(this.memberHashes, var1 + 1, this.memberHashes, var1,
              this.memberCount - var1);
        }

        if (this.memberNames != null) { // L: 154
          System.arraycopy(this.memberNames, var1 + 1, this.memberNames, var1,
              this.memberCount - var1);
        }
  ...
  void method129(long var1, String var3) {
    ...
    if (var1 > 0L != this.useHashes) { // L: 185
      ...
      if (var1 > 0L && (this.bannedMemberHashes == null
          || this.bannedMemberCount >= this.bannedMemberHashes.length) || var3 != null && (
          this.bannedMemberNames == null
              || this.bannedMemberCount >= this.bannedMemberNames.length)) { // L: 187
    ...
    if (this.bannedMemberCount == 0) { // L: 195
      ...
      if (this.bannedMemberNames != null) {
        System.arraycopy(this.bannedMemberNames, var1 + 1, this.bannedMemberNames, var1,
            this.bannedMemberCount - var1); // L: 201
      }
    }
  ...
  int method131(int var1, byte var2) {
    if (var2 != 126 && var2 != 127) { // L: 206
      if (this.currentOwner == var1 && (this.field99 == -1
          || this.memberRanks[this.field99] < 125)) { // L: 207
        return -1;
  ...
  void method139(Buffer var1) {
    ...
    if (var2 >= 1 && var2 <= 6) { // L: 327
      ...
      if (this.memberCount > 0) { // L: 353
        if (this.useHashes && (this.memberHashes == null
            || this.memberHashes.length < this.memberCount)) { // L: 354
          this.memberHashes = new long[this.memberCount];
        }

        if (this.useNames && (this.memberNames == null
            || this.memberNames.length < this.memberCount)) { // L: 355
      ...
      if (this.bannedMemberCount > 0) { // L: 372
        if (this.useHashes && (this.bannedMemberHashes == null
            || this.bannedMemberHashes.length < this.bannedMemberCount)) { // L: 373
          this.bannedMemberHashes = new long[this.bannedMemberCount];
        }

        if (this.useNames && (this.bannedMemberNames == null
            || this.bannedMemberNames.length < this.bannedMemberCount)) { // L: 374
      ...
      if (var2 >= 3) { // L: 380
        ...
        if (var4 > 0) { // L: 382
          this.parameters = new IterableNodeHashTable(
              var4 < 16 ? UrlRequester.method2504(var4) : 16); // L: 383
