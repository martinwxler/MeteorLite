...
public class ItemContainer extends Node {
  ...
  public static boolean method2181(char var0) {
    if (var0 >= ' ' && var0 < 127 || var0 > 127 && var0 < 160
        || var0 > 160 && var0 <= 255) { // L: 61
      return true;
    } else {
      if (var0 != 0) { // L: 62
  ...
  static final int getTileHeight(int var0, int var1, int var2) {
    ...
    if (var3 >= 0 && var4 >= 0 && var3 <= 103 && var4 <= 103) { // L: 5463
      ...
      int var8 =
          (128 - var6) * Tiles.Tiles_heights[var5][var3][var4] + var6 * Tiles.Tiles_heights[var5][
              var3 + 1][var4] >> 7; // L: 5468
      int var9 = Tiles.Tiles_heights[var5][var3 + 1][var4 + 1] * var6
          + Tiles.Tiles_heights[var5][var3][var4 + 1] * (128 - var6) >> 7; // L: 5469
