...
public abstract class class16 extends Node {
  ...
  static final void updateNpcs(boolean var0, PacketBuffer var1) {
    ...
    while (var1.bitsRemaining(Client.packetWriter.serverPacketLength) >= 27) { // L: 7485
      ...
      var4.method2347(class262.localPlayer.pathX[0] + var6, class262.localPlayer.pathY[0] + var7,
          var5 == 1); // L: 7535
    }
    ...
    for (var2 = 0; var2 < Client.field636; ++var2) { // L: 7540
      ...
      if ((var5 & 16) != 0) { // L: 7563
        ...
        } else if (var6 == -1 || var4.sequence == -1
            || WorldMapScaleHandler.SequenceDefinition_get(var6).field1892 >= WorldMapScaleHandler
            .SequenceDefinition_get(var4.sequence).field1892) { // L: 7579
