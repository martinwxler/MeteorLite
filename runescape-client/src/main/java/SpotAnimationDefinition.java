...
public class SpotAnimationDefinition extends DualNode {
  ...
  public static final SpritePixels getItemSprite(int var0, int var1, int var2, int var3, int var4,
      boolean var5) {
    if (var1 == -1) { // L: 357
      var4 = 0;
    ...
    long var6 =
        ((long) var4 << 40) + ((long) var2 << 38) + ((long) var1 << 16) + (long) var0 + ((long) var3
            << 42); // L: 359
    SpritePixels var8;
    if (!var5) { // L: 361
    ...
    if (var19 == null) { // L: 374
      ...
      var19.method4347(0, var9.yan2d, var9.zan2d, var9.xan2d, var9.offsetX2d,
          var19.height / 2 + var17 + var9.offsetY2d, var18 + var9.offsetY2d); // L: 406
      ...
      if (var4 == 1 || var4 == 2 && var9.isStackable == 1) { // L: 413
        ItemComposition.ItemDefinition_fontPlain11
            .draw(MenuAction.method2026(var1), 0, 9, 16776960, 1); // L: 414
      }
  ...
  public final Model getModel(int var1) {
    ...
    if (var2 == null) { // L: 86
      ModelData var3 = ModelData
          .ModelData_get(SpotAnimationDefinition_modelArchive, this.archive, 0); // L: 87
      if (var3 == null) { // L: 88
        return null;
      }
    ...
    if (this.sequence != -1 && var1 != -1) { // L: 103
      var5 = WorldMapScaleHandler.SequenceDefinition_get(this.sequence)
          .transformSpotAnimationModel(var2, var1);
    } else {
