...
public abstract class AbstractFont extends Rasterizer2D {
  ...
  @ObfuscatedName("h")
  static int method5476(byte[][] var0, byte[][] var1, int[] var2, int[] var3, int[] var4, int var5,
      int var6) {
  ...
  static void AbstractFont_drawGlyph(byte[] var0, int var1, int var2, int var3, int var4,
      int var5) {
    ...
    if (var3 > 0 && var4 > 0) { // L: 594
      AbstractFont_placeGlyph(Rasterizer2D.Rasterizer2D_pixels, var0, var5, var9, var6, var3, var4,
          var7, var8); // L: 595
    }
  } // L: 596
  ...
  static void AbstractFont_placeGlyph(int[] var0, byte[] var1, int var2, int var3, int var4,
  ...
  static void AbstractFont_drawGlyphAlpha(byte[] var0, int var1, int var2, int var3, int var4,
      int var5, int var6) {
    ...
    if (var3 > 0 && var4 > 0) { // L: 649
      AbstractFont_placeGlyphAlpha(Rasterizer2D.Rasterizer2D_pixels, var0, var5, var10, var7, var3,
  ...
  static void AbstractFont_placeGlyphAlpha(int[] var0, byte[] var1, int var2, int var3, int var4,
      int var5, int var6, int var7, int var8, int var9) {
    var2 =
        ((var2 & 65280) * var9 & 16711680) + (var9 * (var2 & 16711935) & -16711936) >> 8; // L: 654
    var9 = 256 - var9; // L: 655
    ...
    for (int var10 = -var6; var10 < 0; ++var10) { // L: 656
      for (int var11 = -var5; var11 < 0; ++var11) { // L: 657
        if (var1[var3++] != 0) { // L: 658
          ...
          var0[var4++] =
              (((var12 & 65280) * var9 & 16711680) + ((var12 & 16711935) * var9 & -16711936) >> 8)
                  + var2; // L: 660
        } else {
          ++var4; // L: 662
        }
  ...
  abstract void drawGlyphAlpha(byte[] var1, int var2, int var3, int var4, int var5, int var6,
      int var7);
        ...
        if (var13 != 32 && var13 != 160) { // L: 89
          for (var8 = 0; var8 < 256; ++var8) { // L: 90
            if (var8 != 32 && var8 != 160) { // L: 91
              this.kerning[var8 + (var13 << 8)] = (byte) method5476(var11, var12, var4,
                  this.advances, var10, var13, var8); // L: 92
            }
          }
        }
      }
  ...
  @ObfuscatedName("s")
  @Export("drawLines")
  public int drawLines(String var1, int var2, int var3, int var4, int var5, int var6, int var7,
    ...
    if (var1 == null) { // L: 304
      ...
      if (var9 == 0) { // L: 312
        ...
        var13 = var3 + (var5 - this.maxAscent - this.maxDescent - var10 * (var12 - 1)) / 2
            + this.maxAscent;
      } else if (var9 == 2) { // L: 314
        var13 = var3 + var5 - this.maxDescent - var10 * (var12 - 1);
      } else {
        var14 =
            (var5 - this.maxAscent - this.maxDescent - var10 * (var12 - 1)) / (var12 + 1); // L: 316
        if (var14 < 0) { // L: 317
          var14 = 0;
        }
      ...
      for (var14 = 0; var14 < var12; ++var14) { // L: 321
        if (var8 == 0) {
          ...
          this.draw0(AbstractFont_lines[var14],
              var2 + (var4 - this.stringWidth(AbstractFont_lines[var14])) / 2, var13);
        } else if (var8 == 2) { // L: 324
          this.draw0(AbstractFont_lines[var14],
              var2 + var4 - this.stringWidth(AbstractFont_lines[var14]), var13);
  ...
  public void drawCenteredWave(String var1, int var2, int var3, int var4, int var5, int var6) {
    if (var1 != null) { // L: 339
      ...
      this.drawWithOffsets0(var1, var2 - this.stringWidth(var1) / 2, var3, (int[]) null,
          var7); // L: 343
    }
  } // L: 344
  ...
  public void drawCenteredShake(String var1, int var2, int var3, int var4, int var5, int var6,
      int var7) {
    if (var1 != null) { // L: 359
  ...
  public void drawRandomAlphaAndSpacing(String var1, int var2, int var3, int var4, int var5,
      int var6) {
    if (var1 != null) { // L: 369
        ...
        if (var7 == '<') { // L: 429
          ...
          if (var4 == -1) { // L: 455
            ...
            if (var7 != ' ') { // L: 459
              if (AbstractFont_alpha == 256) { // L: 460
                ...
                this.drawGlyph(this.pixels[var7], var2 + this.leftBearings[var7],
                    var3 + this.topBearings[var7], var12, var9, AbstractFont_color); // L: 462
              } else {
            ...
            if (AbstractFont_strike != -1) { // L: 477
              Rasterizer2D
                  .Rasterizer2D_drawHorizontalLine(var2, var3 + (int) ((double) this.ascent * 0.7D),
                      var13, AbstractFont_strike);
            }
        ...
        if (var10 == '<') { // L: 493
              ...
              if (!var11.equals("gt")) { // L: 501
                if (var11.startsWith("img=")) { // L: 502
                  try {
                    ...
                    var15.drawAt(var12 + var2,
                        var13 + (var3 + this.ascent - var15.height)); // L: 513
          ...
          if (var6 == -1) { // L: 526
            ...
            if (var10 != ' ') { // L: 537
              if (AbstractFont_alpha == 256) { // L: 538
                if (AbstractFont_shadow != -1) { // L: 539
                  AbstractFont_drawGlyph(this.pixels[var10],
                      var13 + var2 + this.leftBearings[var10] + 1,
                      var3 + var14 + this.topBearings[var10] + 1, var17, var12,
                      AbstractFont_shadow);
                }

                this.drawGlyph(this.pixels[var10], var13 + var2 + this.leftBearings[var10],
                    var3 + var14 + this.topBearings[var10], var17, var12,
                    AbstractFont_color); // L: 540
              } else {
                if (AbstractFont_shadow != -1) { // L: 543
                  AbstractFont_drawGlyphAlpha(this.pixels[var10],
                      var13 + var2 + this.leftBearings[var10] + 1,
                      var3 + var14 + this.topBearings[var10] + 1, var17, var12, AbstractFont_shadow,
                      AbstractFont_alpha);
                }

                this.drawGlyphAlpha(this.pixels[var10], var13 + var2 + this.leftBearings[var10],
                    var3 + var14 + this.topBearings[var10], var17, var12, AbstractFont_color,
                    AbstractFont_alpha); // L: 544
              }
            ...
            if (AbstractFont_strike != -1) { // L: 555
              Rasterizer2D
                  .Rasterizer2D_drawHorizontalLine(var2, var3 + (int) ((double) this.ascent * 0.7D),
                      var18, AbstractFont_strike);
            }

            if (AbstractFont_underline != -1) { // L: 556
              Rasterizer2D.Rasterizer2D_drawHorizontalLine(var2, var3 + this.ascent, var18,
                  AbstractFont_underline);
            }
