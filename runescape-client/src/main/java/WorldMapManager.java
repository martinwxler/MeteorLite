...
public final class WorldMapManager {
  ...
  public WorldMapManager(IndexedSprite[] var1, HashMap var2, AbstractArchive var3,
      AbstractArchive var4) {
  ...
  static void method3538(GameEngine var0) {
    while (SecureRandomCallable.isKeyDown()) { // L: 1409
      if (SoundCache.field446 == 13) { // L: 1410
        ...
        Messages.logoSprite
            .drawAt(Login.xPadding + 382 - Messages.logoSprite.subWidth / 2, 18); // L: 1415
        return; // L: 1417
      }
      ...
      } else if (SoundCache.field446 == 97 && Login.worldSelectPage < Login.worldSelectPagesCount
          && class12.worldSelectRightSprite != null) { // L: 1424 1425
        ++Login.worldSelectPage; // L: 1426
      }
    }

    if (MouseHandler.MouseHandler_lastButton == 1
        || !UserComparator3.mouseCam && MouseHandler.MouseHandler_lastButton == 4) { // L: 1430
      int var1 = Login.xPadding + 280; // L: 1431
      if (MouseHandler.MouseHandler_lastPressedX >= var1
          && MouseHandler.MouseHandler_lastPressedX <= var1 + 14
          && MouseHandler.MouseHandler_lastPressedY >= 4
          && MouseHandler.MouseHandler_lastPressedY <= 18) { // L: 1432
        World.changeWorldSelectSorting(0, 0); // L: 1433
        return; // L: 1434
      }

      if (MouseHandler.MouseHandler_lastPressedX >= var1 + 15
          && MouseHandler.MouseHandler_lastPressedX <= var1 + 80
          && MouseHandler.MouseHandler_lastPressedY >= 4
          && MouseHandler.MouseHandler_lastPressedY <= 18) { // L: 1436
        World.changeWorldSelectSorting(0, 1); // L: 1437
        return; // L: 1438
      }

      int var2 = Login.xPadding + 390; // L: 1440
      if (MouseHandler.MouseHandler_lastPressedX >= var2
          && MouseHandler.MouseHandler_lastPressedX <= var2 + 14
          && MouseHandler.MouseHandler_lastPressedY >= 4
          && MouseHandler.MouseHandler_lastPressedY <= 18) { // L: 1441
      ...
      if (MouseHandler.MouseHandler_lastPressedX >= var2 + 15
          ...
          && MouseHandler.MouseHandler_lastPressedY >= 4
          && MouseHandler.MouseHandler_lastPressedY <= 18) { // L: 1445
        World.changeWorldSelectSorting(1, 1); // L: 1446
        return; // L: 1447
      }

      int var3 = Login.xPadding + 500; // L: 1449
      if (MouseHandler.MouseHandler_lastPressedX >= var3
          && MouseHandler.MouseHandler_lastPressedX <= var3 + 14
          && MouseHandler.MouseHandler_lastPressedY >= 4
          && MouseHandler.MouseHandler_lastPressedY <= 18) { // L: 1450
      ...
      if (MouseHandler.MouseHandler_lastPressedX >= var3 + 15
          ...
          && MouseHandler.MouseHandler_lastPressedY >= 4
          && MouseHandler.MouseHandler_lastPressedY <= 18) { // L: 1454
        World.changeWorldSelectSorting(2, 1); // L: 1455
        return; // L: 1456
      }

      int var4 = Login.xPadding + 610; // L: 1458
      if (MouseHandler.MouseHandler_lastPressedX >= var4
          && MouseHandler.MouseHandler_lastPressedX <= var4 + 14
          && MouseHandler.MouseHandler_lastPressedY >= 4
          && MouseHandler.MouseHandler_lastPressedY <= 18) { // L: 1459
      ...
      if (MouseHandler.MouseHandler_lastPressedX >= var4 + 15
          ...
          && MouseHandler.MouseHandler_lastPressedY >= 4
          && MouseHandler.MouseHandler_lastPressedY <= 18) { // L: 1463
      ...
      if (MouseHandler.MouseHandler_lastPressedX >= Login.xPadding + 708
          ...
          && MouseHandler.MouseHandler_lastPressedY <= 20) { // L: 1467
        ...
        Messages.logoSprite
            .drawAt(Login.xPadding + 382 - Messages.logoSprite.subWidth / 2, 18); // L: 1472
        return; // L: 1474
      }
      ...
      if (Login.hoveredWorldIndex != -1) { // L: 1476
        ...
        Messages.logoSprite
            .drawAt(Login.xPadding + 382 - Messages.logoSprite.subWidth / 2, 18); // L: 1483
        return; // L: 1485
      }

      if (Login.worldSelectPage > 0 && NetCache.worldSelectLeftSprite != null
          && MouseHandler.MouseHandler_lastPressedX >= 0
          && MouseHandler.MouseHandler_lastPressedX <= NetCache.worldSelectLeftSprite.subWidth
          && MouseHandler.MouseHandler_lastPressedY >= class0.canvasHeight / 2 - 50
          && MouseHandler.MouseHandler_lastPressedY <= class0.canvasHeight / 2 + 50) { // L: 1487
        --Login.worldSelectPage; // L: 1488
      }

      if (Login.worldSelectPage < Login.worldSelectPagesCount
          && class12.worldSelectRightSprite != null && MouseHandler.MouseHandler_lastPressedX
          >= AttackOption.canvasWidth - class12.worldSelectRightSprite.subWidth - 5
          && MouseHandler.MouseHandler_lastPressedX <= AttackOption.canvasWidth
          && MouseHandler.MouseHandler_lastPressedY >= class0.canvasHeight / 2 - 50
          && MouseHandler.MouseHandler_lastPressedY <= class0.canvasHeight / 2 + 50) { // L: 1490
  ...
  public void load(AbstractArchive var1, String var2, boolean var3) {
    if (!this.loadStarted) { // L: 41
      ...
      Buffer var6 = new Buffer(
          var1.takeFileByNames(WorldMapCacheName.field2131.name, var2)); // L: 49
      Buffer var7 = new Buffer(
          var1.takeFileByNames(WorldMapCacheName.field2134.name, var2)); // L: 50
      ...
      this.tileWidth =
          (this.mapAreaData.getRegionHighX() - this.mapAreaData.getRegionLowX() + 1) * 64; // L: 65
      this.tileHeight =
          (this.mapAreaData.getRegionHighY() - this.mapAreaData.getRegionLowY() + 1) * 64; // L: 66
      ...
      while (var10.hasNext()) {
        ...
        this.regions[var14][var15] = new WorldMapRegion(var12, var13,
            this.mapAreaData.getBackGroundColor(), this.fonts); // L: 80
      ...
      for (int var17 = 0; var17 < var16; ++var17) { // L: 84
        for (int var18 = 0; var18 < var9; ++var18) { // L: 85
          if (this.regions[var17][var18] == null) { // L: 86
            this.regions[var17][var18] = new WorldMapRegion(
                this.mapAreaData.getRegionLowX() + var17, this.mapAreaData.getRegionLowY() + var18,
                this.mapAreaData.getBackGroundColor(), this.fonts); // L: 87
            this.regions[var17][var18].initWorldMapData1(this.mapAreaData.worldMapData1Set,
                this.mapAreaData.iconList); // L: 88
          }
        }
      }
  ...
  @Export("drawTiles")
  public final void drawTiles(int var1, int var2, int var3, int var4, int var5, int var6, int var7,
      int var8) {
    ...
    for (var18 = var13.x; var18 <= var23; ++var18) { // L: 125
      for (var19 = var13.y; var19 <= var17; ++var19) { // L: 126
        this.regions[var18][var19]
            .drawTile(var15, (WorldMapScaleHandler) this.scaleHandlers.get(var15),
                this.mapSceneSprites, this.geographyArchive, this.groundArchive); // L: 127
      }
    }
    ...
    for (int var21 = var13.x; var21 < var13.x + var13.width; ++var21) { // L: 135
      for (int var22 = var13.y; var22 < var13.y + var13.height; ++var22) { // L: 136
        this.regions[var21][var22]
            .method3407(var5 + (this.regions[var21][var22].regionX * 64 - var19) * var18 / 64,
                var8 - (this.regions[var21][var22].regionY * 64 - var20 + 64) * var18 / 64,
                var18); // L: 137
      }
    }
  ...
  @Export("drawElements")
  public final void drawElements(int var1, int var2, int var3, int var4, int var5, int var6,
      int var7, int var8, HashSet var9, HashSet var10, int var11, int var12, boolean var13) {
    ...
    for (var19 = var14.x; var19 < var14.x + var14.width; ++var19) { // L: 148
      for (var20 = var14.y; var20 < var14.height + var14.y; ++var20) { // L: 149
        ...
        this.regions[var19][var20]
            .method3417(var5 + (this.regions[var19][var20].regionX * 64 - var17) * var16 / 64,
                var8 - (this.regions[var19][var20].regionY * 64 - var18 + 64) * var16 / 64, var16,
                var9); // L: 153
      }
    }
  ...
  @Export("drawOverview")
  public void drawOverview(int var1, int var2, int var3, int var4, HashSet var5, int var6,
      int var7) {
      ...
      if (var6 > 0 && var6 % var7 < var7 / 2) { // L: 170
        ...
        while (true) {
          ...
          while (var11.hasNext()) { // L: 183
            ...
            Rasterizer2D.Rasterizer2D_drawCircleAlpha(var13 + var1, var14 + var2, 2, 16776960,
                256); // L: 188
          }
        }
      }
  ...
  public List method3526(int var1, int var2, int var3, int var4, int var5, int var6, int var7,
      ...
      for (int var17 = var12.x; var17 < var12.width + var12.x; ++var17) { // L: 205
        for (int var18 = var12.y; var18 < var12.y + var12.height; ++var18) { // L: 206
          List var19 = this.regions[var17][var18]
              .method3437(var5 + (this.regions[var17][var18].regionX * 64 - var15) * var14 / 64,
                  var8 + var6 - (this.regions[var17][var18].regionY * 64 - var16 + 64) * var14 / 64,
                  var14, var9, var10); // L: 207
