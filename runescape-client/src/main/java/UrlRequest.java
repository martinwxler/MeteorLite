...
public class UrlRequest {
  ...
  static void method2519(int var0, int var1, int var2, int var3) {
    for (ObjectSound var4 = (ObjectSound) ObjectSound.objectSounds.last(); var4 != null;
        var4 = (ObjectSound) ObjectSound.objectSounds.previous()) { // L: 85
      if (var4.soundEffectId != -1 || var4.soundEffectIds != null) { // L: 86
        ...
        if (var5 - 64 <= var4.field939 && class4.clientPreferences.areaSoundEffectsVolume != 0
            && var0 == var4.plane) { // L: 92
          var5 -= 64; // L: 103
          if (var5 < 0) { // L: 104
            var5 = 0;
          }

          int var6 = (var4.field939 - var5) * class4.clientPreferences.areaSoundEffectsVolume
              / var4.field939; // L: 105
          if (var4.stream1 == null) { // L: 106
            if (var4.soundEffectId >= 0) { // L: 107
              SoundEffect var7 = SoundEffect
                  .readSoundEffect(class26.archive4, var4.soundEffectId, 0); // L: 108
              if (var7 != null) { // L: 109
          ...
          if (var4.stream2 == null) { // L: 119
            if (var4.soundEffectIds != null && (var4.field945 -= var3) <= 0) { // L: 120
              ...
              SoundEffect var12 = SoundEffect
                  .readSoundEffect(class26.archive4, var4.soundEffectIds[var11], 0); // L: 122
              if (var12 != null) { // L: 123
                ...
                var4.field945 = var4.field941 + (int) (Math.random() * (double) (var4.field943
                    - var4.field941)); // L: 129
              }
            }
          } else {
  ...
  static Archive newArchive(int var0, boolean var1, boolean var2, boolean var3) {
    ...
    if (JagexCache.JagexCache_dat2File != null) { // L: 2420
      var4 = new ArchiveDisk(var0, JagexCache.JagexCache_dat2File,
          class369.JagexCache_idxFiles[var0], 1000000);
    }
      ...
      if (class226.field2693 == var0) { // L: 7042
        ...
        if (var6 >= 0 && var7 >= 0 && var6 < 104 && var7 < 104) { // L: 7049
          ...
          if (var42 != null) { // L: 7051
            for (TileItem var36 = (TileItem) var42.last(); var36 != null;
                var36 = (TileItem) var42.previous()) { // L: 7052 7053 7058
        ...
        if (class226.field2683 == var0) { // L: 7065
          ...
          if (var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104) { // L: 7074
            class375
                .updatePendingSpawn(SoundSystem.Client_plane, var3, var4, var9, var5, var7, var8, 0,
                    -1); // L: 7075
          }
          ...
          if (var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104) { // L: 7084
            ...
            if (var34 != null) { // L: 7086
              for (var35 = (TileItem) var34.last(); var35 != null;
                  var35 = (TileItem) var34.previous()) { // L: 7087 7088 7093
          ...
          if (class226.field2686 == var0) { // L: 7101
            ...
            if (var3 >= 0 && var4 >= 0 && var3 < 103 && var4 < 103) { // L: 7110
              if (var8 == 0) { // L: 7111
                BoundaryObject var33 = DevicePcmPlayerProvider.scene
                    .method4058(SoundSystem.Client_plane, var3, var4); // L: 7112
                if (var33 != null) { // L: 7113
                  var11 = Message.Entity_unpackID(var33.tag); // L: 7114
                  if (var6 == 2) { // L: 7115
                    var33.renderable1 = new DynamicObject(var11, 2, var7 + 4,
                        SoundSystem.Client_plane, var3, var4, var9, false,
                        var33.renderable1); // L: 7116
                    var33.renderable2 = new DynamicObject(var11, 2, var7 + 1 & 3,
                        SoundSystem.Client_plane, var3, var4, var9, false,
                        var33.renderable2); // L: 7117
                  } else {
                    var33.renderable1 = new DynamicObject(var11, var6, var7,
                        SoundSystem.Client_plane, var3, var4, var9, false,
                        var33.renderable1); // L: 7119
                  }
                }
              }

              if (var8 == 1) { // L: 7122
                WallDecoration var43 = DevicePcmPlayerProvider.scene
                    .method4059(SoundSystem.Client_plane, var3, var4); // L: 7123
                  ...
                  if (var6 != 4 && var6 != 5) { // L: 7126
                    if (var6 == 6) { // L: 7127
                      var43.renderable1 = new DynamicObject(var11, 4, var7 + 4,
                          SoundSystem.Client_plane, var3, var4, var9, false, var43.renderable1);
                    } else if (var6 == 7) { // L: 7128
                      var43.renderable1 = new DynamicObject(var11, 4, (var7 + 2 & 3) + 4,
                          SoundSystem.Client_plane, var3, var4, var9, false, var43.renderable1);
                    } else if (var6 == 8) { // L: 7129
                      var43.renderable1 = new DynamicObject(var11, 4, var7 + 4,
                          SoundSystem.Client_plane, var3, var4, var9, false,
                          var43.renderable1); // L: 7130
                      var43.renderable2 = new DynamicObject(var11, 4, (var7 + 2 & 3) + 4,
                          SoundSystem.Client_plane, var3, var4, var9, false,
                          var43.renderable2); // L: 7131
                    }
                  } else {
                    var43.renderable1 = new DynamicObject(var11, 4, var7, SoundSystem.Client_plane,
                        var3, var4, var9, false, var43.renderable1);
                  }
                }
              }

              if (var8 == 2) { // L: 7135
                GameObject var44 = DevicePcmPlayerProvider.scene
                    .method4094(SoundSystem.Client_plane, var3, var4); // L: 7136
                if (var6 == 11) { // L: 7137
                  var6 = 10;
                }

                if (var44 != null) { // L: 7138
                  var44.renderable = new DynamicObject(Message.Entity_unpackID(var44.tag), var6,
                      var7, SoundSystem.Client_plane, var3, var4, var9, false, var44.renderable);
                }
              }

              if (var8 == 3) { // L: 7140
                FloorDecoration var45 = DevicePcmPlayerProvider.scene
                    .getFloorDecoration(SoundSystem.Client_plane, var3, var4); // L: 7141
                if (var45 != null) {
                  var45.renderable = new DynamicObject(Message.Entity_unpackID(var45.tag), 22, var7,
                      SoundSystem.Client_plane, var3, var4, var9, false,
                      var45.renderable); // L: 7142
                }
              }
            }
            ...
            if (class226.field2688 == var0) { // L: 7147
              ...
              if (var4 >= 0 && var5 >= 0 && var4 < 104 && var5 < 104) { // L: 7156
                var10 = var8 + 1; // L: 7157
                if (class262.localPlayer.pathX[0] >= var4 - var10
                    && class262.localPlayer.pathX[0] <= var4 + var10
                    && class262.localPlayer.pathY[0] >= var5 - var10
                    && class262.localPlayer.pathY[0] <= var10 + var5
                    && class4.clientPreferences.areaSoundEffectsVolume != 0 && var9 > 0
                    && Client.soundEffectCount < 50) { // L: 7158 7159
                  ...
                  Client.soundLocations[Client.soundEffectCount] =
                      var8 + (var5 << 8) + (var4 << 16); // L: 7164
            ...
            if (class226.field2690 == var0) { // L: 7170
              ...
              if (class226.field2691 == var0) { // L: 7183
                ...
                if (var17 != null) { // L: 7202
                  ...
                  int var26 = var25[var22][var24] + var25[var22][var23] + var25[var21][var23]
                      + var25[var21][var24] >> 2; // L: 7219
                  ...
                  if (var29 != null) { // L: 7223
                    class375
                        .updatePendingSpawn(SoundSystem.Client_plane, var5, var6, var12, -1, 0, 0,
                            var14 + 1, var16 + 1); // L: 7224
              ...
              if (class226.field2689 == var0) { // L: 7248
                ...
                if (var9 >= 0 && var10 >= 0 && var9 < 104 && var10 < 104 && var3 >= 0 && var12 >= 0
                    && var3 < 104 && var12 < 104 && var7 != 65535) { // L: 7264
                  var9 = var9 * 128 + 64; // L: 7265
                  var10 = var10 * 128 + 64; // L: 7266
                  var3 = var3 * 128 + 64; // L: 7267
                  var12 = var12 * 128 + 64; // L: 7268
                  Projectile var32 = new Projectile(var7, SoundSystem.Client_plane, var9, var10,
                      ItemContainer.getTileHeight(var9, var10, SoundSystem.Client_plane) - var14,
                      var4 + Client.cycle, var5 + Client.cycle, var6, var11, var2,
                      var41); // L: 7269
                  var32.setDestination(var3, var12,
                      ItemContainer.getTileHeight(var3, var12, SoundSystem.Client_plane) - var41,
                      var4 + Client.cycle); // L: 7270
                ...
                if (var4 >= 0 && var5 >= 0 && var4 < 104 && var5 < 104) { // L: 7282
                  ...
                  GraphicsObject var31 = new GraphicsObject(var7, SoundSystem.Client_plane, var4,
                      var5,
                      ItemContainer.getTileHeight(var4, var5, SoundSystem.Client_plane) - var6,
                      var2, Client.cycle); // L: 7285
