...
public class Bounds {
  ...
  public static Font method6034(AbstractArchive var0, AbstractArchive var1, int var2, int var3) {
    if (!Message.method1263(var0, var2, var3)) { // L: 28
      ...
      if (var5 == null) { // L: 32
        ...
        Font var6 = new Font(var5, class397.SpriteBuffer_xOffsets, class26.SpriteBuffer_yOffsets,
            Canvas.SpriteBuffer_spriteWidths, Clock.SpriteBuffer_spriteHeights,
            class397.SpriteBuffer_spritePalette, class126.SpriteBuffer_pixels); // L: 36
  ...
  void method6010(Bounds var1, Bounds var2) {
    ...
    if (this.lowX < var1.lowX) {
      var2.highX = (var2.highX * -2021811263 - (var1.lowX * -2021811263 - this.lowX * -2021811263))
          * -259492799; // L: 41
  ...
  void method6031(Bounds var1, Bounds var2) {
    ...
    if (this.lowY < var1.lowY) { // L: 53
      var2.highY = (var2.highY * -1355515155 - (var1.lowY * -1355515155 - this.lowY * -1355515155))
          * 67302117; // L: 54
