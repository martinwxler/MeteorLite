...
public class class20 extends class16 {
  ...
  public static boolean loadInterface(int var0) {
    if (Widget.Widget_loadedInterfaces[var0]) { // L: 216
      ...
      if (var1 == 0) { // L: 219
        ...
        if (GrandExchangeOfferOwnWorldComparator.Widget_interfaceComponents[var0]
            == null) { // L: 223
          GrandExchangeOfferOwnWorldComparator.Widget_interfaceComponents[var0] = new Widget[var1];
        }

        for (int var2 = 0; var2 < var1; ++var2) { // L: 224
          if (GrandExchangeOfferOwnWorldComparator.Widget_interfaceComponents[var0][var2]
              == null) { // L: 225
            ...
            if (var3 != null) { // L: 227
              ...
              GrandExchangeOfferOwnWorldComparator.Widget_interfaceComponents[var0][var2].id =
                  var2 + (var0 << 16); // L: 229
              if (var3[0] == -1) { // L: 230
                GrandExchangeOfferOwnWorldComparator.Widget_interfaceComponents[var0][var2]
                    .decode(new Buffer(var3));
              } else {
                GrandExchangeOfferOwnWorldComparator.Widget_interfaceComponents[var0][var2]
                    .decodeLegacy(new Buffer(var3)); // L: 231
              }
            }
          }
        }
  ...
  static void Widget_runOnTargetLeave() {
    if (Client.isSpellSelected) { // L: 8796
      Widget var0 = class17
          .getWidgetChild(class15.selectedSpellWidget, Client.selectedSpellChildIndex); // L: 8797
  ...
  static final void method288() {
    PacketBufferNode var0 = InterfaceParent
        .getPacketBufferNode(ClientPacket.field2593, Client.packetWriter.isaacCipher); // L: 11242
    Client.packetWriter.addNode(var0); // L: 11243

    for (InterfaceParent var1 = (InterfaceParent) Client.interfaceParents.first(); var1 != null;
        var1 = (InterfaceParent) Client.interfaceParents.next()) { // L: 11244
