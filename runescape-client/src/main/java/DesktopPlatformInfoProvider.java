...
public class DesktopPlatformInfoProvider implements PlatformInfoProvider {
  ...
  static void method6109(AbstractArchive var0, AbstractArchive var1, boolean var2, int var3) {
    if (class377.clearLoginScreen) { // L: 124
      ...
      Coord.titleboxSprite = TextureProvider
          .SpriteBuffer_getIndexedSpriteByName(var1, "titlebox", ""); // L: 136
      class289.titlebuttonSprite = TextureProvider
          .SpriteBuffer_getIndexedSpriteByName(var1, "titlebutton", ""); // L: 137
      Login.runesSprite = WorldMapLabelSize.method3268(var1, "runes", ""); // L: 138
      GrandExchangeEvents.title_muteSprite = WorldMapLabelSize
          .method3268(var1, "title_mute", ""); // L: 139
      Login.options_buttons_0Sprite = TextureProvider
          .SpriteBuffer_getIndexedSpriteByName(var1, "options_radio_buttons,0", ""); // L: 140
      NetFileRequest.field3577 = TextureProvider
          .SpriteBuffer_getIndexedSpriteByName(var1, "options_radio_buttons,4", ""); // L: 141
      WorldMapCacheName.options_buttons_2Sprite = TextureProvider
          .SpriteBuffer_getIndexedSpriteByName(var1, "options_radio_buttons,2", ""); // L: 142
      Login.field1005 = TextureProvider
          .SpriteBuffer_getIndexedSpriteByName(var1, "options_radio_buttons,6", ""); // L: 143
      ...
      PendingSpawn.loginScreenRunesAnimation = new LoginScreenAnimation(
          Login.runesSprite); // L: 146
      if (var2) { // L: 147
      ...
      Messages.logoSprite
          .drawAt(Login.xPadding + 382 - Messages.logoSprite.subWidth / 2, 18); // L: 171
    }
  } // L: 128 172
  ...
  public PlatformInfo get() {
    ...
    return new PlatformInfo(var1, var24, var7, var8, this.field3939, this.field3937, this.field3941,
        false, var10, var11, var12, 0, var13, var14, var15, var16, 0, 0, 0, 0, var17, var18, var23,
        0, ""); // L: 97
  }
