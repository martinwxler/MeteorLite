...
public final class class32 {
    ...
    if (var0 == ScriptOpcodes.ACTIVECLANSETTINGS_FIND_LISTENED) { // L: 2455
      ...
      if (var0 == ScriptOpcodes.ACTIVECLANSETTINGS_FIND_AFFINED) { // L: 2463
        ...
        Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
            - 1] = DirectByteArrayCopier.field3128.name; // L: 2473
        return 1; // L: 2474
        ...
        Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
            - 1] = DirectByteArrayCopier.field3128.memberNames[var3]; // L: 2502
        return 1; // L: 2503
        ...
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
            - 1] = DirectByteArrayCopier.field3128.memberRanks[var3]; // L: 2507
        return 1; // L: 2508
      } else if (var0 == ScriptOpcodes.ACTIVECLANSETTINGS_GETBANNEDCOUNT) { // L: 2510
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
            - 1] = DirectByteArrayCopier.field3128.bannedMemberCount; // L: 2511
        return 1; // L: 2512
        ...
        Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
            - 1] = DirectByteArrayCopier.field3128.bannedMemberNames[var3]; // L: 2516
        return 1; // L: 2517
      } else {
        int var5;
        int var6;
        if (var0 == ScriptOpcodes.ACTIVECLANSETTINGS_GETAFFINEDEXTRAINFO) { // L: 2519
          ...
          var5 = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
              + 2]; // L: 2523
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
              - 1] = DirectByteArrayCopier.field3128.method170(var3, var6, var5); // L: 2524
          return 1; // L: 2525
        } else if (var0 == ScriptOpcodes.ACTIVECLANSETTINGS_GETCURRENTOWNER_SLOT) { // L: 2527
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
              - 1] = DirectByteArrayCopier.field3128.currentOwner; // L: 2528
          return 1; // L: 2529
        } else if (var0 == ScriptOpcodes.ACTIVECLANSETTINGS_GETREPLACEMENTOWNER_SLOT) { // L: 2531
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
              - 1] = DirectByteArrayCopier.field3128.field99; // L: 2532
          return 1; // L: 2533
        } else if (var0 == ScriptOpcodes.ACTIVECLANSETTINGS_GETAFFINEDSLOT) { // L: 2535
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
              - 1] = DirectByteArrayCopier.field3128.method196(
              Interpreter.Interpreter_stringStack[--UserComparator9.Interpreter_stringStackSize]); // L: 2536
          return 1; // L: 2537
        } else if (var0 == ScriptOpcodes.ACTIVECLANSETTINGS_GETSORTEDAFFINEDSLOT) { // L: 2539
          Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
              - 1] = DirectByteArrayCopier.field3128
              .getSortedMembers()[Interpreter.Interpreter_intStack[
              ChatChannel.Interpreter_intStackSize - 1]]; // L: 2540
          return 1; // L: 2541
          ...
          if (var0 == ScriptOpcodes.ACTIVECLANSETTINGS_GETAFFINEDMUTED) { // L: 2562
            ...
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                DirectByteArrayCopier.field3128.field97[var3] ? 1 : 0; // L: 2564
            return 1; // L: 2565
            ...
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                - 1] = ((ClanChannelMember) WorldMapIcon_0.field2031.members
                .get(var3)).name; // L: 2603
            return 1; // L: 2604
            ...
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = WorldMapIcon_0.field2031.method38(
                Interpreter.Interpreter_stringStack[--UserComparator9.Interpreter_stringStackSize]); // L: 2622
            return 1; // L: 2623
          } else if (var0 == ScriptOpcodes.ACTIVECLANCHANNEL_GETSORTEDUSERSLOT) { // L: 2625
            Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
                - 1] = WorldMapIcon_0.field2031.getSortedMembers()[Interpreter.Interpreter_intStack[
                ChatChannel.Interpreter_intStackSize - 1]]; // L: 2626
            return 1; // L: 2627
          } else if (var0 == ScriptOpcodes.CLANPROFILE_FIND) { // L: 2629
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                class10.field74 != null ? 1 : 0; // L: 2630
            return 1; // L: 2631
          } else {
            return 2; // L: 2633
          }
  ...
  static final void drawSpriteOnMinimap(int var0, int var1, int var2, int var3, SpritePixels var4,
      SpriteMask var5) {
    if (var4 != null) { // L: 11423
      ...
      if (var7 <= 6400) { // L: 11426
        ...
        if (var7 > 2500) {
          var4.method7041(var10 + var5.width / 2 - var4.width / 2,
              var5.height / 2 - var11 - var4.height / 2, var0, var1, var5.width, var5.height,
              var5.xStarts, var5.xWidths); // L: 11431
        } else {
          var4.drawTransBgAt(var0 + var10 + var5.width / 2 - var4.width / 2,
              var5.height / 2 + var1 - var11 - var4.height / 2); // L: 11432
        }
