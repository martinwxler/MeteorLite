...
public class class143 {
  ...
  static void method2810() {
    ...
    if (Login.Login_username.length() == 0) { // L: 711
      CollisionMap.setLoginResponseString("Please enter your username.",
          ...
          "2010, this will be the creation email address."); // L: 712
    } else {
      ...
      if (var1 == 0L) { // L: 717
        ...
        int[] var8 = new int[]{var5.nextInt(), var5.nextInt(), (int) (var1 >> 32),
            (int) var1}; // L: 725 726 727 728 729
        ...
        for (int var17 = 0; var17 < var15 + 0; var17 += 3) { // L: 779
          ...
          if (var17 < var15 - 1) { // L: 782
            ...
            if (var17 < var15 - 2) { // L: 785
              ...
              var16.append(class303.field3747[(var19 & 15) << 2 | var20 >>> 6])
                  .append(class303.field3747[var20 & 63]); // L: 787
            } else {
        ...
        try {
          URL var22 = new URL(
              class19.method283("services", false) + "m=accountappeal/login.ws"); // L: 799
          ...
          var23.write("data2=" + Renderable.method4251(var14) + "&dest=" + Renderable
              .method4251("passwordchoice.ws")); // L: 805
          var23.flush(); // L: 806
      ...
      switch (var0) { // L: 855
        case 2:
          CollisionMap.setLoginResponseString(Strings.field3499, Strings.field3500,
              Strings.field3286); // L: 872
        ...
        case 3:
          ...
          break; // L: 864
        case 4:
          CollisionMap.setLoginResponseString("The part of the website you are trying",
              "to connect to is offline at the moment.", "Please try again later."); // L: 857
          break; // L: 858
        case 5:
          CollisionMap.setLoginResponseString("Sorry, there was an error trying to",
              "log you in to this part of the website.", "Please try again later."); // L: 860
          break; // L: 861
        case 6:
        ...
        case 7:
          CollisionMap
              .setLoginResponseString("You must enter a valid login to proceed. For accounts",
                  "created after 24th November 2010, please use your",
                  "email address. Otherwise please use your username."); // L: 866
      }
  ...
  static final void drawLoadingMessage(String var0, boolean var1) {
    if (Client.showLoadingMessages) { // L: 4505
      ...
      Rasterizer2D.Rasterizer2D_fillRectangle(var3 - var2, var4 - var2, var2 + var2 + var5,
          var2 + var6 + var2, 0); // L: 4511
      Rasterizer2D.Rasterizer2D_drawRectangle(var3 - var2, var4 - var2, var5 + var2 + var2,
          var2 + var6 + var2, 16777215); // L: 4512
      AbstractSocket.fontPlain12
          .drawLines(var0, var3, var4, var5, var6, 16777215, -1, 1, 1, 0); // L: 4513
      AccessFile
          .method6437(var3 - var2, var4 - var2, var2 + var5 + var2, var2 + var6 + var2); // L: 4514
      if (var1) { // L: 4515
