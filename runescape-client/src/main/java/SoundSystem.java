...
public class SoundSystem implements Runnable {
  ...
  @Export("drawWidgets")
  static final void drawWidgets(int var0, int var1, int var2, int var3, int var4, int var5,
      int var6, int var7) {
    if (class20.loadInterface(var0)) { // L: 9373
      WorldMapCacheName.field2135 = null; // L: 9380
      PcmPlayer
          .drawInterface(GrandExchangeOfferOwnWorldComparator.Widget_interfaceComponents[var0], -1,
              var1, var2, var3, var4, var5, var6, var7); // L: 9381
      if (WorldMapCacheName.field2135 != null) { // L: 9382
        PcmPlayer.drawInterface(WorldMapCacheName.field2135, -1412584499, var1, var2, var3, var4,
            Clock.field1538, Canvas.field296, var7); // L: 9383
  ...
  static final void worldToMinimap(int var0, int var1, int var2, int var3, SpritePixels var4,
      SpriteMask var5) {
    ...
    if (var6 > 4225 && var6 < 90000) { // L: 11406
      ...
      class22.redHintArrowSprite.method7043(var15 + (var0 + var5.width / 2 - var17 / 2),
          var5.height / 2 + var1 - var17 / 2 - var16 - 10, var17, var17, 15, 15, var12,
          256); // L: 11417
    } else {
