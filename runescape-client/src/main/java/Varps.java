...
public class Varps {
  ...
  static final void method4783() {
    ...
    if (Client.oculusOrbState == 0) { // L: 3960
      ...
      if (FriendSystem.oculusOrbFocalPointX - var0 < -500
          || FriendSystem.oculusOrbFocalPointX - var0 > 500
          || VarbitComposition.oculusOrbFocalPointY - var1 < -500
          || VarbitComposition.oculusOrbFocalPointY - var1 > 500) { // L: 3963
      ...
      if (var1 != VarbitComposition.oculusOrbFocalPointY) { // L: 3968
        VarbitComposition.oculusOrbFocalPointY +=
            (var1 - VarbitComposition.oculusOrbFocalPointY) / 16;
      }

      var2 = FriendSystem.oculusOrbFocalPointX >> 7; // L: 3969
      var3 = VarbitComposition.oculusOrbFocalPointY >> 7; // L: 3970
      var4 = ItemContainer
          .getTileHeight(FriendSystem.oculusOrbFocalPointX, VarbitComposition.oculusOrbFocalPointY,
              SoundSystem.Client_plane); // L: 3971
      var5 = 0; // L: 3972
      int var6;
      ...
      class14.field124 = ItemContainer
          .getTileHeight(class262.localPlayer.x, class262.localPlayer.y, SoundSystem.Client_plane)
          - Client.camFollowHeight; // L: 3988
      ...
      if (Client.field705 && class262.localPlayer != null) { // L: 3992
        ...
        if (var0 >= 0 && var1 >= 0 && var0 < 104 && var1 < 104) { // L: 3995
          ...
          var2 = ItemContainer.getTileHeight(class262.localPlayer.x, class262.localPlayer.y,
              SoundSystem.Client_plane) - Client.camFollowHeight; // L: 3997
      ...
      if (var10 >= 0 || var11 != 0) { // L: 4020
        var2 = KeyHandler.KeyHandler_pressedKeys[81] ? Client.oculusOrbSlowedSpeed * 930603185
            * -1091934127 : Client.oculusOrbNormalSpeed * 1556069133 * 1614384069; // L: 4021
        var2 *= 16; // L: 4022
    ...
    if (MouseHandler.MouseHandler_currentButton == 4 && UserComparator3.mouseCam) { // L: 4053
      ...
      Client.mouseCamClickedY =
          var0 != -1 && var0 != 1 ? (MouseHandler.MouseHandler_y + Client.mouseCamClickedY) / 2
              : MouseHandler.MouseHandler_y * -1895436129 * 1644112735; // L: 4056
      var1 = Client.mouseCamClickedX - MouseHandler.MouseHandler_x; // L: 4057
      Client.camAngleDY = var1 * 2; // L: 4058
      Client.mouseCamClickedX =
          var1 != -1 && var1 != 1 ? (Client.mouseCamClickedX + MouseHandler.MouseHandler_x) / 2
              : MouseHandler.MouseHandler_x * -356572869 * 1657999347; // L: 4059
    } else {
