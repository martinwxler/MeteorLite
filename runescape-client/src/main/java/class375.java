...
public class class375 implements Enumerated {
  ...
  static final void method6530(String var0) {
    PacketBufferNode var1 = InterfaceParent
        .getPacketBufferNode(ClientPacket.field2665, Client.packetWriter.isaacCipher); // L: 136
  ...
  static int method6531(int var0, Script var1, boolean var2) {
    ...
    if (var0 == ScriptOpcodes.OC_NAME) { // L: 3153
      ...
      Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
          - 1] = class250.ItemDefinition_get(var3).name; // L: 3155
      return 1; // L: 3156
    } else {
      int var4;
      ...
      if (var0 == ScriptOpcodes.OC_OP) { // L: 3158
        ...
        if (var4 >= 1 && var4 <= 5 && var5.groundActions[var4 - 1] != null) {
          Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
              - 1] = var5.groundActions[var4 - 1]; // L: 3163
        } else {
          Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
              - 1] = ""; // L: 3164
        }
        ...
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = class250
            .ItemDefinition_get(var3).price; // L: 3178
        return 1; // L: 3179
        ...
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
            class250.ItemDefinition_get(var3).isStackable == 1 ? 1 : 0; // L: 3183
        return 1; // L: 3184
      } else {
        ...
        if (var0 == ScriptOpcodes.OC_CERT) { // L: 3186
          ...
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
              class250.ItemDefinition_get(var3).isMembersOnly ? 1 : 0; // L: 3202
          return 1; // L: 3203
          ...
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
              - 1] = ApproximateRouteStrategy.foundItemIdCount; // L: 3223
          return 1; // L: 3224
          ...
          if (ClanChannel.foundItemIds != null
              && PcmPlayer.foundItemIndex < ApproximateRouteStrategy.foundItemIdCount) { // L: 3227
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                ClanChannel.foundItemIds[++PcmPlayer.foundItemIndex - 1] & '\uffff'; // L: 3228
          } else {
  ...
  static final void updatePendingSpawn(int var0, int var1, int var2, int var3, int var4, int var5,
      int var6, int var7, int var8) {
    PendingSpawn var9 = null; // L: 7293

    for (PendingSpawn var10 = (PendingSpawn) Client.pendingSpawns.last(); var10 != null;
        var10 = (PendingSpawn) Client.pendingSpawns.previous()) { // L: 7294 7295 7300
      if (var0 == var10.plane && var10.x == var1 && var2 == var10.y
          && var3 == var10.type) { // L: 7296
        var9 = var10; // L: 7297
        break;
      }
    }
