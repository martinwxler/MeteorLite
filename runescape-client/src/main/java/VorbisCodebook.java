...
public class VorbisCodebook {
  ...
  VorbisCodebook() {
    ...
    if (var1) { // L: 46
      ...
      for (var3 = VorbisSample.readBits(5) + 1; var2 < this.entries; ++var3) { // L: 48 49 52
        int var4 = VorbisSample.readBits(class5.iLog(this.entries - var2)); // L: 50
    ...
    if (var2 > 0) { // L: 64
      ...
      this.field482 = new int[var7]; // L: 72

      int var8;
      for (var8 = 0; var8 < var7; ++var8) { // L: 73
        this.field482[var8] = VorbisSample.readBits(var5);
      }
      ...
      if (var2 == 1) { // L: 75
        for (var8 = 0; var8 < this.entries; ++var8) { // L: 76
          ...
          for (var11 = 0; var11 < this.dimensions; ++var11) { // L: 79
            ...
            float var13 = (float) this.field482[var12] * var16 + var15 + var9; // L: 81
        ...
        for (var8 = 0; var8 < this.entries; ++var8) { // L: 89
          ...
          for (var11 = 0; var11 < this.dimensions; ++var11) { // L: 92
            float var17 = (float) this.field482[var10] * var16 + var15 + var9; // L: 93
  ...
  int method1111() {
    int var1;
    for (var1 = 0; this.keys[var1] >= 0;
        var1 = VorbisSample.readBit() != 0 ? this.keys[var1] : var1 + 1) { // L: 170 171
    }
  ...
  @ObfuscatedName("y")
  float[] method1113() {
    return this.field479[this.method1111()]; // L: 176
  }
}
