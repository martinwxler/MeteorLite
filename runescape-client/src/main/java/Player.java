...
public final class Player extends Actor {
  ...
  static final void method2258(int var0, int var1, int var2, int var3, int var4, int var5,
      Scene var6, CollisionMap var7) {
    if (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var1][var2] & 2) != 0
        || (Tiles.Tiles_renderFlags[var0][var1][var2] & 16) == 0) { // L: 212 213 214
      ...
      int var16 =
          var15[var11][var14] + var15[var11][var13] + var15[var12][var13] + var15[var12][var14]
              >> 2; // L: 250
      ...
      Object var29;
      if (var5 == 22) { // L: 257
        if (!Client.isLowDetail || var8.int1 != 0 || var8.interactType == 1
            || var8.boolean2) { // L: 258
          if (var8.animationId == -1 && var8.transforms == null) { // L: 260
            var29 = var8.getEntity(22, var4, var15, var17, var16, var18);
          } else {
            var29 = new DynamicObject(var3, 22, var4, var0, var1, var2, var8.animationId,
                var8.field1784, (Renderable) null); // L: 261
          }

          var6.newFloorDecoration(var0, var1, var2, var16, (Renderable) var29, var19,
              var21); // L: 262
        ...
        if (var5 != 10 && var5 != 11) { // L: 266
          ...
          if (var5 >= 12) { // L: 287
            if (var8.animationId == -1 && var8.transforms == null) { // L: 289
              ...
              var29 = new DynamicObject(var3, var5, var4, var0, var1, var2, var8.animationId,
                  var8.field1784, (Renderable) null); // L: 290
            }

            var6.method4046(var0, var1, var2, var16, 1, 1, (Renderable) var29, 0, var19,
                var21); // L: 291
            ...
            if (var8.animationId == -1 && var8.transforms == null) { // L: 298
              ...
              var29 = new DynamicObject(var3, 0, var4, var0, var1, var2, var8.animationId,
                  var8.field1784, (Renderable) null); // L: 299
            }

            var6.newBoundaryObject(var0, var1, var2, var16, (Renderable) var29, (Renderable) null,
                Tiles.field1102[var4], 0, var19, var21); // L: 300
            if (var4 == 0) { // L: 301
            ...
            if (var8.animationId == -1 && var8.transforms == null) { // L: 335
              ...
              var29 = new DynamicObject(var3, 1, var4, var0, var1, var2, var8.animationId,
                  var8.field1784, (Renderable) null); // L: 336
            }

            var6.newBoundaryObject(var0, var1, var2, var16, (Renderable) var29, (Renderable) null,
                Tiles.field1107[var4], 0, var19, var21); // L: 337
            ...
            if (var5 == 2) { // L: 347
              ...
              if (var8.animationId == -1 && var8.transforms == null) { // L: 351
                ...
                var30 = new DynamicObject(var3, 2, var4 + 4, var0, var1, var2, var8.animationId,
                    var8.field1784, (Renderable) null); // L: 356
                var24 = new DynamicObject(var3, 2, var22, var0, var1, var2, var8.animationId,
                    var8.field1784, (Renderable) null); // L: 357
              }

              var6.newBoundaryObject(var0, var1, var2, var16, (Renderable) var30,
                  (Renderable) var24, Tiles.field1102[var4], Tiles.field1102[var22], var19,
                  var21); // L: 359
              ...
              if (var8.animationId == -1 && var8.transforms == null) { // L: 384
                ...
                var29 = new DynamicObject(var3, 3, var4, var0, var1, var2, var8.animationId,
                    var8.field1784, (Renderable) null); // L: 385
              }

              var6.newBoundaryObject(var0, var1, var2, var16, (Renderable) var29, (Renderable) null,
                  Tiles.field1107[var4], 0, var19, var21); // L: 386
              ...
              if (var8.animationId == -1 && var8.transforms == null) { // L: 398
                ...
                var29 = new DynamicObject(var3, var5, var4, var0, var1, var2, var8.animationId,
                    var8.field1784, (Renderable) null); // L: 399
              }
              ...
              if (var8.animationId == -1 && var8.transforms == null) { // L: 407
                ...
                var29 = new DynamicObject(var3, 4, var4, var0, var1, var2, var8.animationId,
                    var8.field1784, (Renderable) null); // L: 408
              }

              var6.newWallDecoration(var0, var1, var2, var16, (Renderable) var29, (Renderable) null,
                  Tiles.field1102[var4], 0, 0, 0, var19, var21); // L: 409
            } else {
              long var23;
              Object var25;
              if (var5 == 5) { // L: 412
                ...
                if (var8.animationId == -1 && var8.transforms == null) { // L: 417
                  ...
                  var25 = new DynamicObject(var3, 4, var4, var0, var1, var2, var8.animationId,
                      var8.field1784, (Renderable) null); // L: 418
                }

                var6.newWallDecoration(var0, var1, var2, var16, (Renderable) var25,
                    (Renderable) null, Tiles.field1102[var4], 0, var22 * Tiles.field1100[var4],
                    var22 * Tiles.field1105[var4], var19, var21); // L: 419
                ...
                if (var8.animationId == -1 && var8.transforms == null) { // L: 427
                  ...
                  var25 = new DynamicObject(var3, 4, var4 + 4, var0, var1, var2, var8.animationId,
                      var8.field1784, (Renderable) null); // L: 428
                }

                var6.newWallDecoration(var0, var1, var2, var16, (Renderable) var25,
                    (Renderable) null, 256, var4, var22 * Tiles.field1106[var4],
                    var22 * Tiles.field1097[var4], var19, var21); // L: 429
                ...
                if (var8.animationId == -1 && var8.transforms == null) { // L: 435
                  ...
                  var29 = new DynamicObject(var3, 4, var28 + 4, var0, var1, var2, var8.animationId,
                      var8.field1784, (Renderable) null); // L: 436
                }

                var6.newWallDecoration(var0, var1, var2, var16, (Renderable) var29,
                    (Renderable) null, 256, var28, 0, 0, var19, var21); // L: 437
                ...
                if (var8.animationId == -1 && var8.transforms == null) { // L: 447
                  ...
                  var25 = new DynamicObject(var3, 4, var4 + 4, var0, var1, var2, var8.animationId,
                      var8.field1784, (Renderable) null); // L: 452
                  var26 = new DynamicObject(var3, 4, var27 + 4, var0, var1, var2, var8.animationId,
                      var8.field1784, (Renderable) null); // L: 453
                }

                var6.newWallDecoration(var0, var1, var2, var16, (Renderable) var25,
                    (Renderable) var26, 256, var4, var22 * Tiles.field1106[var4],
                    var22 * Tiles.field1097[var4], var19, var21); // L: 455
              }
            }
          }
        } else {
          if (var8.animationId == -1 && var8.transforms == null) { // L: 268
            ...
            var29 = new DynamicObject(var3, 10, var4, var0, var1, var2, var8.animationId,
                var8.field1784, (Renderable) null); // L: 269
          }

          if (var29 != null && var6
              .method4046(var0, var1, var2, var16, var9, var10, (Renderable) var29,
                  var5 == 11 ? 256 : 0, var19, var21) && var8.clipped) { // L: 270 271
            var28 = 15; // L: 272
  ...
  static int method2235(int var0, Script var1, boolean var2) {
    ...
    if (var0 == ScriptOpcodes.IF_GETSCROLLX) { // L: 1296
      ...
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
          - 1] = var3.color2; // L: 1345
      return 1; // L: 1346
    } else if (var0 == 2613) { // L: 1348
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = var3.fillMode
          .rsOrdinal(); // L: 1349
      return 1; // L: 1350
    } else if (var0 == ScriptOpcodes.IF_GETMODELTRANSPARENT) { // L: 1352
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
          var3.modelTransparency ? 1 : 0; // L: 1353
      return 1; // L: 1354
  ...
  final void read(Buffer var1) {
    ...
    this.username = new Username(var1.readStringCp1252NullTerminated(),
        LoginScreenAnimation.loginType); // L: 101
  ...
  protected final Model getModel() {
    if (this.appearance == null) { // L: 182
      ...
      SequenceDefinition var1 =
          super.sequence != -1 && super.sequenceDelay == 0 ? WorldMapScaleHandler
              .SequenceDefinition_get(super.sequence) : null; // L: 183
      SequenceDefinition var2 = super.movementSequence == -1 || this.isUnanimated
          ...
          : WorldMapScaleHandler.SequenceDefinition_get(super.movementSequence); // L: 184
      Model var3 = this.appearance
          .getModel(var1, super.sequenceFrame, var2, super.movementFrame); // L: 185
      if (var3 == null) { // L: 186
        return null;
      } else {
        ...
        Model var4;
        Model[] var5;
        if (!this.isUnanimated && super.spotAnimation != -1
            && super.spotAnimationFrame != -1) { // L: 189
          var4 = Tiles.SpotAnimationDefinition_get(super.spotAnimation)
              .getModel(super.spotAnimationFrame); // L: 190
          if (var4 != null) { // L: 191
        ...
        if (!this.isUnanimated && this.model0 != null) { // L: 197
          ...
          if (Client.cycle >= this.animationCycleStart
              && Client.cycle < this.animationCycleEnd) { // L: 199
            var4 = this.model0; // L: 200
            var4.offsetBy(this.field1185 - super.x, this.tileHeight2 - this.tileHeight,
                this.field1197 - super.y); // L: 201
            ...
            var4.offsetBy(super.x - this.field1185, this.tileHeight - this.tileHeight2,
                super.y - this.field1197); // L: 224
          }
        }
  ...
  void checkIsFriend() {
    this.isFriendTriBool = DevicePcmPlayerProvider.friendSystem.isFriendAndHasWorld(this.username)
        ? TriBool.TriBool_true : TriBool.TriBool_false; // L: 141
  } // L: 142
  ...
  void updateIsInFriendsChat() {
    this.isInFriendsChat =
        class289.friendsChat != null && class289.friendsChat.contains(this.username)
            ? TriBool.TriBool_true : TriBool.TriBool_false; // L: 156
  } // L: 157
  ...
  void updateIsInClanChat() {
    this.isInClanChat = Client.currentClanSettings[0] != null
        && Client.currentClanSettings[0].method196(this.username.getName()) != -1
        ? TriBool.TriBool_true : TriBool.TriBool_false; // L: 160
  } // L: 161
  ...
  int transformedSize() {
    return this.appearance != null && this.appearance.npcTransformId != -1 ? class248
        .getNpcDefinition(this.appearance.npcTransformId).size : 1; // L: 175 176 178
  }
  ...
  final void method2217(int var1, int var2, byte var3) {
    if (super.sequence != -1
        && WorldMapScaleHandler.SequenceDefinition_get(super.sequence).field1893 == 1) { // L: 232
      super.sequence = -1;
    }

    super.field1280 = -1;
    if (var1 >= 0 && var1 < 104 && var2 >= 0 && var2 < 104) {
      if (super.pathX[0] >= 0 && super.pathX[0] < 104 && super.pathY[0] >= 0
          && super.pathY[0] < 104) {
        if (var3 == 2) { // L: 237
          Player var4 = this;
          ...
          if (var5 >= var7 && var5 < 104 - var7 && var6 >= var7 && var6 < 104 - var7 && var1 >= var7
              && var1 < 104 - var7 && var2 >= var7 && var2 < 104 - var7) { // L: 244
              ...
              if (var15 >= 128) {
                ...
                if (var9 == 1) { // L: 267
                  ...
                  while (true) {
                    ...
                    if (var37 > 0 && class160.directions[var37 - 1][var38] == 0
                    ...
                    if (var37 < 126 && class160.directions[var37 + 1][var38] == 0
                        && (var25[var26 + 2][var27] & 19136899) == 0
                        && (var25[var26 + 2][var27 + 1] & 19136992) == 0) { // L: 312
                      class160.bufferX[var40] = var17 + 1;
                    ...
                    if (var38 > 0 && class160.directions[var37][var38 - 1] == 0
                        && (var25[var26][var27 - 1] & 19136782) == 0
                        && (var25[var26 + 1][var27 - 1] & 19136899) == 0) { // L: 319 321
                    ...
                    if (var38 < 126 && class160.directions[var37][var38 + 1] == 0
                        && (var25[var26][var27 + 2] & 19136824) == 0
                        && (var25[var26 + 1][var27 + 2] & 19136992) == 0) { // L: 332
                      class160.bufferX[var40] = var17;
                    ...
                    if (var37 > 0 && var38 > 0 && class160.directions[var37 - 1][var38 - 1] == 0
                        && (var25[var26 - 1][var27] & 19136830) == 0
                        && (var25[var26 - 1][var27 - 1] & 19136782) == 0
                        && (var25[var26][var27 - 1] & 19136911) == 0) { // L: 343
                      class160.bufferX[var40] = var17 - 1;
                      class160.bufferY[var40] = var18 - 1;
                    ...
                    if (var37 < 126 && var38 > 0 && class160.directions[var37 + 1][var38 - 1] == 0
                        && (var25[var26 + 1][var27 - 1] & 19136911) == 0
                        && (var25[var26 + 2][var27 - 1] & 19136899) == 0
                        && (var25[var26 + 2][var27] & 19136995) == 0) { // L: 350 354
                    ...
                    if (var37 > 0 && var38 < 126 && class160.directions[var37 - 1][var38 + 1] == 0
                        && (var25[var26 - 1][var27 + 1] & 19136830) == 0
                        && (var25[var26 - 1][var27 + 2] & 19136824) == 0
                        && (var25[var26][var27 + 2] & 19137016) == 0) { // L: 364
                      class160.bufferX[var40] = var17 - 1;
                      class160.bufferY[var40] = var18 + 1;
                    ...
                    if (var37 < 126 && var38 < 126 && class160.directions[var37 + 1][var38 + 1] == 0
                        && (var25[var26 + 1][var27 + 2] & 19137016) == 0
                        && (var25[var26 + 2][var27 + 2] & 19136992) == 0
                        && (var25[var26 + 2][var27 + 1] & 19136995) == 0) { // L: 372 376
                ...
                label435:
                {
                    ...
                    for (var27 = var40 - var39; var27 <= var39 + var40; ++var27) { // L: 404
                      for (var28 = var24 - var39; var28 <= var39 + var24; ++var28) {
                        ...
                        if (var29 >= 0 && var30 >= 0 && var29 < 128 && var30 < 128
                            && class160.distances[var29][var30] < 100) {
                          int var31 = 0;
                          ...
                          if (var33 < var38
                              || var38 == var33 && class160.distances[var29][var30] < var21) {
                            var38 = var33;
                  ...
                  if (var18 == var5 && var6 == var37) {
                    ...
                    for (var21 = var22 = class160.directions[var18 - var16][var37 - var17];
                        var18 != var5 || var37 != var6;
                        var21 = class160.directions[var18 - var16][var37 - var17]) { // L: 457
                      if (var21 != var22) {
                        var22 = var21;
