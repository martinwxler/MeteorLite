...
public class class25 extends class16 {
  ...
  static final void method337(byte[] var0, int var1, int var2, int var3, int var4, int var5,
      int var6, int var7, Scene var8, CollisionMap[] var9) {
    ...
    while (true) {
      ...
      while (true) {
        ...
        if (var17 == var4 && var16 >= var5 && var16 < var5 + 8 && var15 >= var6
            && var15 < var6 + 8) { // L: 195
          ObjectComposition var21 = Tiles.getObjectDefinition(var11); // L: 196
          int var22 = var2 + AbstractWorldMapIcon
              .method3787(var16 & 7, var15 & 7, var7, var21.sizeX, var21.sizeY, var20); // L: 197
          int var23 = var3 + FaceNormal
              .method4253(var16 & 7, var15 & 7, var7, var21.sizeX, var21.sizeY, var20); // L: 198
          if (var22 > 0 && var23 > 0 && var22 < 103 && var23 < 103) { // L: 199
            ...
            Player.method2258(var1, var22, var23, var11, var20 + var7 & 3, var19, var8,
                var25); // L: 204
          }
        }
      }
  ...
  static int method336(int var0, Script var1, boolean var2) {
    if (var0 == ScriptOpcodes.CHAT_GETFILTER_PUBLIC) { // L: 3250
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
          - 1] = Client.publicChatMode; // L: 3251
      return 1; // L: 3252
      ...
      ClanChannel.privateChatMode = class244.method4812(
          Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize + 1]); // L: 3257
      if (ClanChannel.privateChatMode == null) { // L: 3258
        ClanChannel.privateChatMode = PrivateChatMode.field3886;
      }

      Client.tradeChatMode = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
          + 2]; // L: 3259
      PacketBufferNode var13 = InterfaceParent
          .getPacketBufferNode(ClientPacket.field2679, Client.packetWriter.isaacCipher); // L: 3261
      ...
      if (var0 == ScriptOpcodes.CHAT_SENDABUSEREPORT) { // L: 3268
        ...
        var9 = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
            + 1]; // L: 3272
        var6 = InterfaceParent.getPacketBufferNode(ClientPacket.field2636,
            Client.packetWriter.isaacCipher); // L: 3274
        var6.packetBuffer
            .writeByte(class44.stringCp1252NullTerminatedByteSize(var8) + 2); // L: 3275
        ...
        if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYTYPEANDLINE) { // L: 3282
          ...
          if (var5 != null) { // L: 3287
            ...
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize - 1] =
                var5.sender != null ? var5.sender : ""; // L: 3290
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize - 1] =
                var5.prefix != null ? var5.prefix : ""; // L: 3291
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize - 1] =
                var5.text != null ? var5.text : ""; // L: 3292
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                var5.isFromFriend() ? 1 : (var5.isFromIgnored() ? 2 : 0); // L: 3293
          } else {
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = -1; // L: 3296
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
          ...
          if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYUID) { // L: 3305
            ...
            if (var4 != null) { // L: 3308
              ...
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                  - 1] = var4.cycle; // L: 3310
              Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                  - 1] = var4.sender != null ? var4.sender : ""; // L: 3311
              Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                  - 1] = var4.prefix != null ? var4.prefix : ""; // L: 3312
              Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                  - 1] = var4.text != null ? var4.text : ""; // L: 3313
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                  var4.isFromFriend() ? 1 : (var4.isFromIgnored() ? 2 : 0); // L: 3314
            } else {
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                  - 1] = -1; // L: 3317
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
            ...
            if (ClanChannel.privateChatMode == null) { // L: 3327
              ...
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                  - 1] = ClanChannel.privateChatMode.field3884; // L: 3328
            }
            ...
            if (var0 == ScriptOpcodes.CHAT_SENDPUBLIC) { // L: 3331
              ...
              var12 = class342
                  .method6068(var7, var8, AbstractArchive.clientLanguage, -1); // L: 3334
              ...
              String var11 = Interpreter.Interpreter_stringStack[
                  UserComparator9.Interpreter_stringStackSize + 1]; // L: 3341
              var12 = InterfaceParent.getPacketBufferNode(ClientPacket.field2668,
                  Client.packetWriter.isaacCipher); // L: 3343
              ...
              var9 = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
                  + 1]; // L: 3356
              var6 = class342
                  .method6068(var7, var8, AbstractArchive.clientLanguage, var9); // L: 3357
              ...
              if (var0 == ScriptOpcodes.CHAT_GETFILTER_TRADE) { // L: 3368
                ...
                Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                    - 1] = AbstractArchive.Messages_getHistorySize(var3); // L: 3374
                return 1; // L: 3375
                ...
                Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                    - 1] = class80.Messages_getLastChatID(var3); // L: 3379
                return 1; // L: 3380
                ...
                Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                    - 1] = class22.method306(var3); // L: 3384
                return 1; // L: 3385
                ...
                Client.field642 = Interpreter.Interpreter_stringStack[--UserComparator9.Interpreter_stringStackSize]
                    .toLowerCase().trim(); // L: 3393
                return 1; // L: 3394
              } else if (var0 == ScriptOpcodes.CHAT_GETMESSAGEFILTER) { // L: 3396
                Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                    - 1] = Client.field642; // L: 3397
                return 1; // L: 3398
                ...
                if (var5 != null) { // L: 3418
                  ...
                  Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                      - 1] = var5.cycle; // L: 3420
                  Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                      - 1] = var5.sender != null ? var5.sender : ""; // L: 3421
                  Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                      - 1] = var5.prefix != null ? var5.prefix : ""; // L: 3422
                  Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                      - 1] = var5.text != null ? var5.text : ""; // L: 3423
                  Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                      var5.isFromFriend() ? 1 : (var5.isFromIgnored() ? 2 : 0); // L: 3424
                  Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                      - 1] = ""; // L: 3425
                  Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                      - 1] = 0; // L: 3426
                ...
                if (var4 != null) { // L: 3443
                  ...
                  Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                      - 1] = var4.cycle; // L: 3445
                  Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                      - 1] = var4.sender != null ? var4.sender : ""; // L: 3446
                  Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                      - 1] = var4.prefix != null ? var4.prefix : ""; // L: 3447
                  Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                      - 1] = var4.text != null ? var4.text : ""; // L: 3448
                  Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                      var4.isFromFriend() ? 1 : (var4.isFromIgnored() ? 2 : 0); // L: 3449
                  Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                      - 1] = ""; // L: 3450
                  Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                      - 1] = 0; // L: 3451
              ...
              if (class262.localPlayer != null
                  && class262.localPlayer.username != null) { // L: 3363
  ...
  static final void method330(int var0) {
    if (class20.loadInterface(var0)) { // L: 11051
      class246.drawModelComponents(
          GrandExchangeOfferOwnWorldComparator.Widget_interfaceComponents[var0], -1); // L: 11052
    }
  } // L: 11053
