...
public class AudioFilter {
  ...
  float method1191(int var1, int var2, float var3) {
    float var4 = (float) this.field530[var1][0][var2] + var3 * (float) (this.field530[var1][1][var2]
        - this.field530[var1][0][var2]); // L: 24
  ...
  float method1177(int var1, int var2, float var3) {
    float var4 = (float) this.field533[var1][0][var2] + var3 * (float) (this.field533[var1][1][var2]
        - this.field533[var1][0][var2]); // L: 35
  ...
  int compute(int var1, float var2) {
    ...
    if (var1 == 0) { // L: 41
      var3 =
          (float) this.field531[0] + (float) (this.field531[1] - this.field531[0]) * var2; // L: 42
    ...
    if (this.pairs[var1] == 0) { // L: 47
      ...
      field532[var1][0] =
          -2.0F * var3 * (float) Math.cos((double) this.method1177(var1, 0, var2)); // L: 49
      ...
      for (var4 = 1; var4 < this.pairs[var1]; ++var4) { // L: 51
        ...
        float var5 =
            -2.0F * var3 * (float) Math.cos((double) this.method1177(var1, var4, var2)); // L: 53
        float var6 = var3 * var3; // L: 54
        field532[var1][var4 * 2 + 1] = field532[var1][var4 * 2 - 1] * var6; // L: 55
        field532[var1][var4 * 2] =
            field532[var1][var4 * 2 - 1] * var5 + field532[var1][var4 * 2 - 2] * var6; // L: 56
