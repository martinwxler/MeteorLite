...
public class class261 {
  ...
  public static InvDefinition getInvDefinition(int var0) {
    InvDefinition var1 = (InvDefinition) InvDefinition.InvDefinition_cached
        .get((long) var0); // L: 17
    if (var1 != null) { // L: 18
      return var1;
    } else {
  ...
  static final void Widget_addToMenu(Widget var0, int var1, int var2) {
    ...
    if (var0.buttonType == 2 && !Client.isSpellSelected) { // L: 10177
      ...
      if (var3 != null) { // L: 10179
        class22
            .insertMenuItemNoShift(var3, SecureRandomFuture.colorStartTag(65280) + var0.spellName,
                25, 0, -1, var0.id); // L: 10180
      }
    }
        ...
        for (var5 = 0; var5 < var0.width; ++var5) { // L: 10203
          ...
          if (var1 >= var18 && var2 >= var7 && var1 < var18 + 32 && var2 < var7 + 32) { // L: 10210
            ...
            if (var0.itemIds[var15] > 0) { // L: 10213
              ItemComposition var8 = class250
                  .ItemDefinition_get(var0.itemIds[var15] - 1); // L: 10214
              if (Client.isItemSelected == 1 && class372
                  .method6497(class22.getWidgetFlags(var0))) { // L: 10215
                if (var0.id != class246.selectedItemWidget
                    || var15 != Timer.selectedItemSlot) { // L: 10216
                  class22.insertMenuItemNoShift("Use",
                      Client.selectedItemName + " " + "->" + " " + SecureRandomFuture
                          .colorStartTag(16748608) + var8.name, 31, var8.id, var15,
                      var0.id); // L: 10217
                }
              } else if (Client.isSpellSelected && class372
                  .method6497(class22.getWidgetFlags(var0))) { // L: 10221
                if ((LoginPacket.selectedSpellFlags & 16) == 16) { // L: 10222
                  class22.insertMenuItemNoShift(Client.selectedSpellActionName,
                      Client.selectedSpellName + " " + "->" + " " + SecureRandomFuture
                          .colorStartTag(16748608) + var8.name, 32, var8.id, var15,
                      var0.id); // L: 10223
                }
              } else {
                ...
                if (var11) { // L: 10250
                  class22.insertMenuItemNoShift("Use",
                      SecureRandomFuture.colorStartTag(16748608) + var8.name, 38, var8.id, var15,
                      var0.id); // L: 10251
                }
                ...
                if (var9 != null) { // L: 10264
                  for (var13 = 4; var13 >= 0; --var13) { // L: 10265
                    if (var9[var13] != null) { // L: 10266
                      ...
                      class22.insertMenuItemNoShift(var9[var13],
                          SecureRandomFuture.colorStartTag(16748608) + var8.name, var14, var8.id,
                          var15, var0.id); // L: 10273
                    }
                  }
                }

                class22.insertMenuItemNoShift("Examine",
                    SecureRandomFuture.colorStartTag(16748608) + var8.name, 1005, var8.id, var15,
                    var0.id); // L: 10278
              }
            }
          }
    ...
    if (var0.isIf3) { // L: 10287
      if (Client.isSpellSelected) { // L: 10288
        ...
        for (var15 = 9; var15 >= 5; --var15) { // L: 10300
          String var17;
          if (!class136.method2696(class22.getWidgetFlags(var0), var15)
              && var0.onOp == null) { // L: 10303
            var17 = null; // L: 10304
          } else if (var0.actions != null && var0.actions.length > var15
              && var0.actions[var15] != null
              && var0.actions[var15].trim().length() != 0) { // L: 10307
          ...
          if (var17 != null) { // L: 10314
            class22.insertMenuItemNoShift(var17, var0.dataText, 1007, var15 + 1, var0.childIndex,
                var0.id); // L: 10315
          }
        }
        ...
        if (var3 != null) { // L: 10320
          class22.insertMenuItemNoShift(var3, var0.dataText, 25, 0, var0.childIndex,
              var0.id); // L: 10321
        }

        for (var4 = 4; var4 >= 0; --var4) { // L: 10324
          String var16;
          if (!class136.method2696(class22.getWidgetFlags(var0), var4)
              && var0.onOp == null) { // L: 10327
            var16 = null; // L: 10328
          } else if (var0.actions != null && var0.actions.length > var4
              && var0.actions[var4] != null
              && var0.actions[var4].trim().length() != 0) { // L: 10331
          ...
          if (var16 != null) { // L: 10338
            PacketWriter
                .insertMenuItem(var16, var0.dataText, 57, var4 + 1, var0.childIndex, var0.id,
                    var0.prioritizeMenuEntry); // L: 10339
          }
        }
        ...
        if (var19) { // L: 10348
          class22
              .insertMenuItemNoShift("Continue", "", 30, 0, var0.childIndex, var0.id); // L: 10349
        }
      }
    }
