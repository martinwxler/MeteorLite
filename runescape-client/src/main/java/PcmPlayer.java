...
public class PcmPlayer {
  ...
  static void method895() {
    ...
    for (InterfaceParent var3 = (InterfaceParent) Client.interfaceParents.first(); var3 != null;
        var3 = (InterfaceParent) Client.interfaceParents.next()) { // L: 2981
  ...
  static final void logOut() {
    ...
    for (ObjectSound var1 = (ObjectSound) ObjectSound.objectSounds.last(); var1 != null;
        var1 = (ObjectSound) ObjectSound.objectSounds.previous()) { // L: 3135
  ...
  static final void drawInterface(Widget[] var0, int var1, int var2, int var3, int var4, int var5,
    ...
    for (int var9 = 0; var9 < var0.length; ++var9) { // L: 9392
      ...
      if (var10 != null && (var10.parentId == var1
          || var1 == -1412584499 && var10 == Client.clickedWidget)) { // L: 9394 9395
        int var11;
        if (var8 == -1) { // L: 9397
        ...
        if (!var10.isIf3 || !class35.isComponentHidden(var10)) { // L: 9407
          ...
          if (var10 == Client.clickedWidget) { // L: 9412
            ...
            if (Client.isDraggingWidget && Client.field821) { // L: 9419
              ...
              if (var15 + var10.width
                  > Client.field801 + Client.clickedWidgetParent.width) { // L: 9425
              ...
              if (var16 + var10.height
                  > Client.field802 + Client.clickedWidgetParent.height) { // L: 9427
          ...
          if (!var10.isIf3 || var15 < var17 && var16 < var18) { // L: 9473
            if (var10.contentType != 0) { // L: 9474
              if (var10.contentType == 1336) { // L: 9475
                if (Client.displayFps) { // L: 9476
                  ...
                  AbstractSocket.fontPlain12
                      .drawRightAligned("Fps:" + GameEngine.fps, var12 + var10.width, var13,
                          16776960, -1); // L: 9478
                  var13 += 15; // L: 9479
                  ...
                  AbstractSocket.fontPlain12
                      .drawRightAligned("Mem:" + var20 + "k", var12 + var10.width, var13, var21,
                          -1); // L: 9484
                  var13 += 15; // L: 9485
                }
                continue;
              ...
              if (var10.contentType == 1400) { // L: 9507
                class80.worldMap
                    .draw(var12, var13, var10.width, var10.height, Client.cycle); // L: 9508
              }
            ...
            if (var10.type == 0) { // L: 9517
              if (!var10.isIf3 && class35.isComponentHidden(var10)
                  && var10 != MusicPatchNode.mousedOverWidgetIf1) { // L: 9518
                continue;
              }
              ...
              drawInterface(var0, var10.id, var15, var16, var17, var18, var12 - var10.scrollX,
                  var13 - var10.scrollY, var11); // L: 9523
              ...
              InterfaceParent var30 = (InterfaceParent) Client.interfaceParents
                  .get((long) var10.id); // L: 9525
              if (var30 != null) { // L: 9526
                SoundSystem.drawWidgets(var30.group, var15, var16, var17, var18, var12, var13,
                    var11); // L: 9527
              }
            ...
            if (Client.isResizable || Client.field833[var11]
                || Client.gameDrawingMode > 1) { // L: 9532
              if (var10.type == 0 && !var10.isIf3
                  && var10.scrollHeight > var10.height) { // L: 9533 9534
                BufferedSource
                    .drawScrollBar(var12 + var10.width, var13, var10.scrollY, var10.height,
                        var10.scrollHeight);
              }
              ...
              if (var10.type != 1) { // L: 9536
                ...
                if (var10.type == 2) { // L: 9539
                  ...
                  for (var20 = 0; var20 < var10.rawHeight; ++var20) { // L: 9541
                    for (var21 = 0; var21 < var10.rawWidth; ++var21) { // L: 9542
                      ...
                      if (var10.itemIds[var19] <= 0) { // L: 9549
                        ...
                        if (var22 + 32 > var2 && var22 < var4 && var23 + 32 > var3 && var23 < var5
                            || var10 == VerticalAlignment.dragInventoryWidget
                            && var19 == Client.dragItemSlotSource) { // L: 9553
                          SpritePixels var35;
                          if (Client.isItemSelected == 1 && var19 == Timer.selectedItemSlot
                              && var10.id == class246.selectedItemWidget) { // L: 9555
                            var35 = SpotAnimationDefinition
                                .getItemSprite(var26, var10.itemQuantities[var19], 2, 0, 2, false);
                          } else {
                            var35 = SpotAnimationDefinition
                                .getItemSprite(var26, var10.itemQuantities[var19], 1, 3153952, 2,
                                    false); // L: 9556
                          }

                          if (var35 != null) { // L: 9557
                            if (var10 == VerticalAlignment.dragInventoryWidget
                                && var19 == Client.dragItemSlotSource) { // L: 9558
                              var24 =
                                  MouseHandler.MouseHandler_x - Client.draggedWidgetX; // L: 9559
                              var25 =
                                  MouseHandler.MouseHandler_y - Client.draggedWidgetY; // L: 9560
                              ...
                              if (var1 != -1) { // L: 9568
                                ...
                                if (var23 + var25 < Rasterizer2D.Rasterizer2D_yClipStart
                                    && var28.scrollY > 0) { // L: 9570
                                  var29 = (Rasterizer2D.Rasterizer2D_yClipStart - var23 - var25)
                                      * Client.field683 / 3; // L: 9571
                                ...
                                if (var25 + var23 + 32 > Rasterizer2D.Rasterizer2D_yClipEnd
                                    && var28.scrollY
                                    < var28.scrollHeight - var28.height) { // L: 9578
                                  var29 = (var25 + var23 + 32 - Rasterizer2D.Rasterizer2D_yClipEnd)
                                      * Client.field683 / 3; // L: 9579
                                  if (var29 > Client.field683 * 10) { // L: 9580
                                    var29 = Client.field683 * 10;
                                  }

                                  if (var29 > var28.scrollHeight - var28.height
                                      - var28.scrollY) { // L: 9581
                            ...
                            } else if (var10 == Login.field1034
                                && var19 == Client.field729) { // L: 9588
                  ...
                  if (Friend.runCs1(var10)) { // L: 9606
                    ...
                    if (var10 == MusicPatchNode.mousedOverWidgetIf1
                        && var10.mouseOverColor2 != 0) { // L: 9608
                      var19 = var10.mouseOverColor2;
                    }
                  } else {
                    var19 = var10.color; // L: 9611
                    if (var10 == MusicPatchNode.mousedOverWidgetIf1
                        && var10.mouseOverColor != 0) { // L: 9612
                    ...
                    switch (var10.fillMode.field4242) { // L: 9615
                      case 1:
                        Rasterizer2D.Rasterizer2D_fillRectangleGradient(var12, var13, var10.width,
                            var10.height, var10.color, var10.color2); // L: 9624
                        break; // L: 9625
                      case 2:
                        Rasterizer2D
                            .Rasterizer2D_fillRectangleGradientAlpha(var12, var13, var10.width,
                                var10.height, var10.color, var10.color2,
                                255 - (var10.transparencyTop & 255),
                                255 - (var10.transparencyBot & 255)); // L: 9621
                        break; // L: 9622
                      default:
                        if (var14 == 0) { // L: 9617
                          Rasterizer2D
                              .Rasterizer2D_fillRectangle(var12, var13, var10.width, var10.height,
                                  var19);
                        } else {
                          Rasterizer2D.Rasterizer2D_fillRectangleAlpha(var12, var13, var10.width,
                              var10.height, var19, 256 - (var14 & 255)); // L: 9618
                        }
                    }
                  } else if (var14 == 0) { // L: 9629
                    Rasterizer2D
                        .Rasterizer2D_drawRectangle(var12, var13, var10.width, var10.height, var19);
                  } else {
                    Rasterizer2D
                        .Rasterizer2D_drawRectangleAlpha(var12, var13, var10.width, var10.height,
                            var19, 256 - (var14 & 255)); // L: 9630
                  }
                } else {
                  Font var39;
                  if (var10.type == 4) { // L: 9634
                    ...
                    if (var39 == null) { // L: 9636
                      ...
                      if (Friend.runCs1(var10)) { // L: 9642
                        ...
                        if (var10 == MusicPatchNode.mousedOverWidgetIf1
                            && var10.mouseOverColor2 != 0) { // L: 9644
                        ...
                        if (var10 == MusicPatchNode.mousedOverWidgetIf1
                            && var10.mouseOverColor != 0) { // L: 9649
                          var20 = var10.mouseOverColor;
                        }
                      }

                      if (var10.isIf3 && var10.itemId != -1) { // L: 9651
                        ItemComposition var45 = class250
                            .ItemDefinition_get(var10.itemId); // L: 9652
                        var44 = var45.name; // L: 9653
                        if (var44 == null) { // L: 9654
                          var44 = "null";
                        }

                        if ((var45.isStackable == 1 || var10.itemQuantity != 1)
                            && var10.itemQuantity != -1) { // L: 9655
                          var44 =
                              SecureRandomFuture.colorStartTag(16748608) + var44 + "</col>" + " "
                                  + 'x' + MusicPatchNode.formatItemStacks(var10.itemQuantity);
                        }
                      }
                      ...
                      var39.drawLines(var44, var12, var13, var10.width, var10.height, var20,
                          var10.textShadowed ? 0 : -1, var10.textXAlignment, var10.textYAlignment,
                          var10.textLineHeight); // L: 9662
                    }
                    ...
                    if (!var10.isIf3) { // L: 9666
                      ...
                      if (var10.itemId != -1) { // L: 9673
                        var40 = SpotAnimationDefinition
                            .getItemSprite(var10.itemId, var10.itemQuantity, var10.outline,
                                var10.spriteShadow, var10.itemQuantityMode, false);
                      } else {
                      ...
                      if (var40 == null) { // L: 9675
                        ...
                        if (!var10.spriteTiling) { // L: 9678
                          ...
                          if (var10.spriteAngle != 0) { // L: 9693
                            var40.method7097(var10.width / 2 + var12, var10.height / 2 + var13,
                                var10.spriteAngle, var22);
                          } else if (var14 != 0) { // L: 9694
                            var40.drawTransScaledAt(var12, var13, var10.width, var10.height,
                                256 - (var14 & 255));
                          ...
                          Rasterizer2D.Rasterizer2D_expandClip(var12, var13, var12 + var10.width,
                              var13 + var10.height); // L: 9679
                          ...
                          for (var24 = 0; var24 < var22; ++var24) { // L: 9682
                            for (var25 = 0; var25 < var23; ++var25) { // L: 9683
                              if (var10.spriteAngle != 0) { // L: 9684
                                var40.method7097(var20 / 2 + var12 + var20 * var24,
                                    var21 / 2 + var13 + var25 * var21, var10.spriteAngle, 4096);
                              } else if (var14 != 0) { // L: 9685
                                var40.drawTransAt(var12 + var24 * var20, var13 + var21 * var25,
                                    256 - (var14 & 255));
                              } else {
                                var40.drawTransBgAt(var12 + var24 * var20,
                                    var13 + var25 * var21); // L: 9686
                              }
                            }
                          }
                    ...
                    if (var10.type == 6) { // L: 9703
                      ...
                      if (var10.itemId != -1) { // L: 9710
                        ...
                        if (var10.modelId == 0) { // L: 9723
                          var41 = Client.playerAppearance
                              .getModel((SequenceDefinition) null, -1, (SequenceDefinition) null,
                                  -1);
                        } else {
                          var41 = class262.localPlayer.getModel(); // L: 9724
                        }
                      } else if (var20 == -1) { // L: 9726
                        var41 = var10.getModel((SequenceDefinition) null, -1, var36,
                            class262.localPlayer.appearance); // L: 9727
                        if (var41 == null && Widget.field2958) { // L: 9728
                          Script.invalidateWidget(var10);
                        }
                      } else {
                        SequenceDefinition var47 = WorldMapScaleHandler
                            .SequenceDefinition_get(var20); // L: 9731
                        var41 = var10.getModel(var47, var10.modelFrame, var36,
                            class262.localPlayer.appearance); // L: 9732
                      ...
                      Rasterizer3D
                          .method3950(var10.width / 2 + var12, var10.height / 2 + var13); // L: 9735
                      var23 = Rasterizer3D.Rasterizer3D_sine[var10.modelAngleX] * var10.modelZoom
                          >> 16; // L: 9736
                      var24 = Rasterizer3D.Rasterizer3D_cosine[var10.modelAngleX] * var10.modelZoom
                          >> 16; // L: 9737
                      if (var41 != null) { // L: 9738
                        if (!var10.isIf3) { // L: 9739
                          var41.method4347(0, var10.modelAngleY, 0, var10.modelAngleX, 0, var23,
                              var24);
                        } else {
                          var41.calculateBoundsCylinder(); // L: 9741
                          if (var10.modelOrthog) { // L: 9742
                            var41.method4309(0, var10.modelAngleY, var10.modelAngleZ,
                                var10.modelAngleX, var10.modelOffsetX,
                                var22 + var23 + var10.modelOffsetY, var24 + var10.modelOffsetY,
                                var10.modelZoom);
                          } else {
                            var41.method4347(0, var10.modelAngleY, var10.modelAngleZ,
                                var10.modelAngleX, var10.modelOffsetX,
                                var23 + var22 + var10.modelOffsetY,
                                var24 + var10.modelOffsetY); // L: 9743
                          }
                        }
                      }
                        ...
                        for (var21 = 0; var21 < var10.rawHeight; ++var21) { // L: 9756
                          for (var22 = 0; var22 < var10.rawWidth; ++var22) { // L: 9757
                            if (var10.itemIds[var20] > 0) { // L: 9758
                              var33 = class250
                                  .ItemDefinition_get(var10.itemIds[var20] - 1); // L: 9759
                              String var34;
                              if (var33.isStackable != 1
                                  && var10.itemQuantities[var20] == 1) { // L: 9761
                                var34 = SecureRandomFuture.colorStartTag(16748608) + var33.name
                                    + "</col>";
                              } else {
                                var34 = SecureRandomFuture.colorStartTag(16748608) + var33.name
                                    + "</col>" + " " + 'x' + MusicPatchNode
                                    .formatItemStacks(var10.itemQuantities[var20]); // L: 9762
                              }

                              var25 = var12 + var22 * (var10.paddingX + 115); // L: 9763
                              var26 = (var10.paddingY + 12) * var21 + var13; // L: 9764
                              if (var10.textXAlignment == 0) { // L: 9765
                                var39.draw(var34, var25, var26, var10.color,
                                    var10.textShadowed ? 0 : -1);
                              } else if (var10.textXAlignment == 1) { // L: 9766
                                var39.drawCentered(var34, var10.width / 2 + var25, var26,
                                    var10.color, var10.textShadowed ? 0 : -1);
                              } else {
                                var39.drawRightAligned(var34, var25 + var10.width - 1, var26,
                                    var10.color, var10.textShadowed ? 0 : -1); // L: 9767
                              }
                            }
                      ...
                      if (var10.type == 8 && var10 == class5.field42
                          && Client.field773 == Client.field693) { // L: 9773 9774
                        var19 = 0; // L: 9775
                        var20 = 0; // L: 9776
                        ...
                        String var43;
                        for (var32 = ItemContainer.method2184(var32, var10); var32.length() > 0;
                            var20 = var20 + var31.ascent + 1) { // L: 9780 9781 9793
                        ...
                        Rasterizer2D.Rasterizer2D_fillRectangle(var24, var25, var19, var20,
                            16777120); // L: 9802
                        Rasterizer2D
                            .Rasterizer2D_drawRectangle(var24, var25, var19, var20, 0); // L: 9803
                        var32 = var10.text; // L: 9804
                        var26 = var25 + var31.ascent + 2; // L: 9805

                        for (var32 = ItemContainer.method2184(var32, var10); var32.length() > 0;
                            var26 = var26 + var31.ascent + 1) { // L: 9806 9807 9818
                      ...
                      if (var10.type == 9) { // L: 9822
                        ...
                        if (var10.lineWid == 1) { // L: 9839
                          ...
                          PlayerComposition.method4850(var19, var20, var21, var22, var10.color,
                              var10.lineWid); // L: 9843
                        }
                      }
                    }
                  }
            ...
            while (true) {
              while (true) {
                ...
                if (var12 != null && var12.position > var8) { // L: 216
                  ...
                  if (var14 != null) { // L: 228
                    for (int var15 = var11.field473; var14 != null;
                        var14 = var11.nextSubStream()) { // L: 229 230 232
