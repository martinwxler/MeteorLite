...
public enum ModeWhere implements Enumerated {
  ...
  public static int method5292(Buffer var0, String var1) {
    ...
    var0.offset += class250.huffman
        .compress(var5, 0, var5.length, var0.array, var0.offset); // L: 59
  ...
  static ModeWhere[] method5289() {
    return new ModeWhere[]{field3701, field3693, field3696, field3699, field3694, field3704,
        field3691, field3690, field3700, field3695, field3698, field3692, field3697}; // L: 35
  }
  ...
  static int method5283(int var0, Script var1, boolean var2) {
    ...
    if (var0 == 6600) { // L: 3844
      ...
      if (var0 == ScriptOpcodes.WORLDMAP_GETMAPNAME) { // L: 3851
        ...
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = BZip2State
            .getWorldMap().getZoomLevel(); // L: 3867
        return 1; // L: 3868
        ...
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
            BZip2State.getWorldMap().isCacheLoaded() ? 1 : 0; // L: 3876
        return 1; // L: 3877
      } else {
        Coord var14;
        if (var0 == ScriptOpcodes.WORLDMAP_JUMPTODISPLAYCOORD) { // L: 3879
          var14 = new Coord(
              Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]); // L: 3880
          ...
          var14 = new Coord(
              Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]); // L: 3885
          ...
          var14 = new Coord(
              Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]); // L: 3890
          ...
          var14 = new Coord(
              Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]); // L: 3895
          BZip2State.getWorldMap()
              .jumpToSourceCoordInstant(var14.plane, var14.x, var14.y); // L: 3896
          return 1; // L: 3897
        } else if (var0 == ScriptOpcodes.WORLDMAP_GETDISPLAYPOSITION) { // L: 3899
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = BZip2State
              .getWorldMap().getDisplayX(); // L: 3900
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = BZip2State
              .getWorldMap().getDisplayY(); // L: 3901
          return 1; // L: 3902
        } else {
          WorldMapArea var11;
          if (var0 == ScriptOpcodes.WORLDMAP_GETCONFIGORIGIN) { // L: 3904
            ...
            if (var11 == null) { // L: 3907
              ...
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = var11
                  .getOrigin().packed(); // L: 3911
            }
            ...
            if (var11 == null) { // L: 3918
              ...
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                  (var11.getRegionHighX() - var11.getRegionLowX() + 1) * 64; // L: 3923
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                  (var11.getRegionHighY() - var11.getRegionLowY() + 1) * 64; // L: 3924
            }
            ...
            if (var11 == null) { // L: 3931
              ...
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                  var11.getRegionLowX() * 64; // L: 3938
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                  var11.getRegionLowY() * 64; // L: 3939
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                  var11.getRegionHighX() * 64 + 64 - 1; // L: 3940
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                  var11.getRegionHighY() * 64 + 64 - 1; // L: 3941
            }
            ...
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = BZip2State.getWorldMap().currentMapAreaId(); // L: 3969
            return 1; // L: 3970
          } else if (var0 == ScriptOpcodes.WORLDMAP_GETDISPLAYCOORD) { // L: 3972
            var14 = new Coord(
                Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]); // L: 3973
            ...
            if (var0 == 6618) { // L: 3991
              var14 = new Coord(
                  Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]); // L: 3992
              ...
              if (var0 == 6619) { // L: 4008
                ...
                if (var9 == null) { // L: 4027
                  ...
                  Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                      var9.containsCoord(var10.plane, var10.x, var10.y) ? 1 : 0; // L: 4031
                  return 1; // L: 4032
                }
              } else if (var0 == ScriptOpcodes.WORLDMAP_GETSIZE) { // L: 4034
                Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                    - 1] = BZip2State.getWorldMap().getDisplayWith(); // L: 4035
                Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                    - 1] = BZip2State.getWorldMap().getDisplayHeight(); // L: 4036
                return 1; // L: 4037
              } else if (var0 == 6623) { // L: 4039
                var14 = new Coord(
                    Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]); // L: 4040
                var11 = BZip2State.getWorldMap()
                    .mapAreaAtCoord(var14.plane, var14.x, var14.y); // L: 4041
                if (var11 == null) { // L: 4042
                  Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                      - 1] = -1; // L: 4043
                } else {
                  Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                      - 1] = var11.getId(); // L: 4046
                }

                return 1; // L: 4048
              } else if (var0 == 6624) { // L: 4050
                BZip2State.getWorldMap().setMaxFlashCount(
                    Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]); // L: 4051
                return 1; // L: 4052
              } else if (var0 == 6625) { // L: 4054
                BZip2State.getWorldMap().resetMaxFlashCount(); // L: 4055
                return 1; // L: 4056
              } else if (var0 == 6626) { // L: 4058
                BZip2State.getWorldMap().setCyclesPerFlash(
                    Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]); // L: 4059
                return 1; // L: 4060
                ...
                if (var0 == ScriptOpcodes.WORLDMAP_PERPETUALFLASH) { // L: 4066
                  var13 = Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]
                      == 1; // L: 4067
                  ...
                  if (var0 == ScriptOpcodes.WORLDMAP_DISABLEELEMENT) { // L: 4090
                    ...
                    Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                        BZip2State.getWorldMap().getElementsDisabled() ? 1 : 0; // L: 4105
                    return 1; // L: 4106
                    ...
                    Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                        BZip2State.getWorldMap().isElementDisabled(var3) ? 1 : 0; // L: 4110
                    return 1; // L: 4111
                    ...
                    Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                        BZip2State.getWorldMap().isCategoryDisabled(var3) ? 1 : 0; // L: 4115
                    return 1; // L: 4116
                    ...
                    if (var0 == ScriptOpcodes.WORLDMAP_LISTELEMENT_START) { // L: 4131
                      ...
                      if (var6 == null) { // L: 4133
                        ...
                        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                            - 1] = var6.getElement(); // L: 4138
                        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                            - 1] = var6.coord2.packed(); // L: 4139
                      }
                      ...
                      if (var6 == null) { // L: 4145
                        ...
                        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                            - 1] = var6.getElement(); // L: 4150
                        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                            - 1] = var6.coord2.packed(); // L: 4151
                      }
                      ...
                      if (var0 == ScriptOpcodes.MEC_TEXT) { // L: 4155
                        ...
                        if (var4.name == null) { // L: 4158
                          Interpreter.Interpreter_stringStack[
                              ++UserComparator9.Interpreter_stringStackSize - 1] = ""; // L: 4159
                        } else {
                          Interpreter.Interpreter_stringStack[
                        ...
                        if (var4 == null) { // L: 4186
                          ...
                          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                              - 1] = var4.sprite1; // L: 4190
                        }

                        return 1; // L: 4192
                      } else if (var0 == ScriptOpcodes.WORLDMAP_ELEMENT) { // L: 4194
                        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                            - 1] = Occluder.worldMapEvent.mapElement; // L: 4195
                        return 1; // L: 4196
                      } else if (var0 == 6698) { // L: 4198
                        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                            - 1] = Occluder.worldMapEvent.coord1.packed(); // L: 4199
                        return 1; // L: 4200
                      } else if (var0 == ScriptOpcodes.WORLDMAP_ELEMENTCOORD) { // L: 4202
                        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                            - 1] = Occluder.worldMapEvent.coord2.packed(); // L: 4203
                        return 1; // L: 4204
                      } else {
                        return 2; // L: 4206
                      }
