...
public class WorldMap {
  ...
  @Export("init")
  public void init(AbstractArchive var1, AbstractArchive var2, AbstractArchive var3, Font var4,
      HashMap var5, IndexedSprite[] var6) {
    ...
    this.fonts
        .put(WorldMapLabelSize.WorldMapLabelSize_small, var5.get(fontNameVerdana11)); // L: 111
    this.fonts
        .put(WorldMapLabelSize.WorldMapLabelSize_medium, var5.get(fontNameVerdana13)); // L: 112
    this.fonts
        .put(WorldMapLabelSize.WorldMapLabelSize_large, var5.get(fontNameVerdana15)); // L: 113
  ...
  public void onCycle(int var1, int var2, boolean var3, int var4, int var5, int var6, int var7) {
    if (this.cacheLoader.isLoaded()) { // L: 138
      ...
      if (var3) { // L: 143
        ...
        List var10 = this.worldMapManager
            .method3526(this.centerTileX - var8 / 2 - 1, this.centerTileY - var9 / 2 - 1,
                var8 / 2 + this.centerTileX + 1, var9 / 2 + this.centerTileY + 1, var4, var5, var6,
                var7, var1, var2); // L: 148
        ...
        ScriptEvent var14;
        WorldMapEvent var15;
        for (var12 = var10.iterator(); var12.hasNext();
            WorldMapSection1.runScriptEvent(var14)) { // L: 150 163
  ...
  public void method6133(int var1, int var2, boolean var3, boolean var4) {
    ...
    if (this.hasTarget() || !var4 && !var3) { // L: 184
      ...
      if (this.field4011 != -1) { // L: 191
        ...
        this.setWorldMapPosition(this.field4011 - (int) ((float) var7 / this.zoomTarget),
            (int) ((float) var8 / this.zoomTarget) + this.field4027, false); // L: 194
      }
    }
  ...
  void method6160(int var1, int var2, boolean var3, long var4) {
    if (this.currentMapArea != null) { // L: 208
      int var6 = (int) ((float) this.centerTileX + ((float) (var1 - this.worldMapDisplayX)
          - (float) this.getDisplayWith() * this.zoom / 2.0F) / this.zoom); // L: 209
      int var7 = (int) ((float) this.centerTileY - ((float) (var2 - this.worldMapDisplayY)
          - (float) this.getDisplayHeight() * this.zoom / 2.0F) / this.zoom); // L: 210
      this.mouseCoord = this.currentMapArea.coord(var6 + this.currentMapArea.getRegionLowX() * 64,
          var7 + this.currentMapArea.getRegionLowY() * 64); // L: 211
      if (this.mouseCoord != null && var3) { // L: 212
        boolean var8 = Client.staffModLevel >= 2; // L: 215
        int var10;
        int var11;
        if (var8 && KeyHandler.KeyHandler_pressedKeys[82]
            && KeyHandler.KeyHandler_pressedKeys[81]) { // L: 217
          int var14 = this.mouseCoord.x; // L: 218
          var10 = this.mouseCoord.y; // L: 219
          var11 = this.mouseCoord.plane; // L: 220
          PacketBufferNode var12 = InterfaceParent.getPacketBufferNode(ClientPacket.field2596,
              Client.packetWriter.isaacCipher); // L: 223
          ...
          if (this.field4033) { // L: 233
            ...
            if (var4 - this.field3992 > 500L || var10 < -25 || var10 > 25 || var11 < -25
                || var11 > 25) { // L: 236
              var9 = false; // L: 237
            }
          }
          ...
          if (var9) { // L: 240
            PacketBufferNode var13 = InterfaceParent.getPacketBufferNode(ClientPacket.field2575,
                Client.packetWriter.isaacCipher); // L: 241
  ...
  void scrollToTarget() {
    if (this.hasTarget()) { // L: 266
      ...
      if (this.centerTileX == this.worldMapTargetX
          && this.centerTileY == this.worldMapTargetY) { // L: 278
  ...
  void initializeWorldMapManager(WorldMapArea var1) {
    ...
    this.worldMapManager = new WorldMapManager(this.mapSceneSprites, this.fonts,
        this.WorldMap_geographyArchive, this.WorldMap_groundArchive); // L: 361
  ...
  void jump(int var1, int var2, int var3) {
    if (this.currentMapArea != null) { // L: 381
      ...
      if (var4 == null) { // L: 385
        var4 = this.currentMapArea
            .position(this.currentMapArea.getOriginPlane(), this.currentMapArea.getOriginX(),
                this.currentMapArea.getOriginY()); // L: 386
      }

      this.setWorldMapPosition(var4[0] - this.currentMapArea.getRegionLowX() * 64,
          var4[1] - this.currentMapArea.getRegionLowY() * 64, true); // L: 388
  ...
  public void draw(int var1, int var2, int var3, int var4, int var5) {
    ...
    if (var7 < 100) { // L: 404
      ...
      if (!this.worldMapManager.isLoaded()) { // L: 408
        this.worldMapManager.load(this.WorldMap_archive, this.currentMapArea.getInternalName(),
            Client.isMembersWorld); // L: 409
      ...
      this.worldMapManager.drawTiles(this.centerTileX - var8 / 2, this.centerTileY - var9 / 2,
          var8 / 2 + this.centerTileX, var9 / 2 + this.centerTileY, var1, var2, var3 + var1,
          var2 + var4); // L: 426
      boolean var10;
      if (!this.elementsDisabled) { // L: 427
        ...
        this.worldMapManager.drawElements(this.centerTileX - var8 / 2, this.centerTileY - var9 / 2,
            var8 / 2 + this.centerTileX, var9 / 2 + this.centerTileY, var1, var2, var3 + var1,
            var2 + var4, this.field4037, this.flashingElements, this.flashCycle,
            this.cyclesPerFlash, var10); // L: 433
      }
  ...
  void method6151(int var1, int var2, int var3, int var4, int var5, int var6) {
    if (LoginPacket.field2800 != null) { // L: 459
      ...
      int var13 = var1
          - (var11 + var7 - this.minCachedTileX) * this.worldMapManager.pixelsPerTile; // L: 468
      int var14 = var2 - this.worldMapManager.pixelsPerTile * (var7 - (var12
          - this.minCachedTileY)); // L: 469
      if (this.method6142(var8, var9, var13, var14, var3, var4)) { // L: 470
        if (this.sprite != null && this.sprite.subWidth == var8
            && this.sprite.subHeight == var9) { // L: 471
        ...
        LoginPacket.field2800.method5247(this.minCachedTileX, this.minCachedTileY, this.sprite,
            (float) this.cachedPixelsPerTile / var10); // L: 478
        this.field4026 = Client.field798; // L: 479
        var13 = var1
            - (var7 + var11 - this.minCachedTileX) * this.worldMapManager.pixelsPerTile; // L: 480
        var14 = var2 - this.worldMapManager.pixelsPerTile * (var7 - (var12
            - this.minCachedTileY)); // L: 481
      }
      ...
      if (var10 == 1.0F) { // L: 484
        ...
        this.sprite
            .method7038(var13, var14, (int) (var10 * (float) var8), (int) (var10 * (float) var9),
                192); // L: 488
      }
    }
  ...
  public void drawOverview(int var1, int var2, int var3, int var4) {
    if (this.cacheLoader.isLoaded()) { // L: 494
      ...
      this.worldMapManager
          .drawOverview(var1, var2, var3, var4, this.flashingElements, this.flashCycle,
              this.cyclesPerFlash); // L: 503
    }
  } // L: 495 504
  ...
  public void setWorldMapPositionTargetInstant(int var1, int var2) {
    if (this.currentMapArea != null) { // L: 567
      this.setWorldMapPosition(var1 - this.currentMapArea.getRegionLowX() * 64,
          var2 - this.currentMapArea.getRegionLowY() * 64, true); // L: 570
  ...
  public int getDisplayX() {
    return this.currentMapArea == null ? -1
        : this.centerTileX + this.currentMapArea.getRegionLowX() * 64; // L: 596 597 599
  }
  ...
  public int getDisplayY() {
    return this.currentMapArea == null ? -1
        : this.centerTileY + this.currentMapArea.getRegionLowY() * 64; // L: 603 604 606
  }
  ...
  public Coord getDisplayCoord() {
    return this.currentMapArea == null ? null
        : this.currentMapArea.coord(this.getDisplayX(), this.getDisplayY()); // L: 610 611 613
  }
  ...
  public void flashCategory(int var1) {
    ...
    for (int var2 = 0; var2 < WorldMapElement.WorldMapElement_count; ++var2) { // L: 659
      if (Archive.WorldMapElement_get(var2) != null
          && Archive.WorldMapElement_get(var2).category == var1) { // L: 660 663
  ...
  public void setCategoryDisabled(int var1, boolean var2) {
    ...
    for (int var3 = 0; var3 < WorldMapElement.WorldMapElement_count; ++var3) { // L: 694
      if (Archive.WorldMapElement_get(var3) != null
          && Archive.WorldMapElement_get(var3).category == var1) { // L: 695 698
  ...
  public void addElementMenuOptions(int var1, int var2, int var3, int var4, int var5, int var6) {
    if (this.cacheLoader.isLoaded()) { // L: 730
      ...
      List var9 = this.worldMapManager
          .method3526(this.centerTileX - var7 / 2 - 1, this.centerTileY - var8 / 2 - 1,
              var7 / 2 + this.centerTileX + 1, var8 / 2 + this.centerTileY + 1, var1, var2, var3,
              var4, var5, var6); // L: 735
        ...
        do {
          ...
          for (int var14 = this.menuOpcodes.length - 1; var14 >= 0; --var14) { // L: 744
            if (var12.menuActions[var14] != null) { // L: 745
              class22.insertMenuItemNoShift(var12.menuActions[var14], var12.menuTargetName,
                  this.menuOpcodes[var14], var11.getElement(), var11.coord1.packed(),
                  var11.coord2.packed()); // L: 746
              var13 = true; // L: 747
            }
          }
        } while (!var13); // L: 750
