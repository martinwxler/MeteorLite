...
public class RawPcmStream extends PcmStream {
  ...
  static int method1056(int var0, int var1) {
    return var1 < 0 ? var0
        : (int) ((double) var0 * Math.sqrt((double) (16384 - var1) * 1.220703125E-4D)
            + 0.5D); // L: 23
  }
  ...
  static int method1043(int var0, int var1) {
    return var1 < 0 ? -var0
        : (int) ((double) var0 * Math.sqrt((double) var1 * 1.220703125E-4D) + 0.5D); // L: 27
  }
  ...
  public static RawPcmStream createRawPcmStream(RawSound var0, int var1, int var2) {
    return var0.samples != null && var0.samples.length != 0 ? new RawPcmStream(var0,
        (int) ((long) var0.sampleRate * 256L * (long) var1 / (long) (class341.field3921 * 100)),
        var2 << 6) : null; // L: 63 64
  }
  ...
  public static RawPcmStream method937(RawSound var0, int var1, int var2, int var3) {
    return var0.samples != null && var0.samples.length != 0 ? new RawPcmStream(var0, var1, var2,
        var3) : null; // L: 68 69
  }
  ...
  static int method968(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6,
      int var7, RawPcmStream var8) {
    var2 >>= 8; // L: 583
    var7 >>= 8; // L: 584
    var4 <<= 2; // L: 585
  ...
  static int method984(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6,
      int var7, int var8, int var9, RawPcmStream var10) {
    var3 >>= 8; // L: 603
    var9 >>= 8; // L: 604
    var5 <<= 2; // L: 605
    var6 <<= 2; // L: 606
  ...
  static int method970(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6,
      int var7, RawPcmStream var8) {
    var2 >>= 8; // L: 636
    var7 >>= 8; // L: 637
    var4 <<= 2; // L: 638
  ...
  static int method971(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6,
      int var7, int var8, int var9, RawPcmStream var10) {
    var3 >>= 8; // L: 656
    var9 >>= 8; // L: 657
    var5 <<= 2; // L: 658
  ...
  static int method972(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6,
      int var7, int var8, int var9, RawPcmStream var10, int var11, int var12) {
  ...
  static int method1006(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6,
      int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
  ...
  static int method974(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6,
      int var7, int var8, int var9, RawPcmStream var10, int var11, int var12) {
    ...
    for (var1 = var11; var5 < var7; var4 += var1) { // L: 743 744 746
      var10001 = var5++;
      var3[var10001] +=
          ((var0 << 8) + (var2[var4 >> 8] - var0) * (var4 & 255)) * var6 >> 6; // L: 745
    }
  ...
  static int method975(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6,
      int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
  ...
  static int method976(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6,
      int var7, int var8, RawPcmStream var9) {
    var2 >>= 8; // L: 778
    var8 >>= 8; // L: 779
    var4 <<= 2; // L: 780
    var5 <<= 2; // L: 781
  ...
  static int method977(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6,
      int var7, int var8, int var9, int var10, int var11, RawPcmStream var12) {
    var3 >>= 8; // L: 807
    var11 >>= 8; // L: 808
    var5 <<= 2; // L: 809
    var6 <<= 2; // L: 810
  ...
  static int method978(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6,
      int var7, int var8, RawPcmStream var9) {
    var2 >>= 8; // L: 855
    var8 >>= 8; // L: 856
    var4 <<= 2; // L: 857
  ...
  static int method979(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6,
      int var7, int var8, int var9, int var10, int var11, RawPcmStream var12) {
    var3 >>= 8; // L: 884
    var11 >>= 8; // L: 885
    var5 <<= 2; // L: 886
  ...
  static int method965(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6,
      int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
    ...
    while (var5 < var8) { // L: 935
      ...
      var10001 = var5++;
      var3[var10001] +=
          ((var14 << 8) + (var2[var1 + 1] - var14) * (var4 & 255)) * var6 >> 6; // L: 938
      var6 += var7; // L: 939
      var4 += var12; // L: 940
    }
  ...
  static int method981(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6,
      int var7, int var8, int var9, int var10, int var11, int var12, RawPcmStream var13, int var14,
      int var15) {
    ...
    if (var14 == 0
        || (var10 = (var5 >> 1) + (var12 - var4 + var14 - 1) / var14) > var11) { // L: 972
      var10 = var11;
    }
  ...
  static int method982(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6,
      int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
  ...
  static int method983(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6,
      int var7, int var8, int var9, int var10, int var11, int var12, RawPcmStream var13, int var14,
      int var15) {
        ...
        if (this.numLoops > 0) { // L: 275
          if (this.field466) { // L: 276
            label127:
            {
              ...
              do {
                var9 = this
                    .method1080(var1, var9, var6, var3, var4.samples[this.end - 1]); // L: 285
  ...
  public boolean method1065() {
    return this.field469 < 0
        || this.field469 >= ((RawSound) super.sound).samples.length << 8; // L: 192
  }
    ...
    while (true) {
      if (this.field462 > 0) { // L: 474
        ...
        if (this.field457 == 256 && (this.field469 & 255) == 0) { // L: 478
          if (PcmPlayer.PcmPlayer_stereo) { // L: 479
            var2 = method977(0, ((RawSound) super.sound).samples, var1, this.field469, var2,
                this.field461, this.field456, this.field467, this.field470, 0, var6, var3, this);
          } else {
            var2 = method976(((RawSound) super.sound).samples, var1, this.field469, var2,
                this.field460, this.field468, 0, var6, var3, this); // L: 480
          }
        } else if (PcmPlayer.PcmPlayer_stereo) { // L: 483
          var2 = method981(0, 0, ((RawSound) super.sound).samples, var1, this.field469, var2,
              this.field461, this.field456, this.field467, this.field470, 0, var6, var3, this,
              this.field457, var5);
        } else {
          var2 = method965(0, 0, ((RawSound) super.sound).samples, var1, this.field469, var2,
              this.field460, this.field468, 0, var6, var3, this, this.field457, var5); // L: 484
        }
      ...
      if (this.field457 == 256 && (this.field469 & 255) == 0) { // L: 490
        if (PcmPlayer.PcmPlayer_stereo) { // L: 491
          return method984(0, ((RawSound) super.sound).samples, var1, this.field469, var2,
              this.field461, this.field456, 0, var4, var3, this);
        }

        return method968(((RawSound) super.sound).samples, var1, this.field469, var2, this.field460,
            0, var4, var3, this); // L: 492
      }

      if (PcmPlayer.PcmPlayer_stereo) { // L: 495
        return method1006(0, 0, ((RawSound) super.sound).samples, var1, this.field469, var2,
            this.field461, this.field456, 0, var4, var3, this, this.field457, var5);
      }

      return method972(0, 0, ((RawSound) super.sound).samples, var1, this.field469, var2,
          this.field460, 0, var4, var3, this, this.field457, var5); // L: 496
    }
  }
    ...
    while (true) {
      if (this.field462 > 0) { // L: 501
        ...
        if (this.field457 == -256 && (this.field469 & 255) == 0) { // L: 505
          if (PcmPlayer.PcmPlayer_stereo) { // L: 506
            var2 = method979(0, ((RawSound) super.sound).samples, var1, this.field469, var2,
                this.field461, this.field456, this.field467, this.field470, 0, var6, var3, this);
          } else {
            var2 = method978(((RawSound) super.sound).samples, var1, this.field469, var2,
                this.field460, this.field468, 0, var6, var3, this); // L: 507
          }
        } else if (PcmPlayer.PcmPlayer_stereo) { // L: 510
          var2 = method983(0, 0, ((RawSound) super.sound).samples, var1, this.field469, var2,
              this.field461, this.field456, this.field467, this.field470, 0, var6, var3, this,
              this.field457, var5);
        } else {
          var2 = method982(0, 0, ((RawSound) super.sound).samples, var1, this.field469, var2,
              this.field460, this.field468, 0, var6, var3, this, this.field457, var5); // L: 511
        }
      ...
      if (this.field457 == -256 && (this.field469 & 255) == 0) { // L: 517
        if (PcmPlayer.PcmPlayer_stereo) { // L: 518
          return method971(0, ((RawSound) super.sound).samples, var1, this.field469, var2,
              this.field461, this.field456, 0, var4, var3, this);
        }

        return method970(((RawSound) super.sound).samples, var1, this.field469, var2, this.field460,
            0, var4, var3, this); // L: 519
      }

      if (PcmPlayer.PcmPlayer_stereo) { // L: 522
        return method975(0, 0, ((RawSound) super.sound).samples, var1, this.field469, var2,
            this.field461, this.field456, 0, var4, var3, this, this.field457, var5);
      }

      return method974(0, 0, ((RawSound) super.sound).samples, var1, this.field469, var2,
          this.field460, 0, var4, var3, this, this.field457, var5); // L: 523
    }
  }
