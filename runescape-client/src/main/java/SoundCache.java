  ...
  static int method929(int var0, Script var1, boolean var2) {
    ...
    if (var0 == ScriptOpcodes.APPEND_NUM) { // L: 2992
      ...
      if (var0 == ScriptOpcodes.APPEND) { // L: 2998
        ...
        Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize - 1] =
            var3 + HealthBarDefinition.intToString(var9, true); // L: 3008
        return 1; // L: 3009
        ...
        if (var0 == ScriptOpcodes.FROMDATE) { // L: 3016
          ...
          Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize - 1] =
              var6 + "-" + Interpreter.Interpreter_MONTHS[var17] + "-" + var8; // L: 3023
          return 1; // L: 3024
          ...
          if (var0 == ScriptOpcodes.TOSTRING) { // L: 3034
            ...
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                - 1] = Integer.toString(var10); // L: 3036
            return 1; // L: 3037
          } else if (var0 == ScriptOpcodes.COMPARE) { // L: 3039
            UserComparator9.Interpreter_stringStackSize -= 2; // L: 3040
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = class269
                .method5000(class226.compareStrings(
                    Interpreter.Interpreter_stringStack[UserComparator9.Interpreter_stringStackSize],
                    Interpreter.Interpreter_stringStack[UserComparator9.Interpreter_stringStackSize
                        + 1], AbstractArchive.clientLanguage)); // L: 3041
            return 1; // L: 3042
          } else {
            int var5;
            byte[] var11;
            ...
            if (var0 == ScriptOpcodes.PARAHEIGHT) { // L: 3044
              ...
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = var12
                  .lineCount(var3, var9); // L: 3051
              return 1; // L: 3052
              ...
              Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                  - 1] = AbstractFont.escapeBrackets(var3); // L: 3074
              return 1; // L: 3075
              ...
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                  GameBuild.isCharPrintable((char) var10) ? 1 : 0; // L: 3085
              return 1; // L: 3086
              ...
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                  DynamicObject.isAlphaNumeric((char) var10) ? 1 : 0; // L: 3090
              return 1; // L: 3091
              ...
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                  HitSplatDefinition.isCharAlphabetic((char) var10) ? 1 : 0; // L: 3095
              return 1; // L: 3096
              ...
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
                  class105.isDigit((char) var10) ? 1 : 0; // L: 3100
              return 1; // L: 3101
              ...
              var5 = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
                  + 1]; // L: 3113
              Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                  - 1] = var3.substring(var9, var5); // L: 3114
              return 1; // L: 3115
          ...
          var4 = Interpreter.Interpreter_stringStack[UserComparator9.Interpreter_stringStackSize
              + 1]; // L: 3029
          if (class262.localPlayer.appearance != null
              && class262.localPlayer.appearance.isFemale) { // L: 3030
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                - 1] = var4;
          } else {
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
  ...
  static final void method930(Actor var0) {
    ...
    if (var0.pathLength == 0) { // L: 4199
      ...
      if (var0.sequence != -1 && var0.sequenceDelay == 0) { // L: 4203
        SequenceDefinition var1 = WorldMapScaleHandler
            .SequenceDefinition_get(var0.sequence); // L: 4204
      ...
      if (var3 - var10 <= 256 && var3 - var10 >= -256 && var4 - var2 <= 256
          && var4 - var2 >= -256) { // L: 4231
        ...
        if (var9) { // L: 4249
          if (var0.rotation != var0.orientation && var0.targetIndex == -1
              && var0.field1275 != 0) { // L: 4250
            var8 = 2;
          }
        ...
        if (var8 >= 8 && var0.movementSequence == var0.walkSequence
            && var0.runSequence != -1) { // L: 4267
