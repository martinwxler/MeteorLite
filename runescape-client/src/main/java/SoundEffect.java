...
public class SoundEffect {
  ...
  final byte[] mix() {
    ...
    for (var2 = 0; var2 < 10; ++var2) { // L: 58
      if (this.instruments[var2] != null
          && this.instruments[var2].duration + this.instruments[var2].offset > var1) { // L: 59 60
    ...
    if (var1 == 0) { // L: 63
      ...
      for (int var4 = 0; var4 < 10; ++var4) { // L: 66
        if (this.instruments[var4] != null) { // L: 67
          ...
          int[] var7 = this.instruments[var4]
              .synthesize(var5, this.instruments[var4].duration); // L: 70
