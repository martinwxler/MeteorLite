    ...
    if (var1 == 0) { // L: 59
      ...
      try {
        ...
        Object[] var5 = new Object[]{
            (new URL(class44.applet.getCodeBase(), var0)).toString()}; // L: 78
      ...
      try {
        class44.applet.getAppletContext()
            .showDocument(new URL(class44.applet.getCodeBase(), var0), "_blank"); // L: 92
        return true; // L: 93
      ...
      try {
        class44.applet.getAppletContext()
            .showDocument(new URL(class44.applet.getCodeBase(), var0), "_top"); // L: 105
        return true; // L: 106
