...
public class Rasterizer2D extends DualNode {
  ...
  public static void Rasterizer2D_clear() {
    ...
    int var1;
    for (var1 = Rasterizer2D_width * Rasterizer2D_height - 7; var0 < var1;
        Rasterizer2D_pixels[var0++] = 0) { // L: 66 67 75
  ...
  public static void Rasterizer2D_drawCircleAlpha(int var0, int var1, int var2, int var3,
      int var4) {
    if (var4 != 0) { // L: 136
      if (var4 == 256) { // L: 137
        ...
        while (var14 < var1) { // L: 160
          ...
          for (var23 = var20; var23 < var21; ++var23) { // L: 170
            ...
            var24 =
                (var8 + var11 >> 8) + (var6 + var9 >> 8 << 16) + (var7 + var10 >> 8 << 8); // L: 174
        ...
        for (var19 -= var17; var14 < var13; var18 += var17++ + var17) { // L: 185 186 205
          ...
          for (var23 = var20; var23 <= var21; ++var23) { // L: 196
            ...
            var24 =
                (var8 + var11 >> 8) + (var6 + var9 >> 8 << 16) + (var7 + var10 >> 8 << 8); // L: 200
  ...
  public static void Rasterizer2D_fillRectangleAlpha(int var0, int var1, int var2, int var3,
      int var4, int var5) {
    ...
    var4 =
        (var5 * (var4 & 16711935) >> 8 & 16711935) + (var5 * (var4 & 65280) >> 8 & 65280); // L: 220
    ...
    for (int var9 = 0; var9 < var3; ++var9) { // L: 224
      for (int var10 = -var2; var10 < 0; ++var10) { // L: 225
        ...
        var11 = ((var11 & 16711935) * var6 >> 8 & 16711935) + (var6 * (var11 & 65280) >> 8
            & 65280); // L: 227
  ...
  public static void Rasterizer2D_fillRectangleGradient(int var0, int var1, int var2, int var3,
      int var4, int var5) {
    if (var2 > 0 && var3 > 0) { // L: 256
      ...
      for (int var10 = -var3; var10 < 0; ++var10) { // L: 272
        ...
        int var13 = (var12 * (var5 & 16711935) + var11 * (var4 & 16711935) & -16711936) + (
            var12 * (var5 & 65280) + var11 * (var4 & 65280) & 16711680) >>> 8; // L: 275
  ...
  public static void Rasterizer2D_fillRectangleGradientAlpha(int var0, int var1, int var2, int var3,
      ...
      for (int var12 = -var3; var12 < 0; ++var12) { // L: 301
        ...
        if (var15 == 0) { // L: 305
          ...
          int var16 = (var14 * (var5 & 16711935) + var13 * (var4 & 16711935) & -16711936) + (
              var14 * (var5 & 65280) + var13 * (var4 & 65280) & 16711680) >>> 8; // L: 310
          int var17 = 255 - var15; // L: 311
          int var18 = ((var16 & 16711935) * var15 >> 8 & 16711935) + (var15 * (var16 & 65280) >> 8
              & 65280); // L: 312
          ...
          for (int var19 = -var2; var19 < 0; ++var19) { // L: 313
            ...
            if (var20 == 0) { // L: 315
              ...
              var20 = ((var20 & 16711935) * var17 >> 8 & 16711935) + (var17 * (var20 & 65280) >> 8
                  & 65280); // L: 319
  ...
  public static void Rasterizer2D_drawGradientPixels(int var0, int var1, int var2, int var3,
      int var4, int var5, byte[] var6, int var7) {
          ...
          for (var15 = var9 + var1; var15 < var3 + var9 + var1; ++var15) { // L: 365
            for (var16 = var0 + var8; var16 < var0 + var8 + var2; ++var16) { // L: 366
              ...
              int var23 = ((var19 & 16711935) * var20 + (var22 & 16711935) * var21 & -16711936) + (
                  var20 * (var19 & 65280) + var21 * (var22 & 65280) & 16711680) >> 8; // L: 374
  ...
  public static void Rasterizer2D_drawRectangleAlpha(int var0, int var1, int var2, int var3,
      int var4, int var5) {
  ...
  static void Rasterizer2D_drawHorizontalLineAlpha(int var0, int var1, int var2, int var3,
      int var4) {
    if (var1 >= Rasterizer2D_yClipStart && var1 < Rasterizer2D_yClipEnd) { // L: 410
      ...
      for (int var13 = 0; var13 < var2; ++var13) { // L: 424
        ...
        int var14 =
            (var8 + var11 >> 8) + (var6 + var9 >> 8 << 16) + (var7 + var10 >> 8 << 8); // L: 428
  ...
  static void Rasterizer2D_drawVerticalLineAlpha(int var0, int var1, int var2, int var3, int var4) {
    if (var0 >= Rasterizer2D_xClipStart && var0 < Rasterizer2D_xClipEnd) { // L: 445
      ...
      for (int var13 = 0; var13 < var2; ++var13) { // L: 459
        ...
        int var14 =
            (var8 + var11 >> 8) + (var6 + var9 >> 8 << 16) + (var7 + var10 >> 8 << 8); // L: 463
  ...
  static void Rasterizer2D_setPixel(int var0, int var1, int var2) {
    if (var0 >= Rasterizer2D_xClipStart && var1 >= Rasterizer2D_yClipStart
        && var0 < Rasterizer2D_xClipEnd && var1 < Rasterizer2D_yClipEnd) { // L: 527
  ...
  public static void Rasterizer2D_fillMaskedRectangle(int var0, int var1, int var2, int[] var3,
      int[] var4) {
