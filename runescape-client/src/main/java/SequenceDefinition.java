...
public class SequenceDefinition extends DualNode {
  ...
  public static synchronized void ByteArrayPool_release(byte[] var0) {
    if (var0.length == 100 && ByteArrayPool.ByteArrayPool_smallCount < 1000) { // L: 61
      ByteArrayPool.ByteArrayPool_small[++ByteArrayPool.ByteArrayPool_smallCount
          - 1] = var0; // L: 62
      ...
      ByteArrayPool.ByteArrayPool_large[++ByteArrayPool.ByteArrayPool_largeCount
          - 1] = var0; // L: 70
    } else {
      if (Tiles.ByteArrayPool_arrays != null) { // L: 73
        for (int var1 = 0; var1 < class372.ByteArrayPool_alternativeSizes.length; ++var1) { // L: 74
          if (var0.length == class372.ByteArrayPool_alternativeSizes[var1]
              && WorldMapScaleHandler.ByteArrayPool_altSizeArrayCounts[var1]
              < Tiles.ByteArrayPool_arrays[var1].length) { // L: 75
  ...
  public Model applyTransformations(Model var1, int var2, SequenceDefinition var3, int var4) {
    ...
    if (var5 == null) { // L: 143
      ...
      if (var6 == null) { // L: 147
        ...
        var7 = var1.toSharedSequenceModel(
            !var5.hasAlphaTransform(var2) & !var6.hasAlphaTransform(var4)); // L: 152
  ...
  public Model transformWidgetModel(Model var1, int var2) {
    ...
    if (var4 == null) { // L: 161
      ...
      if (var5 != null && var6 != 65535) { // L: 169
        var7 = var1.toSharedSequenceModel(
            !var4.hasAlphaTransform(var3) & !var5.hasAlphaTransform(var6)); // L: 174
