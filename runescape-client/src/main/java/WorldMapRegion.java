...
public class WorldMapRegion {
  ...
  static int method3472(int var0, Script var1, boolean var2) {
    ...
    if (var0 == ScriptOpcodes.CC_GETTARGETMASK) { // L: 1203
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = ModelData0
          .Widget_unpackTargetMask(class22.getWidgetFlags(var3)); // L: 1204
      return 1; // L: 1205
      ...
      --var4; // L: 1209
      if (var3.actions != null && var4 < var3.actions.length
          && var3.actions[var4] != null) { // L: 1210
        Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
            - 1] = var3.actions[var4]; // L: 1211
      } else {
  ...
  static final void method3519(int var0, int var1) {
    if (Client.currentClanChannels[var0] != null) { // L: 11510
      if (var1 >= 0 && var1 < Client.currentClanChannels[var0].method49()) { // L: 11511
        ClanChannelMember var2 = (ClanChannelMember) Client.currentClanChannels[var0].members
            .get(var1); // L: 11512
        if (var2.rank == -1) { // L: 11513
          PacketWriter var3 = Client.packetWriter; // L: 11514
          PacketBufferNode var4 = InterfaceParent
              .getPacketBufferNode(ClientPacket.field2584, var3.isaacCipher); // L: 11515
          var4.packetBuffer
              .writeByte(3 + class44.stringCp1252NullTerminatedByteSize(var2.name)); // L: 11516
  ...
  void method3407(int var1, int var2, int var3) {
    ...
    SpritePixels var4 = (SpritePixels) WorldMapRegion_cachedSprites
        .get(GameEngine.method716(var5, var6, var7)); // L: 61
    if (var4 != null) { // L: 64
  ...
  void getIcon(ObjectComposition var1, int var2, int var3, int var4, AbstractWorldMapData var5) {
    ...
    if (this.worldMapData_0 != null) { // L: 145
      var7 = new Coord(this.worldMapData_0.minPlane + var2,
          var3 + this.worldMapData_0.regionXLow * 64,
          var4 + this.worldMapData_0.regionYLow * 64); // L: 146
    } else {
      WorldMapData_1 var8 = (WorldMapData_1) var5; // L: 149
      var7 = new Coord(var2 + var8.minPlane, var8.regionXLow * 64 + var3 + var8.getChunkXLow() * 8,
          var4 + var8.regionYLow * 64 + var8.getChunkYLow() * 8); // L: 150
    }
  ...
  void addAllToIconList(List var1) {
    ...
    while (var2.hasNext()) { // L: 189
      ...
      if (Archive.WorldMapElement_get(var3.element).field1569 && var3.coord2.x >> 6 == this.regionX
          && var3.coord2.y >> 6 == this.regionY) { // L: 181 184
        WorldMapIcon_0 var4 = new WorldMapIcon_0(var3.coord2, var3.coord2, var3.element,
            this.method3435(var3.element)); // L: 185
  ...
  boolean loadGeography(AbstractArchive var1) {
    ...
    if (this.worldMapData_0 != null) { // L: 208
      ...
      Iterator var3;
      WorldMapData_1 var4;
      for (var3 = this.worldMapData1List.iterator(); var3.hasNext();
          var2 &= var4.isFullyLoaded()) { // L: 218 222
  ...
  void drawTile(int var1, WorldMapScaleHandler var2, IndexedSprite[] var3, AbstractArchive var4,
    ...
    if (this.worldMapData_0 != null || !this.worldMapData1List.isEmpty()) { // L: 239
      ...
      SpritePixels var6 = (SpritePixels) WorldMapRegion_cachedSprites
          .get(GameEngine.method716(var7, var8, var1)); // L: 246
      if (var6 == null) { // L: 248
        ...
        if (var9) { // L: 262
          ...
          SpritePixels var14 = new SpritePixels(this.pixelsPerTile * 64,
              this.pixelsPerTile * 64); // L: 273
          ...
          WorldMapRegion_cachedSprites.put(var14, GameEngine.method716(var15, var16, var17),
              var14.pixels.length * 4); // L: 285
  ...
  void method3421(int var1, int var2, AbstractWorldMapData var3, WorldMapScaleHandler var4,
      IndexedSprite[] var5) {
  ...
  void drawTileGround(int var1, int var2, AbstractWorldMapData var3, WorldMapScaleHandler var4,
      WorldMapSprite var5) {
    ...
    if (var6 == -1 && var7 == -1) { // L: 359
      Rasterizer2D
          .Rasterizer2D_fillRectangle(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2),
              this.pixelsPerTile, this.pixelsPerTile, this.backgroundColor); // L: 360
    }
    ...
    if (var7 != -1) { // L: 363
      ...
      if (var11 == null) { // L: 368
        ...
        if (var11.texture >= 0) { // L: 375
          var12 = WorldMapID.method3718(
              Rasterizer3D.Rasterizer3D_textureLoader.getAverageTextureRGB(var11.texture),
              96); // L: 376
          var9 = Rasterizer3D.Rasterizer3D_colorPalette[var12] | -16777216; // L: 377
        } else if (var11.primaryRgb == 16711935) { // L: 379
          var9 = var10; // L: 380
        } else {
          var12 = ClientPreferences
              .method2330(var11.hue, var11.saturation, var11.lightness); // L: 383
    ...
    if (var7 > -1 && var3.field2068[0][var1][var2] == 0) { // L: 390
      Rasterizer2D
          .Rasterizer2D_fillRectangle(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2),
              this.pixelsPerTile, this.pixelsPerTile, var8); // L: 391
    } else {
      var9 = this.method3424(var1, var2, var3, var5); // L: 394
      if (var7 == -1) { // L: 395
        Rasterizer2D
            .Rasterizer2D_fillRectangle(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2),
                this.pixelsPerTile, this.pixelsPerTile, var9); // L: 396
      } else {
        var4.method3819(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), var9, var8,
            this.pixelsPerTile, this.pixelsPerTile, var3.field2068[0][var1][var2],
            var3.field2074[0][var1][var2]); // L: 399
      }
    }
  } // L: 392 397 400
      ...
      if (var6 > -1) { // L: 405
        ...
        if (var9 == null) { // L: 410
          ...
          if (var9.texture >= 0) { // L: 417
            var10 = WorldMapID.method3718(
                Rasterizer3D.Rasterizer3D_textureLoader.getAverageTextureRGB(var9.texture),
                96); // L: 418
            var7 = Rasterizer3D.Rasterizer3D_colorPalette[var10] | -16777216; // L: 419
          } else if (var9.primaryRgb == 16711935) { // L: 421
            var7 = var8; // L: 422
          } else {
            var10 = ClientPreferences
                .method2330(var9.hue, var9.saturation, var9.lightness); // L: 425
        ...
        if (var3.field2068[var5][var1][var2] == 0) { // L: 431
          Rasterizer2D.Rasterizer2D_fillRectangle(this.pixelsPerTile * var1,
              this.pixelsPerTile * (63 - var2), this.pixelsPerTile, this.pixelsPerTile,
              var7); // L: 432
        } else {
          var4.method3819(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), 0, var7,
              this.pixelsPerTile, this.pixelsPerTile, var3.field2068[var5][var1][var2],
              var3.field2074[var5][var1][var2]); // L: 435
        }
      }
    }
  ...
  int method3424(int var1, int var2, AbstractWorldMapData var3, WorldMapSprite var4) {
    return var3.floorUnderlayIds[0][var1][var2] == 0 ? this.backgroundColor
        : var4.getTileColor(var1, var2); // L: 442 443 445
  }
      ...
      if (var6 != null && var6.length != 0) { // L: 451
        ...
        for (int var8 = 0; var8 < var7.length; ++var8) { // L: 456
          ...
          boolean var10 = var11 >= WorldMapDecorationType.field3154.id
              && var11 <= WorldMapDecorationType.field3167.id; // L: 462
          if (var10 || class32.method384(var9.decoration)) { // L: 464
            ...
            if (var12.mapSceneId != -1) { // L: 466
              if (var12.mapSceneId != 46 && var12.mapSceneId != 52) { // L: 467
                var4[var12.mapSceneId]
                    .method6997(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2),
                        this.pixelsPerTile * 2, this.pixelsPerTile * 2); // L: 471
              } else {
                var4[var12.mapSceneId]
                    .method6997(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2),
                        this.pixelsPerTile * 2 + 1, this.pixelsPerTile * 2 + 1); // L: 468
              }
            }
          }
        }
            ...
            if (var8.decoration == WorldMapDecorationType.field3170.id) { // L: 502
              ...
              if (var8.rotation == 1) {
                Rasterizer2D.Rasterizer2D_drawHorizontalLine(
                    this.pixelsPerTile * var1 + this.pixelsPerTile - 1,
                    this.pixelsPerTile * (63 - var2), 1, var10); // L: 504
              }
              ...
              if (var11 == 0) { // L: 510
                for (var12 = 0; var12 < this.pixelsPerTile; ++var12) { // L: 511
                  Rasterizer2D.Rasterizer2D_drawHorizontalLine(var12 + this.pixelsPerTile * var1,
                      (64 - var2) * this.pixelsPerTile - 1 - var12, 1, var10); // L: 512
                }
              } else {
                for (var12 = 0; var12 < this.pixelsPerTile; ++var12) { // L: 516
                  Rasterizer2D.Rasterizer2D_drawHorizontalLine(var12 + this.pixelsPerTile * var1,
                      var12 + this.pixelsPerTile * (63 - var2), 1, var10); // L: 517
                }
              }
            }
          }
    ...
    if (var6 != null) { // L: 592
      if (var6.size.method3278(var5)) { // L: 595
        ...
        var7.drawLines(var6.text, var3 - var6.width / 2, var4, var6.width, var6.height,
            -16777216 | var2.field1563, 0, 1, 0, var7.ascent / 2); // L: 599
      }
    }
  } // L: 593 596 600
  ...
  WorldMapLabel createMapLabel(WorldMapElement var1) {
    if (var1.name != null && this.fonts != null
        && this.fonts.get(WorldMapLabelSize.WorldMapLabelSize_small) != null) { // L: 660
  ...
  void method3439(int var1, int var2, int var3, int var4) {
    var3 %= 4; // L: 722
    if (var3 == 0) { // L: 723
      Rasterizer2D.Rasterizer2D_drawVerticalLine(this.pixelsPerTile * var1,
    ...
    if (var3 == 3) {
      Rasterizer2D.Rasterizer2D_drawHorizontalLine(this.pixelsPerTile * var1,
          this.pixelsPerTile * (63 - var2) + this.pixelsPerTile - 1, this.pixelsPerTile,
          var4); // L: 726
    }
