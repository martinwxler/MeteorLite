  ...
  static void doCycleTitle(GameEngine var0) {
    if (Login.worldSelectOpen) { // L: 204
      ...
      if ((MouseHandler.MouseHandler_lastButton == 1
          ...
          && MouseHandler.MouseHandler_lastPressedY >= 453) { // L: 208
      ...
      if (Client.gameState != 5) { // L: 221
        ...
        boolean var24;
        if (Client.archiveLoaders != null && Client.archiveLoadersDone < Client.archiveLoaders
            .size()) { // L: 228
          while (true) {
            ...
            ArchiveLoader var4 = (ArchiveLoader) Client.archiveLoaders
                .get(Client.archiveLoadersDone); // L: 233
        ...
        if (Client.gameState == 10 || Client.gameState == 11) { // L: 250
          ...
          if (AbstractArchive.clientLanguage == Language.Language_EN) { // L: 251
            if (MouseHandler.MouseHandler_lastButton == 1 || !UserComparator3.mouseCam
                && MouseHandler.MouseHandler_lastButton == 4) { // L: 252
              var18 = Login.xPadding + 5; // L: 253
              short var5 = 463; // L: 254
              byte var6 = 100; // L: 255
              byte var7 = 35; // L: 256
              if (MouseHandler.MouseHandler_lastPressedX >= var18
                  && MouseHandler.MouseHandler_lastPressedX <= var6 + var18
                  && MouseHandler.MouseHandler_lastPressedY >= var5
                  && MouseHandler.MouseHandler_lastPressedY <= var7 + var5) { // L: 257
          ...
          if (Login.loginIndex == 0) { // L: 278
            ...
            var29 = 291; // L: 286
            if (var18 == 1 && var25 >= var30 - 75 && var25 <= var30 + 75 && var26 >= var29 - 20
                && var26 <= var29 + 20) { // L: 287
              AttackOption.openURL(class19.method283("secure", true)
                      + "m=account-creation/g=oldscape/create_account_funnel.ws", true,
                  false); // L: 288
            }

            var30 = class25.loginBoxCenter + 80; // L: 290
            if (var18 == 1 && var25 >= var30 - 75 && var25 <= var30 + 75 && var26 >= var29 - 20
                && var26 <= var29 + 20 || var35) { // L: 291
            ...
            if (Login.loginIndex == 1) { // L: 328
              while (true) {
                if (!SecureRandomCallable.isKeyDown()) { // L: 329
                  ...
                  var8 = 321; // L: 338
                  if (var18 == 1 && var25 >= var27 - 75 && var25 <= var27 + 75 && var26 >= var8 - 20
                      && var26 <= var8 + 20) { // L: 339
              ...
              if (Login.loginIndex == 2) { // L: 347
                ...
                if (Client.field903 != null) { // L: 355
                  ...
                  if (var18 == 1 && var25 >= Client.field903.lowX - var30
                      && var25 <= var30 + Client.field903.lowX && var26 >= var28 - 15
                      && var26 < var28) { // L: 357
                    switch (Login.field1012) { // L: 358
                      case 1:
                        CollisionMap.setLoginResponseString("Please enter your username.",
                            "If you created your account after November",
                            "2010, this will be the creation email address."); // L: 361
                        Login.loginIndex = 5; // L: 362
                        return; // L: 363
                      case 2:
                        AttackOption.openURL("https://support.runescape.com/hc/en-gb", true,
                            false); // L: 367
                    }
                  }
                }
                ...
                if (var18 == 1 && var25 >= var30 - 75 && var25 <= var30 + 75 && var26 >= var29 - 20
                  ...
                  if (Login.Login_password.length() == 0) { // L: 381
                    CollisionMap
                        .setLoginResponseString("", "Please enter your password.", ""); // L: 382
                    return; // L: 383
                  }
                ...
                var29 = 277; // L: 400
                Login.field1006 =
                    var25 >= var30 && var25 < var30 + class126.field1477 && var26 >= var29
                        && var26 < var29 + PcmPlayer.field416; // L: 401
                if (var18 == 1 && Login.field1006) { // L: 402
                  ...
                  if (!Client.Login_isUsernameRemembered
                      && class4.clientPreferences.rememberedUsername != null) { // L: 404
                ...
                Login.field1021 =
                    var25 >= var30 && var25 < var30 + class126.field1477 && var26 >= var29
                        && var26 < var29 + PcmPlayer.field416; // L: 411
                ...
                while (true) {
                  ...
                  do {
                    while (true) {
                          ...
                          while (SecureRandomCallable.isKeyDown()) { // L: 421
                            if (SoundCache.field446 != 13) { // L: 422
                              ...
                              for (var11 = 0; var11
                                  ...
                                  .length() && var32
                                  != "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:'@#~,<.>/?\\| "
                                  .charAt(var11); ++var11) { // L: 434 435
                              }

                              if (SoundCache.field446 == 85
                                  && Login.Login_username.length() > 0) { // L: 438
                                Login.Login_username = Login.Login_username
                                    .substring(0, Login.Login_username.length() - 1);
                              }

                              if (SoundCache.field446 == 84
                                  || SoundCache.field446 == 80) { // L: 439
                                Login.currentLoginField = 1;
                              }
                      ...
                      if (SoundCache.field446 == 85
                          && Login.Login_password.length() > 0) { // L: 448
                        Login.Login_password = Login.Login_password
                            .substring(0, Login.Login_password.length() - 1); // L: 449
                        ...
                        if (SoundCache.field446 == 84) { // L: 453
                          ...
                          if (Login.Login_username.length() == 0) { // L: 455
                            CollisionMap.setLoginResponseString("",
                                "Please enter your username/email address.", ""); // L: 456
                            return; // L: 457
                          }
                          ...
                          CollisionMap
                              .setLoginResponseString("", "Connecting to server...", ""); // L: 463
                      ...
                      if ((KeyHandler.KeyHandler_pressedKeys[82]
                          || KeyHandler.KeyHandler_pressedKeys[87])
                          && SoundCache.field446 == 67) { // L: 469
                        Clipboard var19 = Toolkit.getDefaultToolkit()
                            .getSystemClipboard(); // L: 470
                        var20 = var19.getContents(class1.client); // L: 471
                        var33 = 20 - Login.Login_password.length(); // L: 472
                        break;
                      }

                      if (ItemContainer.method2181(Timer.field3780) && PacketWriter
                          .method2496(Timer.field3780)
                          && Login.Login_password.length() < 20) { // L: 489
                  ...
                  try {
                    String var13 = (String) var20
                        .getTransferData(DataFlavor.stringFlavor); // L: 475
                    int var14 = Math.min(var33, var13.length()); // L: 476

                    for (int var15 = 0; var15 < var14; ++var15) { // L: 477
                      if (!ItemContainer.method2181(var13.charAt(var15)) || !PacketWriter
                          .method2496(var13.charAt(var15))) { // L: 478
                    ...
                    Login.Login_password =
                        Login.Login_password + var13.substring(0, var14); // L: 483
                ...
                if (var18 == 1 && var25 >= var27 - 75 && var25 <= var27 + 75 && var26 >= var8 - 20
                  ...
                  CollisionMap.setLoginResponseString("Please enter your username.",
                      "If you created your account after November",
                      "2010, this will be the creation email address."); // L: 505
                ...
                if (Login.loginIndex == 4) { // L: 510
                  ...
                  if (var18 == 1 && var25 >= var27 - 75 && var25 <= var27 + 75 && var26 >= var8 - 20
                    ...
                    if (ItemLayer.otp.length() != 6) { // L: 515
                      CollisionMap
                          .setLoginResponseString("", "Please enter a 6-digit PIN.", ""); // L: 516
                      return; // L: 517
                    }
                    ...
                    CollisionMap
                        .setLoginResponseString("", "Connecting to server...", ""); // L: 522
                    Projectile.updateGameState(20); // L: 523
                    return; // L: 524
                  }

                  if (var18 == 1 && var25 >= Login.loginBoxX + 180 - 9
                      && var25 <= Login.loginBoxX + 180 + 130 && var26 >= 263
                      && var26 <= 296) { // L: 526
                    Login.field1022 = !Login.field1022; // L: 527
                  }

                  if (var18 == 1 && var25 >= Login.loginBoxX + 180 - 34
                      && var25 <= Login.loginBoxX + 34 + 180 && var26 >= 351
                      && var26 <= 363) { // L: 529
                    AttackOption.openURL(class19.method283("secure", true)
                        + "m=totp-authenticator/disableTOTPRequest", true, false); // L: 530
                  }
                  ...
                  while (SecureRandomCallable.isKeyDown()) { // L: 540
                    ...
                    if (SoundCache.field446 == 13) { // L: 548
                      ...
                      if (SoundCache.field446 == 84) { // L: 557
                        ...
                        CollisionMap
                            .setLoginResponseString("", "Connecting to server...", ""); // L: 566
                  ...
                  if (DefaultsGroup.field3891 != null) { // L: 586
                    ...
                    if (var18 == 1 && var25 >= DefaultsGroup.field3891.lowX - var10
                        && var25 <= var10 + DefaultsGroup.field3891.lowX && var26 >= var29 - 15
                        && var26 < var29) { // L: 588
                      AttackOption.openURL(
                          class19.method283("secure", true) + "m=weblogin/g=oldscape/cant_log_in",
                          true, false); // L: 589
                    }
                  }
                  ...
                  while (SecureRandomCallable.isKeyDown()) { // L: 592
                    ...
                    if (SoundCache.field446 == 13) { // L: 600
                      ...
                      if (SoundCache.field446 == 85
                          && Login.Login_username.length() > 0) { // L: 604
                        Login.Login_username = Login.Login_username
                            .substring(0, Login.Login_username.length() - 1);
                      }
                  ...
                  if (Login.loginIndex == 7) { // L: 624
                    ...
                    var8 = 321; // L: 626
                    if (var18 == 1 && var25 >= var27 - 75 && var25 <= var27 + 75
                        && var26 >= var8 - 20 && var26 <= var8 + 20) { // L: 627
                      AttackOption
                          .openURL(class19.method283("secure", true) + "m=dob/set_dob.ws", true,
                              false); // L: 628
                      CollisionMap.setLoginResponseString("", "Page has opened in a new window.",
                          "(Please check your popup blocker.)"); // L: 629
                    ...
                    if (var18 == 1 && var25 >= var27 - 75 && var25 <= var27 + 75
                        && var26 >= var8 - 20 && var26 <= var8 + 20) { // L: 634
                    ...
                    var8 = 321; // L: 640
                    if (var18 == 1 && var25 >= var27 - 75 && var25 <= var27 + 75
                        && var26 >= var8 - 20 && var26 <= var8 + 20) { // L: 641
                      AttackOption
                          .openURL("https://www.jagex.com/terms/privacy", true, false); // L: 642
                      CollisionMap.setLoginResponseString("", "Page has opened in a new window.",
                          "(Please check your popup blocker.)"); // L: 643
                    ...
                    if (var18 == 1 && var25 >= var27 - 75 && var25 <= var27 + 75
                        && var26 >= var8 - 20 && var26 <= var8 + 20) { // L: 648
                    ...
                    var29 = 276; // L: 666
                    if (var18 == 1 && var25 >= var30 - 75 && var25 <= var30 + 75
                        && var26 >= var29 - 20 && var26 <= var29 + 20) { // L: 667
                      AttackOption.openURL(var21, true, false); // L: 668
                      CollisionMap.setLoginResponseString("", "Page has opened in a new window.",
                          "(Please check your popup blocker.)"); // L: 669
                    ...
                    var29 = 326; // L: 674
                    if (var18 == 1 && var25 >= var30 - 75 && var25 <= var30 + 75
                        && var26 >= var29 - 20 && var26 <= var29 + 20) { // L: 675
                    ...
                    var8 = 301; // L: 681
                    if (var18 == 1 && var25 >= var27 - 75 && var25 <= var27 + 75
                        && var26 >= var8 - 20 && var26 <= var8 + 20) { // L: 682
