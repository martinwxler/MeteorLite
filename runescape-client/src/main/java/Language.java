...
public class Language implements Enumerated {
  ...
  static {
    ...
    Language_ES_MX = new Language("ES_MX", "es-mx", "Spanish (Latin American)", ModeWhere.field3701,
        6, "MX"); // L: 16
    Language[] var0 = new Language[]{Language_EN, Language_ES, Language_ES_MX, Language_PT,
        Language_FR, Language_DE, Language_NL}; // L: 25
  ...
  public static Language method5269(int var0) {
    return var0 >= 0 && var0 < Language_valuesOrdered.length ? Language_valuesOrdered[var0]
        : null; // L: 64 65
  }
  ...
  static void method5270() {
    GrandExchangeEvent.method5222(UserComparator3.menuWidth / 2 + StructComposition.menuX,
        class143.menuY); // L: 7906
  } // L: 7907
