  ...
  static final void method5203(int var0, int var1, boolean var2) {
    if (Client.currentClanChannels[var0] != null) { // L: 11524
      if (var1 >= 0 && var1 < Client.currentClanChannels[var0].method49()) { // L: 11525
        ClanChannelMember var3 = (ClanChannelMember) Client.currentClanChannels[var0].members
            .get(var1); // L: 11526
        PacketWriter var4 = Client.packetWriter; // L: 11527
        PacketBufferNode var5 = InterfaceParent
            .getPacketBufferNode(ClientPacket.field2675, var4.isaacCipher); // L: 11528
        var5.packetBuffer
            .writeByte(4 + class44.stringCp1252NullTerminatedByteSize(var3.name)); // L: 11529
