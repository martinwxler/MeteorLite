...
public abstract class Renderable extends DualNode {
  ...
  public static File method4244(String var0, String var1, int var2) {
    ...
    SecureRandomCallable.JagexCache_locationFile = new File(JagexCache.userHomeDirectory,
        "jagex_cl_" + var0 + "_" + var1 + var3 + ".dat"); // L: 41
    ...
    if (SecureRandomCallable.JagexCache_locationFile.exists()) { // L: 45
      try {
        AccessFile var7 = new AccessFile(SecureRandomCallable.JagexCache_locationFile, "rw",
            10000L); // L: 48

        int var9;
        for (var8 = new Buffer((int) var7.length()); var8.offset < var8.array.length;
            var8.offset += var9) { // L: 49 50 53
    ...
    if (var4 == null && var2 == 0) { // L: 102
      ...
      for (int var16 = 0; var16 < JagexCache.cacheSubPaths.length; ++var16) { // L: 103
        for (int var17 = 0; var17 < ArchiveLoader.cacheParentPaths.length; ++var17) { // L: 104
          File var18 = new File(
              ArchiveLoader.cacheParentPaths[var17] + JagexCache.cacheSubPaths[var16]
                  + File.separatorChar + var0 + File.separatorChar); // L: 105
    ...
    if (var4 == null) { // L: 133
      var4 = JagexCache.userHomeDirectory + File.separatorChar + "jagexcache" + var3
          + File.separatorChar + var0 + File.separatorChar + var1 + File.separatorChar; // L: 134
      var6 = true; // L: 135
    }
    ...
    if (var6) { // L: 159
      ...
      try {
        AccessFile var34 = new AccessFile(SecureRandomCallable.JagexCache_locationFile, "rw",
            10000L); // L: 165
  ...
  static int method4250(int var0, Script var1, boolean var2) {
    ...
    if (var0 >= 2000) { // L: 1017
      ...
      var3 = WorldMapData_1.getWidget(
          Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]); // L: 1019
    } else {
    ...
    if (var4.length() > 0 && var4.charAt(var4.length() - 1) == 'Y') { // L: 1024
      ...
      if (var6 > 0) { // L: 1026
        for (var5 = new int[var6]; var6-- > 0;
            var5[var6] = Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]) { // L: 1027 1028
        }
      }
    ...
    for (var7 = var8.length - 1; var7 >= 1; --var7) { // L: 1033
      if (var4.charAt(var7 - 1) == 's') { // L: 1034
        ...
        var8[var7] = new Integer(
            Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]); // L: 1035
      }
    }
