...
public final class BZip2Decompressor {
  ...
  public static int BZip2Decompressor_decompress(byte[] var0, int var1, byte[] var2, int var3,
      int var4) {
    ...
    while (true) {
      while (var26) {
        ...
        for (var38 = 0; var38 < var40; ++var38) { // L: 254
          ...
          BZip2Decompressor_createHuffmanTables(var0.limit[var38], var0.base[var38],
              var0.perm[var38], var0.temp_charArray2d[var38], var2, var3, var39); // L: 261
        ...
        int var52;
        byte var53;
        for (var52 = BZip2Decompressor_readBits(var22, var0); var52 > var23[var51];
            var52 = var52 << 1 | var53) { // L: 293 295 298
          ++var51; // L: 296
          ...
          while (var46 != var42) { // L: 302
            if (var46 != 0 && var46 != 1) { // L: 303
              ...
              if (var33 < 16) { // L: 350
                ...
                for (var1 = var0.ll8[var30]; var30 > var0.getAndMoveToFrontDecode_yy[var31];
                    --var30) { // L: 371 372 374
                  var0.ll8[var30] = var0.ll8[var30 - 1]; // L: 373
                }

                for (var10002 = var0.getAndMoveToFrontDecode_yy[var31]++; var31 > 0;
                    --var31) { // L: 376 377 380
                  var10002 = var0.getAndMoveToFrontDecode_yy[var31]--; // L: 378
                  var0.ll8[var0.getAndMoveToFrontDecode_yy[var31]] = var0.ll8[
                      var0.getAndMoveToFrontDecode_yy[var31 - 1] + 16 - 1]; // L: 379
                }
                ...
                if (var0.getAndMoveToFrontDecode_yy[0] == 0) { // L: 384
                  ...
                  for (var35 = 15; var35 >= 0; --var35) { // L: 386
                    for (var55 = 15; var55 >= 0; --var55) { // L: 387
                      var0.ll8[var56] = var0.ll8[var0.getAndMoveToFrontDecode_yy[var35]
                          + var55]; // L: 388
                      --var56; // L: 389
                    }
              ...
              BZip2State.BZip2Decompressor_block[var47] =
                  var0.seqToUnseq[var1 & 255] & 255; // L: 397
              ++var47; // L: 398
              if (var45 == 0) { // L: 399
                ++var43; // L: 400
                var45 = 50; // L: 401
              ...
              for (var52 = BZip2Decompressor_readBits(var22, var0); var52 > var23[var51];
                  var52 = var52 << 1 | var53) { // L: 410 412 415
                ++var51; // L: 413
              ...
              do {
                ...
                for (var52 = BZip2Decompressor_readBits(var22, var0); var52 > var23[var51];
                    var52 = var52 << 1 | var53) { // L: 321 323 326
                  ++var51; // L: 324
  ...
  static void BZip2Decompressor_createHuffmanTables(int[] var0, int[] var1, int[] var2, byte[] var3,
