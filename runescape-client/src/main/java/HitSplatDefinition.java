...
public class HitSplatDefinition extends DualNode {
  ...
  public String getString(int var1) {
    ...
    while (true) {
      ...
      var2 = var2.substring(0, var3) + HealthBarDefinition.intToString(var1, false) + var2
          .substring(var3 + 2); // L: 121
    }
  }
  ...
  public SpritePixels method2978() {
    if (this.field1739 < 0) { // L: 127
      ...
      SpritePixels var1 = (SpritePixels) HitSplatDefinition_cachedSprites
          .get((long) this.field1739); // L: 128
      if (var1 != null) {
        return var1; // L: 129
      } else {
  ...
  public Font getFont() {
    if (this.fontId == -1) { // L: 167
      ...
      if (var1 != null) { // L: 169
        ...
        var1 = Bounds
            .method6034(field1741, HitSplatDefinition_fontsArchive, this.fontId, 0); // L: 170
        if (var1 != null) {
