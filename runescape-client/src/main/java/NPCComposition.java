...
public class NPCComposition extends DualNode {
  ...
  public static void method2868(AbstractArchive var0, AbstractArchive var1, AbstractArchive var2,
    ...
    GrandExchangeOfferOwnWorldComparator.Widget_interfaceComponents = new Widget[AttackOption.Widget_archive
        .getGroupCount()][]; // L: 194
    Widget.Widget_loadedInterfaces = new boolean[AttackOption.Widget_archive
        .getGroupCount()]; // L: 195
  } // L: 196
  ...
  static int method2857(int var0, Script var1, boolean var2) {
    ...
    if (var0 == ScriptOpcodes.ADD) { // L: 2784
      ...
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = (int) (
          Math.random() * (double) var3); // L: 2814
      return 1; // L: 2815
      ...
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = (int) (
          Math.random() * (double) (var3 + 1)); // L: 2819
      return 1; // L: 2820
    } else {
      int var5;
      int var6;
      ...
      if (var0 == ScriptOpcodes.INTERPOLATE) { // L: 2822
        ...
        var7 = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
            + 4]; // L: 2828
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
            var3 + (var7 - var5) * (var4 - var3) / (var6 - var5); // L: 2829
        return 1; // L: 2830
        ...
        if (var3 == 0) { // L: 2871
          ...
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = (int) Math
              .pow((double) var3, (double) var4); // L: 2872
        }
        ...
        if (var3 == 0) { // L: 2879
          ...
          switch (var4) { // L: 2883
            ...
            case 2:
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                  - 1] = (int) Math.sqrt((double) var3); // L: 2886
              break;
            case 3:
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                  - 1] = (int) Math.cbrt((double) var3); // L: 2891
              break; // L: 2892
            case 4:
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                  - 1] = (int) Math.sqrt(Math.sqrt((double) var3)); // L: 2901
              break; // L: 2902
            default:
              Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                  - 1] = (int) Math.pow((double) var3, 1.0D / (double) var4); // L: 2911
          }
        ...
        long var11 = (long) Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
            + 1]; // L: 2934
        long var13 = (long) Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
            + 2]; // L: 2935
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = (int) (
            var9 * var13 / var11); // L: 2936
        return 1; // L: 2937
      } else if (var0 == ScriptOpcodes.BITCOUNT) { // L: 2939
        var3 = class269.method4992(
            Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]); // L: 2940
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
            - 1] = var3; // L: 2941
        return 1; // L: 2942
        ...
        var5 = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
            + 2]; // L: 2955
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = WorldMapLabel
            .method3714(var3, var4, var5); // L: 2956
        return 1; // L: 2957
        ...
        var5 = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
            + 2]; // L: 2963
        Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
            - 1] = AbstractWorldMapIcon.method3785(var3, var4, var5); // L: 2964
        return 1; // L: 2965
  ...
  @Export("getModel")
  public final Model getModel(SequenceDefinition var1, int var2, SequenceDefinition var3,
      int var4) {
