...
public class FloorOverlayDefinition extends DualNode {
  ...
  static final void drawMinimap(Widget var0, int var1, int var2, int var3) {
    ...
    if (var4 != null) { // L: 11315
      Rasterizer2D
          .Rasterizer2D_setClip(var1, var2, var4.width + var1, var2 + var4.height); // L: 11316
      if (Client.minimapState != 2 && Client.minimapState != 5) { // L: 11317
        ...
        class69.sceneMinimapSprite
            .drawRotatedMaskedCenteredAround(var1, var2, var4.width, var4.height, var6, var7, var5,
                256, var4.xStarts, var4.xWidths); // L: 11321
        ...
        for (var8 = 0; var8 < Client.mapIconCount; ++var8) { // L: 11322
          ...
          class32.drawSpriteOnMinimap(var1, var2, var16, var10, Client.mapIcons[var8],
              var4); // L: 11325
        }
        ...
        for (var8 = 0; var8 < 104; ++var8) { // L: 11327
          for (var16 = 0; var16 < 104; ++var16) { // L: 11328
            ...
            if (var14 != null) { // L: 11330
              ...
              class32.drawSpriteOnMinimap(var1, var2, var11, var12, class171.mapDotSprites[0],
                  var4); // L: 11333
            }
          }
        }
        ...
        for (var8 = 0; var8 < Client.npcCount; ++var8) { // L: 11337
          ...
          if (var9 != null && var9.isVisible()) { // L: 11339
            ...
            if (var18 != null && var18.drawMapDot && var18.isInteractable) { // L: 11342
              ...
              class32.drawSpriteOnMinimap(var1, var2, var11, var12, class171.mapDotSprites[1],
                  var4); // L: 11345
            }
          }
        }
        ...
        for (var10 = 0; var10 < var8; ++var10) { // L: 11351
          ...
          if (var15 != null && var15.isVisible() && !var15.isHidden
              && var15 != class262.localPlayer) { // L: 11353
            ...
            if (var15.isFriend()) { // L: 11356
              class32
                  .drawSpriteOnMinimap(var1, var2, var12, var13, class171.mapDotSprites[3], var4);
            } else if (class262.localPlayer.team != 0 && var15.team != 0
                && var15.team == class262.localPlayer.team) { // L: 11357
              class32
                  .drawSpriteOnMinimap(var1, var2, var12, var13, class171.mapDotSprites[4], var4);
            } else if (var15.isFriendsChatMember()) { // L: 11358
              class32
                  .drawSpriteOnMinimap(var1, var2, var12, var13, class171.mapDotSprites[5], var4);
            } else if (var15.isClanMember()) { // L: 11359
              class32
                  .drawSpriteOnMinimap(var1, var2, var12, var13, class171.mapDotSprites[6], var4);
            } else {
              class32.drawSpriteOnMinimap(var1, var2, var12, var13, class171.mapDotSprites[2],
                  var4); // L: 11360
            }
          }
        }
        ...
        if (Client.hintArrowType != 0 && Client.cycle % 20 < 10) { // L: 11363
          if (Client.hintArrowType == 1 && Client.hintArrowNpcIndex >= 0
              && Client.hintArrowNpcIndex < Client.npcs.length) { // L: 11364
            ...
            if (var19 != null) { // L: 11366
              ...
              SoundSystem
                  .worldToMinimap(var1, var2, var11, var12, BuddyRankComparator.mapMarkerSprites[1],
                      var4); // L: 11369
            }
          }

          if (Client.hintArrowType == 2) { // L: 11372
            var10 = Client.hintArrowX * 4 - class15.baseX * 4 + 2
                - class262.localPlayer.x / 32; // L: 11373
            var11 = Client.hintArrowY * 4 - WorldMapSprite.baseY * 4 + 2
                - class262.localPlayer.y / 32; // L: 11374
            SoundSystem
                .worldToMinimap(var1, var2, var10, var11, BuddyRankComparator.mapMarkerSprites[1],
                    var4); // L: 11375
          }

          if (Client.hintArrowType == 10 && Client.hintArrowPlayerIndex >= 0
              && Client.hintArrowPlayerIndex < Client.players.length) { // L: 11377
        ...
        if (Client.destinationX != 0) { // L: 11386
          ...
          class32.drawSpriteOnMinimap(var1, var2, var10, var11,
              BuddyRankComparator.mapMarkerSprites[0], var4); // L: 11389
        }

        if (!class262.localPlayer.isHidden) { // L: 11391
          Rasterizer2D
              .Rasterizer2D_fillRectangle(var4.width / 2 + var1 - 1, var4.height / 2 + var2 - 1, 3,
                  3, 16777215);
        }
      } else {
        Rasterizer2D.Rasterizer2D_fillMaskedRectangle(var1, var2, 0, var4.xStarts,
            var4.xWidths); // L: 11393
      }
