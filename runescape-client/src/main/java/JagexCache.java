...
public class JagexCache {
  ...
  static final void method2637(int var0, int var1, int var2, boolean var3) {
    if (class20.loadInterface(var0)) { // L: 9946
      DynamicObject
          .resizeInterface(GrandExchangeOfferOwnWorldComparator.Widget_interfaceComponents[var0],
              -1, var1, var2, var3); // L: 9947
    }
  } // L: 9948
        ...
        if (var1 == 1 && var3.onSubChange != null) { // L: 10883
          if (var3.childIndex >= 0) { // L: 10884
            ...
            if (var6 == null || var6.children == null || var3.childIndex >= var6.children.length
                || var3 != var6.children[var3.childIndex]) { // L: 10886
              continue;
            }
          }
