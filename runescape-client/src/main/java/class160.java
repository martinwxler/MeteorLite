  ...
  static void addPlayerToScene(Player var0, boolean var1) {
    if (var0 != null && var0.isVisible() && !var0.isHidden) { // L: 4778
      ...
      if ((Client.isLowDetail && Players.Players_count > 50 || Players.Players_count > 200) && var1
          && var0.movementSequence == var0.idleSequence) { // L: 4780 4781
      ...
      if (var2 >= 0 && var2 < 104 && var3 >= 0 && var3 < 104) { // L: 4785
        ...
        if (var0.model0 != null && Client.cycle >= var0.animationCycleStart
            && Client.cycle < var0.animationCycleEnd) { // L: 4787
          var0.isUnanimated = false; // L: 4788
          var0.tileHeight = ItemContainer
              .getTileHeight(var0.x, var0.y, SoundSystem.Client_plane); // L: 4789
          var0.playerCycle = Client.cycle; // L: 4790
          DevicePcmPlayerProvider.scene
              .addNullableObject(SoundSystem.Client_plane, var0.x, var0.y, var0.tileHeight, 60,
                  var0, var0.rotation, var4, var0.minX, var0.minY, var0.maxX, var0.maxY); // L: 4791
        } else {
          ...
          var0.tileHeight = ItemContainer
              .getTileHeight(var0.x, var0.y, SoundSystem.Client_plane); // L: 4798
          var0.playerCycle = Client.cycle; // L: 4799
          DevicePcmPlayerProvider.scene
              .drawEntity(SoundSystem.Client_plane, var0.x, var0.y, var0.tileHeight, 60, var0,
                  var0.rotation, var4, var0.isWalking); // L: 4800
        }
      }
    }
