...
public class ClanChannel extends Node {
  ...
  static final void worldToScreen(int var0, int var1, int var2) {
    if (var0 >= 128 && var1 >= 128 && var0 <= 13056 && var1 <= 13056) { // L: 5431
      int var3 =
          ItemContainer.getTileHeight(var0, var1, SoundSystem.Client_plane) - var2; // L: 5436
      ...
      if (var1 >= 50) { // L: 5450
        Client.viewportTempX =
            var0 * Client.viewportZoom / var1 + Client.viewportWidth / 2; // L: 5451
        Client.viewportTempY =
            var8 * Client.viewportZoom / var1 + Client.viewportHeight / 2; // L: 5452
      } else {
  ...
  public int[] getSortedMembers() {
    if (this.sortedMembers == null) { // L: 29
      ...
      for (int var2 = 0; var2 < this.members.size();
          this.sortedMembers[var2] = var2++) { // L: 32 34
