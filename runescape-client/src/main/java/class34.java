...
public enum class34 implements Enumerated {
  ...
  static void load() {
    ...
    if (Client.titleLoadingStage == 0) { // L: 1747
      ...
      GrandExchangeOfferOwnWorldComparator.archive13 = UrlRequest
          .newArchive(13, true, false, true); // L: 1776
      ...
      var21 +=
          class10.archive17.method5044() && class10.archive17.isFullyLoaded() ? 1 : 0; // L: 1809
      if (var21 != 100) { // L: 1810
        if (var21 != 0) { // L: 1811
      ...
      ItemLayer.method3860(class306.archive15, PacketWriter.archive14, class26.archive4,
          var39); // L: 1847
      ...
      class314.WorldMapElement_fonts = new Fonts(ModeWhere.archive8,
          GrandExchangeOfferOwnWorldComparator.archive13); // L: 1855
      ...
      FontName[] var32 = new FontName[]{FontName.FontName_verdana15, FontName.FontName_verdana11,
          FontName.FontName_verdana13, FontName.FontName_bold12, FontName.FontName_plain11,
          FontName.FontName_plain12}; // L: 1863
      Client.fontsMap = var38.createMap(var32); // L: 1865
      if (Client.fontsMap.size() < var21) { // L: 1866
        Login.Login_loadingText =
            "Loading fonts - " + Client.fontsMap.size() * 100 / var21 + "%"; // L: 1867
        Login.Login_loadingPercent = 40; // L: 1868
      } else {
        UserComparator10.fontPlain11 = (Font) Client.fontsMap
            .get(FontName.FontName_plain11); // L: 1871
        AbstractSocket.fontPlain12 = (Font) Client.fontsMap
            .get(FontName.FontName_plain12); // L: 1872
      ...
      if (Client.titleLoadingStage == 60) { // L: 1880
        ...
        if (!SecureRandomFuture.archive2.isFullyLoaded()) { // L: 1923
          Login.Login_loadingText =
              "Loading config - " + SecureRandomFuture.archive2.loadPercent() + "%"; // L: 1924
          ...
          TileItem.KitDefinition_fileCount = class125.KitDefinition_archive
              .getGroupFileCount(3); // L: 1938
          Actor.method2262(SecureRandomFuture.archive2, PcmPlayer.archive7,
              Client.isLowDetail); // L: 1940
          ...
          ItemComposition.ItemDefinition_fileCount = ItemComposition.ItemDefinition_archive
              .getGroupFileCount(10); // L: 1959
          ...
          NPCComposition.method2868(class18.archive3, PcmPlayer.archive7, ModeWhere.archive8,
              GrandExchangeOfferOwnWorldComparator.archive13); // L: 1976
          ...
          class27.field215 = new class370(class182.field2114, 54, AbstractArchive.clientLanguage,
              SecureRandomFuture.archive2); // L: 1990
          class26.HitSplatDefinition_cachedSprites = new class370(class182.field2114, 47,
              AbstractArchive.clientLanguage, SecureRandomFuture.archive2); // L: 1991
          class20.varcs = new Varcs(); // L: 1992
          LoginScreenAnimation.method2312(SecureRandomFuture.archive2, ModeWhere.archive8,
              GrandExchangeOfferOwnWorldComparator.archive13); // L: 1993
        ...
        if (Friend.compass == null) { // L: 2020
          Friend.compass = Tile
              .SpriteBuffer_getSprite(ModeWhere.archive8, ClanChannel.spriteIds.compass, 0);
        } else {
          ++var21; // L: 2021
        }

        if (class22.redHintArrowSprite == null) { // L: 2022
          class22.redHintArrowSprite = Tile
              .SpriteBuffer_getSprite(ModeWhere.archive8, ClanChannel.spriteIds.field3892, 0);
        } else {
          ++var21; // L: 2023
        }
        ...
        if (var21 < 11) { // L: 2315
          ...
          FloorDecoration.mapSceneSprites[0]
              .shiftColors(var22 + var24, var23 + var24, var3 + var24); // L: 2326
        ...
        if (!class16.archive9.isFullyLoaded()) { // L: 2333
          ...
          Renderable.textureProvider = new TextureProvider(class16.archive9, ModeWhere.archive8, 20,
              class4.clientPreferences.field1312, Client.isLowDetail ? 64 : 128); // L: 2338
        ...
        if (!JagexCache.archive10.tryLoadFileByNames("huffman", "")) { // L: 2365
          ...
          Huffman var0 = new Huffman(
              JagexCache.archive10.takeFileByNames("huffman", "")); // L: 2370
        ...
        if (!class18.archive3.isFullyLoaded()) { // L: 2378
          Login.Login_loadingText =
              "Loading interfaces - " + class18.archive3.loadPercent() * 4 / 5 + "%"; // L: 2379
          Login.Login_loadingPercent = 96; // L: 2380
        } else if (!Varcs.archive12.isFullyLoaded()) { // L: 2383
          Login.Login_loadingText =
              "Loading interfaces - " + (80 + Varcs.archive12.loadPercent() / 6) + "%"; // L: 2384
          Login.Login_loadingPercent = 96; // L: 2385
        } else if (!GrandExchangeOfferOwnWorldComparator.archive13.isFullyLoaded()) { // L: 2388
          Login.Login_loadingText = "Loading interfaces - " + (96
              + GrandExchangeOfferOwnWorldComparator.archive13.loadPercent() / 50) + "%"; // L: 2389
        ...
        if (!WorldMapEvent.archive19
            .tryLoadGroupByName(WorldMapCacheName.field2131.name)) { // L: 2400
          Login.Login_loadingText = "Loading world map - "
              + WorldMapEvent.archive19.groupLoadPercentByName(WorldMapCacheName.field2131.name)
              / 10 + "%"; // L: 2401
        } else {
          if (class80.worldMap == null) { // L: 2404
            class80.worldMap = new WorldMap(); // L: 2405
            class80.worldMap
                .init(WorldMapEvent.archive19, class6.archive18, WorldMapLabel.archive20,
                    class309.fontBold12, Client.fontsMap,
                    FloorDecoration.mapSceneSprites); // L: 2406
          }
