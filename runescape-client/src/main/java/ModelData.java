...
public class ModelData extends Renderable {
  ...
  static {
    field2197 = new int[10000]; // L: 44
    field2179 = new int[10000]; // L: 45
    field2199 = 0; // L: 46
    ...
    for (var9 = 0; var9 < var2; ++var9) { // L: 522
      ...
      if (var10 != null) { // L: 524
        ...
        for (var11 = 0; var11 < var10.faceCount; ++var11) { // L: 525
          ...
          this.indices1[this.faceCount] = this.method3868(var10, var10.indices1[var11]); // L: 548
          this.indices2[this.faceCount] = this.method3868(var10, var10.indices2[var11]); // L: 549
          this.indices3[this.faceCount] = this.method3868(var10, var10.indices3[var11]); // L: 550
        ...
        for (var11 = 0; var11 < var10.textureTriangleCount; ++var11) { // L: 553
          ...
          if (var12 == 0) { // L: 555
            this.texTriangleX[this.textureTriangleCount] = (short) this
                .method3868(var10, var10.texTriangleX[var11]); // L: 556
            this.texTriangleY[this.textureTriangleCount] = (short) this
                .method3868(var10, var10.texTriangleY[var11]); // L: 557
            this.texTriangleZ[this.textureTriangleCount] = (short) this
                .method3868(var10, var10.texTriangleZ[var11]); // L: 558
          }
  ...
  ModelData(byte[] var1) {
    ...
    if (var1[var1.length - 1] == -1 && var1[var1.length - 2] == -1) { // L: 59
      this.method3866(var1);
    } else {
      this.method3903(var1); // L: 60
    }

  } // L: 61

  @ObfuscatedSignature(
      descriptor = "(Lga;ZZZZ)V",
      garbageValue = "1"
  )
  public ModelData(ModelData var1, boolean var2, boolean var3, boolean var4, boolean var5) {
    ...
    this.field2168 = var1.field2168; // L: 643
  ...
  @ObfuscatedName("c")
  @ObfuscatedSignature(
      descriptor = "(Lga;Lga;IIIZ)V"
  )
  static void method3885(ModelData var0, ModelData var1, int var2, int var3, int var4,
      boolean var5) {
    ...
    for (var9 = 0; var9 < var0.verticesCount; ++var9) { // L: 980
      ...
      if (var10.magnitude != 0) { // L: 982
        ...
        if (var11 <= var1.field2192) { // L: 984
          int var12 = var0.verticesX[var9] - var2; // L: 985
          if (var12 >= var1.field2193 && var12 <= var1.field2194) { // L: 986
            int var13 = var0.verticesZ[var9] - var4; // L: 987
            if (var13 >= var1.field2195 && var13 <= var1.field2176) { // L: 988
              for (int var14 = 0; var14 < var8; ++var14) { // L: 989
                ...
                if (var12 == var7[var14] && var13 == var1.verticesZ[var14]
                    && var11 == var1.verticesY[var14] && var15.magnitude != 0) { // L: 991
                  if (var0.field2168 == null) { // L: 992
                    var0.field2168 = new VertexNormal[var0.verticesCount];
                  }

                  if (var1.field2168 == null) { // L: 993
                    var1.field2168 = new VertexNormal[var8];
                  }

                  VertexNormal var16 = var0.field2168[var9]; // L: 994
                  if (var16 == null) { // L: 995
                    var16 = var0.field2168[var9] = new VertexNormal(var10);
                  }

                  VertexNormal var17 = var1.field2168[var14]; // L: 996
                  if (var17 == null) {
                    var17 = var1.field2168[var14] = new VertexNormal(var15); // L: 997
                  }
                  ...
                  ++var6; // L: 1006
                  field2197[var9] = field2199; // L: 1007
                  field2179[var14] = field2199; // L: 1008
                }
              }
            }
          }
    ...
    if (var6 >= 3 && var5) { // L: 1012
      for (var9 = 0; var9 < var0.faceCount; ++var9) { // L: 1013
        if (field2197[var0.indices1[var9]] == field2199
            && field2197[var0.indices2[var9]] == field2199
            && field2197[var0.indices3[var9]] == field2199) { // L: 1014
      ...
      for (var9 = 0; var9 < var1.faceCount; ++var9) { // L: 1019
        if (field2199 == field2179[var1.indices1[var9]]
            && field2199 == field2179[var1.indices2[var9]]
            && field2199 == field2179[var1.indices3[var9]]) { // L: 1020
  ...
  @ObfuscatedName("w")
  static final int method3888(int var0) {
    if (var0 < 2) { // L: 1161
      var0 = 2;
    } else if (var0 > 126) {
      var0 = 126; // L: 1162
      ...
      for (var43 = 0; var43 < var10; ++var43) { // L: 457
        ...
        if (var44 != 255) { // L: 459
          if (this.indices1[var43] == (this.texTriangleX[var44] & '\uffff')
              ...
              && this.indices3[var43] == (this.texTriangleZ[var44] & '\uffff')) { // L: 460
  ...
  final int method3868(ModelData var1, int var2) {
    int var3 = -1; // L: 567
    ...
    for (int var7 = 0; var7 < this.verticesCount; ++var7) { // L: 571
      if (var4 == this.verticesX[var7] && var5 == this.verticesY[var7]
          && var6 == this.verticesZ[var7]) { // L: 572
        var3 = var7; // L: 573
        break;
      }
    }
    ...
    if (var3 == -1) { // L: 577
      ...
      if (var1.vertexSkins != null) {
        this.vertexSkins[this.verticesCount] = var1.vertexSkins[var2]; // L: 581
      }
  ...
  @ObfuscatedName("r")
  @ObfuscatedSignature(
      descriptor = "([[IIIIZI)Lga;"
  )
  public ModelData method3933(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
    this.calculateBounds(); // L: 686
    int var7 = var2 + this.field2193; // L: 687
    int var8 = var2 + this.field2194; // L: 688
    int var9 = var4 + this.field2195; // L: 689
    int var10 = var4 + this.field2176; // L: 690
    if (var7 >= 0 && var8 + 128 >> 7 < var1.length && var9 >= 0
        && var10 + 128 >> 7 < var1[0].length) { // L: 691
      var7 >>= 7; // L: 692
      var8 = var8 + 127 >> 7; // L: 693
      var9 >>= 7; // L: 694
      var10 = var10 + 127 >> 7; // L: 695
      if (var3 == var1[var7][var9] && var3 == var1[var8][var9] && var3 == var1[var7][var10]
          && var3 == var1[var8][var10]) { // L: 696
        return this;
      } else {
        ...
        if (var6 == 0) { // L: 730
          for (var12 = 0; var12 < var11.verticesCount; ++var12) { // L: 731
            ...
            var18 = var14 >> 7; // L: 737
            var19 =
                var1[var17][var18] * (128 - var15) + var1[var17 + 1][var18] * var15 >> 7; // L: 738
          ...
          for (var12 = 0; var12 < var11.verticesCount; ++var12) { // L: 745
            ...
            if (var13 < var6) { // L: 747
              ...
              var11.verticesY[var12] =
                  (var6 - var13) * (var22 - var3) / var6 + this.verticesY[var12]; // L: 757
            }
          }
        }
  ...
  void method3872() {
    ...
    if (this.vertexSkins != null) { // L: 766
      ...
      for (var3 = 0; var3 < this.verticesCount;
          this.vertexLabels[var4][var1[var4]++] = var3++) { // L: 779 781
    ...
    if (this.faceSkins != null) { // L: 785
      ...
      for (var3 = 0; var3 < this.faceCount;
          this.faceLabelsAlpha[var4][var1[var4]++] = var3++) { // L: 798 800
  ...
  @ObfuscatedName("i")
  public void method3864(int var1) {
    ...
    for (int var4 = 0; var4 < this.verticesCount; ++var4) { // L: 835
      ...
      this.verticesZ[var4] =
          var3 * this.verticesZ[var4] - var2 * this.verticesX[var4] >> 16; // L: 837
    ...
    if (this.vertexNormals == null) { // L: 885
      ...
      for (var1 = 0; var1 < this.faceCount; ++var1) { // L: 888
        ...
        for (var13 = var5 * var9 - var8 * var6;
            var11 > 8192 || var12 > 8192 || var13 > 8192 || var11 < -8192 || var12 < -8192
                || var13 < -8192; var13 >>= 1) { // L: 900 901 904
          var11 >>= 1; // L: 902
          var12 >>= 1; // L: 903
        }

        int var14 = (int) Math
            .sqrt((double) (var11 * var11 + var12 * var12 + var13 * var13)); // L: 906
        if (var14 <= 0) { // L: 907
          var14 = 1;
        }
  ...
  void calculateBounds() {
    if (!this.isBoundsCalculated) { // L: 950
      ...
      this.field2192 = 0; // L: 952
      this.field2193 = 999999; // L: 953
      this.field2194 = -999999; // L: 954
      this.field2176 = -99999; // L: 955
      this.field2195 = 99999; // L: 956
      ...
      for (int var1 = 0; var1 < this.verticesCount; ++var1) { // L: 957
        ...
        if (var2 < this.field2193) { // L: 961
          this.field2193 = var2;
        }

        if (var2 > this.field2194) { // L: 962
          this.field2194 = var2;
        }

        if (var4 < this.field2195) { // L: 963
          this.field2195 = var4;
        }

        if (var4 > this.field2176) { // L: 964
          this.field2176 = var4;
        }
  ...
  public final Model toModel(int var1, int var2, int var3, int var4, int var5) {
    ...
    if (this.textureTriangleCount > 0 && this.textureCoords != null) { // L: 1035
      ...
      var8.field2449 = new int[var8.field2438]; // L: 1044
      var8.field2440 = new int[var8.field2438]; // L: 1045
      var8.field2441 = new int[var8.field2438]; // L: 1046
      var10 = 0; // L: 1047

      int var11;
      for (var11 = 0; var11 < this.textureTriangleCount; ++var11) { // L: 1048
        if (var9[var11] > 0 && this.textureRenderTypes[var11] == 0) { // L: 1049
          var8.field2449[var10] = this.texTriangleX[var11] & '\uffff'; // L: 1050
          var8.field2440[var10] = this.texTriangleY[var11] & '\uffff'; // L: 1051
          var8.field2441[var10] = this.texTriangleZ[var11] & '\uffff'; // L: 1052
      ...
      var8.field2448 = new byte[this.faceCount]; // L: 1057

      for (var11 = 0; var11 < this.faceCount; ++var11) { // L: 1058
        if (this.textureCoords[var11] != -1) { // L: 1059
          var8.field2448[var11] = (byte) var9[this.textureCoords[var11] & 255];
        } else {
          var8.field2448[var11] = -1; // L: 1060
        }
      }
    }
      ...
      if (var12 == -1) { // L: 1075
        if (var17 != 0) { // L: 1076
          if (var17 == 1) { // L: 1093
            ...
            var14 = (var4 * var19.y + var5 * var19.z + var3 * var19.x) / (var7 / 2 + var7)
                + var1; // L: 1095
            var8.faceColors1[var16] = method3887(this.faceColors[var16] & '\uffff',
                var14); // L: 1096
          ...
          if (this.field2168 != null && this.field2168[this.indices1[var16]] != null) { // L: 1080
            var13 = this.field2168[this.indices1[var16]];
          } else {
            var13 = this.vertexNormals[this.indices1[var16]]; // L: 1081
          }

          var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude)
              + var1; // L: 1082
          var8.faceColors1[var16] = method3887(var15, var14); // L: 1083
          if (this.field2168 != null && this.field2168[this.indices2[var16]] != null) { // L: 1084
            var13 = this.field2168[this.indices2[var16]];
          } else {
          ...
          var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude)
              + var1; // L: 1086
          var8.faceColors2[var16] = method3887(var15, var14); // L: 1087
          if (this.field2168 != null && this.field2168[this.indices3[var16]] != null) { // L: 1088
            var13 = this.field2168[this.indices3[var16]];
          } else {
          ...
          var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude)
              + var1; // L: 1090
          var8.faceColors3[var16] = method3887(var15, var14); // L: 1091
        }
        ...
        if (var17 == 1) { // L: 1124
          ...
          var14 = (var4 * var19.y + var5 * var19.z + var3 * var19.x) / (var7 / 2 + var7)
              + var1; // L: 1126
          var8.faceColors1[var16] = method3888(var14); // L: 1127
          var8.faceColors3[var16] = -1; // L: 1128
        } else {
          var8.faceColors3[var16] = -2; // L: 1131
        }
      } else {
        if (this.field2168 != null && this.field2168[this.indices1[var16]] != null) { // L: 1111
          var13 = this.field2168[this.indices1[var16]];
        } else {
        ...
        var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude)
            + var1; // L: 1113
        var8.faceColors1[var16] = method3888(var14); // L: 1114
        if (this.field2168 != null && this.field2168[this.indices2[var16]] != null) { // L: 1115
          var13 = this.field2168[this.indices2[var16]];
        } else {
        ...
        var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude)
            + var1; // L: 1117
        var8.faceColors2[var16] = method3888(var14); // L: 1118
        if (this.field2168 != null && this.field2168[this.indices3[var16]] != null) { // L: 1119
          var13 = this.field2168[this.indices3[var16]];
        } else {
        ...
        var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude)
            + var1; // L: 1121
        var8.faceColors3[var16] = method3888(var14); // L: 1122
      }
    }

    this.method3872(); // L: 1135
    ...
    var8.field2437 = this.priority; // L: 1146
