...
public class class69 {
    ...
    for (var2 = 0; var2 < 4; ++var2) { // L: 478
      ...
      for (var11 = 1; var11 < 103; ++var11) { // L: 487
        for (var12 = 1; var12 < 103; ++var12) { // L: 488
          var13 = Tiles.Tiles_heights[var2][var12 + 1][var11] - Tiles.Tiles_heights[var2][var12
              - 1][var11]; // L: 489
          var14 =
              Tiles.Tiles_heights[var2][var12][var11 + 1] - Tiles.Tiles_heights[var2][var12][var11
                  - 1]; // L: 490
          ...
          var20 = (var42[var12 - 1][var11] >> 2) + (var42[var12][var11 - 1] >> 2) + (
              var42[var12 + 1][var11] >> 3) + (var42[var12][var11 + 1] >> 3) + (var42[var12][var11]
              >> 1); // L: 496
      ...
      for (var11 = -5; var11 < 109; ++var11) { // L: 507
        for (var12 = 0; var12 < 104; ++var12) { // L: 508
          ...
          if (var13 >= 0 && var13 < 104) { // L: 510
            ...
            if (var14 > 0) { // L: 512
              var16 = var14 - 1; // L: 514
              FloorUnderlayDefinition var44 = (FloorUnderlayDefinition) FloorUnderlayDefinition.FloorUnderlayDefinition_cached
                  .get((long) var16); // L: 516
              FloorUnderlayDefinition var46;
              if (var44 != null) { // L: 517
                var46 = var44; // L: 518
              } else {
                byte[] var45 = FloorUnderlayDefinition.FloorUnderlayDefinition_archive
                    .takeFile(1, var16); // L: 521
                ...
                FloorUnderlayDefinition.FloorUnderlayDefinition_cached
                    .put(var44, (long) var16); // L: 525
                var46 = var44; // L: 526
              }
          ...
          if (var14 >= 0 && var14 < 104) { // L: 537
            ...
            if (var15 > 0) { // L: 539
              var17 = var15 - 1; // L: 541
              FloorUnderlayDefinition var52 = (FloorUnderlayDefinition) FloorUnderlayDefinition.FloorUnderlayDefinition_cached
                  .get((long) var17); // L: 543
              FloorUnderlayDefinition var48;
              if (var52 != null) { // L: 544
                var48 = var52; // L: 545
              } else {
                byte[] var47 = FloorUnderlayDefinition.FloorUnderlayDefinition_archive
                    .takeFile(1, var17); // L: 548
        ...
        if (var11 >= 1 && var11 < 103) { // L: 564
          ...
          for (var17 = -5; var17 < 109; ++var17) { // L: 570
            ...
            if (var17 >= 1 && var17 < 103 && (!Client.isLowDetail
                || (Tiles.Tiles_renderFlags[0][var11][var17] & 2) != 0
                || (Tiles.Tiles_renderFlags[var2][var11][var17] & 16) == 0)) { // L: 587 588 589 590
              ...
              if (var20 > 0 || var21 > 0) { // L: 596
                ...
                if (var2 > 0) { // L: 618
                  ...
                  if (var21 > 0 && !WorldMapSectionType
                      .method3677(var21 - 1).hideUnderlay) { // L: 621
                    var50 = false;
                  }
                ...
                if (var21 == 0) { // L: 628
                  var0.addTile(var2, var11, var17, 0, 0, -1, var22, var23, var24, var25,
                      class378.method6550(var30, var26), class378.method6550(var30, var27),
                      class378.method6550(var30, var28), class378.method6550(var30, var29), 0, 0, 0,
                      0, var32, 0); // L: 629
                } else {
                  var33 = class22.field186[var2][var11][var17] + 1; // L: 632
                  byte var51 = class16.field132[var2][var11][var17]; // L: 633
                  FloorOverlayDefinition var35 = WorldMapSectionType
                      .method3677(var21 - 1); // L: 634
                  ...
                  int var40;
                  if (var36 >= 0) { // L: 638
                    var38 = Rasterizer3D.Rasterizer3D_textureLoader
                        .getAverageTextureRGB(var36); // L: 639
                    var37 = -1; // L: 640
                    ...
                    var37 = class125
                        .hslToRgb(var35.hue, var35.saturation, var35.lightness); // L: 649
                  ...
                  var39 = 0; // L: 657
                  if (var38 != -2) { // L: 658
                    var39 = Rasterizer3D.Rasterizer3D_colorPalette[WorldMapID
                        .method3716(var38, 96)];
                  }
                  ...
                  if (var35.secondaryRgb != -1) { // L: 659
                    ...
                    var39 = Rasterizer3D.Rasterizer3D_colorPalette[WorldMapID
                        .method3716(var38, 96)]; // L: 665
                  }

                  var0.addTile(var2, var11, var17, var33, var51, var36, var22, var23, var24, var25,
                      class378.method6550(var30, var26), class378.method6550(var30, var27),
                      class378.method6550(var30, var28), class378.method6550(var30, var29),
                      WorldMapID.method3716(var37, var26), WorldMapID.method3716(var37, var27),
                      WorldMapID.method3716(var37, var28), WorldMapID.method3716(var37, var29),
                      var32, var39); // L: 667
                }
              }
            }
        ...
        for (int var7 = 0; var7 <= 104; ++var7) { // L: 717
          for (int var8 = 0; var8 <= 104; ++var8) { // L: 718
            ...
            if ((Tiles.field1101[var6][var8][var7] & var2) != 0) { // L: 719
              ...
              for (var12 = var6; var9 > 0 && (Tiles.field1101[var6][var8][var9 - 1] & var2) != 0;
                  --var9) { // L: 723 724
              }

              while (var10 < 104
                  && (Tiles.field1101[var6][var8][var10 + 1] & var2) != 0) { // L: 725
                ++var10;
              }
              ...
              if (var13 >= 8) { // L: 735
                ...
                Scene.Scene_addOccluder(var5, 1, var8 * 128, var8 * 128, var9 * 128,
                    var10 * 128 + 128, var15, var16); // L: 739
            ...
            if ((Tiles.field1101[var6][var8][var7] & var3) != 0) { // L: 745
              ...
              for (var12 = var6; var9 > 0 && (Tiles.field1101[var6][var9 - 1][var7] & var3) != 0;
                  --var9) { // L: 749 750
              }

              while (var10 < 104
                  && (Tiles.field1101[var6][var10 + 1][var7] & var3) != 0) { // L: 751
                ++var10;
              }
              ...
              if (var13 >= 8) { // L: 761
                ...
                Scene.Scene_addOccluder(var5, 2, var9 * 128, var10 * 128 + 128, var7 * 128,
                    var7 * 128, var15, var16); // L: 765
            ...
            if ((Tiles.field1101[var6][var8][var7] & var4) != 0) { // L: 771
              ...
              for (var12 = var7; var11 > 0 && (Tiles.field1101[var6][var8][var11 - 1] & var4) != 0;
                  --var11) { // L: 775 776
              }

              while (var12 < 104
                  && (Tiles.field1101[var6][var8][var12 + 1] & var4) != 0) { // L: 777
                ++var12;
              }
              ...
              if ((var10 - var9 + 1) * (var12 - var11 + 1) >= 4) { // L: 786
                ...
                Scene.Scene_addOccluder(var5, 4, var9 * 128, var10 * 128 + 128, var11 * 128,
                    var12 * 128 + 128, var13, var13); // L: 788
  ...
  static Frames getFrames(int var0) {
    Frames var1 = (Frames) SequenceDefinition.SequenceDefinition_cachedFrames
        .get((long) var0); // L: 181
    if (var1 != null) { // L: 182
      return var1;
    } else {
      var1 = class15.method240(SequenceDefinition.SequenceDefinition_animationsArchive,
          SequenceDefinition.SequenceDefinition_skeletonsArchive, var0, false); // L: 183
      if (var1 != null) { // L: 184
