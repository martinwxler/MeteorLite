...
public class WorldMapEvent {
  ...
  static final void addPendingSpawnToScene(int var0, int var1, int var2, int var3, int var4,
      int var5, int var6) {
    if (var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) { // L: 7400
      ...
      if (0L != var7) { // L: 7410
        ...
        if (var1 == 2) { // L: 7421
          ...
          if (var2 + var13.sizeX > 103 || var3 + var13.sizeX > 103 || var2 + var13.sizeY > 103
              || var3 + var13.sizeY > 103) { // L: 7424
            return;
          }

          if (var13.interactType != 0) { // L: 7425
            Client.collisionMaps[var0]
                .setFlagOffNonSquare(var2, var3, var13.sizeX, var13.sizeY, var16, var13.boolean1);
          }
        }
      ...
      if (var4 >= 0) { // L: 7433
        ...
        Decimator
            .method1167(var0, var12, var2, var3, var4, var5, var6, DevicePcmPlayerProvider.scene,
                Client.collisionMaps[var0]); // L: 7436
      }
    }
