...
public class BufferedSink implements Runnable {
  ...
  static int method5990(int var0, Script var1, boolean var2) {
    ...
    if (var0 >= 2000) { // L: 804
      ...
      var3 = WorldMapData_1.getWidget(
          Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]); // L: 806
    } else {
    ...
    if (var0 != ScriptOpcodes.CC_SETOBJECT && var0 != ScriptOpcodes.CC_SETOBJECT_NONUM
        && var0 != ScriptOpcodes.CC_SETOBJECT_ALWAYS_NUM) { // L: 810
  ...
  static void method5992() {
    PacketBufferNode var0 = InterfaceParent
        .getPacketBufferNode(ClientPacket.field2656, Client.packetWriter.isaacCipher); // L: 4412
