...
public abstract class GameEngine extends Applet implements Runnable, FocusListener, WindowListener {
  ...
  final void resizeCanvas() {
    ...
    if (var1 != null) { // L: 137
      ...
      AbstractWorldMapData.rasterProvider = new RasterProvider(AttackOption.canvasWidth,
          class0.canvasHeight, this.canvas); // L: 148
  ...
  final synchronized void addCanvas() {
    ...
    if (AbstractWorldMapData.rasterProvider != null
        && AttackOption.canvasWidth == AbstractWorldMapData.rasterProvider.width
        && class0.canvasHeight == AbstractWorldMapData.rasterProvider.height) { // L: 256
      ...
      AbstractWorldMapData.rasterProvider = new RasterProvider(AttackOption.canvasWidth,
          class0.canvasHeight, this.canvas); // L: 261
    }
  ...
  final void method581() {
    ...
    if (this.contentWidth != var1.highX || this.contentHeight != var1.highY
        || this.resizeCanvasNextFrame) { // L: 369
  ...
  protected final void drawInitial(int var1, String var2, boolean var3) {
    try {
      ...
      if (class13.fontHelvetica13 == null) { // L: 471
        ...
        class265.loginScreenFontMetrics = this.canvas
            .getFontMetrics(class13.fontHelvetica13); // L: 473
      }
      ...
      try {
        ...
        var6.drawString(var2, (304 - class265.loginScreenFontMetrics.stringWidth(var2)) / 2,
            22); // L: 491
        var4.drawImage(MilliClock.field1527, AttackOption.canvasWidth / 2 - 152,
            class0.canvasHeight / 2 - 18, (ImageObserver) null); // L: 492
        ...
        var4.drawString(var2, var7 + (304 - class265.loginScreenFontMetrics.stringWidth(var2)) / 2,
            var8 + 22); // L: 505
      }
  ...
  public final synchronized void paint(Graphics var1) {
    if (this == gameEngine && !isKilled) { // L: 434
      ...
      if (ClientPacket.currentTimeMillis() - this.field348 > 1000L) { // L: 436
        ...
        if (var2 == null
            || var2.width >= AttackOption.canvasWidth && var2.height >= class0.canvasHeight) {
      ...
      if (TaskHandler.javaVendor != null) { // L: 280
        ...
        if (var1.indexOf("sun") != -1 || var1.indexOf("apple") != -1) { // L: 282
          ...
          if (var2.equals("1.1") || var2.startsWith("1.1.") || var2.equals("1.2") || var2
              ...
              .startsWith("1.5.") || var2.equals("1.6.0")) { // L: 284
          ...
          if (var2.startsWith("1.6.0_")) { // L: 288
            int var3;
            for (var3 = 6; var3 < var2.length() && class105.isDigit(var2.charAt(var3));
                ++var3) { // L: 289 290
            }
