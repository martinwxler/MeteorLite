...
public class HealthBarDefinition extends DualNode {
  ...
  public SpritePixels getFrontSprite() {
    if (this.frontSpriteID < 0) { // L: 74
      ...
      SpritePixels var1 = (SpritePixels) HealthBarDefinition_cachedSprites
          .get((long) this.frontSpriteID); // L: 75
      if (var1 != null) {
        return var1; // L: 76
      } else {
        var1 = Tile
            .SpriteBuffer_getSprite(class378.HitSplatDefinition_spritesArchive, this.frontSpriteID,
                0); // L: 77
        if (var1 != null) { // L: 78
  ...
  public SpritePixels getBackSprite() {
    if (this.backSpriteID < 0) { // L: 84
      ...
      SpritePixels var1 = (SpritePixels) HealthBarDefinition_cachedSprites
          .get((long) this.backSpriteID); // L: 85
      if (var1 != null) {
        return var1; // L: 86
      } else {
        var1 = Tile
            .SpriteBuffer_getSprite(class378.HitSplatDefinition_spritesArchive, this.backSpriteID,
                0); // L: 87
        if (var1 != null) { // L: 88
