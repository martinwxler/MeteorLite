...
public class ObjectComposition extends DualNode {
  ...
  public final boolean method3019(int var1) {
    if (this.models != null) { // L: 235
      ...
      for (int var3 = 0; var3 < this.modelIds.length; ++var3) { // L: 239
        var2 &= ObjectDefinition_modelsArchive
            .tryLoadFile(this.modelIds[var3] & 65535, 0); // L: 240
      }
  ...
  public final boolean needsModelFiles() {
    if (this.modelIds == null) { // L: 253
      ...
      for (int var2 = 0; var2 < this.modelIds.length; ++var2) { // L: 255
        var1 &= ObjectDefinition_modelsArchive
            .tryLoadFile(this.modelIds[var2] & 65535, 0); // L: 256
      }
  ...
  @Export("getEntity")
  public final Renderable getEntity(int var1, int var2, int[][] var3, int var4, int var5,
      int var6) {
    long var7;
  ...
  final ModelData getModelData(int var1, int var2) {
    ...
    ModelData var8 = new ModelData(var3, var2 == 0 && !var4 && !var11, this.recolorFrom == null,
        this.retextureFrom == null, true); // L: 369
