...
public final class Canvas extends java.awt.Canvas {
  ...
  static void method495() {
    for (ObjectSound var0 = (ObjectSound) ObjectSound.objectSounds.last(); var0 != null;
        var0 = (ObjectSound) ObjectSound.objectSounds.previous()) { // L: 30
  ...
  static final void doCheat(String var0) {
    if (var0.equalsIgnoreCase("toggleroof")) { // L: 3871
      ...
      if (class4.clientPreferences.roofsHidden) { // L: 3874
        ...
        UserComparator10
            .addGameMessage(99, "", "Roofs will only be removed selectively"); // L: 3875
      }
    }
    ...
    PacketBufferNode var1 = InterfaceParent
        .getPacketBufferNode(ClientPacket.field2619, Client.packetWriter.isaacCipher); // L: 3889
