  ...
  public static void sortItemsByName(String[] var0, short[] var1, int var2, int var3) {
    if (var2 < var3) { // L: 9
      ...
      for (int var8 = var2; var8 < var3; ++var8) { // L: 18
        if (var6 == null || var0[var8] != null && var0[var8].compareTo(var6) < (var8
            & 1)) { // L: 19
  ...
  static int method5204(int var0, Script var1, boolean var2) {
    ...
    if (var0 == ScriptOpcodes.STOCKMARKET_GETOFFERTYPE) { // L: 2637
      ...
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
          - 1] = Client.grandExchangeOffers[var3].type(); // L: 2639
      return 1; // L: 2640
      ...
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
          - 1] = Client.grandExchangeOffers[var3].id; // L: 2644
      return 1; // L: 2645
      ...
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
          - 1] = Client.grandExchangeOffers[var3].unitPrice; // L: 2649
      return 1; // L: 2650
      ...
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
          - 1] = Client.grandExchangeOffers[var3].totalQuantity; // L: 2654
      return 1; // L: 2655
      ...
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
          - 1] = Client.grandExchangeOffers[var3].currentQuantity; // L: 2659
      return 1; // L: 2660
      ...
      Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
          - 1] = Client.grandExchangeOffers[var3].currentPrice; // L: 2664
      return 1; // L: 2665
    } else {
      int var13;
      if (var0 == ScriptOpcodes.STOCKMARKET_ISOFFEREMPTY) { // L: 2667
        ...
        if (var0 == ScriptOpcodes.TRADINGPOST_SORTBY_NAME) { // L: 2691
          var12 = Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize]
              == 1; // L: 2692
          if (class267.grandExchangeEvents != null) { // L: 2693
            class267.grandExchangeEvents
                .sort(GrandExchangeEvents.GrandExchangeEvents_nameComparator, var12); // L: 2694
          }
          ...
          if (class267.grandExchangeEvents != null) { // L: 2700
            class267.grandExchangeEvents
                .sort(GrandExchangeEvents.GrandExchangeEvents_priceComparator, var12); // L: 2701
          }
          ...
          var12 = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize]
              == 1; // L: 2707
          boolean var11 = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize + 1]
              == 1; // L: 2708
          if (class267.grandExchangeEvents != null) { // L: 2709
            Client.GrandExchangeEvents_worldComparator.filterWorlds = var11; // L: 2710
            class267.grandExchangeEvents
                .sort(Client.GrandExchangeEvents_worldComparator, var12); // L: 2711
          }
          ...
          if (class267.grandExchangeEvents != null) { // L: 2717
            class267.grandExchangeEvents
                .sort(GrandExchangeEvents.GrandExchangeEvents_ageComparator, var12); // L: 2718
          }
          ...
          if (class267.grandExchangeEvents != null) { // L: 2724
            class267.grandExchangeEvents
                .sort(GrandExchangeEvents.GrandExchangeEvents_quantityComparator, var12); // L: 2725
          }

          return 1; // L: 2727
        } else if (var0 == ScriptOpcodes.TRADINGPOST_GETTOTALOFFERS) { // L: 2729
          Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] =
              class267.grandExchangeEvents == null ? 0
                  : class267.grandExchangeEvents.events.size(); // L: 2730
          return 1; // L: 2731
        } else {
          ...
          if (var0 == ScriptOpcodes.TRADINGPOST_GETOFFERWORLD) { // L: 2733
            ...
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                - 1] = var4.getPreviousOfferName(); // L: 2748
            return 1; // L: 2749
            ...
            long var5 =
                ClientPacket.currentTimeMillis() - WorldMapEvent.field2150 - var4.age; // L: 2754
            int var7 = (int) (var5 / 3600000L); // L: 2755
            int var8 = (int) ((var5 - (long) (var7 * 3600000)) / 60000L); // L: 2756
            int var9 = (int) ((var5 - (long) (var7 * 3600000) - (long) (var8 * 60000))
                / 1000L); // L: 2757
            String var10 =
                var7 + ":" + var8 / 10 + var8 % 10 + ":" + var9 / 10 + var9 % 10; // L: 2758
            Interpreter.Interpreter_stringStack[++UserComparator9.Interpreter_stringStackSize
                - 1] = var10; // L: 2759
            return 1; // L: 2760
            ...
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = var4.grandExchangeOffer.totalQuantity; // L: 2765
            return 1; // L: 2766
            ...
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = var4.grandExchangeOffer.unitPrice; // L: 2771
            return 1; // L: 2772
            ...
            Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize
                - 1] = var4.grandExchangeOffer.id; // L: 2777
            return 1; // L: 2778
          } else {
            return 2; // L: 2780
          }
