...
public class MilliClock extends Clock {
  ...
  public int wait(int var1, int var2) {
    ...
    if (this.field1518[this.field1525] == 0L) { // L: 36
      ...
      this.field1519 = (int) ((long) (var1 * 2560) / (this.field1520
          - this.field1518[this.field1525]));
    }
    ...
    if (this.field1519 > 256) { // L: 42
      ...
      this.field1521 = (int) ((long) var1
          - (this.field1520 - this.field1518[this.field1525]) / 10L); // L: 44
    }
