...
public class TaskHandler implements Runnable {
  ...
  static final void method2625(MenuAction var0, int var1, int var2) {
    GameObject.menuAction(var0.param0, var0.param1, var0.opcode, var0.identifier, var0.action,
        var0.action, var1, var2); // L: 7930
  } // L: 7931
  ...
  static void method2615(String var0) {
    ...
    try {
      ...
      if (var0.length() == 0) { // L: 11592
        ...
        String var5 = Calendar.DAYS_OF_THE_WEEK[var8 - 1] + ", " + var9 / 10 + var9 % 10 + "-"
            + Calendar.MONTH_NAMES_ENGLISH_GERMAN[0][var10] + "-" + var11 + " " + var12 / 10
            + var12 % 10 + ":" + var13 / 10 + var13 % 10 + ":" + var14 / 10 + var14 % 10
            + " GMT"; // L: 11606
  ...
  public final void run() {
    while (true) {
      ...
      try {
        ...
        if (var5 == 1) { // L: 65
          var1.result = new Socket(InetAddress.getByName((String) var1.objectArgument),
              var1.intArgument); // L: 66
        } else if (var5 == 2) { // L: 68
