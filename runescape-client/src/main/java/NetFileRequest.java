...
public class NetFileRequest extends DualNode {
  ...
  static void drawTitle(Font var0, Font var1, Font var2) {
    ...
    if (Login.worldSelectOpen) { // L: 882
      ...
      Messages.logoSprite
          .drawAt(Login.xPadding + 382 - Messages.logoSprite.subWidth / 2, 18); // L: 888
      int var4;
      if (Client.gameState == 0 || Client.gameState == 5) { // L: 889
        byte var3 = 20; // L: 890
        var0.drawCentered("RuneScape is loading - please wait...", Login.loginBoxX + 180,
            245 - var3, 16777215, -1); // L: 891
        var4 = 253 - var3; // L: 892
        Rasterizer2D.Rasterizer2D_drawRectangle(Login.loginBoxX + 180 - 152, var4, 304, 34,
            9179409); // L: 893
        Rasterizer2D.Rasterizer2D_drawRectangle(Login.loginBoxX + 180 - 151, var4 + 1, 302, 32,
            0); // L: 894
        Rasterizer2D.Rasterizer2D_fillRectangle(Login.loginBoxX + 180 - 150, var4 + 2,
            Login.Login_loadingPercent * 3, 30, 9179409); // L: 895
        Rasterizer2D.Rasterizer2D_fillRectangle(
            Login.Login_loadingPercent * 3 + (Login.loginBoxX + 180 - 150), var4 + 2,
            300 - Login.Login_loadingPercent * 3, 30, 0); // L: 896
        var0.drawCentered(Login.Login_loadingText, Login.loginBoxX + 180, 276 - var3, 16777215,
            -1); // L: 897
      }
      ...
      if (Client.gameState == 20) { // L: 899
        Coord.titleboxSprite.drawAt(Login.loginBoxX + 180 - Coord.titleboxSprite.subWidth / 2,
            271 - Coord.titleboxSprite.subHeight / 2); // L: 900
        var16 = 201; // L: 901
        var0.drawCentered(Login.Login_response1, Login.loginBoxX + 180, var16, 16776960,
            0); // L: 902
        var17 = var16 + 15; // L: 903
        var0.drawCentered(Login.Login_response2, Login.loginBoxX + 180, var17, 16776960,
            0); // L: 904
        var17 += 15; // L: 905
        var0.drawCentered(Login.Login_response3, Login.loginBoxX + 180, var17, 16776960,
            0); // L: 906
        var17 += 15; // L: 907
        var17 += 7; // L: 908
        if (Login.loginIndex != 4) { // L: 909
          ...
          for (var5 = class17.method255(); var0.stringWidth(var5) > var18;
              var5 = var5.substring(0, var5.length() - 1)) { // L: 912 913 914
          }

          var0.draw(AbstractFont.escapeBrackets(var5), Login.loginBoxX + 180 - 70, var17, 16777215,
              0); // L: 916
          var17 += 15; // L: 917

          for (var6 = class22.method315(Login.Login_password); var0.stringWidth(var6) > var18;
              var6 = var6.substring(1)) { // L: 918 919 920
          }
      ...
      if (Client.gameState == 10 || Client.gameState == 11) { // L: 926
        ...
        if (Login.loginIndex == 0) { // L: 928
          var16 = 251; // L: 929
          var0.drawCentered("Welcome to RuneScape", Login.loginBoxX + 180, var16, 16776960,
              0); // L: 930
          var17 = var16 + 30; // L: 931
          var4 = Login.loginBoxX + 180 - 80; // L: 932
          var11 = 291; // L: 933
          class289.titlebuttonSprite.drawAt(var4 - 73, var11 - 20); // L: 934
          var0.drawLines("New User", var4 - 73, var11 - 20, 144, 40, 16777215, 0, 1, 1,
              0); // L: 935
          var4 = Login.loginBoxX + 180 + 80; // L: 936
          class289.titlebuttonSprite.drawAt(var4 - 73, var11 - 20); // L: 937
          var0.drawLines("Existing User", var4 - 73, var11 - 20, 144, 40, 16777215, 0, 1, 1,
              0); // L: 938
        } else if (Login.loginIndex == 1) { // L: 940
          var0.drawCentered(Login.Login_response0, Login.loginBoxX + 180, 201, 16776960,
              0); // L: 941
          var16 = 236; // L: 942
          var0.drawCentered(Login.Login_response1, Login.loginBoxX + 180, var16, 16777215,
              0); // L: 943
          var17 = var16 + 15; // L: 944
          var0.drawCentered(Login.Login_response2, Login.loginBoxX + 180, var17, 16777215,
              0); // L: 945
          var17 += 15; // L: 946
          var0.drawCentered(Login.Login_response3, Login.loginBoxX + 180, var17, 16777215,
              0); // L: 947
          var17 += 15; // L: 948
          ...
          if (Login.loginIndex == 2) { // L: 957
            var16 = 201; // L: 958
            var0.drawCentered(Login.Login_response1, class25.loginBoxCenter, var16, 16776960,
                0); // L: 959
            var17 = var16 + 15; // L: 960
            var0.drawCentered(Login.Login_response2, class25.loginBoxCenter, var17, 16776960,
                0); // L: 961
            var17 += 15; // L: 962
            var0.drawCentered(Login.Login_response3, class25.loginBoxCenter, var17, 16776960,
                0); // L: 963
            var17 += 15; // L: 964
            var17 += 7; // L: 965
            ...
            for (var5 = class17.method255(); var0.stringWidth(var5) > var18;
                var5 = var5.substring(1)) { // L: 968 969 970
            }

            var0.draw(AbstractFont.escapeBrackets(var5) + (
                    Login.currentLoginField == 0 & Client.cycle % 40 < 20 ?
                        SecureRandomFuture.colorStartTag(16776960) + "|" : ""),
                class25.loginBoxCenter - 70, var17, 16777215, 0); // L: 972
            var17 += 15; // L: 973

            for (var6 = class22.method315(Login.Login_password); var0.stringWidth(var6) > var18;
                var6 = var6.substring(1)) { // L: 974 975 976
            }

            var0.draw("Password: " + var6 + (Login.currentLoginField == 1 & Client.cycle % 40 < 20 ?
                    SecureRandomFuture.colorStartTag(16776960) + "|" : ""),
                class25.loginBoxCenter - 108, var17, 16777215, 0); // L: 978
            var17 += 15; // L: 979
            var16 = 277; // L: 980
            var7 = class25.loginBoxCenter + -117; // L: 981
            IndexedSprite var14 = Archive
                .method5021(Client.Login_isUsernameRemembered, Login.field1006); // L: 982
            ...
            var14 = Archive
                .method5021(class4.clientPreferences.hideUsername, Login.field1021); // L: 987
            ...
            Client.field903 = new Bounds(class25.loginBoxCenter, var16,
                var1.stringWidth(class215.field2557), 11); // L: 1008
            DefaultsGroup.field3891 = new Bounds(class25.loginBoxCenter, var16,
                var1.stringWidth("Still having trouble logging in?"), 11); // L: 1009
            var1.drawCentered(class215.field2557, class25.loginBoxCenter, var16, 16777215,
                0); // L: 1010
          } else if (Login.loginIndex == 3) { // L: 1012
            var16 = 201; // L: 1013
            var0.drawCentered("Invalid credentials.", Login.loginBoxX + 180, var16, 16776960,
                0); // L: 1014
            var17 = var16 + 20; // L: 1015
            var1.drawCentered("For accounts created after 24th November 2010, please use your",
                Login.loginBoxX + 180, var17, 16776960, 0); // L: 1016
            var17 += 15; // L: 1017
            var1.drawCentered("email address to login. Otherwise please login with your username.",
                Login.loginBoxX + 180, var17, 16776960, 0); // L: 1018
            var17 += 15; // L: 1019
            ...
            if (Login.loginIndex == 4) { // L: 1029
              var0.drawCentered("Authenticator", Login.loginBoxX + 180, 201, 16776960,
                  0); // L: 1030
              var16 = 236; // L: 1031
              var0.drawCentered(Login.Login_response1, Login.loginBoxX + 180, var16, 16777215,
                  0); // L: 1032
              ...
              var0.drawCentered(Login.Login_response3, Login.loginBoxX + 180, var17, 16777215,
                  0); // L: 1036
              var17 += 15; // L: 1037
              var0.draw("PIN: " + class22.method315(ItemLayer.otp) + (Client.cycle % 40 < 20 ?
                      SecureRandomFuture.colorStartTag(16776960) + "|" : ""),
                  Login.loginBoxX + 180 - 108, var17, 16777215, 0); // L: 1038
              var17 -= 8; // L: 1039
              var0.draw("Trust this computer", Login.loginBoxX + 180 - 9, var17, 16776960,
                  0); // L: 1040
              var17 += 15; // L: 1041
              ...
              var1.drawCentered("<u=ff>Can't Log In?</u>", Login.loginBoxX + 180, var8 + 36, 255,
                  0); // L: 1061
            } else if (Login.loginIndex == 5) { // L: 1063
              var0.drawCentered("Forgotten your password?", Login.loginBoxX + 180, 201, 16776960,
                  0); // L: 1064
              var16 = 221; // L: 1065
              var2.drawCentered(Login.Login_response1, Login.loginBoxX + 180, var16, 16776960,
                  0); // L: 1066
              var17 = var16 + 15; // L: 1067
              var2.drawCentered(Login.Login_response2, Login.loginBoxX + 180, var17, 16776960,
                  0); // L: 1068
              var17 += 15; // L: 1069
              var2.drawCentered(Login.Login_response3, Login.loginBoxX + 180, var17, 16776960,
                  0); // L: 1070
              var17 += 15; // L: 1071
              var17 += 14; // L: 1072
              var0.draw("Username/email: ", Login.loginBoxX + 180 - 145, var17, 16777215,
                  0); // L: 1073
              var18 = 174; // L: 1074

              for (var5 = class17.method255(); var0.stringWidth(var5) > var18;
                  var5 = var5.substring(1)) { // L: 1075 1076 1077
              }

              var0.draw(AbstractFont.escapeBrackets(var5) + (Client.cycle % 40 < 20 ?
                      SecureRandomFuture.colorStartTag(16776960) + "|" : ""),
                  Login.loginBoxX + 180 - 34, var17, 16777215, 0); // L: 1079
              var17 += 15; // L: 1080
              ...
              var20 = 356; // L: 1088
              var1.drawCentered("Still having trouble logging in?", class25.loginBoxCenter, var20,
                  268435455, 0); // L: 1089
              ...
              var16 = 216; // L: 1105
              var0.drawCentered("Your date of birth isn't set.", Login.loginBoxX + 180, var16,
                  16776960, 0); // L: 1106
              var17 = var16 + 15; // L: 1107
              var2.drawCentered("Please verify your account status by", Login.loginBoxX + 180,
                  var17, 16776960, 0); // L: 1108
              var17 += 15; // L: 1109
              var2.drawCentered("setting your date of birth.", Login.loginBoxX + 180, var17,
                  16776960, 0); // L: 1110
              var17 += 15; // L: 1111
              ...
              var0.drawCentered("Sorry, but your account is not eligible to play.",
                  Login.loginBoxX + 180, var16, 16776960, 0); // L: 1122
              var17 = var16 + 15; // L: 1123
              var2.drawCentered("For more information, please take a look at",
                  Login.loginBoxX + 180, var17, 16776960, 0); // L: 1124
              var17 += 15; // L: 1125
              var2.drawCentered("our privacy policy.", Login.loginBoxX + 180, var17, 16776960,
                  0); // L: 1126
              var17 += 15; // L: 1127
      ...
      if (Client.gameState >= 10) { // L: 1191
        ...
        Rasterizer2D.Rasterizer2D_setClip(Login.xPadding, 0, Login.xPadding + 765,
            class0.canvasHeight); // L: 1194
        PendingSpawn.loginScreenRunesAnimation.draw(Login.xPadding - 22, Client.cycle); // L: 1195
        PendingSpawn.loginScreenRunesAnimation
            .draw(Login.xPadding + 22 + 765 - 128, Client.cycle); // L: 1196
        Rasterizer2D.Rasterizer2D_setClipArray(var15); // L: 1197
      }

      GrandExchangeEvents.title_muteSprite[class4.clientPreferences.titleMusicDisabled ? 1 : 0]
          .drawAt(Login.xPadding + 765 - 40, 463); // L: 1199
      if (Client.gameState > 5
          && AbstractArchive.clientLanguage == Language.Language_EN) { // L: 1200
        if (class35.field244 != null) { // L: 1201
          ...
          var0.drawCentered("World" + " " + Client.worldId, var23 / 2 + var17,
              var22 / 2 + var18 - 2, 16777215, 0); // L: 1207
          if (World.World_request != null) { // L: 1208
            var1.drawCentered("Loading...", var23 / 2 + var17, var22 / 2 + var18 + 12, 16777215, 0);
          } else {
            var1.drawCentered("Click to switch", var23 / 2 + var17, var22 / 2 + var18 + 12,
                16777215, 0); // L: 1209
          }
        } else {
          class35.field244 = TextureProvider
              .SpriteBuffer_getIndexedSpriteByName(ModeWhere.archive8, "sl_button", ""); // L: 1212
        }
      }
