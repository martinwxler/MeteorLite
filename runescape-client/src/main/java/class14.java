...
public abstract class class14 extends Node {
  ...
  static final void method229(String var0, int var1) {
    PacketBufferNode var2 = InterfaceParent
        .getPacketBufferNode(ClientPacket.field2653, Client.packetWriter.isaacCipher); // L: 252
  ...
  static final void addWidgetItemMenuItem(Widget var0, ItemComposition var1, int var2, int var3,
      boolean var4) {
    ...
    if (var6 != -1 && var7 != null) { // L: 10167
      PacketWriter
          .insertMenuItem(var7, SecureRandomFuture.colorStartTag(16748608) + var1.name, var6,
              var1.id, var2, var0.id, var4); // L: 10168
    }
