  ...
  final int[] synthesize(int var1, int var2) {
    ...
    if (var2 < 10) { // L: 54
      ...
      if (this.pitchModifier != null) { // L: 61
        ...
        var5 = (int) ((double) (this.pitchModifier.end - this.pitchModifier.start) * 32.768D
            / var3); // L: 64
      ...
      if (this.volumeMultiplier != null) { // L: 70
        ...
        var8 = (int) ((double) (this.volumeMultiplier.end - this.volumeMultiplier.start) * 32.768D
            / var3); // L: 73
      ...
      for (var11 = 0; var11 < 5; ++var11) { // L: 76
        if (this.oscillatorVolume[var11] != 0) { // L: 77
          ...
          Instrument_pitchSteps[var11] = (int) (
              (double) (this.pitch.end - this.pitch.start) * 32.768D * Math
                  .pow(1.0057929410678534D, (double) this.oscillatorPitch[var11]) / var3); // L: 81
          Instrument_pitchBaseSteps[var11] = (int) ((double) this.pitch.start * 32.768D
              / var3); // L: 82
        }
      }
      ...
      for (var11 = 0; var11 < var1; ++var11) { // L: 84
        ...
        if (this.volumeMultiplier != null) { // L: 93
          ...
          var13 =
              var13 * ((this.evaluateWave(var10, var15, this.volumeMultiplier.form) >> 1) + 32768)
                  >> 15; // L: 96
        ...
        for (var14 = 0; var14 < 5; ++var14) { // L: 99
          if (this.oscillatorVolume[var14] != 0) { // L: 100
            ...
            if (var15 < var1) { // L: 102
              ...
              var10000[var14] +=
                  (var12 * Instrument_pitchSteps[var14] >> 16) + Instrument_pitchBaseSteps[var14];
            }
          }
        }
      }
      ...
      if (this.release != null) { // L: 108
        ...
        for (var14 = 0; var14 < var1; ++var14) { // L: 114
          ...
          if (var20) { // L: 117
            ...
            var12 = (var16 * (this.release.end - this.release.start) >> 8)
                + this.release.start; // L: 118
          }
      ...
      if (this.filter.pairs[0] > 0 || this.filter.pairs[1] > 0) { // L: 130
        ...
        if (var1 >= var12 + var13) { // L: 135
          ...
          while (var14 < var15) {
            var16 = (int) (
                (long) Instrument_samples[var14 + var12] * (long) AudioFilter.forwardMultiplier
                    >> 16); // L: 140
