...
public enum VerticalAlignment implements Enumerated {
  ...
  static final void method2889(int var0, int var1, int var2, int var3, int var4, int var5,
      int var6) {
    ...
    if (Client.oculusOrbState == 1 && Client.staffModLevel >= 2 && Client.cycle % 50 == 0 && (
        FriendSystem.oculusOrbFocalPointX >> 7 != class262.localPlayer.x >> 7
            || VarbitComposition.oculusOrbFocalPointY >> 7
            != class262.localPlayer.y >> 7)) { // L: 5507 5508
      ...
      PacketBufferNode var16 = InterfaceParent
          .getPacketBufferNode(ClientPacket.field2596, Client.packetWriter.isaacCipher); // L: 5514
