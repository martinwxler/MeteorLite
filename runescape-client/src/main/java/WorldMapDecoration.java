...
public class WorldMapDecoration {
  ...
  static final void method3710(int var0, int var1, int var2, int var3) {
    ...
    if (var4) { // L: 5348
      UserComparator4
          .drawActor2d(Client.players[Client.combatTargetPlayerIndex], var5, var0, var1, var2,
              var3); // L: 5349
    }
    ...
    for (var9 = 0; var9 < Client.overheadTextCount; ++var9) { // L: 5351
      ...
      while (var14) {
        ...
        for (int var19 = 0; var19 < var9; ++var19) { // L: 5359
          if (var11 + 2 > Client.overheadTextYs[var19] - Client.overheadTextAscents[var19]
              && var11 - var13 < Client.overheadTextYs[var19] + 2
              && var10 - var12 < Client.overheadTextXs[var19] + Client.overheadTextXOffsets[var19]
              && var12 + var10 > Client.overheadTextXs[var19] - Client.overheadTextXOffsets[var19]
              && Client.overheadTextYs[var19] - Client.overheadTextAscents[var19]
              < var11) { // L: 5360 5361
      ...
      if (Client.chatEffects == 0) { // L: 5371
        ...
        if (Client.overheadTextEffects[var9] == 0) { // L: 5395
          class309.fontBold12
              .drawCentered(var15, var0 + Client.viewportTempX, Client.viewportTempY + var1, var16,
                  0);
        }

        if (Client.overheadTextEffects[var9] == 1) { // L: 5396
          class309.fontBold12
              .drawCenteredWave(var15, var0 + Client.viewportTempX, Client.viewportTempY + var1,
                  var16, 0, Client.viewportDrawCount);
        }

        if (Client.overheadTextEffects[var9] == 2) { // L: 5397
          class309.fontBold12
              .drawCenteredWave2(var15, var0 + Client.viewportTempX, Client.viewportTempY + var1,
                  var16, 0, Client.viewportDrawCount);
        }

        if (Client.overheadTextEffects[var9] == 3) { // L: 5398
          class309.fontBold12
              .drawCenteredShake(var15, var0 + Client.viewportTempX, Client.viewportTempY + var1,
                  var16, 0, Client.viewportDrawCount,
        ...
        if (Client.overheadTextEffects[var9] == 4) { // L: 5399
          var17 = (150 - Client.overheadTextCyclesRemaining[var9]) * (
              class309.fontBold12.stringWidth(var15) + 100) / 150; // L: 5400
          Rasterizer2D.Rasterizer2D_expandClip(var0 + Client.viewportTempX - 50, var1,
              var0 + Client.viewportTempX + 50, var3 + var1); // L: 5401
          class309.fontBold12
              .draw(var15, var0 + Client.viewportTempX + 50 - var17, Client.viewportTempY + var1,
                  var16, 0); // L: 5402
        ...
        if (Client.overheadTextEffects[var9] == 5) { // L: 5405
          ...
          Rasterizer2D.Rasterizer2D_expandClip(var0,
              Client.viewportTempY + var1 - class309.fontBold12.ascent - 1, var0 + var2,
              Client.viewportTempY + var1 + 5); // L: 5410
          class309.fontBold12
              .drawCentered(var15, var0 + Client.viewportTempX, var18 + Client.viewportTempY + var1,
                  var16, 0); // L: 5411
          Rasterizer2D.Rasterizer2D_setClip(var0, var1, var0 + var2, var3 + var1); // L: 5412
        }
      } else {
        class309.fontBold12
            .drawCentered(var15, var0 + Client.viewportTempX, Client.viewportTempY + var1, 16776960,
                0); // L: 5416
      }
    }
