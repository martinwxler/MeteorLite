...
public class class106 {
  ...
  public static PlayerType[] PlayerType_values() {
    return new PlayerType[]{PlayerType.PlayerType_playerModerator, PlayerType.PlayerType_normal,
        PlayerType.PlayerType_ironman, PlayerType.PlayerType_jagexModerator,
        PlayerType.PlayerType_hardcoreIronman, PlayerType.field3544,
        PlayerType.PlayerType_ultimateIronman}; // L: 20
  }
  ...
  static VerticalAlignment[] method2373() {
    return new VerticalAlignment[]{VerticalAlignment.VerticalAlignment_centered,
        VerticalAlignment.field1676, VerticalAlignment.field1679}; // L: 14
  }
  ...
  static final byte[] decompressBytes(byte[] var0) {
    ...
    if (var3 < 0 || AbstractArchive.field3599 != 0 && var3 > AbstractArchive.field3599) { // L: 409
      ...
      if (var4 >= 0 && (AbstractArchive.field3599 == 0
          || var4 <= AbstractArchive.field3599)) { // L: 419
  ...
  static final int method2372() {
    if (class4.clientPreferences.roofsHidden) { // L: 4849
      ...
      int var0 = ItemContainer
          .getTileHeight(ObjectSound.cameraX, Canvas.cameraZ, SoundSystem.Client_plane); // L: 4850
      return var0 - class160.cameraY < 800 &&
          (Tiles.Tiles_renderFlags[SoundSystem.Client_plane][ObjectSound.cameraX >> 7][
              Canvas.cameraZ >> 7] & 4) != 0 ? SoundSystem.Client_plane : 3; // L: 4851 4852
    }
  }
