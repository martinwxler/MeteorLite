...
public class InvDefinition extends DualNode {
  ...
  static int method2699(int var0, Script var1, boolean var2) {
    ...
    if (var0 == ScriptOpcodes.CC_SETSCROLLPOS) { // L: 623
      ...
      var3.scrollY = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
          + 1]; // L: 628
      ...
      var3.fill =
          Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize] == 1; // L: 640
      ...
      var3.spriteTiling =
          Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize] == 1; // L: 665
      ...
      var3.modelOffsetY = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
          + 1]; // L: 678
      var3.modelAngleX = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
          + 2]; // L: 679
      var3.modelAngleY = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
          + 3]; // L: 680
      var3.modelAngleZ = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
          + 4]; // L: 681
      var3.modelZoom = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
          + 5]; // L: 682
      ...
      if (var0 == ScriptOpcodes.CC_SETMODELANIM) { // L: 686
        ...
        var3.modelOrthog =
            Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize] == 1; // L: 697
        ...
        var3.textYAlignment = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
            + 1]; // L: 717
        var3.textLineHeight = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
            + 2]; // L: 718
        Script.invalidateWidget(var3); // L: 719
        return 1; // L: 720
      } else if (var0 == ScriptOpcodes.CC_SETTEXTSHADOW) { // L: 722
        var3.textShadowed =
            Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize] == 1; // L: 723
        ...
        var3.spriteFlipV =
            Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize] == 1; // L: 738
        Script.invalidateWidget(var3); // L: 739
        return 1; // L: 740
      } else if (var0 == ScriptOpcodes.CC_SETHFLIP) { // L: 742
        var3.spriteFlipH =
            Interpreter.Interpreter_intStack[--ChatChannel.Interpreter_intStackSize] == 1; // L: 743
        ...
        var3.scrollHeight = Interpreter.Interpreter_intStack[ChatChannel.Interpreter_intStackSize
            + 1]; // L: 750
        Script.invalidateWidget(var3); // L: 751
        if (var4 != -1 && var3.type == 0) { // L: 752
          WorldMapLabelSize.revalidateWidgetScroll(
              GrandExchangeOfferOwnWorldComparator.Widget_interfaceComponents[var4 >> 16], var3,
              false);
        }
        ...
        FillMode var6 = (FillMode) Clock
            .findEnumerated(GrandExchangeEvent.FillMode_values(), var8); // L: 778
        if (var6 != null) { // L: 779
