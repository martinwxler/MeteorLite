...
public class PlayerComposition {
  ...
  public void method4837(int[] var1, class136[] var2, boolean var3, int[] var4, boolean var5,
      int var6) {
    ...
    if (var1 == null) { // L: 36
      ...
      for (int var5 = 0; var5 < 7; ++var5) { // L: 38
        for (int var6 = 0; var6 < TileItem.KitDefinition_fileCount; ++var6) { // L: 39
          ...
          if (var7 != null && !var7.nonSelectable
              && var7.bodypartID == (var3 ? 7 : 0) + var5) { // L: 41
  ...
  public void changeAppearance(int var1, boolean var2) {
    if (var1 != 1 || !this.isFemale) { // L: 56
      ...
      if (var3 != 0) { // L: 58
        ...
        } while (var4 == null || var4.nonSelectable
            || var1 + (this.isFemale ? 7 : 0) != var4.bodypartID); // L: 70
  ...
  public Model getModel(SequenceDefinition var1, int var2, SequenceDefinition var3, int var4) {
    if (this.npcTransformId != -1) { // L: 154
      return class248.getNpcDefinition(this.npcTransformId)
          .getModel(var1, var2, var3, var4); // L: 155
    } else {
      ...
      if (var18 == null) { // L: 172
        ...
        for (int var10 = 0; var10 < 12; ++var10) { // L: 174
          ...
          if (var11 >= 256 && var11 < 512 && !class23.KitDefinition_get(var11 - 256)
              .ready()) { // L: 176 177
            var9 = true;
          }

          if (var11 >= 512 && !class250.ItemDefinition_get(var11 - 512)
              .hasNoValidModel(this.isFemale)) { // L: 179 180
            var9 = true;
          }
        }
        ...
        if (var18 == null) { // L: 187
            ...
            if (var13 >= 512) { // L: 196
              ...
              if (var15 != null) { // L: 199
                if (this.field2939 != null) { // L: 200
                  ...
                  if (var16 != null) { // L: 202
                    int var17;
                    if (var16.field1542 != null && var22.recolorFrom != null
                        && var22.recolorTo.length == var16.field1542.length) { // L: 203
                      for (var17 = 0; var17 < var22.recolorFrom.length; ++var17) { // L: 204
                        var15.recolor(var22.recolorTo[var17], var16.field1542[var17]); // L: 205
                      }
                    }

                    if (var16.field1541 != null && var22.retextureFrom != null
                        && var16.field1541.length == var22.retextureTo.length) { // L: 208
          ...
          for (var13 = 0; var13 < 5; ++var13) { // L: 220
            if (this.bodyColors[var13] < class69.field568[var13].length) { // L: 221
              var20.recolor(VarcInt.field1581[var13],
                  class69.field568[var13][this.bodyColors[var13]]);
            }

            if (this.bodyColors[var13] < Skills.field3175[var13].length) { // L: 222
              var20.recolor(ModelData0.field2517[var13],
                  Skills.field3175[var13][this.bodyColors[var13]]);
            }
          }
  ...
  ModelData getModelData() {
    if (this.npcTransformId != -1) { // L: 238
      ...
      for (int var2 = 0; var2 < 12; ++var2) { // L: 242
        ...
        if (var3 >= 256 && var3 < 512 && !class23.KitDefinition_get(var3 - 256)
            .method2754()) { // L: 244 245
          var1 = true;
        }

        if (var3 >= 512 && !class250.ItemDefinition_get(var3 - 512)
            .method3102(this.isFemale)) { // L: 247 248
          var1 = true;
        }
      }
  ...
  public int getChatHeadId() {
    return this.npcTransformId == -1 ? (this.equipment[0] << 15) + this.equipment[1] + (
        this.equipment[11] << 5) + (this.equipment[8] << 10) + (this.bodyColors[0] << 25) + (
        this.bodyColors[4] << 20)
        : 305419896 + class248.getNpcDefinition(this.npcTransformId).id; // L: 274 275
  }
}
