...
public class FriendsList extends UserList {
  ...
  static void method5711(int var0, String var1) {
    ...
    for (int var6 = 0; var6 < var2; ++var6) { // L: 8741
      ...
      if (var7 != null && var7 != class262.localPlayer && var7.username != null && var7.username
          .equals(var5)) { // L: 8743
        PacketBufferNode var8;
        if (var0 == 1) { // L: 8744
          var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2618,
              Client.packetWriter.isaacCipher); // L: 8746
          ...
          var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2627,
              Client.packetWriter.isaacCipher); // L: 8753
          ...
          var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2605,
              Client.packetWriter.isaacCipher); // L: 8760
          ...
          var8 = InterfaceParent.getPacketBufferNode(ClientPacket.field2673,
              Client.packetWriter.isaacCipher); // L: 8767
  ...
  public void read(Buffer var1, int var2) {
    while (true) {
      if (var1.offset < var2) { // L: 37
        ...
        Username var4 = new Username(var1.readStringCp1252NullTerminated(),
            this.loginType); // L: 39
        Username var5 = new Username(var1.readStringCp1252NullTerminated(),
            this.loginType); // L: 40
          ...
          if (var11 != null) { // L: 65
            ...
            if (var6 != var11.world) { // L: 67
              ...
              for (FriendLoginUpdate var13 = (FriendLoginUpdate) this.friendLoginUpdates.last();
                  var13 != null;
                  var13 = (FriendLoginUpdate) this.friendLoginUpdates.previous()) { // L: 69
