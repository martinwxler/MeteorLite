...
public class class286 {
  ...
  public class286() {
    ...
    for (byte var3 = 12; var1 < 16; var2 -= var3) { // L: 25
      var4 = class93.method2186((double) ((float) var2 / 360.0F), 0.9998999834060669D,
          (double) (0.425F * (float) var1 / 16.0F + 0.075F)); // L: 27
    ...
    for (int var6 = var2 / 6; var1 < class379.field4145.length; var2 -= var6) { // L: 31 32 38
      ...
      for (int var5 = class93
          .method2186((double) ((float) var2 / 360.0F), 0.9998999834060669D, 0.5D);
          var1 < var4 && var1 < class379.field4145.length; ++var1) { // L: 34 35
  ...
  void method5250(int var1) {
    ...
    for (int var8 = 0; var8 < var2; ++var8) { // L: 49
      for (int var9 = 0; var9 < var2; ++var9) { // L: 50
        int var10 = var6[var9 + var2 * var8] = (int) (256.0D * (var3[var8] * var3[var9]
            / var4)); // L: 51
