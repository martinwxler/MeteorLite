...
public class Coord {
  ...
  static final void method4790() {
    ...
    int var2 = ItemContainer.getTileHeight(var0, var1, SoundSystem.Client_plane)
        - Client.field659; // L: 3898
    if (ObjectSound.cameraX < var0) { // L: 3899
      ObjectSound.cameraX = (var0 - ObjectSound.cameraX) * FloorUnderlayDefinition.field1707 / 1000
          + ObjectSound.cameraX + Message.field602; // L: 3900
    ...
    if (ObjectSound.cameraX > var0) { // L: 3903
      ObjectSound.cameraX -= FloorUnderlayDefinition.field1707 * (ObjectSound.cameraX - var0) / 1000
          + Message.field602; // L: 3904
    ...
    if (class160.cameraY < var2) { // L: 3907
      class160.cameraY =
          (var2 - class160.cameraY) * FloorUnderlayDefinition.field1707 / 1000 + class160.cameraY
              + Message.field602; // L: 3908
    ...
    if (class160.cameraY > var2) { // L: 3911
      class160.cameraY -= FloorUnderlayDefinition.field1707 * (class160.cameraY - var2) / 1000
          + Message.field602; // L: 3912
    ...
    if (Canvas.cameraZ < var1) { // L: 3915
      Canvas.cameraZ =
          (var1 - Canvas.cameraZ) * FloorUnderlayDefinition.field1707 / 1000 + Canvas.cameraZ
              + Message.field602; // L: 3916
    ...
    if (Canvas.cameraZ > var1) { // L: 3919
      Canvas.cameraZ -= FloorUnderlayDefinition.field1707 * (Canvas.cameraZ - var1) / 1000
          + Message.field602; // L: 3920
    ...
    var2 = ItemContainer.getTileHeight(var0, var1, SoundSystem.Client_plane)
        - FriendsChat.field3815; // L: 3925
    ...
    if (class69.cameraPitch < var7) { // L: 3934
      class69.cameraPitch =
          (var7 - class69.cameraPitch) * class20.field166 / 1000 + class69.cameraPitch
              + GrandExchangeOfferOwnWorldComparator.field607; // L: 3935
    ...
    if (class69.cameraPitch > var7) { // L: 3938
      class69.cameraPitch -= class20.field166 * (class69.cameraPitch - var7) / 1000
          + GrandExchangeOfferOwnWorldComparator.field607; // L: 3939
    ...
    if (var9 > 0) { // L: 3945
      class32.cameraYaw = class32.cameraYaw + GrandExchangeOfferOwnWorldComparator.field607
          + var9 * class20.field166 / 1000; // L: 3946
      class32.cameraYaw &= 2047; // L: 3947
    }

    if (var9 < 0) { // L: 3949
      class32.cameraYaw -= -var9 * class20.field166 / 1000
          + GrandExchangeOfferOwnWorldComparator.field607; // L: 3950
  ...
  static final void Clan_joinChat(String var0) {
    if (!var0.equals("")) { // L: 11479
      PacketBufferNode var1 = InterfaceParent
          .getPacketBufferNode(ClientPacket.field2667, Client.packetWriter.isaacCipher); // L: 11481
  ...
  String toString(String var1) {
    return this.plane + var1 + (this.x >> 6) + var1 + (this.y >> 6) + var1 + (this.x & 63) + var1
        + (this.y & 63); // L: 55
  }
