...
public interface ItemComposition extends ParamHolder {
   ...
   * <p>
   * Calling this method on a noted item will result in the ID of itself in unnoted form, and on an
   * unnoted item its noted variant.
   *
   ...
   * <p>
   * Calling this method on a normal item will result in the ID of itself in placeholder form, and
   * on a placeholder item its normal variant.
   *
   ...
   * <p>
   * Although not all items can be found in a store, they have a store price which can be used to
   * calculate high and low alchemy values. Multiplying the price by {@code 0.6} and {@code 0.4}
   * gives these high and low alchemy values, respectively.
   *
  ...
  /**
   * Get the high alchemy price for this item. All items have a high alchemy price, but not all
   * items can be alched.
   *
  ...
  /**
   * Since the client reuses item models, it stores colors that can be replaced. This returns what
   * colors the item model will be replaced with.
   *
  ...
  /**
   * Since the client reuses item models, it stores textures that can be replaced. This returns what
   * textures the item model will be replaced with.
   *
