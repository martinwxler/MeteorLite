...
public abstract class WorldHoppingMixin implements RSClient
{
	...
	public void openWorldHopper()
	{
		...
		invokeMenuAction("World Switcher", "", 1, MenuAction.CC_OP.getId(), -1, WidgetInfo.WORLD_SWITCHER_BUTTON.getPackedId());
	}
	...
	public void hopToWorld(World world)
	{
		...
		invokeMenuAction("Switch", "<col=ff9040>" + (worldId - 300) + "</col>", 1, MenuAction.CC_OP.getId(), worldId, WidgetInfo.WORLD_SWITCHER_LIST.getPackedId());
	}
}
