...
public abstract class Rasterizer2DMixin implements RSClient {
  ...
  private static void copy$drawGradientAlpha(int var0, int var1, int var2, int var3, int var4,
      ...
      for (int var12 = -var3; var12 < 0; ++var12) {
        ...
        if (var15 == 0) {
          ...
          int var16 = (var14 * (var5 & 16711935) + var13 * (var4 & 16711935) & -16711936) + (
              var14 * (var5 & 65280) + var13 * (var4 & 65280) & 16711680) >>> 8;
          int var17 = 255 - var15;
          int var18 =
              ((var16 & 16711935) * var15 >> 8 & 16711935) + (var15 * (var16 & 65280) >> 8 & 65280);
  ...
  public static void copy$raster2d7(int var0, int var1, int var2, int var3, int var4, int var5,
      byte[] var6, int var7) {
    final int width = client.getGraphicsPixelsWidth();
          ...
          for (var15 = var9 + var1; var15 < var3 + var9 + var1; ++var15) {
            for (var16 = var0 + var8; var16 < var0 + var8 + var2; ++var16) {
              ...
              int var23 = ((var19 & 16711935) * var20 + (var22 & 16711935) * var21 & -16711936) + (
                  var20 * (var19 & 65280) + var21 * (var22 & 65280) & 16711680) >> 8;
